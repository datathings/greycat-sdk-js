...
export namespace compute {
  ...
  export class ComputeOperationCelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCelu {
      return new ComputeOperationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[1], input, output, alpha);
    }
  ...
  export class ComputeOperationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output, slope, shift}: {input: string, output: string, slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationHardSigmoid {
      return new ComputeOperationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[2], input, output, slope, shift);
    }
  ...
  export class ComputeLayerSeq extends $sdk.GCObject {
    ...
    static createFrom({name, calls, optimizer}: {name: string, calls: globalThis.Array<compute.ComputeLayerCall>, optimizer: compute.ComputeOptimizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerSeq {
      return new ComputeLayerSeq($g.abi.libs_by_name.get(algebralib.name)!.mapped[3], name, calls, optimizer);
    }
  ...
  export class ComputeOperationSumIf extends $sdk.GCObject {
    ...
    static createFrom({input, ifCondition, output, counts, classes}: {input: string, ifCondition: string, output: string, counts: string, classes: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSumIf {
      return new ComputeOperationSumIf($g.abi.libs_by_name.get(algebralib.name)!.mapped[4], input, ifCondition, output, counts, classes);
    }
  ...
  export class ComputeOperationAddBias extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAddBias {
      return new ComputeOperationAddBias($g.abi.libs_by_name.get(algebralib.name)!.mapped[5], input, input2, output);
    }
  ...
  export class ComputeOptimizerMomentum extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerMomentum {
      return new ComputeOptimizerMomentum($g.abi.libs_by_name.get(algebralib.name)!.mapped[6], learning_rate, decay_rate);
    }
  ...
  export class ComputeOperationLeCunTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeCunTanh {
      return new ComputeOperationLeCunTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[8], input, output);
    }
  ...
  export class ComputeBinding extends $sdk.GCObject {
    ...
    static createFrom({src_layer_name, src_var_name, target_var_name}: {src_layer_name: string, src_var_name: string, target_var_name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeBinding {
      return new ComputeBinding($g.abi.libs_by_name.get(algebralib.name)!.mapped[9], src_layer_name, src_var_name, target_var_name);
    }
  ...
  export class ComputeInitializerConstant extends $sdk.GCObject {
    ...
    static createFrom({value}: {value: any}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerConstant {
      return new ComputeInitializerConstant($g.abi.libs_by_name.get(algebralib.name)!.mapped[10], value);
    }
  ...
  export class ComputeVarConst extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarConst {
      return new ComputeVarConst($g.abi.libs_by_name.get(algebralib.name)!.mapped[11], name, type, shape);
    }
  ...
  export class ComputeLayerLSTM extends $sdk.GCObject {
    ...
    static createFrom({name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences}: {name: string, bias_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_regularizer: compute.ComputeRegularizer | null, type: $sdk.std.core.TensorType, use_bias: boolean | null, return_sequences: boolean | null, bidirectional: boolean | null, auto_init_states: boolean | null, inputs: bigint | number, outputs: bigint | number, layers: bigint | number, sequences: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLSTM {
      return new ComputeLayerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[12], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
    }
  ...
  export class ComputeOperationTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTanh {
      return new ComputeOperationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[13], input, output);
    }
  ...
  export class ComputeOperationEuclidean extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationEuclidean {
      return new ComputeOperationEuclidean($g.abi.libs_by_name.get(algebralib.name)!.mapped[15], input, input2, output);
    }
  ...
  export class ComputeOperationAtanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtanh {
      return new ComputeOperationAtanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[16], input, output);
    }
  ...
  export class ComputeOperationSqrt extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSqrt {
      return new ComputeOperationSqrt($g.abi.libs_by_name.get(algebralib.name)!.mapped[17], input, output);
    }
  ...
  export class ComputeInitializerIdentity extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerIdentity {
      return new ComputeInitializerIdentity($g.abi.libs_by_name.get(algebralib.name)!.mapped[18]);
    }
  ...
  export class ComputeLayerLossRegression extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeRegressionLoss}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossRegression {
      return new ComputeLayerLossRegression($g.abi.libs_by_name.get(algebralib.name)!.mapped[21], name, reduction, loss_type);
    }
  ...
  export class ComputeLayerLinear extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLinear {
      return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[23], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
    }
  ...
  export class ComputeLayerActivation extends $sdk.GCObject {
    ...
    static createFrom({name, activation}: {name: string, activation: compute.ComputeActivation}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerActivation {
      return new ComputeLayerActivation($g.abi.libs_by_name.get(algebralib.name)!.mapped[24], name, activation);
    }
  ...
  export class ComputeOperationTan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTan {
      return new ComputeOperationTan($g.abi.libs_by_name.get(algebralib.name)!.mapped[26], input, output);
    }
  ...
  export class ComputeInitializerLSTM extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLSTM {
      return new ComputeInitializerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[27]);
    }
  ...
  export class ComputeOperationAcos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcos {
      return new ComputeOperationAcos($g.abi.libs_by_name.get(algebralib.name)!.mapped[28], input, output);
    }
  ...
  export class ComputeOptimizerRmsProp extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate, smooth_epsilon}: {learning_rate: number | null, decay_rate: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerRmsProp {
      return new ComputeOptimizerRmsProp($g.abi.libs_by_name.get(algebralib.name)!.mapped[33], learning_rate, decay_rate, smooth_epsilon);
    }
  ...
  export class ComputeOperationSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSign {
      return new ComputeOperationSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[35], input, output);
    }
  ...
  export class ComputeVarOptimize extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, l1, l2, init}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, l1: number, l2: number, init: compute.ComputeInitializer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarOptimize {
      return new ComputeVarOptimize($g.abi.libs_by_name.get(algebralib.name)!.mapped[37], name, type, shape, l1, l2, init);
    }
  ...
  export class ComputeActivationSelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSelu {
      return new ComputeActivationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[40]);
    }
  ...
  export class ComputeVarInOut extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, with_grad}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, with_grad: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarInOut {
      return new ComputeVarInOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[41], name, type, shape, with_grad);
    }
  ...
  export class ComputeOperationCos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCos {
      return new ComputeOperationCos($g.abi.libs_by_name.get(algebralib.name)!.mapped[42], input, output);
    }
  ...
  export class ComputeInitializerXavier extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavier {
      return new ComputeInitializerXavier($g.abi.libs_by_name.get(algebralib.name)!.mapped[43]);
    }
  ...
  export class ComputeLayerLossClassification extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeClassificationLoss, has_class_weights: boolean, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossClassification {
      return new ComputeLayerLossClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[44], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOptimizerAdaGrad extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, initial_accumulator, smooth_epsilon}: {learning_rate: number | null, initial_accumulator: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaGrad {
      return new ComputeOptimizerAdaGrad($g.abi.libs_by_name.get(algebralib.name)!.mapped[47], learning_rate, initial_accumulator, smooth_epsilon);
    }
  ...
  export class ComputeOperationSoftSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftSign {
      return new ComputeOperationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[48], input, output);
    }
  ...
  export class ComputeOperationArgMin extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMin {
      return new ComputeOperationArgMin($g.abi.libs_by_name.get(algebralib.name)!.mapped[49], input, output, output2);
    }
  ...
  export class ComputeActivationSigmoid extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSigmoid {
      return new ComputeActivationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[50]);
    }
  ...
  export class ComputeInitializerSigmoidUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerSigmoidUniform {
      return new ComputeInitializerSigmoidUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[51]);
    }
  ...
  export class ComputeLayerDense extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[52], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
    static create(name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[52], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
  ...
  export class ComputeModel extends $sdk.GCObject {
    ...
    static createFrom({layers}: {layers: globalThis.Array<compute.ComputeLayer>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeModel {
      return new ComputeModel($g.abi.libs_by_name.get(algebralib.name)!.mapped[53], layers);
    }
  ...
  export class ComputeLayerClassification extends $sdk.GCObject {
    ...
    static createFrom({name, calculate_probabilities, from_logits}: {name: string, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerClassification {
      return new ComputeLayerClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[54], name, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOperationLog extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLog {
      return new ComputeOperationLog($g.abi.libs_by_name.get(algebralib.name)!.mapped[55], input, output);
    }
  ...
  export class ComputeInitializerUniformIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformIn {
      return new ComputeInitializerUniformIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[57]);
    }
  ...
  export class ComputeOperationClip extends $sdk.GCObject {
    ...
    static createFrom({input, output, min, max}: {input: string, output: string, min: number | null, max: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationClip {
      return new ComputeOperationClip($g.abi.libs_by_name.get(algebralib.name)!.mapped[58], input, output, min, max);
    }
  ...
  export class ComputeOperationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftmax {
      return new ComputeOperationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[59], input, output);
    }
  ...
  export class ComputeOperationSelu extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSelu {
      return new ComputeOperationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[60], input, output);
    }
  ...
  export class ComputeOperationElu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationElu {
      return new ComputeOperationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[61], input, output, alpha);
    }
  ...
  export class ComputeInitializerGlorotUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerGlorotUniform {
      return new ComputeInitializerGlorotUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[62]);
    }
  ...
  export class ComputeOperationSin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSin {
      return new ComputeOperationSin($g.abi.libs_by_name.get(algebralib.name)!.mapped[64], input, output);
    }
  ...
  export class ComputeOperationAvg extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAvg {
      return new ComputeOperationAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[65], input, input2, output);
    }
  ...
  export class ComputeInitializerNone extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNone {
      return new ComputeInitializerNone($g.abi.libs_by_name.get(algebralib.name)!.mapped[67]);
    }
  ...
  export class ComputeOptimizerSgd extends $sdk.GCObject {
    ...
    static createFrom({learning_rate}: {learning_rate: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerSgd {
      return new ComputeOptimizerSgd($g.abi.libs_by_name.get(algebralib.name)!.mapped[68], learning_rate);
    }
  ...
  export class ComputeOperationMatMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output, transposeA, transposeB, alpha, beta}: {input: string, input2: string, output: string, transposeA: boolean, transposeB: boolean, alpha: number, beta: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMatMul {
      return new ComputeOperationMatMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[70], input, input2, output, transposeA, transposeB, alpha, beta);
    }
  ...
  export class ComputeOptimizerAdaMax extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaMax {
      return new ComputeOptimizerAdaMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[71], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeOperationArgMax extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMax {
      return new ComputeOperationArgMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[72], input, output, output2);
    }
  ...
  export class ComputeInitializerXavierUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavierUniform {
      return new ComputeInitializerXavierUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[76]);
    }
  ...
  export class ComputeOptimizerAdaDelta extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate, smooth_epsilon}: {learning_rate: number | null, decay_rate: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaDelta {
      return new ComputeOptimizerAdaDelta($g.abi.libs_by_name.get(algebralib.name)!.mapped[79], learning_rate, decay_rate, smooth_epsilon);
    }
  ...
  export class ComputeOperationAcosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcosh {
      return new ComputeOperationAcosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[80], input, output);
    }
  ...
  export class ComputeOperationAbs extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAbs {
      return new ComputeOperationAbs($g.abi.libs_by_name.get(algebralib.name)!.mapped[84], input, output);
    }
  ...
  export class ComputeActivationSoftplus extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftplus {
      return new ComputeActivationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[87]);
    }
  ...
  export class ComputeOptimizerNadam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNadam {
      return new ComputeOptimizerNadam($g.abi.libs_by_name.get(algebralib.name)!.mapped[88], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeOperationPow extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationPow {
      return new ComputeOperationPow($g.abi.libs_by_name.get(algebralib.name)!.mapped[90], input, input2, output);
    }
  ...
  export class ComputeRegularizer extends $sdk.GCObject {
    ...
    static createFrom({l1, l2}: {l1: number, l2: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeRegularizer {
      return new ComputeRegularizer($g.abi.libs_by_name.get(algebralib.name)!.mapped[91], l1, l2);
    }
  ...
  export class ComputeOperationCosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCosh {
      return new ComputeOperationCosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[94], input, output);
    }
  ...
  export class ComputeInitializerNormalAvg extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalAvg {
      return new ComputeInitializerNormalAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[95]);
    }
  ...
  export class ComputeInitializerLeCunUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLeCunUniform {
      return new ComputeInitializerLeCunUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[97]);
    }
  ...
  export class ComputeOperationSub extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSub {
      return new ComputeOperationSub($g.abi.libs_by_name.get(algebralib.name)!.mapped[99], input, input2, output);
    }
  ...
  export class ComputeOperationFilter extends $sdk.GCObject {
    ...
    static createFrom({input, output, mask, nbOutputs}: {input: string, output: string, mask: string, nbOutputs: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationFilter {
      return new ComputeOperationFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[100], input, output, mask, nbOutputs);
    }
  ...
  export class ComputeInitializerNormalOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalOut {
      return new ComputeInitializerNormalOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[101]);
    }
  ...
  export class ComputeLayerMinMaxScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerMinMaxScaler {
      return new ComputeLayerMinMaxScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[102], name, type, inverse_transform);
    }
  ...
  export class ComputeOperationSoftplus extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftplus {
      return new ComputeOperationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[103], input, output);
    }
  ...
  export class ComputeInitializerRelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerRelu {
      return new ComputeInitializerRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[104]);
    }
  ...
  export class ComputeVarProxy extends $sdk.GCObject {
    ...
    static createFrom({name}: {name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarProxy {
      return new ComputeVarProxy($g.abi.libs_by_name.get(algebralib.name)!.mapped[106], name);
    }
  ...
  export class ComputeLayerPCAScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerPCAScaler {
      return new ComputeLayerPCAScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[108], name, type, inverse_transform);
    }
  ...
  export class ComputeInitializerUniformOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformOut {
      return new ComputeInitializerUniformOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[109]);
    }
  ...
  export class ComputeInitializerNormal extends $sdk.GCObject {
    ...
    static createFrom({avg, std}: {avg: number, std: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormal {
      return new ComputeInitializerNormal($g.abi.libs_by_name.get(algebralib.name)!.mapped[111], avg, std);
    }
  ...
  export class ComputeOperationSinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSinh {
      return new ComputeOperationSinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[112], input, output);
    }
  ...
  export class ComputeOperationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha, max_value, threshold}: {input: string, output: string, alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeakyRelu {
      return new ComputeOperationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[113], input, output, alpha, max_value, threshold);
    }
  ...
  export class ComputeOperationNeg extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationNeg {
      return new ComputeOperationNeg($g.abi.libs_by_name.get(algebralib.name)!.mapped[114], input, output);
    }
  ...
  export class ComputeOperationAtan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtan {
      return new ComputeOperationAtan($g.abi.libs_by_name.get(algebralib.name)!.mapped[116], input, output);
    }
  ...
  export class ComputeOperationRaiseToPower extends $sdk.GCObject {
    ...
    static createFrom({input, output, power}: {input: string, output: string, power: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationRaiseToPower {
      return new ComputeOperationRaiseToPower($g.abi.libs_by_name.get(algebralib.name)!.mapped[118], input, output, power);
    }
  ...
  export class ComputeOperationAsin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsin {
      return new ComputeOperationAsin($g.abi.libs_by_name.get(algebralib.name)!.mapped[119], input, output);
    }
  ...
  export class ComputeOperationAdd extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAdd {
      return new ComputeOperationAdd($g.abi.libs_by_name.get(algebralib.name)!.mapped[121], input, input2, output);
    }
  ...
  export class ComputeInitializerReluUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerReluUniform {
      return new ComputeInitializerReluUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[123]);
    }
  ...
  export class ComputeLayerStandardScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerStandardScaler {
      return new ComputeLayerStandardScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[124], name, type, inverse_transform);
    }
...
export namespace nn {
  ...
  export class RegressionNetwork extends $sdk.GCObject {
    ...
    static createFrom({inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput}: {inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): RegressionNetwork {
      return new RegressionNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[136], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput);
    }
    static create(inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null, $g: $sdk.GreyCat = globalThis.greycat.default): RegressionNetwork {
      return new RegressionNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[136], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput);
    }
...
export const algebralib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[0].resolveGeneratedOffsets('input','input2','output');
    this.mapped[1] = abi.type_by_fqn.get(compute.ComputeOperationCelu._type)!;
    this.mapped[1].resolveGeneratedOffsets('input','output','alpha');
    this.mapped[1].static_values = [1.0];
    this.mapped[2] = abi.type_by_fqn.get(compute.ComputeOperationHardSigmoid._type)!;
    this.mapped[2].resolveGeneratedOffsets('input','output','slope','shift');
    this.mapped[2].static_values = [0.2,0.5];
    this.mapped[3] = abi.type_by_fqn.get(compute.ComputeLayerSeq._type)!;
    this.mapped[3].resolveGeneratedOffsets('name','calls','optimizer');
    this.mapped[4] = abi.type_by_fqn.get(compute.ComputeOperationSumIf._type)!;
    this.mapped[4].resolveGeneratedOffsets('input','ifCondition','output','counts','classes');
    this.mapped[5] = abi.type_by_fqn.get(compute.ComputeOperationAddBias._type)!;
    this.mapped[5].resolveGeneratedOffsets('input','input2','output');
    this.mapped[6] = abi.type_by_fqn.get(compute.ComputeOptimizerMomentum._type)!;
    this.mapped[6].resolveGeneratedOffsets('learning_rate','decay_rate');
    this.mapped[6].static_values = [0.001,0.9];
    this.mapped[7] = abi.type_by_fqn.get(compute.ComputeOperationLogSoftmax._type)!;
    this.mapped[7].resolveGeneratedOffsets('input','output','axis');
    this.mapped[8] = abi.type_by_fqn.get(compute.ComputeOperationLeCunTanh._type)!;
    this.mapped[8].resolveGeneratedOffsets('input','output');
    this.mapped[9] = abi.type_by_fqn.get(compute.ComputeBinding._type)!;
    this.mapped[9].resolveGeneratedOffsets('src_layer_name','src_var_name','target_var_name');
    this.mapped[10] = abi.type_by_fqn.get(compute.ComputeInitializerConstant._type)!;
    this.mapped[10].resolveGeneratedOffsets('value');
    this.mapped[11] = abi.type_by_fqn.get(compute.ComputeVarConst._type)!;
    this.mapped[11].resolveGeneratedOffsets('name','type','shape');
    this.mapped[12] = abi.type_by_fqn.get(compute.ComputeLayerLSTM._type)!;
    this.mapped[12].resolveGeneratedOffsets('name','bias_initializer','weight_regularizer','bias_regularizer','type','use_bias','return_sequences','bidirectional','auto_init_states','inputs','outputs','layers','sequences');
    this.mapped[12].static_values = ["input","output","hx","cx","hy","cy","weight","bias","internal_i","internal_f","internal_cp","internal_o","internal_h","internal_c","internal_mult","internal_output"];
    this.mapped[13] = abi.type_by_fqn.get(compute.ComputeOperationTanh._type)!;
    this.mapped[13].resolveGeneratedOffsets('input','output');
    this.mapped[14] = abi.type_by_fqn.get(compute.ComputeLayerFilter._type)!;
    this.mapped[14].resolveGeneratedOffsets('name','type','inputs','outputs','maskValues');
    this.mapped[14].static_values = ["input","output","mask"];
    this.mapped[15] = abi.type_by_fqn.get(compute.ComputeOperationEuclidean._type)!;
    this.mapped[15].resolveGeneratedOffsets('input','input2','output');
    this.mapped[16] = abi.type_by_fqn.get(compute.ComputeOperationAtanh._type)!;
    this.mapped[16].resolveGeneratedOffsets('input','output');
    this.mapped[17] = abi.type_by_fqn.get(compute.ComputeOperationSqrt._type)!;
    this.mapped[17].resolveGeneratedOffsets('input','output');
    this.mapped[18] = abi.type_by_fqn.get(compute.ComputeInitializerIdentity._type)!;
    this.mapped[19] = abi.type_by_fqn.get(compute.ComputeOptimizer._type)!;
    this.mapped[19].resolveGeneratedOffsets('learning_rate');
    this.mapped[20] = abi.type_by_fqn.get(compute.ComputeOperation._type)!;
    this.mapped[21] = abi.type_by_fqn.get(compute.ComputeLayerLossRegression._type)!;
    this.mapped[21].resolveGeneratedOffsets('name','reduction','loss_type');
    this.mapped[22] = abi.type_by_fqn.get(compute.ComputeActivationExp._type)!;
    this.mapped[23] = abi.type_by_fqn.get(compute.ComputeLayerLinear._type)!;
    this.mapped[23].resolveGeneratedOffsets('name','type','inputs','outputs','use_bias','weight_initializer','weight_regularizer','bias_initializer','bias_regularizer');
    this.mapped[23].static_values = ["input","output","weight","bias","mult"];
    this.mapped[24] = abi.type_by_fqn.get(compute.ComputeLayerActivation._type)!;
    this.mapped[24].resolveGeneratedOffsets('name','activation');
    this.mapped[24].static_values = ["input","output"];
    ...
    this.mapped[26] = abi.type_by_fqn.get(compute.ComputeOperationTan._type)!;
    this.mapped[26].resolveGeneratedOffsets('input','output');
    this.mapped[27] = abi.type_by_fqn.get(compute.ComputeInitializerLSTM._type)!;
    this.mapped[28] = abi.type_by_fqn.get(compute.ComputeOperationAcos._type)!;
    this.mapped[28].resolveGeneratedOffsets('input','output');
    this.mapped[29] = abi.type_by_fqn.get(compute.ComputeCounter._type)!;
    this.mapped[29].resolveGeneratedOffsets('epoch','optimizationSteps','batchNotOptimized');
    this.mapped[30] = abi.type_by_fqn.get(compute.ComputeReduction._type)!;
    this.mapped[30].resolveGeneratedOffsetWithValues('auto', "auto",'none', "none",'sum', "sum",'mean', "mean",'disabled', "disabled");
    ...
    this.mapped[32].resolveGeneratedOffsets('input','output','max_value','threshold');
    this.mapped[32].static_values = [0.0];
    this.mapped[33] = abi.type_by_fqn.get(compute.ComputeOptimizerRmsProp._type)!;
    this.mapped[33].resolveGeneratedOffsets('learning_rate','decay_rate','smooth_epsilon');
    this.mapped[33].static_values = [0.001,0.9,0.0000001];
    this.mapped[34] = abi.type_by_fqn.get(compute.ComputeLayerLoss._type)!;
    this.mapped[34].resolveGeneratedOffsets('name','reduction');
    this.mapped[34].static_values = ["computed","expected","loss"];
    this.mapped[35] = abi.type_by_fqn.get(compute.ComputeOperationSign._type)!;
    this.mapped[35].resolveGeneratedOffsets('input','output');
    this.mapped[36] = abi.type_by_fqn.get(compute.ComputeInitializer._type)!;
    this.mapped[37] = abi.type_by_fqn.get(compute.ComputeVarOptimize._type)!;
    this.mapped[37].resolveGeneratedOffsets('name','type','shape','l1','l2','init');
    this.mapped[38] = abi.type_by_fqn.get(compute.ComputeOperationArg._type)!;
    ...
    this.mapped[39].resolveGeneratedOffsets('input','output','axis');
    this.mapped[40] = abi.type_by_fqn.get(compute.ComputeActivationSelu._type)!;
    this.mapped[41] = abi.type_by_fqn.get(compute.ComputeVarInOut._type)!;
    this.mapped[41].resolveGeneratedOffsets('name','type','shape','with_grad');
    this.mapped[42] = abi.type_by_fqn.get(compute.ComputeOperationCos._type)!;
    this.mapped[42].resolveGeneratedOffsets('input','output');
    this.mapped[43] = abi.type_by_fqn.get(compute.ComputeInitializerXavier._type)!;
    this.mapped[44] = abi.type_by_fqn.get(compute.ComputeLayerLossClassification._type)!;
    this.mapped[44].resolveGeneratedOffsets('name','reduction','loss_type','has_class_weights','calculate_probabilities','from_logits');
    this.mapped[44].static_values = ["class_weights","predicted_classes","probabilities","sum_reduce"];
    this.mapped[45] = abi.type_by_fqn.get(compute.ComputeState._type)!;
    ...
    this.mapped[47] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaGrad._type)!;
    this.mapped[47].resolveGeneratedOffsets('learning_rate','initial_accumulator','smooth_epsilon');
    this.mapped[47].static_values = [0.001,0.1,0.0000001];
    this.mapped[48] = abi.type_by_fqn.get(compute.ComputeOperationSoftSign._type)!;
    this.mapped[48].resolveGeneratedOffsets('input','output');
    this.mapped[49] = abi.type_by_fqn.get(compute.ComputeOperationArgMin._type)!;
    this.mapped[49].resolveGeneratedOffsets('input','output','output2');
    this.mapped[50] = abi.type_by_fqn.get(compute.ComputeActivationSigmoid._type)!;
    this.mapped[51] = abi.type_by_fqn.get(compute.ComputeInitializerSigmoidUniform._type)!;
    this.mapped[52] = abi.type_by_fqn.get(compute.ComputeLayerDense._type)!;
    this.mapped[52].resolveGeneratedOffsets('name','type','inputs','outputs','use_bias','weight_initializer','weight_regularizer','bias_initializer','bias_regularizer','activation');
    this.mapped[52].static_values = ["input","output","weight","bias","mult","pre_activation"];
    this.mapped[53] = abi.type_by_fqn.get(compute.ComputeModel._type)!;
    this.mapped[53].resolveGeneratedOffsets('layers');
    this.mapped[54] = abi.type_by_fqn.get(compute.ComputeLayerClassification._type)!;
    this.mapped[54].resolveGeneratedOffsets('name','calculate_probabilities','from_logits');
    this.mapped[54].static_values = ["input","predicted_classes","probabilities"];
    this.mapped[55] = abi.type_by_fqn.get(compute.ComputeOperationLog._type)!;
    ...
    this.mapped[56].resolveGeneratedOffsets('slope','shift');
    this.mapped[56].static_values = [0.2,0.5];
    this.mapped[57] = abi.type_by_fqn.get(compute.ComputeInitializerUniformIn._type)!;
    this.mapped[58] = abi.type_by_fqn.get(compute.ComputeOperationClip._type)!;
    this.mapped[58].resolveGeneratedOffsets('input','output','min','max');
    this.mapped[59] = abi.type_by_fqn.get(compute.ComputeOperationSoftmax._type)!;
    this.mapped[59].resolveGeneratedOffsets('input','output');
    this.mapped[60] = abi.type_by_fqn.get(compute.ComputeOperationSelu._type)!;
    this.mapped[60].resolveGeneratedOffsets('input','output');
    this.mapped[61] = abi.type_by_fqn.get(compute.ComputeOperationElu._type)!;
    this.mapped[61].resolveGeneratedOffsets('input','output','alpha');
    this.mapped[61].static_values = [1.0];
    this.mapped[62] = abi.type_by_fqn.get(compute.ComputeInitializerGlorotUniform._type)!;
    ...
    this.mapped[64] = abi.type_by_fqn.get(compute.ComputeOperationSin._type)!;
    this.mapped[64].resolveGeneratedOffsets('input','output');
    this.mapped[65] = abi.type_by_fqn.get(compute.ComputeOperationAvg._type)!;
    this.mapped[65].resolveGeneratedOffsets('input','input2','output');
    this.mapped[66] = abi.type_by_fqn.get(compute.ComputeVariable._type)!;
    this.mapped[66].resolveGeneratedOffsets('name');
    this.mapped[67] = abi.type_by_fqn.get(compute.ComputeInitializerNone._type)!;
    this.mapped[68] = abi.type_by_fqn.get(compute.ComputeOptimizerSgd._type)!;
    this.mapped[68].resolveGeneratedOffsets('learning_rate');
    this.mapped[68].static_values = [0.01];
    ...
    this.mapped[70] = abi.type_by_fqn.get(compute.ComputeOperationMatMul._type)!;
    this.mapped[70].resolveGeneratedOffsets('input','input2','output','transposeA','transposeB','alpha','beta');
    this.mapped[70].static_values = [false,1.0,0.0];
    this.mapped[71] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaMax._type)!;
    this.mapped[71].resolveGeneratedOffsets('learning_rate','beta1','beta2','smooth_epsilon');
    this.mapped[71].static_values = [0.001,0.9,0.999,0.0000001];
    this.mapped[72] = abi.type_by_fqn.get(compute.ComputeOperationArgMax._type)!;
    this.mapped[72].resolveGeneratedOffsets('input','output','output2');
    ...
    this.mapped[75].resolveGeneratedOffsets('max_value','threshold');
    this.mapped[75].static_values = [0.0];
    this.mapped[76] = abi.type_by_fqn.get(compute.ComputeInitializerXavierUniform._type)!;
    ...
    this.mapped[79] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaDelta._type)!;
    this.mapped[79].resolveGeneratedOffsets('learning_rate','decay_rate','smooth_epsilon');
    this.mapped[79].static_values = [0.001,0.95,0.0000001];
    this.mapped[80] = abi.type_by_fqn.get(compute.ComputeOperationAcosh._type)!;
    this.mapped[80].resolveGeneratedOffsets('input','output');
    this.mapped[81] = abi.type_by_fqn.get(compute.ComputeEngine._type)!;
    this.mapped[82] = abi.type_by_fqn.get(compute.ComputeRegressionLoss._type)!;
    this.mapped[82].resolveGeneratedOffsetWithValues('square', "Square",'abs', "Abs");
    this.mapped[83] = abi.type_by_fqn.get(compute.ComputeInitializerUniformAvg._type)!;
    this.mapped[84] = abi.type_by_fqn.get(compute.ComputeOperationAbs._type)!;
    ...
    this.mapped[87] = abi.type_by_fqn.get(compute.ComputeActivationSoftplus._type)!;
    this.mapped[88] = abi.type_by_fqn.get(compute.ComputeOptimizerNadam._type)!;
    this.mapped[88].resolveGeneratedOffsets('learning_rate','beta1','beta2','smooth_epsilon');
    this.mapped[88].static_values = [0.001,0.9,0.999,0.0000001];
    ...
    this.mapped[90] = abi.type_by_fqn.get(compute.ComputeOperationPow._type)!;
    this.mapped[90].resolveGeneratedOffsets('input','input2','output');
    this.mapped[91] = abi.type_by_fqn.get(compute.ComputeRegularizer._type)!;
    this.mapped[91].resolveGeneratedOffsets('l1','l2');
    ...
    this.mapped[94] = abi.type_by_fqn.get(compute.ComputeOperationCosh._type)!;
    this.mapped[94].resolveGeneratedOffsets('input','output');
    this.mapped[95] = abi.type_by_fqn.get(compute.ComputeInitializerNormalAvg._type)!;
    this.mapped[96] = abi.type_by_fqn.get(compute.ComputeInitializerPytorch._type)!;
    this.mapped[97] = abi.type_by_fqn.get(compute.ComputeInitializerLeCunUniform._type)!;
    this.mapped[98] = abi.type_by_fqn.get(compute.ComputeLayer._type)!;
    this.mapped[98].resolveGeneratedOffsets('name');
    this.mapped[99] = abi.type_by_fqn.get(compute.ComputeOperationSub._type)!;
    this.mapped[99].resolveGeneratedOffsets('input','input2','output');
    this.mapped[100] = abi.type_by_fqn.get(compute.ComputeOperationFilter._type)!;
    this.mapped[100].resolveGeneratedOffsets('input','output','mask','nbOutputs');
    this.mapped[101] = abi.type_by_fqn.get(compute.ComputeInitializerNormalOut._type)!;
    this.mapped[102] = abi.type_by_fqn.get(compute.ComputeLayerMinMaxScaler._type)!;
    this.mapped[102].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[102].static_values = ["input","output","min","max"];
    this.mapped[103] = abi.type_by_fqn.get(compute.ComputeOperationSoftplus._type)!;
    this.mapped[103].resolveGeneratedOffsets('input','output');
    this.mapped[104] = abi.type_by_fqn.get(compute.ComputeInitializerRelu._type)!;
    this.mapped[105] = abi.type_by_fqn.get(compute.ComputeActivationSoftmax._type)!;
    this.mapped[105].resolveGeneratedOffsets('classes');
    this.mapped[106] = abi.type_by_fqn.get(compute.ComputeVarProxy._type)!;
    this.mapped[106].resolveGeneratedOffsets('name');
    this.mapped[107] = abi.type_by_fqn.get(compute.ComputeOptimizerFtrl._type)!;
    this.mapped[107].resolveGeneratedOffsets('learning_rate','lambda1','lambda2','beta');
    this.mapped[107].static_values = [0.001,0.0,0.0,0.0];
    this.mapped[108] = abi.type_by_fqn.get(compute.ComputeLayerPCAScaler._type)!;
    this.mapped[108].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[108].static_values = ["input","output","avg","std","space"];
    ...
    this.mapped[110].resolveGeneratedOffsets('input','value');
    this.mapped[111] = abi.type_by_fqn.get(compute.ComputeInitializerNormal._type)!;
    this.mapped[111].resolveGeneratedOffsets('avg','std');
    this.mapped[112] = abi.type_by_fqn.get(compute.ComputeOperationSinh._type)!;
    this.mapped[112].resolveGeneratedOffsets('input','output');
    this.mapped[113] = abi.type_by_fqn.get(compute.ComputeOperationLeakyRelu._type)!;
    this.mapped[113].resolveGeneratedOffsets('input','output','alpha','max_value','threshold');
    this.mapped[113].static_values = [0.3,1.7976931349E308,0.0];
    this.mapped[114] = abi.type_by_fqn.get(compute.ComputeOperationNeg._type)!;
    this.mapped[114].resolveGeneratedOffsets('input','output');
    this.mapped[115] = abi.type_by_fqn.get(compute.ComputeVar._type)!;
    this.mapped[115].resolveGeneratedOffsets('name');
    this.mapped[116] = abi.type_by_fqn.get(compute.ComputeOperationAtan._type)!;
    ...
    this.mapped[118] = abi.type_by_fqn.get(compute.ComputeOperationRaiseToPower._type)!;
    this.mapped[118].resolveGeneratedOffsets('input','output','power');
    this.mapped[119] = abi.type_by_fqn.get(compute.ComputeOperationAsin._type)!;
    ...
    this.mapped[121] = abi.type_by_fqn.get(compute.ComputeOperationAdd._type)!;
    ...
    this.mapped[123] = abi.type_by_fqn.get(compute.ComputeInitializerReluUniform._type)!;
    this.mapped[124] = abi.type_by_fqn.get(compute.ComputeLayerStandardScaler._type)!;
    this.mapped[124].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[124].static_values = ["input","output","avg","std"];
    this.mapped[125] = abi.type_by_fqn.get(compute.ComputeOperation1In1Out._type)!;
    ...
    this.mapped[127].resolveGeneratedOffsets('name','ops','vars');
    ...
    this.mapped[130] = abi.type_by_fqn.get(nn.PreProcessType._type)!;
    this.mapped[130].resolveGeneratedOffsetWithValues('none', "None",'min_max_scaling', "Min/Max Scaling",'standard_scaling', "Standard Scaling",'pca_scaling', "PCA Scaling");
    ...
    this.mapped[133].static_values = ["Inputs or outputs can't be negative","Last layer has different number of outputs than declared","Incompatible loss function","Some NN layers are not currently supported","Tensor Type not currently supported","NN should contain at least 1 layer","layer placeholders","layer classification","layer preprocess","layer postprocess learn","layer main","layer loss learn","layer loss display","layer postprocess display","seq predict","seq learn","seq loss display","seq encode","seq decode","var input","var enc input","var targets","var Classifier classes","var Classifier probabilities","var Classifier class weights","var input avg","var input min","var input max","var input std","var input space","var output avg","var output min","var output max","var output std"];
    ...
    this.mapped[138] = abi.type_by_fqn.get(nn.ComputeOptimizers._type)!;
    this.mapped[138].resolveGeneratedOffsetWithValues('ada_delta', "Ada Delta",'ada_grad', "Ada Grad",'adam', "Adam",'ada_max', "Ada Max",'nadam', "NAdam",'ftrl', "Ftrl",'sgd', "Stochastic Gradient Descent",'rms_prop', "RMS Prop",'momentum', "Momentum",'nesterov', "Nesterov");
