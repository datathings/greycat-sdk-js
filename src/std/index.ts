...
export namespace core {
  ...
  export class NodeInfo<T extends $sdk.Value = any> extends $sdk.GCObject {
    ...
    static createFrom({size, from, to}: {size: bigint | number, from: any | null, to: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): NodeInfo {
      return new NodeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[18], size, from, to);
    }
  ...
  export class GeoCircle extends $sdk.GCObject {
    ...
    static createFrom({center, radius}: {center: $sdk.std.core.geo, radius: number}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoCircle {
      return new GeoCircle($g.abi.libs_by_name.get(stdlib.name)!.mapped[19], center, radius);
    }
  ...
  export class GeoBox extends $sdk.GCObject {
    ...
    static createFrom({sw, ne}: {sw: $sdk.std.core.geo, ne: $sdk.std.core.geo}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoBox {
      return new GeoBox($g.abi.libs_by_name.get(stdlib.name)!.mapped[32], sw, ne);
    }
  ...
  export class TableColumnMeta extends $sdk.GCObject {
    ...
    static createFrom({type, size, index, header, min, max, avg, std}: {type: string | null, size: bigint | number, index: boolean, header: string | null, min: any | null, max: any | null, avg: any | null, std: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TableColumnMeta {
      return new TableColumnMeta($g.abi.libs_by_name.get(stdlib.name)!.mapped[38], type, size, index, header, min, max, avg, std);
    }
...
export namespace runtime {
  export class Task extends $sdk.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, status}: {user_id: bigint | number, task_id: bigint | number, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, status: runtime.TaskStatus}, $g: $sdk.GreyCat = globalThis.greycat.default): Task {
      return new Task($g.abi.libs_by_name.get(stdlib.name)!.mapped[39], user_id, task_id, mod, type, fun, creation, status);
    }
  ...
  export class RuntimeInfo extends $sdk.GCObject {
    ...
    static createFrom({version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats}: {version: string, program_version: string | null, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: bigint | number, bg_threads: bigint | number, fg_threads: bigint | number, mem_total: bigint | number, mem_worker: bigint | number, nb_ctx: bigint | number, store_stats: runtime.StoreStat | null}, $g: $sdk.GreyCat = globalThis.greycat.default): RuntimeInfo {
      return new RuntimeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[41], version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
    }
  ...
  export class UserRole extends $sdk.GCObject {
    ...
    static createFrom({name, permissions}: {name: string, permissions: globalThis.Array<string>}, $g: $sdk.GreyCat = globalThis.greycat.default): UserRole {
      return new UserRole($g.abi.libs_by_name.get(stdlib.name)!.mapped[43], name, permissions);
    }
  ...
  export class License extends $sdk.GCObject {
    ...
    static createFrom({name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4}: {name: string | null, start: $sdk.std.core.time, end: $sdk.std.core.time, company: string | null, max_workers: bigint | number, max_memory: bigint | number, extra_1: bigint | number | null, extra_2: bigint | number | null, extra_3: bigint | number | null, extra_4: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): License {
      return new License($g.abi.libs_by_name.get(stdlib.name)!.mapped[46], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4);
    }
  ...
  export class Runtime extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Runtime {
      return new Runtime($g.abi.libs_by_name.get(stdlib.name)!.mapped[49]);
    }
  ...
  export class OpenIDConnect extends $sdk.GCObject {
    ...
    static createFrom({url, clientId}: {url: string, clientId: string}, $g: $sdk.GreyCat = globalThis.greycat.default): OpenIDConnect {
      return new OpenIDConnect($g.abi.libs_by_name.get(stdlib.name)!.mapped[50], url, clientId);
    }
  ...
  export class TaskInfo extends $sdk.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all}: {user_id: bigint | number, task_id: bigint | number, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, status: runtime.TaskStatus, start: $sdk.std.core.time | null, progress: number | null, remaining: $sdk.std.core.duration | null, duration: $sdk.std.core.duration | null, sub_waiting: bigint | number | null, sub_tasks_all: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TaskInfo {
      return new TaskInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[52], user_id, task_id, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all);
    }
  ...
  export class UserCredential extends $sdk.GCObject {
    ...
    static createFrom({offset, pass}: {offset: bigint | number, pass: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): UserCredential {
      return new UserCredential($g.abi.libs_by_name.get(stdlib.name)!.mapped[55], offset, pass);
    }
  ...
  export class SecurityFields extends $sdk.GCObject {
    ...
    static createFrom({email, name, first_name, last_name, roles, groups}: {email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: globalThis.Map<string, string> | null, groups: globalThis.Map<string, string> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): SecurityFields {
      return new SecurityFields($g.abi.libs_by_name.get(stdlib.name)!.mapped[57], email, name, first_name, last_name, roles, groups);
    }
...
export namespace io {
  export class CsvColumnDuration extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, unit: core.DurationUnit | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnDuration {
      return new CsvColumnDuration($g.abi.libs_by_name.get(stdlib.name)!.mapped[58], name, mandatory, offset, unit);
    }
  ...
  export class CsvColumnIgnored extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnIgnored {
      return new CsvColumnIgnored($g.abi.libs_by_name.get(stdlib.name)!.mapped[59], name, mandatory, offset);
    }
  ...
  export class CsvColumnTime extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, unit: core.DurationUnit | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnTime {
      return new CsvColumnTime($g.abi.libs_by_name.get(stdlib.name)!.mapped[60], name, mandatory, offset, unit);
    }
  ...
  export class File extends $sdk.GCObject {
    ...
    static createFrom({path, size, last_modification}: {path: string, size: bigint | number | null, last_modification: $sdk.std.core.time | null}, $g: $sdk.GreyCat = globalThis.greycat.default): File {
      return new File($g.abi.libs_by_name.get(stdlib.name)!.mapped[61], path, size, last_modification);
    }
  ...
  export class CsvColumnDate extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, format, tz, as_time}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, format: string | null, tz: core.TimeZone | null, as_time: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnDate {
      return new CsvColumnDate($g.abi.libs_by_name.get(stdlib.name)!.mapped[62], name, mandatory, offset, format, tz, as_time);
    }
  ...
  export class CsvAnalysis extends $sdk.GCObject {
    ...
    static createFrom({format, row_limit, enum_limit, date_check_limit, date_formats, statistics}: {format: io.CsvFormat | null, row_limit: bigint | number | null, enum_limit: bigint | number | null, date_check_limit: bigint | number | null, date_formats: globalThis.Array<string> | null, statistics: io.CsvStatistics | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvAnalysis {
      return new CsvAnalysis($g.abi.libs_by_name.get(stdlib.name)!.mapped[67], format, row_limit, enum_limit, date_check_limit, date_formats, statistics);
    }
  ...
  export class CsvValidateResult extends $sdk.GCObject {
    ...
    static createFrom({line_count, fail_count, invalid_count}: {line_count: bigint | number, fail_count: bigint | number, invalid_count: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvValidateResult {
      return new CsvValidateResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], line_count, fail_count, invalid_count);
    }
  ...
  export class CsvStatistics extends $sdk.GCObject {
    ...
    static createFrom({columns, line_count, fail_count, file_count}: {columns: globalThis.Array<io.CsvColumnStatistics>, line_count: bigint | number, fail_count: bigint | number, file_count: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvStatistics {
      return new CsvStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[70], columns, line_count, fail_count, file_count);
    }
  ...
  export class HttpHeader extends $sdk.GCObject {
    ...
    static createFrom({name, value}: {name: string, value: string}, $g: $sdk.GreyCat = globalThis.greycat.default): HttpHeader {
      return new HttpHeader($g.abi.libs_by_name.get(stdlib.name)!.mapped[71], name, value);
    }
  ...
  export class CsvColumnBoolean extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnBoolean {
      return new CsvColumnBoolean($g.abi.libs_by_name.get(stdlib.name)!.mapped[72], name, mandatory, offset);
    }
  ...
  export class CsvFormat extends $sdk.GCObject {
    ...
    static createFrom({header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns}: {header_lines: bigint | number | null, infer: boolean | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, columns_size: bigint | number | null, columns: globalThis.Array<io.CsvColumn> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[74], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
  ...
  export class Email extends $sdk.GCObject {
    ...
    static createFrom({from, subject, body, body_is_html, to, cc, bcc}: {from: string, subject: string, body: string, body_is_html: boolean, to: globalThis.Array<string>, cc: globalThis.Array<string> | null, bcc: globalThis.Array<string> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Email {
      return new Email($g.abi.libs_by_name.get(stdlib.name)!.mapped[75], from, subject, body, body_is_html, to, cc, bcc);
    }
  ...
  export class Smtp extends $sdk.GCObject {
    ...
    static createFrom({host, port, mode, authenticate, user, pass}: {host: string, port: bigint | number, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Smtp {
      return new Smtp($g.abi.libs_by_name.get(stdlib.name)!.mapped[76], host, port, mode, authenticate, user, pass);
    }
  ...
  export class CsvColumnFloat extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnFloat {
      return new CsvColumnFloat($g.abi.libs_by_name.get(stdlib.name)!.mapped[80], name, mandatory, offset);
    }
...
export namespace math {
  export class MathConstants extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): MathConstants {
      return new MathConstants($g.abi.libs_by_name.get(stdlib.name)!.mapped[81]);
    }
...
export namespace util {
  export class ProgressTracker extends $sdk.GCObject {
    ...
    static createFrom({start, total, counter, duration, progress, speed, remaining}: {start: $sdk.std.core.time, total: bigint | number | null, counter: bigint | number | null, duration: $sdk.std.core.duration | null, progress: number | null, speed: number | null, remaining: $sdk.std.core.duration | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ProgressTracker {
      return new ProgressTracker($g.abi.libs_by_name.get(stdlib.name)!.mapped[82], start, total, counter, duration, progress, speed, remaining);
    }
  ...
  export class Plot extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Plot {
      return new Plot($g.abi.libs_by_name.get(stdlib.name)!.mapped[87]);
    }
  ...
  export class DenseDim extends $sdk.GCObject {
    ...
    static createFrom({min, max, step}: {min: bigint | number, max: bigint | number, step: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): DenseDim {
      return new DenseDim($g.abi.libs_by_name.get(stdlib.name)!.mapped[91], min, max, step);
    }
  ...
  export class Random extends $sdk.GCObject {
    ...
    static createFrom({seed, v}: {seed: bigint | number, v: number}, $g: $sdk.GreyCat = globalThis.greycat.default): Random {
      return new Random($g.abi.libs_by_name.get(stdlib.name)!.mapped[95], seed, v);
    }
  ...
  export class Assert extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Assert {
      return new Assert($g.abi.libs_by_name.get(stdlib.name)!.mapped[97]);
    }
...
export const stdlib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[3] = abi.type_by_fqn.get(core.DurationUnit._type);
    this.mapped[3]?.resolveGeneratedOffsetWithValues('microseconds', 1,'milliseconds', 1000,'seconds', 1000000,'minutes', 60000000,'hours', 3600000000,'days', 86400000000,'weeks', 604800000000,'months', 2628000000000,'years', 31536000000000);
    this.mapped[4] = abi.type_by_fqn.get(core.nodeIndexBucket._type);
    this.mapped[5] = abi.type_by_fqn.get(core.Array._type);
    this.mapped[6] = abi.type_by_fqn.get(core.Tensor._type);
    this.mapped[7] = abi.type_by_fqn.get(core.Table._type);
    this.mapped[8] = abi.type_by_fqn.get(core.GeoPoly._type);
    ...
    this.mapped[26] = abi.type_by_fqn.get(core.Date._type);
    this.mapped[27] = abi.type_by_fqn.get(core.ti10d._type);
    this.mapped[28] = abi.type_by_fqn.get(core.Tuple._type);
    this.mapped[29] = abi.type_by_fqn.get(core.nodeIndex._type);
    this.mapped[30] = abi.type_by_fqn.get(core.ErrorCode._type);
    this.mapped[30]?.resolveGeneratedOffsetWithValues('none', 0,'too_deep_workspace', 1,'too_deep_iterator', 2,'wrong_operand', 3,'wrong_params', 4,'wrong_param_type', 5,'wrong_numeric', 6,'wrong_state', 7,'wrong_null', 8,'unresolved_ref', 9,'assign_error', 10,'interrupted', 11,'throw', 12,'wrong_type', 13,'wrong_dimension', 14,'unsupported_operation', 15,'unsupported_type', 16,'dimensions_mismatch', 17,'timeout', 18,'forbidden', 19,'runtime_error', 20);
    this.mapped[31] = abi.type_by_fqn.get(core.tf3d._type);
    this.mapped[32] = abi.type_by_fqn.get(core.GeoBox._type);
    this.mapped[33] = abi.type_by_fqn.get(core.nodeTime._type);
    this.mapped[34] = abi.type_by_fqn.get(core.DatePart._type);
    this.mapped[34]?.resolveGeneratedOffsetWithValues('years', 0,'months', 1,'days', 2,'hours', 3,'minutes', 4,'seconds', 5,'microseconds', 6);
    this.mapped[35] = abi.type_by_fqn.get(core.ti5d._type);
    this.mapped[36] = abi.type_by_fqn.get(core.Error._type);
    this.mapped[37] = abi.type_by_fqn.get(core.tf4d._type);
    this.mapped[38] = abi.type_by_fqn.get(core.TableColumnMeta._type);
    this.mapped[39] = abi.type_by_fqn.get(runtime.Task._type);
    ...
    this.mapped[41] = abi.type_by_fqn.get(runtime.RuntimeInfo._type);
    this.mapped[42] = abi.type_by_fqn.get(runtime.SecurityPolicy._type);
    this.mapped[43] = abi.type_by_fqn.get(runtime.UserRole._type);
    this.mapped[44] = abi.type_by_fqn.get(runtime.SecurityEntity._type);
    this.mapped[45] = abi.type_by_fqn.get(runtime.User._type);
    this.mapped[46] = abi.type_by_fqn.get(runtime.License._type);
    this.mapped[47] = abi.type_by_fqn.get(runtime.TaskStatus._type);
    this.mapped[47]?.resolveGeneratedOffsetWithValues('empty', 0,'waiting', 1,'running', 2,'cancelled', 3,'error', 4,'ended', 5);
    this.mapped[48] = abi.type_by_fqn.get(runtime.UserGroupPolicy._type);
    this.mapped[49] = abi.type_by_fqn.get(runtime.Runtime._type);
    this.mapped[50] = abi.type_by_fqn.get(runtime.OpenIDConnect._type);
    this.mapped[51] = abi.type_by_fqn.get(runtime.System._type);
    this.mapped[52] = abi.type_by_fqn.get(runtime.TaskInfo._type);
    this.mapped[53] = abi.type_by_fqn.get(runtime.StoreStat._type);
    this.mapped[54] = abi.type_by_fqn.get(runtime.UserGroup._type);
    this.mapped[55] = abi.type_by_fqn.get(runtime.UserCredential._type);
    this.mapped[56] = abi.type_by_fqn.get(runtime.PeriodicTask._type);
    this.mapped[57] = abi.type_by_fqn.get(runtime.SecurityFields._type);
    this.mapped[58] = abi.type_by_fqn.get(io.CsvColumnDuration._type);
    this.mapped[59] = abi.type_by_fqn.get(io.CsvColumnIgnored._type);
    this.mapped[60] = abi.type_by_fqn.get(io.CsvColumnTime._type);
    this.mapped[61] = abi.type_by_fqn.get(io.File._type);
    this.mapped[62] = abi.type_by_fqn.get(io.CsvColumnDate._type);
    ...
    this.mapped[65] = abi.type_by_fqn.get(io.Http._type);
    this.mapped[66] = abi.type_by_fqn.get(io.Url._type);
    this.mapped[67] = abi.type_by_fqn.get(io.CsvAnalysis._type);
    if (this.mapped[67]) {
      this.mapped[67].static_values = {['row_limit_default']: 1000,['enum_limit_default']: 100,['date_check_limit_default']: 100,};
    }
    ...
    this.mapped[69] = abi.type_by_fqn.get(io.CsvValidateResult._type);
    this.mapped[70] = abi.type_by_fqn.get(io.CsvStatistics._type);
    this.mapped[71] = abi.type_by_fqn.get(io.HttpHeader._type);
    this.mapped[72] = abi.type_by_fqn.get(io.CsvColumnBoolean._type);
    this.mapped[73] = abi.type_by_fqn.get(io.CsvColumnString._type);
    this.mapped[74] = abi.type_by_fqn.get(io.CsvFormat._type);
    this.mapped[75] = abi.type_by_fqn.get(io.Email._type);
    this.mapped[76] = abi.type_by_fqn.get(io.Smtp._type);
    this.mapped[77] = abi.type_by_fqn.get(io.CsvColumnStatistics._type);
    this.mapped[78] = abi.type_by_fqn.get(io.CsvColumn._type);
    this.mapped[79] = abi.type_by_fqn.get(io.TextEncoder._type);
    this.mapped[79]?.resolveGeneratedOffsetWithValues('plain', null,'base64', null,'base64url', null,'hexadecimal', null);
    this.mapped[80] = abi.type_by_fqn.get(io.CsvColumnFloat._type);
    this.mapped[81] = abi.type_by_fqn.get(math.MathConstants._type);
    if (this.mapped[81]) {
      this.mapped[81].static_values = {['e']: 2.7182818285,['log_2e']: 1.4426950409,['log_10e']: 0.4342944819,['ln2']: 0.6931471806,['ln10']: 2.302585093,['pi']: 3.1415926536,['pi_2']: 1.5707963268,['pi_4']: 0.7853981634,['m1_pi']: 0.3183098862,['m2_pi']: 0.6366197724,['m2_sqrt_pi']: 1.1283791671,['sqrt2']: 1.4142135624,['sqrt1_2']: 0.7071067812,};
    }
    this.mapped[82] = abi.type_by_fqn.get(util.ProgressTracker._type);
    this.mapped[83] = abi.type_by_fqn.get(util.Crypto._type);
    this.mapped[84] = abi.type_by_fqn.get(util.HistogramFloat._type);
    if (this.mapped[84]) {
      this.mapped[84].static_values = {['table_off_from']: 0,['table_off_to']: 1,['table_off_count']: 2,['table_off_percentage']: 3,};
    }
    this.mapped[85] = abi.type_by_fqn.get(util.Iban._type);
    this.mapped[86] = abi.type_by_fqn.get(util.BoxPlotFloat._type);
    this.mapped[87] = abi.type_by_fqn.get(util.Plot._type);
    this.mapped[88] = abi.type_by_fqn.get(util.SlidingWindow._type);
    this.mapped[89] = abi.type_by_fqn.get(util.BoxPlotInt._type);
    this.mapped[90] = abi.type_by_fqn.get(util.Queue._type);
    this.mapped[91] = abi.type_by_fqn.get(util.DenseDim._type);
    this.mapped[92] = abi.type_by_fqn.get(util.Gaussian._type);
    this.mapped[93] = abi.type_by_fqn.get(util.HistogramInt._type);
    if (this.mapped[93]) {
    ...
    this.mapped[95] = abi.type_by_fqn.get(util.Random._type);
    ...
    this.mapped[97] = abi.type_by_fqn.get(util.Assert._type);
