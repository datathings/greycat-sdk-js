...
//       return new ComputeOperationSub($g.abi.libs_by_name.get(algebralib.name)!.mapped[0], input, input2, output);
//     }
...
//       return new ComputeOperationLog($g.abi.libs_by_name.get(algebralib.name)!.mapped[1], input, output);
//     }
...
//       return new ComputeOptimizerRmsProp($g.abi.libs_by_name.get(algebralib.name)!.mapped[2], learning_rate, decay_rate, smooth_epsilon);
//     }
...
//       return new ComputeInitializerUniformOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[3]);
//     }
...
//       return new ComputeLayerActivation($g.abi.libs_by_name.get(algebralib.name)!.mapped[4], name, activation);
//     }
...
//       return new ComputeLayerLossRegression($g.abi.libs_by_name.get(algebralib.name)!.mapped[5], name, reduction, loss_type);
//     }
...
//       return new ComputeInitializerIdentity($g.abi.libs_by_name.get(algebralib.name)!.mapped[6]);
//     }
...
//       return new ComputeBinding($g.abi.libs_by_name.get(algebralib.name)!.mapped[8], src_layer_name, src_var_name, target_var_name);
//     }
...
//       return new ComputeActivationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[10], max_value, threshold);
//     }
...
//       return new ComputeOperationSin($g.abi.libs_by_name.get(algebralib.name)!.mapped[11], input, output);
//     }
...
//       return new ComputeOperationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[12], input, output);
//     }
...
//       return new ComputeRegularizer($g.abi.libs_by_name.get(algebralib.name)!.mapped[13], l1, l2);
//     }
...
//       return new ComputeOperationAcosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[14], input, output);
//     }
...
//       return new ComputeOperationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[15], input, output, alpha, max_value, threshold);
//     }
...
//       return new ComputeOperationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[16], input, output, alpha);
//     }
...
//       return new ComputeLayerMinMaxScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[17], name, type, inverse_transform);
//     }
...
//       return new ComputeLayerPCAScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[18], name, type, inverse_transform);
//     }
...
//       return new ComputeLayerClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[19], name, calculate_probabilities, from_logits);
//     }
...
//       return new ComputeActivationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[20]);
//     }
...
//       return new ComputeInitializerReluUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[21]);
//     }
...
//       return new ComputeInitializerNormalAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[22]);
//     }
...
//       return new ComputeInitializerXavierUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[23]);
//     }
...
//       return new ComputeOptimizerMomentum($g.abi.libs_by_name.get(algebralib.name)!.mapped[24], learning_rate, decay_rate);
//     }
...
//       return new ComputeOperationSumIf($g.abi.libs_by_name.get(algebralib.name)!.mapped[25], input, ifCondition, output, counts, classes);
//     }
...
//       return new ComputeOperationPow($g.abi.libs_by_name.get(algebralib.name)!.mapped[26], input, input2, output);
//     }
...
//       return new ComputeOperationSum($g.abi.libs_by_name.get(algebralib.name)!.mapped[27], input, output, axis);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeReduction.Field, value: $sdk.Value) {
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[28];
//       return t.enum_values as ComputeReduction[];
//     }
//   }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeClassificationLoss.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[29];
//       return t.enum_values as ComputeClassificationLoss[];
//     }
//   }
...
//       return new ComputeInitializerGlorotUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[30]);
//     }
...
//       return new ComputeOptimizerAdaGrad($g.abi.libs_by_name.get(algebralib.name)!.mapped[31], learning_rate, initial_accumulator, smooth_epsilon);
//     }
...
//       return new ComputeOperationAdd($g.abi.libs_by_name.get(algebralib.name)!.mapped[32], input, input2, output);
//     }
...
//       return new ComputeOperationRaiseToPower($g.abi.libs_by_name.get(algebralib.name)!.mapped[34], input, output, power);
//     }
...
//       return new ComputeOptimizerNesterov($g.abi.libs_by_name.get(algebralib.name)!.mapped[36], learning_rate, decay_rate);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeRegressionLoss.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[37];
//       return t.enum_values as ComputeRegressionLoss[];
//     }
//   }
...
//       return new ComputeInitializerNormal($g.abi.libs_by_name.get(algebralib.name)!.mapped[38], avg, std);
//     }
...
//       return new ComputeOperationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[39], input, output);
//     }
...
//       return new ComputeModel($g.abi.libs_by_name.get(algebralib.name)!.mapped[40], layers);
//     }
...
//       return new ComputeOperationTan($g.abi.libs_by_name.get(algebralib.name)!.mapped[41], input, output);
//     }
...
//       return new ComputeOperationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[42], input, output);
//     }
...
//       return new ComputeOperationMatMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[44], input, input2, output, transposeA, transposeB, alpha, beta);
//     }
...
//       return new ComputeVarOptimize($g.abi.libs_by_name.get(algebralib.name)!.mapped[45], name, type, shape, l1, l2, init);
//     }
...
//       return new ComputeOperationNeg($g.abi.libs_by_name.get(algebralib.name)!.mapped[46], input, output);
//     }
...
//       return new ComputeOptimizerNadam($g.abi.libs_by_name.get(algebralib.name)!.mapped[47], learning_rate, beta1, beta2, smooth_epsilon);
//     }
...
//       return new ComputeOperationDiv($g.abi.libs_by_name.get(algebralib.name)!.mapped[48], input, input2, output);
//     }
...
//       return new ComputeOperationAddBias($g.abi.libs_by_name.get(algebralib.name)!.mapped[49], input, input2, output);
//     }
...
//       return new ComputeOptimizerFtrl($g.abi.libs_by_name.get(algebralib.name)!.mapped[50], learning_rate, lambda1, lambda2, beta);
//     }
...
//       return new ComputeOperationLogSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[51], input, output, axis);
//     }
...
//       return new ComputeOperationArgMin($g.abi.libs_by_name.get(algebralib.name)!.mapped[52], input, output, output2);
//     }
...
//       return new ComputeOperationEuclidean($g.abi.libs_by_name.get(algebralib.name)!.mapped[53], input, input2, output);
//     }
...
//       return new ComputeActivationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[54], alpha);
//     }
...
//       return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[55], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
//     }
...
//       return new ComputeVarConst($g.abi.libs_by_name.get(algebralib.name)!.mapped[56], name, type, shape);
//     }
...
//       return new ComputeInitializerSigmoidUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[57]);
//     }
...
//       return new ComputeOperationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[62], input, output);
//     }
...
//       return new ComputeInitializerUniformAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[63]);
//     }
...
//       return new ComputeInitializerNormalIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[64]);
//     }
...
//       return new ComputeActivationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[65]);
//     }
...
//       return new ComputeActivationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[66]);
//     }
...
//       return new ComputeOperationArgMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[67], input, output, output2);
//     }
...
//       return new ComputeOperationCosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[68], input, output);
//     }
...
//       return new ComputeInitializerRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[69]);
//     }
...
//       return new ComputeOperationLeCunTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[70], input, output);
//     }
...
//       return new ComputeActivationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[71]);
//     }
...
//       return new ComputeVar($g.abi.libs_by_name.get(algebralib.name)!.mapped[72], name);
//     }
...
//       return new ComputeOperationAtanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[73], input, output);
//     }
...
//       return new ComputeLayerConfusion($g.abi.libs_by_name.get(algebralib.name)!.mapped[74], name, nbClass);
//     }
...
//       return new ComputeOperationScale($g.abi.libs_by_name.get(algebralib.name)!.mapped[75], input, output, alpha);
//     }
...
//       return new ComputeOptimizerAdaDelta($g.abi.libs_by_name.get(algebralib.name)!.mapped[76], learning_rate, decay_rate, smooth_epsilon);
//     }
...
//       return new ComputeActivationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[77], slope, shift);
//     }
...
//       return new ComputeInitializerXavier($g.abi.libs_by_name.get(algebralib.name)!.mapped[78]);
//     }
...
//       return new ComputeInitializerUniformIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[80]);
//     }
...
//       return new ComputeOperationAcos($g.abi.libs_by_name.get(algebralib.name)!.mapped[81], input, output);
//     }
...
//       return new ComputeOperationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[82], input, output);
//     }
...
//       return new ComputeInitializerUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[83], min, max);
//     }
...
//       return new ComputeLayerCustom($g.abi.libs_by_name.get(algebralib.name)!.mapped[84], name, ops, vars);
//     }
...
//       return new ComputeInitializerPytorch($g.abi.libs_by_name.get(algebralib.name)!.mapped[85]);
//     }
...
//       return new ComputeOperationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[86], input, output, slope, shift);
//     }
...
//       return new ComputeVarProxy($g.abi.libs_by_name.get(algebralib.name)!.mapped[87], name);
//     }
...
//       return new ComputeOperationCos($g.abi.libs_by_name.get(algebralib.name)!.mapped[88], input, output);
//     }
...
//       return new ComputeLayerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[89], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
//     }
...
//       return new ComputeOperationAbs($g.abi.libs_by_name.get(algebralib.name)!.mapped[90], input, output);
//     }
...
//       return new ComputeOperationSinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[91], input, output);
//     }
...
//       return new ComputeInitializerNormalOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[92]);
//     }
...
//       return new ComputeVarInOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[93], name, type, shape, with_grad);
//     }
...
//       return new ComputeActivationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[94]);
//     }
...
//       return new ComputeOperationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[95], input, output);
//     }
...
//       return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[96], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
//     }
//     static create(name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
//       return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[96], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
//     }
...
//       return new ComputeActivationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[98], alpha, max_value, threshold);
//     }
...
//       return new ComputeOperationMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[99], input, input2, output);
//     }
...
//       return new ComputeOperationAtan($g.abi.libs_by_name.get(algebralib.name)!.mapped[100], input, output);
//     }
...
//       return new ComputeActivationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[101]);
//     }
...
//       return new ComputeLayerSeq($g.abi.libs_by_name.get(algebralib.name)!.mapped[102], name, calls, optimizer);
//     }
...
//       return new ComputeInitializerConstant($g.abi.libs_by_name.get(algebralib.name)!.mapped[103], value);
//     }
...
//       return new ComputeOptimizerAdam($g.abi.libs_by_name.get(algebralib.name)!.mapped[104], learning_rate, beta1, beta2, smooth_epsilon);
//     }
...
//       return new ComputeActivationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[105], classes);
//     }
...
//       return new ComputeInitializerLeCunUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[107]);
//     }
...
//       return new ComputeActivationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[108], alpha);
//     }
...
//       return new ComputeOperationAsin($g.abi.libs_by_name.get(algebralib.name)!.mapped[109], input, output);
//     }
...
//       return new ComputeOptimizerAdaMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[110], learning_rate, beta1, beta2, smooth_epsilon);
//     }
...
//       return new ComputeOperationSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[112], input, output);
//     }
...
//       return new ComputeOperationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[113], input, output, max_value, threshold);
//     }
...
//       return new ComputeOperationSqrt($g.abi.libs_by_name.get(algebralib.name)!.mapped[114], input, output);
//     }
...
//       return new ComputeLayerCall($g.abi.libs_by_name.get(algebralib.name)!.mapped[115], layer_name, bindings);
//     }
...
//       return new ComputeOptimizerSgd($g.abi.libs_by_name.get(algebralib.name)!.mapped[116], learning_rate);
//     }
...
//       return new ComputeOperationAsinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[117], input, output);
//     }
...
//     static var_input_name($g: $sdk.GreyCat = globalThis.greycat.default): string {
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[118];
//       return  t.static_values['var_input_name'] as string;
//     }
//     static var_output_name($g: $sdk.GreyCat = globalThis.greycat.default): string {
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[118];
...
//       return new ComputeLayerStandardScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[118], name, type, inverse_transform);
//     }
...
//       return new ComputeOperationAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[119], input, input2, output);
//     }
...
//       return new ComputeCounter($g.abi.libs_by_name.get(algebralib.name)!.mapped[120], epoch, optimizationSteps, batchNotOptimized);
//     }
...
//       return new ComputeOperationFill($g.abi.libs_by_name.get(algebralib.name)!.mapped[121], input, value);
//     }
...
//       return new ComputeLayerLossClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[122], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits);
//     }
...
//       return new ComputeLayerFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[123], name, type, inputs, outputs, maskValues);
//     }
...
//       return new ComputeOperationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[126], input, output);
//     }
...
//       return new ComputeOperationClip($g.abi.libs_by_name.get(algebralib.name)!.mapped[127], input, output, min, max);
//     }
...
//       return new ComputeOperationFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[128], input, output, mask, nbOutputs);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: NNLayersNames.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[129];
//       return t.enum_values as NNLayersNames[];
//     }
//   }
...
//       return new BindingsResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[131], previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: PostProcessType.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[132];
//       return t.enum_values as PostProcessType[];
//     }
//   }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeLayerTypes.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[133];
//       return t.enum_values as ComputeLayerTypes[];
//     }
//   }
...
//       return new RegressionNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[135], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput);
//     }
...
//       return new ClassificationNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[136], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits);
//     }
//     static create(inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null, calculate_probabilities: boolean, has_class_weights: boolean, from_logits: boolean, $g: $sdk.GreyCat = globalThis.greycat.default): ClassificationNetwork {
//       return new ClassificationNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[136], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeActivations.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[137];
//       return t.enum_values as ComputeActivations[];
//     }
//   }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: PreProcessType.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[138];
//       return t.enum_values as PreProcessType[];
//     }
//   }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeInitializers.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[139];
//       return t.enum_values as ComputeInitializers[];
//     }
//   }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: ComputeOptimizers.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[140];
//       return t.enum_values as ComputeOptimizers[];
//     }
//   }
...
//       return new AutoEncoderNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[141], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, encoder_layer_idx, encoder_layer_name, encoder_layer_var);
//     }
//     static create(inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null, encoder_layer_idx: bigint | number, encoder_layer_name: string | null, encoder_layer_var: string | null, $g: $sdk.GreyCat = globalThis.greycat.default): AutoEncoderNetwork {
//       return new AutoEncoderNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[141], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, encoder_layer_idx, encoder_layer_name, encoder_layer_var);
//     }
...
//       return new ClassificationMetrics($g.abi.libs_by_name.get(algebralib.name)!.mapped[142], precision, recall, f1Score);
//     }
...
//       return new KmeanMetaResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[143], runDistances, bestResult);
//     }
...
//       return new Kmeans($g.abi.libs_by_name.get(algebralib.name)!.mapped[144]);
//     }
...
//       return new KmeanResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[145], loss, roundsDistances, centroids, clusters_count, clusters_sum_distance, clusters_avg_distance, assignement, distances, clusterInterDistances);
//     }
...
//       return new EuclideanPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[147], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: SamplingPolicy.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }

//     static as_is($g: $sdk.GreyCat = globalThis.greycat.default): SamplingPolicy {
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[148];
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[148];
//       return t.enum_values as SamplingPolicy[];
//     }
//   }
...
//       return new OverlappingDetection($g.abi.libs_by_name.get(algebralib.name)!.mapped[149], score, best_pattern, timespan, overlap);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: PatternDetectors.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }

//     static none($g: $sdk.GreyCat = globalThis.greycat.default): PatternDetectors {
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[150];
//       return t.static_values['none'];
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[150];
//       return t.enum_values as PatternDetectors[];
//     }
//   }
...
//       return new DTWPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[151]);
//     }
...
//       return new DTWPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[152], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation);
//     }
//     static create(timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, std: number | null, matchingNormalisation: patterns.MatchingNormalisation | null, $g: $sdk.GreyCat = globalThis.greycat.default): DTWPatternDetectionEngine {
//       return new DTWPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[152], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation);
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[153];
...
//       return new SaxPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[153], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length);
//     }
//     static create(timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, alphabet_size: bigint | number, alphabet_boundaries: globalThis.Array<number>, lookup_table: $sdk.std.core.nodeIndex, max_distance: number, pattern_fingerprints: globalThis.Array<string>, fingerprint_length: bigint | number, $g: $sdk.GreyCat = globalThis.greycat.default): SaxPatternDetectionEngine {
//       return new SaxPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[153], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: PatternNullStrategy.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }

//     static replace($g: $sdk.GreyCat = globalThis.greycat.default): PatternNullStrategy {
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[154];
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[154];
//       return t.enum_values as PatternNullStrategy[];
//     }
//   }
...
//       return new FFTPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[155]);
//     }
...
//     constructor(type: $sdk.AbiType, offset: number, public override key: MatchingNormalisation.Field, value: $sdk.Value) {
//       super(type, offset, key, value);
//     }

//     static as_is($g: $sdk.GreyCat = globalThis.greycat.default): MatchingNormalisation {
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[156];
//       return t.static_values['as_is'];
//     }
...
//       const t = $g.abi.libs_by_name.get(algebralib.name)!.mapped[156];
//       return t.enum_values as MatchingNormalisation[];
//     }
//   }
...
//       return new RandomPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[157], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng);
//     }
//     static create(timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, rng: $sdk.std.util.Random, $g: $sdk.GreyCat = globalThis.greycat.default): RandomPatternDetectionEngine {
//       return new RandomPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[157], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng);
//     }
...
//       return new EuclideanPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[158]);
//     }
...
//       return new ScoreDetails($g.abi.libs_by_name.get(algebralib.name)!.mapped[159], best_pattern, timespan);
//     }
...
//       return new PatternDetectionEngineState($g.abi.libs_by_name.get(algebralib.name)!.mapped[160], hasScores, hasDetections, patterns, scores, detections);
//     }
...
//       return new FFTResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[161], distance, best_pattern, best_timespan);
//     }
...
//       return new RandomPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[163]);
//     }
...
//       return new PatternDetectionSensitivity($g.abi.libs_by_name.get(algebralib.name)!.mapped[164], threshold, overlap);
//     }
...
//       return new ScoreDetailsSingleton($g.abi.libs_by_name.get(algebralib.name)!.mapped[165], best_pattern, timespan, timestamp);
//     }
...
//       return new SaxPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[168], alphabet_size, fingerprint_length);
//     }
...
//       return new TimeSeriesDecomposition($g.abi.libs_by_name.get(algebralib.name)!.mapped[169]);
//     }
...
//       return new Solver($g.abi.libs_by_name.get(algebralib.name)!.mapped[170]);
//     }
...
//       return new HeatMapProfile($g.abi.libs_by_name.get(algebralib.name)!.mapped[171], counts, x_labels, y_labels, counts_max, counts_sum);
//     }
...
//   },
//   init(abi) {
//     this.mapped[0] = abi.type_by_fqn.get(compute.ComputeOperationSub._type)!;
//     this.mapped[1] = abi.type_by_fqn.get(compute.ComputeOperationLog._type)!;
//     this.mapped[2] = abi.type_by_fqn.get(compute.ComputeOptimizerRmsProp._type)!;
//     if (this.mapped[2]) {
//       this.mapped[2].static_values = {'learning_rate_def': 0.001,'decay_rate_def': 0.9,'smooth_epsilon_def': 0.0000001,};
//     }
//     this.mapped[3] = abi.type_by_fqn.get(compute.ComputeInitializerUniformOut._type)!;
//     this.mapped[4] = abi.type_by_fqn.get(compute.ComputeLayerActivation._type)!;
//     if (this.mapped[4]) {
//       this.mapped[4].static_values = {'var_input_name': "input",'var_output_name': "output",};
//     }
//     this.mapped[5] = abi.type_by_fqn.get(compute.ComputeLayerLossRegression._type)!;
//     this.mapped[6] = abi.type_by_fqn.get(compute.ComputeInitializerIdentity._type)!;
//     this.mapped[7] = abi.type_by_fqn.get(compute.ComputeInitializerNone._type)!;
//     this.mapped[8] = abi.type_by_fqn.get(compute.ComputeBinding._type)!;
//     this.mapped[9] = abi.type_by_fqn.get(compute.ComputeInitializer._type)!;
//     this.mapped[10] = abi.type_by_fqn.get(compute.ComputeActivationRelu._type)!;
//     if (this.mapped[10]) {
//       this.mapped[10].static_values = {'threshold_def': 0.0,};
//     }
//     this.mapped[11] = abi.type_by_fqn.get(compute.ComputeOperationSin._type)!;
//     this.mapped[12] = abi.type_by_fqn.get(compute.ComputeOperationSoftSign._type)!;
//     this.mapped[13] = abi.type_by_fqn.get(compute.ComputeRegularizer._type)!;
//     this.mapped[14] = abi.type_by_fqn.get(compute.ComputeOperationAcosh._type)!;
//     this.mapped[15] = abi.type_by_fqn.get(compute.ComputeOperationLeakyRelu._type)!;
//     if (this.mapped[15]) {
//       this.mapped[15].static_values = {'alpha_def': 0.3,'max_value_def': 1.7976931349E308,'threshold_def': 0.0,};
//     }
//     this.mapped[16] = abi.type_by_fqn.get(compute.ComputeOperationCelu._type)!;
//     if (this.mapped[16]) {
//       this.mapped[16].static_values = {'alpha_def': 1.0,};
//     }
//     this.mapped[17] = abi.type_by_fqn.get(compute.ComputeLayerMinMaxScaler._type)!;
//     if (this.mapped[17]) {
//       this.mapped[17].static_values = {'var_input_name': "input",'var_output_name': "output",'var_min_name': "min",'var_max_name': "max",};
//     }
//     this.mapped[18] = abi.type_by_fqn.get(compute.ComputeLayerPCAScaler._type)!;
//     if (this.mapped[18]) {
//       this.mapped[18].static_values = {'var_input_name': "input",'var_output_name': "output",'var_avg_name': "avg",'var_std_name': "std",'var_space_name': "space",};
//     }
//     this.mapped[19] = abi.type_by_fqn.get(compute.ComputeLayerClassification._type)!;
//     if (this.mapped[19]) {
//       this.mapped[19].static_values = {'var_input_name': "input",'var_predicted_classes_name': "predicted_classes",'var_probabilities_name': "probabilities",};
//     }
//     this.mapped[20] = abi.type_by_fqn.get(compute.ComputeActivationSoftplus._type)!;
//     this.mapped[21] = abi.type_by_fqn.get(compute.ComputeInitializerReluUniform._type)!;
//     this.mapped[22] = abi.type_by_fqn.get(compute.ComputeInitializerNormalAvg._type)!;
//     this.mapped[23] = abi.type_by_fqn.get(compute.ComputeInitializerXavierUniform._type)!;
//     this.mapped[24] = abi.type_by_fqn.get(compute.ComputeOptimizerMomentum._type)!;
//     if (this.mapped[24]) {
//       this.mapped[24].static_values = {'learning_rate_def': 0.001,'decay_rate_def': 0.9,};
//     }
//     this.mapped[25] = abi.type_by_fqn.get(compute.ComputeOperationSumIf._type)!;
//     this.mapped[26] = abi.type_by_fqn.get(compute.ComputeOperationPow._type)!;
//     this.mapped[27] = abi.type_by_fqn.get(compute.ComputeOperationSum._type)!;
//     this.mapped[28] = abi.type_by_fqn.get(compute.ComputeReduction._type)!;
//     this.mapped[28]?.resolveGeneratedOffsetWithValues('auto', "auto",'none', "none",'sum', "sum",'mean', "mean",'disabled', "disabled");
//     this.mapped[29] = abi.type_by_fqn.get(compute.ComputeClassificationLoss._type)!;
//     this.mapped[29]?.resolveGeneratedOffsetWithValues('categorical_cross_entropy', "Categorical Cross Entropy",'sparse_categorical_cross_entropy', "Sparse Categorical Cross Entropy");
//     this.mapped[30] = abi.type_by_fqn.get(compute.ComputeInitializerGlorotUniform._type)!;
//     this.mapped[31] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaGrad._type)!;
//     if (this.mapped[31]) {
//       this.mapped[31].static_values = {'learning_rate_def': 0.001,'initial_accumulator_def': 0.1,'smooth_epsilon_def': 0.0000001,};
//     }
//     this.mapped[32] = abi.type_by_fqn.get(compute.ComputeOperationAdd._type)!;
//     this.mapped[33] = abi.type_by_fqn.get(compute.ComputeOperation2In1Out._type)!;
//     this.mapped[34] = abi.type_by_fqn.get(compute.ComputeOperationRaiseToPower._type)!;
//     this.mapped[35] = abi.type_by_fqn.get(compute.ComputeOperationArg._type)!;
//     this.mapped[36] = abi.type_by_fqn.get(compute.ComputeOptimizerNesterov._type)!;
//     if (this.mapped[36]) {
//       this.mapped[36].static_values = {'learning_rate_def': 0.001,'decay_rate_def': 0.9,};
//     }
//     this.mapped[37] = abi.type_by_fqn.get(compute.ComputeRegressionLoss._type)!;
//     this.mapped[37]?.resolveGeneratedOffsetWithValues('square', "Square",'abs', "Abs");
//     this.mapped[38] = abi.type_by_fqn.get(compute.ComputeInitializerNormal._type)!;
//     this.mapped[39] = abi.type_by_fqn.get(compute.ComputeOperationSoftmax._type)!;
//     this.mapped[40] = abi.type_by_fqn.get(compute.ComputeModel._type)!;
//     this.mapped[41] = abi.type_by_fqn.get(compute.ComputeOperationTan._type)!;
//     this.mapped[42] = abi.type_by_fqn.get(compute.ComputeOperationExp._type)!;
//     this.mapped[43] = abi.type_by_fqn.get(compute.ComputeVariable._type)!;
//     this.mapped[44] = abi.type_by_fqn.get(compute.ComputeOperationMatMul._type)!;
//     if (this.mapped[44]) {
//       this.mapped[44].static_values = {'transpose_def': false,'alpha_def': 1.0,'beta_def': 0.0,};
//     }
//     this.mapped[45] = abi.type_by_fqn.get(compute.ComputeVarOptimize._type)!;
//     this.mapped[46] = abi.type_by_fqn.get(compute.ComputeOperationNeg._type)!;
//     this.mapped[47] = abi.type_by_fqn.get(compute.ComputeOptimizerNadam._type)!;
//     if (this.mapped[47]) {
//       this.mapped[47].static_values = {'learning_rate_def': 0.001,'beta1_def': 0.9,'beta2_def': 0.999,'smooth_epsilon_def': 0.0000001,};
//     }
//     this.mapped[48] = abi.type_by_fqn.get(compute.ComputeOperationDiv._type)!;
//     this.mapped[49] = abi.type_by_fqn.get(compute.ComputeOperationAddBias._type)!;
//     this.mapped[50] = abi.type_by_fqn.get(compute.ComputeOptimizerFtrl._type)!;
//     if (this.mapped[50]) {
//       this.mapped[50].static_values = {'learning_rate_def': 0.001,'beta_def': 0.0,'lambda1_def': 0.0,'lambda2_def': 0.0,};
//     }
//     this.mapped[51] = abi.type_by_fqn.get(compute.ComputeOperationLogSoftmax._type)!;
//     this.mapped[52] = abi.type_by_fqn.get(compute.ComputeOperationArgMin._type)!;
//     this.mapped[53] = abi.type_by_fqn.get(compute.ComputeOperationEuclidean._type)!;
//     this.mapped[54] = abi.type_by_fqn.get(compute.ComputeActivationElu._type)!;
//     if (this.mapped[54]) {
//       this.mapped[54].static_values = {'alpha_def': 1.0,};
//     }
//     this.mapped[55] = abi.type_by_fqn.get(compute.ComputeLayerLinear._type)!;
//     if (this.mapped[55]) {
//       this.mapped[55].static_values = {'var_input_name': "input",'var_output_name': "output",'var_weight_name': "weight",'var_bias_name': "bias",'var_mult_name': "mult",};
//     }
//     this.mapped[56] = abi.type_by_fqn.get(compute.ComputeVarConst._type)!;
//     this.mapped[57] = abi.type_by_fqn.get(compute.ComputeInitializerSigmoidUniform._type)!;
//     this.mapped[58] = abi.type_by_fqn.get(compute.ComputeOperation1In1Out._type)!;
//     this.mapped[59] = abi.type_by_fqn.get(compute.ComputeOperation._type)!;
//     this.mapped[60] = abi.type_by_fqn.get(compute.ComputeActivation._type)!;
//     this.mapped[61] = abi.type_by_fqn.get(compute.ComputeState._type)!;
//     this.mapped[62] = abi.type_by_fqn.get(compute.ComputeOperationSelu._type)!;
//     this.mapped[63] = abi.type_by_fqn.get(compute.ComputeInitializerUniformAvg._type)!;
//     this.mapped[64] = abi.type_by_fqn.get(compute.ComputeInitializerNormalIn._type)!;
//     this.mapped[65] = abi.type_by_fqn.get(compute.ComputeActivationSoftSign._type)!;
//     this.mapped[66] = abi.type_by_fqn.get(compute.ComputeActivationSigmoid._type)!;
//     this.mapped[67] = abi.type_by_fqn.get(compute.ComputeOperationArgMax._type)!;
//     this.mapped[68] = abi.type_by_fqn.get(compute.ComputeOperationCosh._type)!;
//     this.mapped[69] = abi.type_by_fqn.get(compute.ComputeInitializerRelu._type)!;
//     this.mapped[70] = abi.type_by_fqn.get(compute.ComputeOperationLeCunTanh._type)!;
//     this.mapped[71] = abi.type_by_fqn.get(compute.ComputeActivationExp._type)!;
//     this.mapped[72] = abi.type_by_fqn.get(compute.ComputeVar._type)!;
//     this.mapped[73] = abi.type_by_fqn.get(compute.ComputeOperationAtanh._type)!;
//     this.mapped[74] = abi.type_by_fqn.get(compute.ComputeLayerConfusion._type)!;
//     if (this.mapped[74]) {
//       this.mapped[74].static_values = {'var_computed_name': "computed",'var_expected_name': "expected",'var_confusion_name': "confusion",};
//     }
//     this.mapped[75] = abi.type_by_fqn.get(compute.ComputeOperationScale._type)!;
//     this.mapped[76] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaDelta._type)!;
//     if (this.mapped[76]) {
//       this.mapped[76].static_values = {'learning_rate_def': 0.001,'decay_rate_def': 0.95,'smooth_epsilon_def': 0.0000001,};
//     }
//     this.mapped[77] = abi.type_by_fqn.get(compute.ComputeActivationHardSigmoid._type)!;
//     if (this.mapped[77]) {
//       this.mapped[77].static_values = {'slope_def': 0.2,'shift_def': 0.5,};
//     }
//     this.mapped[78] = abi.type_by_fqn.get(compute.ComputeInitializerXavier._type)!;
//     this.mapped[79] = abi.type_by_fqn.get(compute.ComputeOptimizer._type)!;
//     this.mapped[80] = abi.type_by_fqn.get(compute.ComputeInitializerUniformIn._type)!;
//     this.mapped[81] = abi.type_by_fqn.get(compute.ComputeOperationAcos._type)!;
//     this.mapped[82] = abi.type_by_fqn.get(compute.ComputeOperationSigmoid._type)!;
//     this.mapped[83] = abi.type_by_fqn.get(compute.ComputeInitializerUniform._type)!;
//     this.mapped[84] = abi.type_by_fqn.get(compute.ComputeLayerCustom._type)!;
//     this.mapped[85] = abi.type_by_fqn.get(compute.ComputeInitializerPytorch._type)!;
//     this.mapped[86] = abi.type_by_fqn.get(compute.ComputeOperationHardSigmoid._type)!;
//     if (this.mapped[86]) {
//       this.mapped[86].static_values = {'slope_def': 0.2,'shift_def': 0.5,};
//     }
//     this.mapped[87] = abi.type_by_fqn.get(compute.ComputeVarProxy._type)!;
//     this.mapped[88] = abi.type_by_fqn.get(compute.ComputeOperationCos._type)!;
//     this.mapped[89] = abi.type_by_fqn.get(compute.ComputeLayerLSTM._type)!;
//     if (this.mapped[89]) {
//       this.mapped[89].static_values = {'var_input_name': "input",'var_output_name': "output",'var_hx_name': "hx",'var_cx_name': "cx",'var_hy_name': "hy",'var_cy_name': "cy",'var_weight_name': "weight",'var_bias_name': "bias",'var_internal_i_name': "internal_i",'var_internal_f_name': "internal_f",'var_internal_cp_name': "internal_cp",'var_internal_o_name': "internal_o",'var_internal_h_name': "internal_h",'var_internal_c_name': "internal_c",'var_internal_mult_name': "internal_mult",'var_internal_output_name': "internal_output",};
//     }
//     this.mapped[90] = abi.type_by_fqn.get(compute.ComputeOperationAbs._type)!;
//     this.mapped[91] = abi.type_by_fqn.get(compute.ComputeOperationSinh._type)!;
//     this.mapped[92] = abi.type_by_fqn.get(compute.ComputeInitializerNormalOut._type)!;
//     this.mapped[93] = abi.type_by_fqn.get(compute.ComputeVarInOut._type)!;
//     this.mapped[94] = abi.type_by_fqn.get(compute.ComputeActivationSelu._type)!;
//     this.mapped[95] = abi.type_by_fqn.get(compute.ComputeOperationSoftplus._type)!;
//     this.mapped[96] = abi.type_by_fqn.get(compute.ComputeLayerDense._type)!;
//     if (this.mapped[96]) {
//       this.mapped[96].static_values = {'var_input_name': "input",'var_output_name': "output",'var_weight_name': "weight",'var_bias_name': "bias",'var_mult_name': "mult",'var_pre_activation_name': "pre_activation",};
//     }
//     this.mapped[97] = abi.type_by_fqn.get(compute.ComputeLayer._type)!;
//     this.mapped[98] = abi.type_by_fqn.get(compute.ComputeActivationLeakyRelu._type)!;
//     if (this.mapped[98]) {
//       this.mapped[98].static_values = {'alpha_def': 0.3,'threshold_def': 0.0,};
//     }
//     this.mapped[99] = abi.type_by_fqn.get(compute.ComputeOperationMul._type)!;
//     this.mapped[100] = abi.type_by_fqn.get(compute.ComputeOperationAtan._type)!;
//     this.mapped[101] = abi.type_by_fqn.get(compute.ComputeActivationTanh._type)!;
//     this.mapped[102] = abi.type_by_fqn.get(compute.ComputeLayerSeq._type)!;
//     this.mapped[103] = abi.type_by_fqn.get(compute.ComputeInitializerConstant._type)!;
//     this.mapped[104] = abi.type_by_fqn.get(compute.ComputeOptimizerAdam._type)!;
//     if (this.mapped[104]) {
//       this.mapped[104].static_values = {'learning_rate_def': 0.001,'beta1_def': 0.9,'beta2_def': 0.999,'smooth_epsilon_def': 0.0000001,};
//     }
//     this.mapped[105] = abi.type_by_fqn.get(compute.ComputeActivationSoftmax._type)!;
//     this.mapped[106] = abi.type_by_fqn.get(compute.ComputeEngine._type)!;
//     this.mapped[107] = abi.type_by_fqn.get(compute.ComputeInitializerLeCunUniform._type)!;
//     this.mapped[108] = abi.type_by_fqn.get(compute.ComputeActivationCelu._type)!;
//     if (this.mapped[108]) {
//       this.mapped[108].static_values = {'alpha_def': 1.0,};
//     }
//     this.mapped[109] = abi.type_by_fqn.get(compute.ComputeOperationAsin._type)!;
//     this.mapped[110] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaMax._type)!;
//     if (this.mapped[110]) {
//       this.mapped[110].static_values = {'learning_rate_def': 0.001,'beta1_def': 0.9,'beta2_def': 0.999,'smooth_epsilon_def': 0.0000001,};
//     }
//     this.mapped[111] = abi.type_by_fqn.get(compute.ComputeOperationElu._type)!;
//     if (this.mapped[111]) {
//       this.mapped[111].static_values = {'alpha_def': 1.0,};
//     }
//     this.mapped[112] = abi.type_by_fqn.get(compute.ComputeOperationSign._type)!;
//     this.mapped[113] = abi.type_by_fqn.get(compute.ComputeOperationRelu._type)!;
//     if (this.mapped[113]) {
//       this.mapped[113].static_values = {'threshold_def': 0.0,};
//     }
//     this.mapped[114] = abi.type_by_fqn.get(compute.ComputeOperationSqrt._type)!;
//     this.mapped[115] = abi.type_by_fqn.get(compute.ComputeLayerCall._type)!;
//     this.mapped[116] = abi.type_by_fqn.get(compute.ComputeOptimizerSgd._type)!;
//     if (this.mapped[116]) {
//       this.mapped[116].static_values = {'learning_rate_def': 0.01,};
//     }
//     this.mapped[117] = abi.type_by_fqn.get(compute.ComputeOperationAsinh._type)!;
//     this.mapped[118] = abi.type_by_fqn.get(compute.ComputeLayerStandardScaler._type)!;
//     if (this.mapped[118]) {
//       this.mapped[118].static_values = {'var_input_name': "input",'var_output_name': "output",'var_avg_name': "avg",'var_std_name': "std",};
//     }
//     this.mapped[119] = abi.type_by_fqn.get(compute.ComputeOperationAvg._type)!;
//     this.mapped[120] = abi.type_by_fqn.get(compute.ComputeCounter._type)!;
//     this.mapped[121] = abi.type_by_fqn.get(compute.ComputeOperationFill._type)!;
//     this.mapped[122] = abi.type_by_fqn.get(compute.ComputeLayerLossClassification._type)!;
//     if (this.mapped[122]) {
//       this.mapped[122].static_values = {'var_class_weights_name': "class_weights",'var_predicted_classes_name': "predicted_classes",'var_probabilities_name': "probabilities",'var_sum_reduce_name': "sum_reduce",};
//     }
//     this.mapped[123] = abi.type_by_fqn.get(compute.ComputeLayerFilter._type)!;
//     if (this.mapped[123]) {
//       this.mapped[123].static_values = {'var_input_name': "input",'var_output_name': "output",'var_mask_name': "mask",};
//     }
//     this.mapped[124] = abi.type_by_fqn.get(compute.ComputeInitializerLSTM._type)!;
//     this.mapped[125] = abi.type_by_fqn.get(compute.ComputeLayerLoss._type)!;
//     if (this.mapped[125]) {
//       this.mapped[125].static_values = {'var_computed_name': "computed",'var_expected_name': "expected",'var_loss_name': "loss",};
//     }
//     this.mapped[126] = abi.type_by_fqn.get(compute.ComputeOperationTanh._type)!;
//     this.mapped[127] = abi.type_by_fqn.get(compute.ComputeOperationClip._type)!;
//     this.mapped[128] = abi.type_by_fqn.get(compute.ComputeOperationFilter._type)!;
...
//     this.mapped[135] = abi.type_by_fqn.get(nn.RegressionNetwork._type)!;
//     this.mapped[136] = abi.type_by_fqn.get(nn.ClassificationNetwork._type)!;
//     this.mapped[137] = abi.type_by_fqn.get(nn.ComputeActivations._type)!;
//     this.mapped[137]?.resolveGeneratedOffsetWithValues('relu', "Relu",'leaky_relu', "Leaky Relu",'sigmoid', "Sigmoid",'hard_sigmoid', "Hard Sigmoid",'exp', "Exp",'soft_max', "Soft Max",'soft_plus', "Soft Plus",'soft_sign', "Soft Sign",'tanh', "Tanh",'selu', "Selu",'elu', "Elu",'celu', "Celu");
//     this.mapped[138] = abi.type_by_fqn.get(nn.PreProcessType._type)!;
//     this.mapped[138]?.resolveGeneratedOffsetWithValues('none', "None",'min_max_scaling', "Min/Max Scaling",'standard_scaling', "Standard Scaling",'pca_scaling', "PCA Scaling");
//     this.mapped[139] = abi.type_by_fqn.get(nn.ComputeInitializers._type)!;
//     this.mapped[139]?.resolveGeneratedOffsetWithValues('none', "None",'constant', "Constant",'sigmoid_uniform', "SigmoidUniform",'lecun_uniform', "LeCunUniform",'xavier', "Xavier",'xavier_uniform', "XavierUniform",'relu', "Relu",'relu_uniform', "ReluUniform",'normal', "Normal",'normal_in', "NormalIn",'normal_out', "NormalOut",'normal_avg', "NormalAvg",'uniform', "Uniform",'uniform_in', "UniformIn",'uniform_out', "UniformOut",'uniform_avg', "UniformAvg",'identity', "Identity",'pytorch', "Pytorch");
//     this.mapped[140] = abi.type_by_fqn.get(nn.ComputeOptimizers._type)!;
//     this.mapped[140]?.resolveGeneratedOffsetWithValues('ada_delta', "Ada Delta",'ada_grad', "Ada Grad",'adam', "Adam",'ada_max', "Ada Max",'nadam', "NAdam",'ftrl', "Ftrl",'sgd', "Stochastic Gradient Descent",'rms_prop', "RMS Prop",'momentum', "Momentum",'nesterov', "Nesterov");
//     this.mapped[141] = abi.type_by_fqn.get(nn.AutoEncoderNetwork._type)!;
//     this.mapped[142] = abi.type_by_fqn.get(nn.ClassificationMetrics._type)!;
//     this.mapped[143] = abi.type_by_fqn.get(kmeans.KmeanMetaResult._type)!;
//     this.mapped[144] = abi.type_by_fqn.get(kmeans.Kmeans._type)!;
//     if (this.mapped[144]) {
//       this.mapped[144].static_values = {'var_input': "input",'var_assignement': "assignement",'var_min_distance': "min_distance",'varo_centroids': "centroids",'var_distance': "distance",'var_sum_centroids': "sum_centroids",'var_sum_min_distance': "sum_min_distance",'var_count_centroids': "count_centroids",'var_centroid_distances': "centroid_distances",'var_sum_cluster_distances': "sum_cluster_distances",'var_avg_cluster_distances': "avg_cluster_distances",'var_count_cluster_distances': "count_cluster_distances",'layer_placeholders': "placeholders",'layer_forward': "kmeans_forward",'layer_backward': "kmeans_backward",'layer_init_round': "kmeans_init_round",'layer_end_round': "kmeans_end_round",'layer_stats': "kmeans_stats_layer",'seq_init_round': "kmeans_init_round_seq",'seq_forward': "kmeans_forward_seq",'seq_backward': "kmeans_backward_seq",'seq_end_round': "kmeans_end_round_seq",'seq_stats': "kmeans_stats_seq",'default_meta_rounds': 100,'default_rounds': 20,};
//     }
//     this.mapped[145] = abi.type_by_fqn.get(kmeans.KmeanResult._type)!;
//     this.mapped[146] = abi.type_by_fqn.get(patterns.Detection._type)!;
//     this.mapped[147] = abi.type_by_fqn.get(patterns.EuclideanPatternDetectionEngine._type)!;
//     this.mapped[148] = abi.type_by_fqn.get(patterns.SamplingPolicy._type)!;
//     this.mapped[148]?.resolveGeneratedOffsetWithValues('as_is', "As-is",'average_frequency', "Average frequency",'highest_frequency', "Highest frequency");
//     this.mapped[149] = abi.type_by_fqn.get(patterns.OverlappingDetection._type)!;
//     this.mapped[150] = abi.type_by_fqn.get(patterns.PatternDetectors._type)!;
//     this.mapped[150]?.resolveGeneratedOffsetWithValues('none', "None",'euclidean', "Euclidean",'fft', "FFT",'dtw', "DTW",'random', "Random",'sax', "SAX");
//     this.mapped[151] = abi.type_by_fqn.get(patterns.DTWPatternDetector._type)!;
//     this.mapped[152] = abi.type_by_fqn.get(patterns.DTWPatternDetectionEngine._type)!;
//     this.mapped[153] = abi.type_by_fqn.get(patterns.SaxPatternDetectionEngine._type)!;
//     if (this.mapped[153]) {
//       this.mapped[153].static_values = {'alphabet': "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz",};
//     }
//     this.mapped[154] = abi.type_by_fqn.get(patterns.PatternNullStrategy._type)!;
//     this.mapped[154]?.resolveGeneratedOffsetWithValues('replace', "Replace",'interpolate', "Interpolate",'previous', "Previous",'next', "Next",'none', "None");
//     this.mapped[155] = abi.type_by_fqn.get(patterns.FFTPatternDetector._type)!;
//     this.mapped[156] = abi.type_by_fqn.get(patterns.MatchingNormalisation._type)!;
//     this.mapped[156]?.resolveGeneratedOffsetWithValues('as_is', "As-is",'shift', "Vertical shift",'scaling', "Vertical scaling",'shift_and_scaling', "Vertical shift and scaling");
//     this.mapped[157] = abi.type_by_fqn.get(patterns.RandomPatternDetectionEngine._type)!;
//     this.mapped[158] = abi.type_by_fqn.get(patterns.EuclideanPatternDetector._type)!;
//     this.mapped[159] = abi.type_by_fqn.get(patterns.ScoreDetails._type)!;
//     this.mapped[160] = abi.type_by_fqn.get(patterns.PatternDetectionEngineState._type)!;
//     this.mapped[161] = abi.type_by_fqn.get(patterns.FFTResult._type)!;
//     this.mapped[162] = abi.type_by_fqn.get(patterns.DistanceMetrics._type)!;
//     this.mapped[163] = abi.type_by_fqn.get(patterns.RandomPatternDetector._type)!;
//     this.mapped[164] = abi.type_by_fqn.get(patterns.PatternDetectionSensitivity._type)!;
//     this.mapped[165] = abi.type_by_fqn.get(patterns.ScoreDetailsSingleton._type)!;
//     this.mapped[166] = abi.type_by_fqn.get(patterns.PatternDetectionEngine._type)!;
//     this.mapped[167] = abi.type_by_fqn.get(patterns.PatternDetector._type)!;
//     this.mapped[168] = abi.type_by_fqn.get(patterns.SaxPatternDetector._type)!;
//     this.mapped[169] = abi.type_by_fqn.get(ml.TimeSeriesDecomposition._type)!;
//     this.mapped[170] = abi.type_by_fqn.get(ml.Solver._type)!;
//     this.mapped[171] = abi.type_by_fqn.get(ml.HeatMapProfile._type)!;
//     this.mapped[172] = abi.type_by_fqn.get(ml.Polynomial._type)!;
//     this.mapped[173] = abi.type_by_fqn.get(ml.GaussianND._type)!;
//     this.mapped[174] = abi.type_by_fqn.get(ml.PCA._type)!;
//     if (this.mapped[174]) {
//       this.mapped[174].static_values = {'threshold_def': 0.95,};
//     }
//     this.mapped[175] = abi.type_by_fqn.get(transforms.FFTModel._type)!;
//     this.mapped[176] = abi.type_by_fqn.get(powerflow.PowerBusResult._type)!;
//     this.mapped[177] = abi.type_by_fqn.get(powerflow.PowerLineResult._type)!;
//   },
// };
