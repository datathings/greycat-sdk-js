...
export namespace compute {
  export class ComputeOptimizerAdaMax extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaMax {
      return new ComputeOptimizerAdaMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[0], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeInitializerUniformIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformIn {
      return new ComputeInitializerUniformIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[2]);
    }
  ...
  export class ComputeInitializerUniformAvg extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformAvg {
      return new ComputeInitializerUniformAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[3]);
    }
  ...
  export class ComputeOperationCelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCelu {
      return new ComputeOperationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[5], input, output, alpha);
    }
  ...
  export class ComputeOperationExp extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationExp {
      return new ComputeOperationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[6], input, output);
    }
  ...
  export class ComputeOperationFilter extends $sdk.GCObject {
    ...
    static createFrom({input, output, mask, nbOutputs}: {input: string, output: string, mask: string, nbOutputs: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationFilter {
      return new ComputeOperationFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[7], input, output, mask, nbOutputs);
    }
  ...
  export class ComputeOperationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output, slope, shift}: {input: string, output: string, slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationHardSigmoid {
      return new ComputeOperationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[8], input, output, slope, shift);
    }
  ...
  export class ComputeOperationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha, max_value, threshold}: {input: string, output: string, alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeakyRelu {
      return new ComputeOperationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[9], input, output, alpha, max_value, threshold);
    }
  ...
  export class ComputeVarInOut extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, with_grad}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, with_grad: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarInOut {
      return new ComputeVarInOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[10], name, type, shape, with_grad);
    }
  ...
  export class ComputeOperationAcos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcos {
      return new ComputeOperationAcos($g.abi.libs_by_name.get(algebralib.name)!.mapped[11], input, output);
    }
  ...
  export class ComputeOperationRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, max_value, threshold}: {input: string, output: string, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationRelu {
      return new ComputeOperationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[12], input, output, max_value, threshold);
    }
  ...
  export class ComputeActivationRelu extends $sdk.GCObject {
    ...
    static createFrom({max_value, threshold}: {max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationRelu {
      return new ComputeActivationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[13], max_value, threshold);
    }
  ...
  export class ComputeInitializerPytorch extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerPytorch {
      return new ComputeInitializerPytorch($g.abi.libs_by_name.get(algebralib.name)!.mapped[14]);
    }
  ...
  export class ComputeLayerDense extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[15], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
  ...
  export class ComputeInitializerNormal extends $sdk.GCObject {
    ...
    static createFrom({avg, std}: {avg: number, std: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormal {
      return new ComputeInitializerNormal($g.abi.libs_by_name.get(algebralib.name)!.mapped[16], avg, std);
    }
  ...
  export class ComputeOperationSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSigmoid {
      return new ComputeOperationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[17], input, output);
    }
  ...
  export class ComputeOperationRaiseToPower extends $sdk.GCObject {
    ...
    static createFrom({input, output, power}: {input: string, output: string, power: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationRaiseToPower {
      return new ComputeOperationRaiseToPower($g.abi.libs_by_name.get(algebralib.name)!.mapped[18], input, output, power);
    }
  ...
  export class ComputeLayerStandardScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerStandardScaler {
      return new ComputeLayerStandardScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[20], name, type, inverse_transform);
    }
  ...
  export class ComputeOptimizerSgd extends $sdk.GCObject {
    ...
    static createFrom({learning_rate}: {learning_rate: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerSgd {
      return new ComputeOptimizerSgd($g.abi.libs_by_name.get(algebralib.name)!.mapped[21], learning_rate);
    }
  ...
  export class ComputeInitializerNormalIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalIn {
      return new ComputeInitializerNormalIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[22]);
    }
  ...
  export class ComputeOperationAtanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtanh {
      return new ComputeOperationAtanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[23], input, output);
    }
  ...
  export class ComputeLayerLossRegression extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeRegressionLoss}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossRegression {
      return new ComputeLayerLossRegression($g.abi.libs_by_name.get(algebralib.name)!.mapped[24], name, reduction, loss_type);
    }
  ...
  export class ComputeInitializerConstant extends $sdk.GCObject {
    ...
    static createFrom({value}: {value: any}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerConstant {
      return new ComputeInitializerConstant($g.abi.libs_by_name.get(algebralib.name)!.mapped[25], value);
    }
  ...
  export class ComputeLayerLSTM extends $sdk.GCObject {
    ...
    static createFrom({name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences}: {name: string, bias_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_regularizer: compute.ComputeRegularizer | null, type: $sdk.std.core.TensorType, use_bias: boolean | null, return_sequences: boolean | null, bidirectional: boolean | null, auto_init_states: boolean | null, inputs: bigint | number, outputs: bigint | number, layers: bigint | number, sequences: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLSTM {
      return new ComputeLayerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[26], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
    }
  ...
  export class ComputeOptimizerNadam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNadam {
      return new ComputeOptimizerNadam($g.abi.libs_by_name.get(algebralib.name)!.mapped[28], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeOperationAsin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsin {
      return new ComputeOperationAsin($g.abi.libs_by_name.get(algebralib.name)!.mapped[31], input, output);
    }
  ...
  export class ComputeLayerFilter extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, maskValues}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, maskValues: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerFilter {
      return new ComputeLayerFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[32], name, type, inputs, outputs, maskValues);
    }
  ...
  export class ComputeActivationTanh extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationTanh {
      return new ComputeActivationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[34]);
    }
  ...
  export class ComputeInitializerSigmoidUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerSigmoidUniform {
      return new ComputeInitializerSigmoidUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[35]);
    }
  ...
  export class ComputeOperationEuclidean extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationEuclidean {
      return new ComputeOperationEuclidean($g.abi.libs_by_name.get(algebralib.name)!.mapped[38], input, input2, output);
    }
  ...
  export class ComputeActivationExp extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationExp {
      return new ComputeActivationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[42]);
    }
  ...
  export class ComputeOperationAdd extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAdd {
      return new ComputeOperationAdd($g.abi.libs_by_name.get(algebralib.name)!.mapped[43], input, input2, output);
    }
  ...
  export class ComputeLayerCustom extends $sdk.GCObject {
    ...
    static createFrom({name, ops, vars}: {name: string, ops: globalThis.Array<compute.ComputeOperation>, vars: globalThis.Array<compute.ComputeVariable>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCustom {
      return new ComputeLayerCustom($g.abi.libs_by_name.get(algebralib.name)!.mapped[44], name, ops, vars);
    }
  ...
  export class ComputeOperationAddBias extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAddBias {
      return new ComputeOperationAddBias($g.abi.libs_by_name.get(algebralib.name)!.mapped[46], input, input2, output);
    }
  ...
  export class ComputeLayerCall extends $sdk.GCObject {
    ...
    static createFrom({layer_name, bindings}: {layer_name: string, bindings: globalThis.Array<compute.ComputeBinding>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCall {
      return new ComputeLayerCall($g.abi.libs_by_name.get(algebralib.name)!.mapped[47], layer_name, bindings);
    }
  ...
  export class ComputeOperationSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSign {
      return new ComputeOperationSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[48], input, output);
    }
  ...
  export class ComputeOperationLog extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLog {
      return new ComputeOperationLog($g.abi.libs_by_name.get(algebralib.name)!.mapped[49], input, output);
    }
  ...
  export class ComputeLayerActivation extends $sdk.GCObject {
    ...
    static createFrom({name, activation}: {name: string, activation: compute.ComputeActivation}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerActivation {
      return new ComputeLayerActivation($g.abi.libs_by_name.get(algebralib.name)!.mapped[51], name, activation);
    }
  ...
  export class ComputeBinding extends $sdk.GCObject {
    ...
    static createFrom({src_layer_name, src_var_name, target_var_name}: {src_layer_name: string, src_var_name: string, target_var_name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeBinding {
      return new ComputeBinding($g.abi.libs_by_name.get(algebralib.name)!.mapped[52], src_layer_name, src_var_name, target_var_name);
    }
  ...
  export class ComputeOperationArgMax extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMax {
      return new ComputeOperationArgMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[53], input, output, output2);
    }
  ...
  export class ComputeOperationSoftplus extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftplus {
      return new ComputeOperationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[54], input, output);
    }
  ...
  export class ComputeInitializerXavierUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavierUniform {
      return new ComputeInitializerXavierUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[55]);
    }
  ...
  export class ComputeActivationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({classes}: {classes: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftmax {
      return new ComputeActivationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[57], classes);
    }
  ...
  export class ComputeActivationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({slope, shift}: {slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationHardSigmoid {
      return new ComputeActivationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[58], slope, shift);
    }
  ...
  export class ComputeActivationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({alpha, max_value, threshold}: {alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationLeakyRelu {
      return new ComputeActivationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[61], alpha, max_value, threshold);
    }
  ...
  export class ComputeInitializerRelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerRelu {
      return new ComputeInitializerRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[64]);
    }
  ...
  export class ComputeOptimizerMomentum extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerMomentum {
      return new ComputeOptimizerMomentum($g.abi.libs_by_name.get(algebralib.name)!.mapped[65], learning_rate, decay_rate);
    }
  ...
  export class ComputeInitializerNormalOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalOut {
      return new ComputeInitializerNormalOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[66]);
    }
  ...
  export class ComputeOperationTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTanh {
      return new ComputeOperationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[68], input, output);
    }
  ...
  export class ComputeOperationSqrt extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSqrt {
      return new ComputeOperationSqrt($g.abi.libs_by_name.get(algebralib.name)!.mapped[69], input, output);
    }
  ...
  export class ComputeOperationTan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTan {
      return new ComputeOperationTan($g.abi.libs_by_name.get(algebralib.name)!.mapped[70], input, output);
    }
  ...
  export class ComputeInitializerGlorotUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerGlorotUniform {
      return new ComputeInitializerGlorotUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[73]);
    }
  ...
  export class ComputeOperationAcosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcosh {
      return new ComputeOperationAcosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[74], input, output);
    }
  ...
  export class ComputeLayerClassification extends $sdk.GCObject {
    ...
    static createFrom({name, calculate_probabilities, from_logits}: {name: string, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerClassification {
      return new ComputeLayerClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[75], name, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOperationSum extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSum {
      return new ComputeOperationSum($g.abi.libs_by_name.get(algebralib.name)!.mapped[76], input, output, axis);
    }
  ...
  export class ComputeOperationSub extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSub {
      return new ComputeOperationSub($g.abi.libs_by_name.get(algebralib.name)!.mapped[85], input, input2, output);
    }
  ...
  export class ComputeOperationAtan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtan {
      return new ComputeOperationAtan($g.abi.libs_by_name.get(algebralib.name)!.mapped[86], input, output);
    }
  ...
  export class ComputeOperationMatMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output, transposeA, transposeB, alpha, beta}: {input: string, input2: string, output: string, transposeA: boolean, transposeB: boolean, alpha: number, beta: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMatMul {
      return new ComputeOperationMatMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[87], input, input2, output, transposeA, transposeB, alpha, beta);
    }
  ...
  export class ComputeActivationSoftSign extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftSign {
      return new ComputeActivationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[88]);
    }
  ...
  export class ComputeLayerSeq extends $sdk.GCObject {
    ...
    static createFrom({name, calls, optimizer}: {name: string, calls: globalThis.Array<compute.ComputeLayerCall>, optimizer: compute.ComputeOptimizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerSeq {
      return new ComputeLayerSeq($g.abi.libs_by_name.get(algebralib.name)!.mapped[89], name, calls, optimizer);
    }
  ...
  export class ComputeVarOptimize extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, l1, l2, init}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, l1: number, l2: number, init: compute.ComputeInitializer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarOptimize {
      return new ComputeVarOptimize($g.abi.libs_by_name.get(algebralib.name)!.mapped[90], name, type, shape, l1, l2, init);
    }
  ...
  export class ComputeOperationNeg extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationNeg {
      return new ComputeOperationNeg($g.abi.libs_by_name.get(algebralib.name)!.mapped[91], input, output);
    }
  ...
  export class ComputeInitializerXavier extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavier {
      return new ComputeInitializerXavier($g.abi.libs_by_name.get(algebralib.name)!.mapped[97]);
    }
  ...
  export class ComputeOperationAbs extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAbs {
      return new ComputeOperationAbs($g.abi.libs_by_name.get(algebralib.name)!.mapped[98], input, output);
    }
  ...
  export class ComputeOperationSinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSinh {
      return new ComputeOperationSinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[99], input, output);
    }
  ...
  export class ComputeActivationElu extends $sdk.GCObject {
    ...
    static createFrom({alpha}: {alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationElu {
      return new ComputeActivationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[100], alpha);
    }
  ...
  export class ComputeOperationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftmax {
      return new ComputeOperationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[103], input, output);
    }
  ...
  export class ComputeOperationSoftSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftSign {
      return new ComputeOperationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[104], input, output);
    }
  ...
  export class ComputeOptimizerRmsProp extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate, smooth_epsilon}: {learning_rate: number | null, decay_rate: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerRmsProp {
      return new ComputeOptimizerRmsProp($g.abi.libs_by_name.get(algebralib.name)!.mapped[106], learning_rate, decay_rate, smooth_epsilon);
    }
  ...
  export class ComputeOperationSin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSin {
      return new ComputeOperationSin($g.abi.libs_by_name.get(algebralib.name)!.mapped[108], input, output);
    }
  ...
  export class ComputeInitializerNone extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNone {
      return new ComputeInitializerNone($g.abi.libs_by_name.get(algebralib.name)!.mapped[109]);
    }
  ...
  export class ComputeInitializerLeCunUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLeCunUniform {
      return new ComputeInitializerLeCunUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[110]);
    }
  ...
  export class ComputeOperationFill extends $sdk.GCObject {
    ...
    static createFrom({input, value}: {input: string, value: any}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationFill {
      return new ComputeOperationFill($g.abi.libs_by_name.get(algebralib.name)!.mapped[111], input, value);
    }
  ...
  export class ComputeOperationMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMul {
      return new ComputeOperationMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[113], input, input2, output);
    }
  ...
  export class ComputeActivationSigmoid extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSigmoid {
      return new ComputeActivationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[115]);
    }
  ...
  export class ComputeInitializerLSTM extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLSTM {
      return new ComputeInitializerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[116]);
    }
  ...
  export class ComputeOperationPow extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationPow {
      return new ComputeOperationPow($g.abi.libs_by_name.get(algebralib.name)!.mapped[119], input, input2, output);
    }
  ...
  export class ComputeOperationAsinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsinh {
      return new ComputeOperationAsinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[120], input, output);
    }
  ...
  export class ComputeOperationArgMin extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMin {
      return new ComputeOperationArgMin($g.abi.libs_by_name.get(algebralib.name)!.mapped[121], input, output, output2);
    }
  ...
  export class ComputeOperationAvg extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAvg {
      return new ComputeOperationAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[123], input, input2, output);
    }
  ...
  export class ComputeOptimizerNesterov extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNesterov {
      return new ComputeOptimizerNesterov($g.abi.libs_by_name.get(algebralib.name)!.mapped[124], learning_rate, decay_rate);
    }
  ...
  export class ComputeOperationLeCunTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeCunTanh {
      return new ComputeOperationLeCunTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[127], input, output);
    }
  ...
  export class ComputeLayerLinear extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLinear {
      return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[128], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
    }
    static create(name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLinear {
      return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[128], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
    }
...
export namespace nn {
  ...
  export class ClassificationMetrics extends $sdk.GCObject {
    ...
    static createFrom({precision, recall, f1Score}: {precision: globalThis.Array<number>, recall: globalThis.Array<number>, f1Score: globalThis.Array<number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ClassificationMetrics {
      return new ClassificationMetrics($g.abi.libs_by_name.get(algebralib.name)!.mapped[134], precision, recall, f1Score);
    }
  ...
  export class RegressionNetwork extends $sdk.GCObject {
    ...
    static createFrom({inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput}: {inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): RegressionNetwork {
      return new RegressionNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[142], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput);
    }
    static create(inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null, $g: $sdk.GreyCat = globalThis.greycat.default): RegressionNetwork {
      return new RegressionNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[142], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput);
    }
...
export const algebralib: $sdk.Library = {
  ...
  init(abi) {
    this.mapped[0] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaMax._type);
    if (this.mapped[0]) {
      this.mapped[0].static_values = {['learning_rate_def']: 0.001,['beta1_def']: 0.9,['beta2_def']: 0.999,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[1] = abi.type_by_fqn.get(compute.ComputeOperation1In1Out._type);
    this.mapped[2] = abi.type_by_fqn.get(compute.ComputeInitializerUniformIn._type);
    this.mapped[3] = abi.type_by_fqn.get(compute.ComputeInitializerUniformAvg._type);
    this.mapped[4] = abi.type_by_fqn.get(compute.ComputeCounter._type);
    this.mapped[5] = abi.type_by_fqn.get(compute.ComputeOperationCelu._type);
    if (this.mapped[5]) {
      this.mapped[5].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[6] = abi.type_by_fqn.get(compute.ComputeOperationExp._type);
    this.mapped[7] = abi.type_by_fqn.get(compute.ComputeOperationFilter._type);
    this.mapped[8] = abi.type_by_fqn.get(compute.ComputeOperationHardSigmoid._type);
    if (this.mapped[8]) {
      this.mapped[8].static_values = {['slope_def']: 0.2,['shift_def']: 0.5,};
    }
    this.mapped[9] = abi.type_by_fqn.get(compute.ComputeOperationLeakyRelu._type);
    if (this.mapped[9]) {
      this.mapped[9].static_values = {['alpha_def']: 0.3,['max_value_def']: 1.7976931349E308,['threshold_def']: 0.0,};
    }
    this.mapped[10] = abi.type_by_fqn.get(compute.ComputeVarInOut._type);
    this.mapped[11] = abi.type_by_fqn.get(compute.ComputeOperationAcos._type);
    this.mapped[12] = abi.type_by_fqn.get(compute.ComputeOperationRelu._type);
    if (this.mapped[12]) {
      this.mapped[12].static_values = {['threshold_def']: 0.0,};
    }
    this.mapped[13] = abi.type_by_fqn.get(compute.ComputeActivationRelu._type);
    if (this.mapped[13]) {
      this.mapped[13].static_values = {['threshold_def']: 0.0,};
    }
    this.mapped[14] = abi.type_by_fqn.get(compute.ComputeInitializerPytorch._type);
    this.mapped[15] = abi.type_by_fqn.get(compute.ComputeLayerDense._type);
    if (this.mapped[15]) {
      this.mapped[15].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_weight_name']: "weight",['var_bias_name']: "bias",['var_mult_name']: "mult",['var_pre_activation_name']: "pre_activation",};
    }
    this.mapped[16] = abi.type_by_fqn.get(compute.ComputeInitializerNormal._type);
    this.mapped[17] = abi.type_by_fqn.get(compute.ComputeOperationSigmoid._type);
    this.mapped[18] = abi.type_by_fqn.get(compute.ComputeOperationRaiseToPower._type);
    this.mapped[19] = abi.type_by_fqn.get(compute.ComputeState._type);
    this.mapped[20] = abi.type_by_fqn.get(compute.ComputeLayerStandardScaler._type);
    if (this.mapped[20]) {
      this.mapped[20].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_avg_name']: "avg",['var_std_name']: "std",};
    }
    this.mapped[21] = abi.type_by_fqn.get(compute.ComputeOptimizerSgd._type);
    if (this.mapped[21]) {
      this.mapped[21].static_values = {['learning_rate_def']: 0.01,};
    }
    this.mapped[22] = abi.type_by_fqn.get(compute.ComputeInitializerNormalIn._type);
    this.mapped[23] = abi.type_by_fqn.get(compute.ComputeOperationAtanh._type);
    this.mapped[24] = abi.type_by_fqn.get(compute.ComputeLayerLossRegression._type);
    this.mapped[25] = abi.type_by_fqn.get(compute.ComputeInitializerConstant._type);
    this.mapped[26] = abi.type_by_fqn.get(compute.ComputeLayerLSTM._type);
    if (this.mapped[26]) {
      this.mapped[26].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_hx_name']: "hx",['var_cx_name']: "cx",['var_hy_name']: "hy",['var_cy_name']: "cy",['var_weight_name']: "weight",['var_bias_name']: "bias",['var_internal_i_name']: "internal_i",['var_internal_f_name']: "internal_f",['var_internal_cp_name']: "internal_cp",['var_internal_o_name']: "internal_o",['var_internal_h_name']: "internal_h",['var_internal_c_name']: "internal_c",['var_internal_mult_name']: "internal_mult",['var_internal_output_name']: "internal_output",};
    }
    this.mapped[27] = abi.type_by_fqn.get(compute.ComputeVar._type);
    this.mapped[28] = abi.type_by_fqn.get(compute.ComputeOptimizerNadam._type);
    if (this.mapped[28]) {
      this.mapped[28].static_values = {['learning_rate_def']: 0.001,['beta1_def']: 0.9,['beta2_def']: 0.999,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[29] = abi.type_by_fqn.get(compute.ComputeLayerConfusion._type);
    if (this.mapped[29]) {
      this.mapped[29].static_values = {['var_computed_name']: "computed",['var_expected_name']: "expected",['var_confusion_name']: "confusion",};
    }
    this.mapped[30] = abi.type_by_fqn.get(compute.ComputeVarProxy._type);
    this.mapped[31] = abi.type_by_fqn.get(compute.ComputeOperationAsin._type);
    this.mapped[32] = abi.type_by_fqn.get(compute.ComputeLayerFilter._type);
    if (this.mapped[32]) {
      this.mapped[32].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_mask_name']: "mask",};
    }
    this.mapped[33] = abi.type_by_fqn.get(compute.ComputeRegularizer._type);
    this.mapped[34] = abi.type_by_fqn.get(compute.ComputeActivationTanh._type);
    this.mapped[35] = abi.type_by_fqn.get(compute.ComputeInitializerSigmoidUniform._type);
    ...
    this.mapped[38] = abi.type_by_fqn.get(compute.ComputeOperationEuclidean._type);
    ...
    this.mapped[41] = abi.type_by_fqn.get(compute.ComputeEngine._type);
    this.mapped[42] = abi.type_by_fqn.get(compute.ComputeActivationExp._type);
    this.mapped[43] = abi.type_by_fqn.get(compute.ComputeOperationAdd._type);
    this.mapped[44] = abi.type_by_fqn.get(compute.ComputeLayerCustom._type);
    this.mapped[45] = abi.type_by_fqn.get(compute.ComputeOperationScale._type);
    this.mapped[46] = abi.type_by_fqn.get(compute.ComputeOperationAddBias._type);
    this.mapped[47] = abi.type_by_fqn.get(compute.ComputeLayerCall._type);
    this.mapped[48] = abi.type_by_fqn.get(compute.ComputeOperationSign._type);
    this.mapped[49] = abi.type_by_fqn.get(compute.ComputeOperationLog._type);
    this.mapped[50] = abi.type_by_fqn.get(compute.ComputeModel._type);
    this.mapped[51] = abi.type_by_fqn.get(compute.ComputeLayerActivation._type);
    if (this.mapped[51]) {
      this.mapped[51].static_values = {['var_input_name']: "input",['var_output_name']: "output",};
    }
    this.mapped[52] = abi.type_by_fqn.get(compute.ComputeBinding._type);
    this.mapped[53] = abi.type_by_fqn.get(compute.ComputeOperationArgMax._type);
    this.mapped[54] = abi.type_by_fqn.get(compute.ComputeOperationSoftplus._type);
    this.mapped[55] = abi.type_by_fqn.get(compute.ComputeInitializerXavierUniform._type);
    this.mapped[56] = abi.type_by_fqn.get(compute.ComputeInitializerIdentity._type);
    this.mapped[57] = abi.type_by_fqn.get(compute.ComputeActivationSoftmax._type);
    this.mapped[58] = abi.type_by_fqn.get(compute.ComputeActivationHardSigmoid._type);
    if (this.mapped[58]) {
      this.mapped[58].static_values = {['slope_def']: 0.2,['shift_def']: 0.5,};
    }
    ...
    this.mapped[61] = abi.type_by_fqn.get(compute.ComputeActivationLeakyRelu._type);
    if (this.mapped[61]) {
      this.mapped[61].static_values = {['alpha_def']: 0.3,['threshold_def']: 0.0,};
    }
    ...
    this.mapped[64] = abi.type_by_fqn.get(compute.ComputeInitializerRelu._type);
    this.mapped[65] = abi.type_by_fqn.get(compute.ComputeOptimizerMomentum._type);
    if (this.mapped[65]) {
      this.mapped[65].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.9,};
    }
    this.mapped[66] = abi.type_by_fqn.get(compute.ComputeInitializerNormalOut._type);
    this.mapped[67] = abi.type_by_fqn.get(compute.ComputeInitializerNormalAvg._type);
    this.mapped[68] = abi.type_by_fqn.get(compute.ComputeOperationTanh._type);
    this.mapped[69] = abi.type_by_fqn.get(compute.ComputeOperationSqrt._type);
    this.mapped[70] = abi.type_by_fqn.get(compute.ComputeOperationTan._type);
    ...
    this.mapped[73] = abi.type_by_fqn.get(compute.ComputeInitializerGlorotUniform._type);
    this.mapped[74] = abi.type_by_fqn.get(compute.ComputeOperationAcosh._type);
    this.mapped[75] = abi.type_by_fqn.get(compute.ComputeLayerClassification._type);
    if (this.mapped[75]) {
      this.mapped[75].static_values = {['var_input_name']: "input",['var_predicted_classes_name']: "predicted_classes",['var_probabilities_name']: "probabilities",};
    }
    this.mapped[76] = abi.type_by_fqn.get(compute.ComputeOperationSum._type);
    ...
    this.mapped[79] = abi.type_by_fqn.get(compute.ComputeRegressionLoss._type);
    this.mapped[79]?.resolveGeneratedOffsetWithValues('square', "Square",'abs', "Abs");
    ...
    this.mapped[82] = abi.type_by_fqn.get(compute.ComputeOptimizer._type);
    this.mapped[83] = abi.type_by_fqn.get(compute.ComputeLayerLoss._type);
    if (this.mapped[83]) {
      this.mapped[83].static_values = {['var_computed_name']: "computed",['var_expected_name']: "expected",['var_loss_name']: "loss",};
    }
    this.mapped[84] = abi.type_by_fqn.get(compute.ComputeInitializer._type);
    this.mapped[85] = abi.type_by_fqn.get(compute.ComputeOperationSub._type);
    this.mapped[86] = abi.type_by_fqn.get(compute.ComputeOperationAtan._type);
    this.mapped[87] = abi.type_by_fqn.get(compute.ComputeOperationMatMul._type);
    if (this.mapped[87]) {
      this.mapped[87].static_values = {['transpose_def']: false,['alpha_def']: 1.0,['beta_def']: 0.0,};
    }
    this.mapped[88] = abi.type_by_fqn.get(compute.ComputeActivationSoftSign._type);
    this.mapped[89] = abi.type_by_fqn.get(compute.ComputeLayerSeq._type);
    this.mapped[90] = abi.type_by_fqn.get(compute.ComputeVarOptimize._type);
    this.mapped[91] = abi.type_by_fqn.get(compute.ComputeOperationNeg._type);
    ...
    if (this.mapped[94]) {
      this.mapped[94].static_values = {['var_class_weights_name']: "class_weights",['var_predicted_classes_name']: "predicted_classes",['var_probabilities_name']: "probabilities",['var_sum_reduce_name']: "sum_reduce",};
    }
    this.mapped[95] = abi.type_by_fqn.get(compute.ComputeOperation2In1Out._type);
    this.mapped[96] = abi.type_by_fqn.get(compute.ComputeActivationCelu._type);
    if (this.mapped[96]) {
      this.mapped[96].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[97] = abi.type_by_fqn.get(compute.ComputeInitializerXavier._type);
    this.mapped[98] = abi.type_by_fqn.get(compute.ComputeOperationAbs._type);
    this.mapped[99] = abi.type_by_fqn.get(compute.ComputeOperationSinh._type);
    this.mapped[100] = abi.type_by_fqn.get(compute.ComputeActivationElu._type);
    if (this.mapped[100]) {
      this.mapped[100].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[101] = abi.type_by_fqn.get(compute.ComputeInitializerReluUniform._type);
    this.mapped[102] = abi.type_by_fqn.get(compute.ComputeVariable._type);
    this.mapped[103] = abi.type_by_fqn.get(compute.ComputeOperationSoftmax._type);
    this.mapped[104] = abi.type_by_fqn.get(compute.ComputeOperationSoftSign._type);
    this.mapped[105] = abi.type_by_fqn.get(compute.ComputeLayer._type);
    this.mapped[106] = abi.type_by_fqn.get(compute.ComputeOptimizerRmsProp._type);
    if (this.mapped[106]) {
      this.mapped[106].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.9,['smooth_epsilon_def']: 0.0000001,};
    }
    ...
    this.mapped[108] = abi.type_by_fqn.get(compute.ComputeOperationSin._type);
    this.mapped[109] = abi.type_by_fqn.get(compute.ComputeInitializerNone._type);
    this.mapped[110] = abi.type_by_fqn.get(compute.ComputeInitializerLeCunUniform._type);
    this.mapped[111] = abi.type_by_fqn.get(compute.ComputeOperationFill._type);
    ...
    this.mapped[113] = abi.type_by_fqn.get(compute.ComputeOperationMul._type);
    this.mapped[114] = abi.type_by_fqn.get(compute.ComputeOperationLogSoftmax._type);
    this.mapped[115] = abi.type_by_fqn.get(compute.ComputeActivationSigmoid._type);
    this.mapped[116] = abi.type_by_fqn.get(compute.ComputeInitializerLSTM._type);
    this.mapped[117] = abi.type_by_fqn.get(compute.ComputeOperation._type);
    this.mapped[118] = abi.type_by_fqn.get(compute.ComputeActivation._type);
    this.mapped[119] = abi.type_by_fqn.get(compute.ComputeOperationPow._type);
    this.mapped[120] = abi.type_by_fqn.get(compute.ComputeOperationAsinh._type);
    this.mapped[121] = abi.type_by_fqn.get(compute.ComputeOperationArgMin._type);
    this.mapped[122] = abi.type_by_fqn.get(compute.ComputeOperationArg._type);
    this.mapped[123] = abi.type_by_fqn.get(compute.ComputeOperationAvg._type);
    this.mapped[124] = abi.type_by_fqn.get(compute.ComputeOptimizerNesterov._type);
    if (this.mapped[124]) {
      this.mapped[124].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.9,};
    }
    ...
    this.mapped[127] = abi.type_by_fqn.get(compute.ComputeOperationLeCunTanh._type);
    this.mapped[128] = abi.type_by_fqn.get(compute.ComputeLayerLinear._type);
    if (this.mapped[128]) {
      this.mapped[128].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_weight_name']: "weight",['var_bias_name']: "bias",['var_mult_name']: "mult",};
    }
    ...
    this.mapped[131] = abi.type_by_fqn.get(nn.ClassificationNetwork._type);
    this.mapped[132] = abi.type_by_fqn.get(nn.BindingsResult._type);
    this.mapped[133] = abi.type_by_fqn.get(nn.ComputeActivations._type);
    this.mapped[133]?.resolveGeneratedOffsetWithValues('relu', "Relu",'leaky_relu', "Leaky Relu",'sigmoid', "Sigmoid",'hard_sigmoid', "Hard Sigmoid",'exp', "Exp",'soft_max', "Soft Max",'soft_plus', "Soft Plus",'soft_sign', "Soft Sign",'tanh', "Tanh",'selu', "Selu",'elu', "Elu",'celu', "Celu");
    this.mapped[134] = abi.type_by_fqn.get(nn.ClassificationMetrics._type);
    ...
    this.mapped[137] = abi.type_by_fqn.get(nn.AutoEncoderNetwork._type);
    ...
    this.mapped[142] = abi.type_by_fqn.get(nn.RegressionNetwork._type);
