...
export namespace core {
  export class nodeGeo extends $greycat.std_n.core.nodeGeo {
    static sample(refs: core.Array<core.nodeGeo>, from: core.geo | null, to: core.geo | null, maxRows: core.int, mode: core.SamplingMode, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Table> {
      return $g.call('core::nodeGeo::sample', [refs, from, to, maxRows, mode], $signal);
    };
    static info(nodes: core.Array<core.nodeGeo>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.geo>>> {
  ...
  export class GeoCircle extends $greycat.GCObject {
    ...
    static createFrom({center, radius}: {center: core.geo, radius: core.float}, $g: $greycat.GreyCat = $greycat.$.default): GeoCircle {
      return new GeoCircle($g.abi.libs_by_name.get(stdlib.name)!.mapped[0], center, radius);
    }
  ...
  export class TableColumnMapping extends $greycat.GCObject {
    ...
    column!: core.int;
    extractors!: core.Array<any>;

    static createFrom({column, extractors}: {column: core.int, extractors: core.Array<any>}, $g: $greycat.GreyCat = $greycat.$.default): TableColumnMapping {
      return new TableColumnMapping($g.abi.libs_by_name.get(stdlib.name)!.mapped[2], column, extractors);
    }
    static create(column: core.int, extractors: core.Array<any>, $g: $greycat.GreyCat = $greycat.$.default): TableColumnMapping {
      return new TableColumnMapping($g.abi.libs_by_name.get(stdlib.name)!.mapped[2], column, extractors);
    }
  }
  ...
  export class nodeTime extends $greycat.std_n.core.nodeTime {
    static sample(refs: core.Array<core.nodeTime>, from: core.time | null, to: core.time | null, maxRows: core.int, mode: core.SamplingMode, maxDephasing: core.duration | null, tz: core.TimeZone | null, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Table> {
      return $g.call('core::nodeTime::sample', [refs, from, to, maxRows, mode, maxDephasing, tz], $signal);
    };
    static info(nodes: core.Array<core.nodeTime>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.time>>> {
  ...
  export class GeoPoly extends $greycat.GCObject {
    ...
    points!: core.Array<core.geo>;

    static createFrom({points}: {points: core.Array<core.geo>}, $g: $greycat.GreyCat = $greycat.$.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[8], points);
    }
    static create(points: core.Array<core.geo>, $g: $greycat.GreyCat = $greycat.$.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[8], points);
    }
  }
  ...
  export class GeoBox extends $greycat.GCObject {
    ...
    static createFrom({sw, ne}: {sw: core.geo, ne: core.geo}, $g: $greycat.GreyCat = $greycat.$.default): GeoBox {
      return new GeoBox($g.abi.libs_by_name.get(stdlib.name)!.mapped[9], sw, ne);
    }
  ...
  export class Error extends $greycat.GCObject {
    ...
    message!: string | null;
    stack!: core.Array<core.ErrorFrame>;

    static createFrom({message, stack}: {message: string | null, stack: core.Array<core.ErrorFrame>}, $g: $greycat.GreyCat = $greycat.$.default): Error {
      return new Error($g.abi.libs_by_name.get(stdlib.name)!.mapped[10], message, stack);
    }
    static create(message: string | null, stack: core.Array<core.ErrorFrame>, $g: $greycat.GreyCat = $greycat.$.default): Error {
      return new Error($g.abi.libs_by_name.get(stdlib.name)!.mapped[10], message, stack);
    }
  }
  ...
  export class MathConstants extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): MathConstants {
      return new MathConstants($g.abi.libs_by_name.get(stdlib.name)!.mapped[11]);
    }
  ...
  export class Tuple<T = any, U = any> extends $greycat.GCObject {
    ...
    static createFrom<T, U>({x, y}: {x: any | null, y: any | null}, $g: $greycat.GreyCat = $greycat.$.default): Tuple {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[12], x, y);
    }
    static create<T, U>(x: any | null, y: any | null, $g: $greycat.GreyCat = $greycat.$.default): Tuple<T, U> {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[12], x, y);
    }
  }
  ...
  export class Table<T = any> extends $greycat.std_n.core.Table<T> {
    static applyMappings(table: core.Table, mappings: core.Array<core.TableColumnMapping>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Table> {
  ...
  export class ErrorFrame extends $greycat.GCObject {
    ...
    static createFrom({module, function_, line, column}: {module: string | null, function_: string, line: core.int, column: core.int}, $g: $greycat.GreyCat = $greycat.$.default): ErrorFrame {
      return new ErrorFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[21], module, function_, line, column);
    }
  ...
  export class nodeIndex extends $greycat.std_n.core.nodeIndex {
    static sample(refs: core.Array<core.nodeIndex>, from: any | null, maxRows: core.int, mode: core.SamplingMode, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Table> {
      return $g.call('core::nodeIndex::sample', [refs, from, maxRows, mode], $signal);
    };
    static info(nodes: core.Array<core.nodeIndex>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<core.NodeInfo>> {
  ...
  export class TensorType extends $greycat.GCEnum {
    ...
    static i32($g: $greycat.GreyCat = $greycat.$.default): TensorType {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[22];
  ...
  export class TimeZone extends $greycat.GCEnum {
    ...
    static Africa_Accra($g: $greycat.GreyCat = $greycat.$.default): TimeZone {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[23];
  ...
  export class node extends $greycat.std_n.core.node {
    static resolve_all(n: core.Array<core.node | null>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array> {
  ...
  export class nodeTimeCursor<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({n, req_time}: {n: core.nodeTime, req_time: core.time | null}, $g: $greycat.GreyCat = $greycat.$.default): nodeTimeCursor {
      return new nodeTimeCursor($g.abi.libs_by_name.get(stdlib.name)!.mapped[24], n, req_time);
    }
    static create<T>(n: core.nodeTime, req_time: core.time | null, $g: $greycat.GreyCat = $greycat.$.default): nodeTimeCursor<T> {
      return new nodeTimeCursor($g.abi.libs_by_name.get(stdlib.name)!.mapped[24], n, req_time);
    }
  }

  export class nodeList extends $greycat.std_n.core.nodeList {
    static sample(refs: core.Array<core.nodeList>, from: core.int | null, to: core.int | null, maxRows: core.int, mode: core.SamplingMode, maxDephasing: core.int | null, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Table> {
      return $g.call('core::nodeList::sample', [refs, from, to, maxRows, mode, maxDephasing], $signal);
    };
    static info(nodes: core.Array<core.nodeList>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.int>>> {
...
export namespace runtime {
  export class StoreStat extends $greycat.GCObject {
    ...
    static createFrom({capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio}: {capacity_bytes: core.int, allocated_bytes: core.int, allocated_ratio: core.float, remained_bytes: core.int, remained_ratio: core.float, used_bytes: core.int, used_ratio: core.float, available_bytes: core.int, available_ratio: core.float}, $g: $greycat.GreyCat = $greycat.$.default): StoreStat {
      return new StoreStat($g.abi.libs_by_name.get(stdlib.name)!.mapped[25], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
    }
  ...
  export class OpenIDConnect extends $greycat.GCObject {
    ...
    static createFrom({url, clientId}: {url: string, clientId: string}, $g: $greycat.GreyCat = $greycat.$.default): OpenIDConnect {
      return new OpenIDConnect($g.abi.libs_by_name.get(stdlib.name)!.mapped[26], url, clientId);
    }
  ...
  export class DebugBreakpoint extends $greycat.GCObject {
    ...
    static createFrom({module, line, column}: {module: string, line: core.int, column: core.int}, $g: $greycat.GreyCat = $greycat.$.default): DebugBreakpoint {
      return new DebugBreakpoint($g.abi.libs_by_name.get(stdlib.name)!.mapped[27], module, line, column);
    }
  ...
  export class User extends $greycat.GCObject {
    ...
    groups!: core.Array<runtime.UserGroupPolicy> | null;
    ...
    static permissions($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<string>> {
    ...
    static createFrom({id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external}: {id: core.int, name: string, activated: boolean, full_name: string | null, email: string | null, role: string | null, permissions_flags: core.int | null, groups: core.Array<runtime.UserGroupPolicy> | null, groups_flags: core.int | null, external: boolean}, $g: $greycat.GreyCat = $greycat.$.default): User {
      return new User($g.abi.libs_by_name.get(stdlib.name)!.mapped[29], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
    }
    static create(id: core.int, name: string, activated: boolean, full_name: string | null, email: string | null, role: string | null, permissions_flags: core.int | null, groups: core.Array<runtime.UserGroupPolicy> | null, groups_flags: core.int | null, external: boolean, $g: $greycat.GreyCat = $greycat.$.default): User {
      return new User($g.abi.libs_by_name.get(stdlib.name)!.mapped[29], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
    }
  }
  ...
  export class DebugInfo extends $greycat.GCObject {
    ...
    scopes!: core.Array<runtime.DebugFrame>;
    root!: any;

    static createFrom({scopes, root}: {scopes: core.Array<runtime.DebugFrame>, root: any}, $g: $greycat.GreyCat = $greycat.$.default): DebugInfo {
      return new DebugInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[30], scopes, root);
    }
    static create(scopes: core.Array<runtime.DebugFrame>, root: any, $g: $greycat.GreyCat = $greycat.$.default): DebugInfo {
      return new DebugInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[30], scopes, root);
    }
  }
  ...
  export class PeriodicTask extends $greycat.GCObject {
    ...
    user_id!: core.int;
    arguments!: core.Array | null;
    start!: core.time;
    every!: core.duration;

    static all($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<runtime.PeriodicTask>> {
      return $g.call('runtime::PeriodicTask::all', undefined, $signal);
    };
    static set(tasks: core.Array<runtime.PeriodicTask>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<unknown> {
      return $g.call('runtime::PeriodicTask::set', [tasks], $signal);
    };
    static createFrom({function_, user_id, arguments_, start, every}: {function_: core.function_ | null, user_id: core.int, arguments_: core.Array | null, start: core.time, every: core.duration}, $g: $greycat.GreyCat = $greycat.$.default): PeriodicTask {
      return new PeriodicTask($g.abi.libs_by_name.get(stdlib.name)!.mapped[31], function_, user_id, arguments_, start, every);
    }
    static create(function_: core.function_ | null, user_id: core.int, arguments_: core.Array | null, start: core.time, every: core.duration, $g: $greycat.GreyCat = $greycat.$.default): PeriodicTask {
      return new PeriodicTask($g.abi.libs_by_name.get(stdlib.name)!.mapped[31], function_, user_id, arguments_, start, every);
    }
  }
  ...
  export class Runtime extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Runtime {
      return new Runtime($g.abi.libs_by_name.get(stdlib.name)!.mapped[32]);
    }
  ...
  export class UserGroupPolicy extends $greycat.GCObject {
    ...
    static createFrom({group_id, type}: {group_id: core.int, type: runtime.UserGroupPolicyType}, $g: $greycat.GreyCat = $greycat.$.default): UserGroupPolicy {
      return new UserGroupPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[33], group_id, type);
    }
  ...
  export class TaskStatus extends $greycat.GCEnum {
    ...
    static empty($g: $greycat.GreyCat = $greycat.$.default): TaskStatus {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[34];
  ...
  export class Task extends $greycat.GCObject {
    ...
    static running($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<runtime.TaskInfo>> {
      return $g.call('runtime::Task::running', undefined, $signal);
    };
    static history(offset: core.int, max: core.int, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<runtime.Task>> {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, start, duration, status}: {user_id: core.int, task_id: core.int, mod: string | null, type: string | null, fun: string | null, creation: core.time, start: core.time | null, duration: core.duration | null, status: runtime.TaskStatus}, $g: $greycat.GreyCat = $greycat.$.default): Task {
      return new Task($g.abi.libs_by_name.get(stdlib.name)!.mapped[35], user_id, task_id, mod, type, fun, creation, start, duration, status);
    }
  ...
  export class System extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): System {
      return new System($g.abi.libs_by_name.get(stdlib.name)!.mapped[36]);
    }
  ...
  export class License extends $greycat.GCObject {
    ...
    static createFrom({name, start, end, company, max_memory, extra_1, extra_2, type}: {name: string | null, start: core.time, end: core.time, company: string | null, max_memory: core.int, extra_1: core.int | null, extra_2: core.int | null, type: runtime.LicenseType | null}, $g: $greycat.GreyCat = $greycat.$.default): License {
      return new License($g.abi.libs_by_name.get(stdlib.name)!.mapped[38], name, start, end, company, max_memory, extra_1, extra_2, type);
    }
  ...
  export class Debug extends $greycat.GCObject {
    ...
    static add(bps: core.Array<runtime.DebugBreakpoint>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<unknown> {
      return $g.call('runtime::Debug::add', [bps], $signal);
    };
    static remove(bps: core.Array<runtime.DebugBreakpoint>, $g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<unknown> {
      return $g.call('runtime::Debug::remove', [bps], $signal);
    };
    static workers($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<core.int>> {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Debug {
      return new Debug($g.abi.libs_by_name.get(stdlib.name)!.mapped[40]);
    }
  ...
  export class DebugFrame extends $greycat.GCObject {
    ...
    line!: core.int;
    column!: core.int;
    scope!: core.Array<runtime.DebugVariable>;

    static createFrom({module, function_, line, column, scope}: {module: string | null, function_: core.function_ | null, line: core.int, column: core.int, scope: core.Array<runtime.DebugVariable>}, $g: $greycat.GreyCat = $greycat.$.default): DebugFrame {
      return new DebugFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[41], module, function_, line, column, scope);
    }
    static create(module: string | null, function_: core.function_ | null, line: core.int, column: core.int, scope: core.Array<runtime.DebugVariable>, $g: $greycat.GreyCat = $greycat.$.default): DebugFrame {
      return new DebugFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[41], module, function_, line, column, scope);
    }
  }
  ...
  export class TaskRequest extends $greycat.GCObject {
    ...
    static createFrom({function_, arguments_, mode}: {function_: core.function_, arguments_: core.Array | null, mode: runtime.TaskMode | null}, $g: $greycat.GreyCat = $greycat.$.default): TaskRequest {
      return new TaskRequest($g.abi.libs_by_name.get(stdlib.name)!.mapped[42], function_, arguments_, mode);
    }
    static create(function_: core.function_, arguments_: core.Array | null, mode: runtime.TaskMode | null, $g: $greycat.GreyCat = $greycat.$.default): TaskRequest {
      return new TaskRequest($g.abi.libs_by_name.get(stdlib.name)!.mapped[42], function_, arguments_, mode);
    }
  }
  ...
  export class TaskResult extends $greycat.GCObject {
    ...
    static createFrom({values, errors}: {values: core.Array, errors: core.int}, $g: $greycat.GreyCat = $greycat.$.default): TaskResult {
      return new TaskResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[43], values, errors);
    }
    static create(values: core.Array, errors: core.int, $g: $greycat.GreyCat = $greycat.$.default): TaskResult {
      return new TaskResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[43], values, errors);
    }
  }
  ...
  export class SecurityEntity extends $greycat.GCObject {
    ...
    static all($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<runtime.SecurityEntity>> {
  ...
  export class DebugVariable extends $greycat.GCObject {
    ...
    static createFrom({name, value}: {name: string | null, value: any | null}, $g: $greycat.GreyCat = $greycat.$.default): DebugVariable {
      return new DebugVariable($g.abi.libs_by_name.get(stdlib.name)!.mapped[45], name, value);
    }
  ...
  export class UserRole extends $greycat.GCObject {
    ...
    name!: string;
    permissions!: core.Array<string>;

    static all($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<runtime.UserRole>> {
    ...
    static createFrom({name, permissions}: {name: string, permissions: core.Array<string>}, $g: $greycat.GreyCat = $greycat.$.default): UserRole {
      return new UserRole($g.abi.libs_by_name.get(stdlib.name)!.mapped[46], name, permissions);
    }
    static create(name: string, permissions: core.Array<string>, $g: $greycat.GreyCat = $greycat.$.default): UserRole {
      return new UserRole($g.abi.libs_by_name.get(stdlib.name)!.mapped[46], name, permissions);
    }
  }
  ...
  export class SecurityFields extends $greycat.GCObject {
    ...
    roles!: core.Map<string, string> | null;
    groups!: core.Map<string, string> | null;
    ...
    static createFrom({email, name, first_name, last_name, roles, groups}: {email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: core.Map<string, string> | null, groups: core.Map<string, string> | null}, $g: $greycat.GreyCat = $greycat.$.default): SecurityFields {
      return new SecurityFields($g.abi.libs_by_name.get(stdlib.name)!.mapped[47], email, name, first_name, last_name, roles, groups);
    }
    static create(email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: core.Map<string, string> | null, groups: core.Map<string, string> | null, $g: $greycat.GreyCat = $greycat.$.default): SecurityFields {
      return new SecurityFields($g.abi.libs_by_name.get(stdlib.name)!.mapped[47], email, name, first_name, last_name, roles, groups);
    }
  }
  ...
  export class UserCredential extends $greycat.GCObject {
    ...
    static createFrom({offset, pass}: {offset: core.int, pass: string | null}, $g: $greycat.GreyCat = $greycat.$.default): UserCredential {
      return new UserCredential($g.abi.libs_by_name.get(stdlib.name)!.mapped[49], offset, pass);
    }
  ...
  export class TaskInfo extends $greycat.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, start, duration, status, progress, remaining, sub_waiting, sub_tasks_all}: {user_id: core.int, task_id: core.int, mod: string | null, type: string | null, fun: string | null, creation: core.time, start: core.time | null, duration: core.duration | null, status: runtime.TaskStatus, progress: core.float | null, remaining: core.duration | null, sub_waiting: core.int | null, sub_tasks_all: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): TaskInfo {
      return new TaskInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[50], user_id, task_id, mod, type, fun, creation, start, duration, status, progress, remaining, sub_waiting, sub_tasks_all);
    }
  ...
  export class SecurityPolicy extends $greycat.GCObject {
    ...
    entities!: core.Array<runtime.SecurityEntity> | null;
    credentials!: core.Map<string, runtime.UserCredential> | null;
    roles!: core.Map<string, runtime.UserRole> | null;
    fields!: runtime.SecurityFields | null;
    keys!: core.Map<string, string> | null;
    keys_last_refresh!: core.time | null;

    static permissions($g: $greycat.GreyCat = $greycat.$.default, $signal?: AbortSignal): Promise<core.Array<string>> {
      return $g.call('runtime::SecurityPolicy::permissions', undefined, $signal);
    };
    static createFrom({entities, credentials, roles, fields, keys, keys_last_refresh}: {entities: core.Array<runtime.SecurityEntity> | null, credentials: core.Map<string, runtime.UserCredential> | null, roles: core.Map<string, runtime.UserRole> | null, fields: runtime.SecurityFields | null, keys: core.Map<string, string> | null, keys_last_refresh: core.time | null}, $g: $greycat.GreyCat = $greycat.$.default): SecurityPolicy {
      return new SecurityPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[52], entities, credentials, roles, fields, keys, keys_last_refresh);
    }
    static create(entities: core.Array<runtime.SecurityEntity> | null, credentials: core.Map<string, runtime.UserCredential> | null, roles: core.Map<string, runtime.UserRole> | null, fields: runtime.SecurityFields | null, keys: core.Map<string, string> | null, keys_last_refresh: core.time | null, $g: $greycat.GreyCat = $greycat.$.default): SecurityPolicy {
      return new SecurityPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[52], entities, credentials, roles, fields, keys, keys_last_refresh);
    }
  }
  ...
  export class RuntimeInfo extends $greycat.GCObject {
    ...
    static createFrom({version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats}: {version: string, program_version: string | null, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: core.int, bg_threads: core.int, fg_threads: core.int, mem_total: core.int, mem_worker: core.int, nb_ctx: core.int, store_stats: runtime.StoreStat | null}, $g: $greycat.GreyCat = $greycat.$.default): RuntimeInfo {
      return new RuntimeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[53], version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
    }
...
export namespace io {
  export class CsvColumnDate extends $greycat.GCObject {
    ...
    static createFrom({name, mandatory, offset, format, tz, as_time}: {name: string | null, mandatory: boolean | null, offset: core.int | null, format: string | null, tz: core.TimeZone | null, as_time: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnDate {
      return new CsvColumnDate($g.abi.libs_by_name.get(stdlib.name)!.mapped[54], name, mandatory, offset, format, tz, as_time);
    }
  ...
  export class TextWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append}: {path: string, append: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): TextWriter {
      return new TextWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[55], path, append);
    }
    static create<T>(path: string, append: boolean | null, $g: $greycat.GreyCat = $greycat.$.default): TextWriter<T> {
      return new TextWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[55], path, append);
    }
  }
  ...
  export class CsvReader<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, pos, format}: {path: string, pos: core.int | null, format: io.CsvFormat}, $g: $greycat.GreyCat = $greycat.$.default): CsvReader {
      return new CsvReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[56], path, pos, format);
    }
  ...
  export class CsvColumnInteger extends $greycat.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnInteger {
      return new CsvColumnInteger($g.abi.libs_by_name.get(stdlib.name)!.mapped[58], name, mandatory, offset);
    }
  ...
  export class CsvFormat extends $greycat.GCObject {
    ...
    columns!: core.Array<io.CsvColumn> | null;
    ...
    static createFrom({header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns}: {header_lines: core.int | null, separator: core.char | null, string_delimiter: core.char | null, decimal_separator: core.char | null, thousands_separator: core.char | null, columns_size: core.int | null, columns: core.Array<io.CsvColumn> | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[59], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
    static create(header_lines: core.int | null, separator: core.char | null, string_delimiter: core.char | null, decimal_separator: core.char | null, thousands_separator: core.char | null, columns_size: core.int | null, columns: core.Array<io.CsvColumn> | null, $g: $greycat.GreyCat = $greycat.$.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[59], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
  }
  ...
  export class CsvColumnString extends $greycat.GCObject {
    ...
    values!: core.Array<string> | null;
    encoder!: io.TextEncoder | null;

    static createFrom({name, mandatory, offset, trim, try_number, try_json, values, encoder}: {name: string | null, mandatory: boolean | null, offset: core.int | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: core.Array<string> | null, encoder: io.TextEncoder | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnString {
      return new CsvColumnString($g.abi.libs_by_name.get(stdlib.name)!.mapped[60], name, mandatory, offset, trim, try_number, try_json, values, encoder);
    }
    static create(name: string | null, mandatory: boolean | null, offset: core.int | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: core.Array<string> | null, encoder: io.TextEncoder | null, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnString {
      return new CsvColumnString($g.abi.libs_by_name.get(stdlib.name)!.mapped[60], name, mandatory, offset, trim, try_number, try_json, values, encoder);
    }
  }
  ...
  export class File extends $greycat.GCObject {
    ...
    static createFrom({path, size, last_modification}: {path: string, size: core.int | null, last_modification: core.time | null}, $g: $greycat.GreyCat = $greycat.$.default): File {
      return new File($g.abi.libs_by_name.get(stdlib.name)!.mapped[62], path, size, last_modification);
    }
  ...
  export class GcbWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append}: {path: string, append: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): GcbWriter {
      return new GcbWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[63], path, append);
    }
    static create<T>(path: string, append: boolean | null, $g: $greycat.GreyCat = $greycat.$.default): GcbWriter<T> {
      return new GcbWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[63], path, append);
    }
  }
  ...
  export class Smtp extends $greycat.GCObject {
    ...
    static createFrom({host, port, mode, authenticate, user, pass}: {host: string, port: core.int, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null}, $g: $greycat.GreyCat = $greycat.$.default): Smtp {
      return new Smtp($g.abi.libs_by_name.get(stdlib.name)!.mapped[64], host, port, mode, authenticate, user, pass);
    }
  ...
  export class HttpHeader extends $greycat.GCObject {
    ...
    static createFrom({name, value}: {name: string, value: string}, $g: $greycat.GreyCat = $greycat.$.default): HttpHeader {
      return new HttpHeader($g.abi.libs_by_name.get(stdlib.name)!.mapped[66], name, value);
    }
  ...
  export class CsvValidateResult extends $greycat.GCObject {
    ...
    line_count!: core.int;
    fail_count!: core.int;
    invalid_count!: core.Array<core.int>;

    static createFrom({line_count, fail_count, invalid_count}: {line_count: core.int, fail_count: core.int, invalid_count: core.Array<core.int>}, $g: $greycat.GreyCat = $greycat.$.default): CsvValidateResult {
      return new CsvValidateResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[67], line_count, fail_count, invalid_count);
    }
    static create(line_count: core.int, fail_count: core.int, invalid_count: core.Array<core.int>, $g: $greycat.GreyCat = $greycat.$.default): CsvValidateResult {
      return new CsvValidateResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[67], line_count, fail_count, invalid_count);
    }
  }

  export class TextReader<T = any> extends $greycat.GCObject {
    static readonly _type = 'io::TextReader';

    path!: string;
    pos!: core.int | null;

    static createFrom<T>({path, pos}: {path: string, pos: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): TextReader {
      return new TextReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[68], path, pos);
    }
    static create<T>(path: string, pos: core.int | null, $g: $greycat.GreyCat = $greycat.$.default): TextReader<T> {
      return new TextReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[68], path, pos);
    }
  }
  ...
  export class Email extends $greycat.GCObject {
    ...
    to!: core.Array<string>;
    cc!: core.Array<string> | null;
    bcc!: core.Array<string> | null;

    static createFrom({from, subject, body, body_is_html, to, cc, bcc}: {from: string, subject: string, body: string, body_is_html: boolean, to: core.Array<string>, cc: core.Array<string> | null, bcc: core.Array<string> | null}, $g: $greycat.GreyCat = $greycat.$.default): Email {
      return new Email($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], from, subject, body, body_is_html, to, cc, bcc);
    }
    static create(from: string, subject: string, body: string, body_is_html: boolean, to: core.Array<string>, cc: core.Array<string> | null, bcc: core.Array<string> | null, $g: $greycat.GreyCat = $greycat.$.default): Email {
      return new Email($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], from, subject, body, body_is_html, to, cc, bcc);
    }
  }
  ...
  export class CsvColumnStatistics extends $greycat.GCObject {
    ...
    date_count!: core.int;
    date_format_count!: core.Map<string, core.int>;
    enumerable_count!: core.Map<any, core.int>;
    ...
    static createFrom({name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile}: {name: string | null, example: any | null, null_count: core.int, bool_count: core.int, int_count: core.int, float_count: core.int, string_count: core.int, date_count: core.int, date_format_count: core.Map<string, core.int>, enumerable_count: core.Map<any, core.int>, profile: util.Gaussian}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnStatistics {
      return new CsvColumnStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[70], name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile);
    }
  ...
  export class GcbReader<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, pos}: {path: string, pos: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): GcbReader {
      return new GcbReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[71], path, pos);
    }
  ...
  export class CsvAnalysisConfig extends $greycat.GCObject {
    ...
    date_formats!: core.Array<string> | null;
    ...
    static createFrom({header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats}: {header_lines: core.int | null, separator: core.char | null, string_delimiter: core.char | null, decimal_separator: core.char | null, thousands_separator: core.char | null, row_limit: core.int | null, enumerable_limit: core.int | null, date_check_limit: core.int | null, date_formats: core.Array<string> | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvAnalysisConfig {
      return new CsvAnalysisConfig($g.abi.libs_by_name.get(stdlib.name)!.mapped[72], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats);
    }
  ...
  export class JsonReader<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, pos}: {path: string, pos: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): JsonReader {
      return new JsonReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[73], path, pos);
    }
  ...
  export class CsvColumnIgnored extends $greycat.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnIgnored {
      return new CsvColumnIgnored($g.abi.libs_by_name.get(stdlib.name)!.mapped[74], name, mandatory, offset);
    }
  ...
  export class Url extends $greycat.GCObject {
    ...
    port!: core.int | null;
    path!: string | null;
    params!: core.Map<string, string> | null;
    hash!: string | null;

    static createFrom({protocol, host, port, path, params, hash}: {protocol: string | null, host: string | null, port: core.int | null, path: string | null, params: core.Map<string, string> | null, hash: string | null}, $g: $greycat.GreyCat = $greycat.$.default): Url {
      return new Url($g.abi.libs_by_name.get(stdlib.name)!.mapped[77], protocol, host, port, path, params, hash);
    }
    static create(protocol: string | null, host: string | null, port: core.int | null, path: string | null, params: core.Map<string, string> | null, hash: string | null, $g: $greycat.GreyCat = $greycat.$.default): Url {
      return new Url($g.abi.libs_by_name.get(stdlib.name)!.mapped[77], protocol, host, port, path, params, hash);
    }
  }
  ...
  export class CsvColumnBoolean extends $greycat.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnBoolean {
      return new CsvColumnBoolean($g.abi.libs_by_name.get(stdlib.name)!.mapped[79], name, mandatory, offset);
    }
  ...
  export class CsvStatistics extends $greycat.GCObject {
    ...
    decimal_separator!: core.char | null;
    thousands_separator!: core.char | null;
    columns!: core.Array<io.CsvColumnStatistics>;
    line_count!: core.int;
    fail_count!: core.int;
    file_count!: core.int;

    static createFrom({header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count}: {header_lines: core.int | null, separator: core.char | null, string_delimiter: core.char | null, decimal_separator: core.char | null, thousands_separator: core.char | null, columns: core.Array<io.CsvColumnStatistics>, line_count: core.int, fail_count: core.int, file_count: core.int}, $g: $greycat.GreyCat = $greycat.$.default): CsvStatistics {
      return new CsvStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[80], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count);
    }
    static create(header_lines: core.int | null, separator: core.char | null, string_delimiter: core.char | null, decimal_separator: core.char | null, thousands_separator: core.char | null, columns: core.Array<io.CsvColumnStatistics>, line_count: core.int, fail_count: core.int, file_count: core.int, $g: $greycat.GreyCat = $greycat.$.default): CsvStatistics {
      return new CsvStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[80], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count);
    }
  ...
  export class TextEncoder extends $greycat.GCEnum {
    ...
    static plain($g: $greycat.GreyCat = $greycat.$.default): TextEncoder {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[81];
      return t.static_values['plain'];
    }
  ...
  export class CsvWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append, format}: {path: string, append: boolean | null, format: io.CsvFormat}, $g: $greycat.GreyCat = $greycat.$.default): CsvWriter {
      return new CsvWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[82], path, append, format);
    }
    static create<T>(path: string, append: boolean | null, format: io.CsvFormat, $g: $greycat.GreyCat = $greycat.$.default): CsvWriter<T> {
      return new CsvWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[82], path, append, format);
    }
  }
  ...
  export class CsvColumnDuration extends $greycat.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: core.int | null, unit: core.DurationUnit | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnDuration {
      return new CsvColumnDuration($g.abi.libs_by_name.get(stdlib.name)!.mapped[83], name, mandatory, offset, unit);
    }
  ...
  export class CsvColumnTime extends $greycat.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: core.int | null, unit: core.DurationUnit | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnTime {
      return new CsvColumnTime($g.abi.libs_by_name.get(stdlib.name)!.mapped[85], name, mandatory, offset, unit);
    }
  ...
  export class FileWalker extends $greycat.GCObject {
    ...
    static createFrom({path}: {path: string}, $g: $greycat.GreyCat = $greycat.$.default): FileWalker {
      return new FileWalker($g.abi.libs_by_name.get(stdlib.name)!.mapped[87], path);
    }
  ...
  export class JsonWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append}: {path: string, append: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): JsonWriter {
      return new JsonWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[88], path, append);
    }
    static create<T>(path: string, append: boolean | null, $g: $greycat.GreyCat = $greycat.$.default): JsonWriter<T> {
      return new JsonWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[88], path, append);
    }
  }
...
export namespace util {
  export class TimeWindow<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({values, width, sum, sumsq, field}: {values: core.Table | null, width: core.duration, sum: core.float | null, sumsq: core.float | null, field: core.field | null}, $g: $greycat.GreyCat = $greycat.$.default): TimeWindow {
      return new TimeWindow($g.abi.libs_by_name.get(stdlib.name)!.mapped[89], values, width, sum, sumsq, field);
    }
  ...
  export class Assert extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Assert {
      return new Assert($g.abi.libs_by_name.get(stdlib.name)!.mapped[90]);
    }
  ...
  export class SlidingWindow<T = any> extends $greycat.GCObject {
    ...
    values!: core.Array | null;
    capacity!: core.int;
    sum!: core.float | null;
    sumsq!: core.float | null;
    field!: core.field | null;

    static createFrom<T>({values, capacity, sum, sumsq, field}: {values: core.Array | null, capacity: core.int, sum: core.float | null, sumsq: core.float | null, field: core.field | null}, $g: $greycat.GreyCat = $greycat.$.default): SlidingWindow {
      return new SlidingWindow($g.abi.libs_by_name.get(stdlib.name)!.mapped[93], values, capacity, sum, sumsq, field);
    }
    static create<T>(values: core.Array | null, capacity: core.int, sum: core.float | null, sumsq: core.float | null, field: core.field | null, $g: $greycat.GreyCat = $greycat.$.default): SlidingWindow<T> {
      return new SlidingWindow($g.abi.libs_by_name.get(stdlib.name)!.mapped[93], values, capacity, sum, sumsq, field);
    }
  }
  ...
  export class HistogramStats extends $greycat.GCObject {
    ...
    static createFrom({min, max, whisker_low, whisker_high, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, count_outliers_low, count_outliers_high, percentage_outliers_low, percentage_outliers_high, sum, avg, std, size}: {min: core.float, max: core.float, whisker_low: core.float, whisker_high: core.float, percentile1: core.float, percentile5: core.float, percentile25: core.float, percentile50: core.float, percentile75: core.float, percentile95: core.float, percentile99: core.float, count_outliers_low: core.int, count_outliers_high: core.int, percentage_outliers_low: core.float, percentage_outliers_high: core.float, sum: core.float, avg: core.float, std: core.float, size: core.int}, $g: $greycat.GreyCat = $greycat.$.default): HistogramStats {
      return new HistogramStats($g.abi.libs_by_name.get(stdlib.name)!.mapped[94], min, max, whisker_low, whisker_high, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, count_outliers_low, count_outliers_high, percentage_outliers_low, percentage_outliers_high, sum, avg, std, size);
    }
  ...
  export class GaussianProfile<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({quantizer, precision, bins, value_min, nb_rejected}: {quantizer: util.Quantizer, precision: core.FloatPrecision, bins: core.Table<core.int> | null, value_min: core.float | null, nb_rejected: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): GaussianProfile {
      return new GaussianProfile($g.abi.libs_by_name.get(stdlib.name)!.mapped[95], quantizer, precision, bins, value_min, nb_rejected);
    }
  ...
  export class Stack<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({values}: {values: core.Array | null}, $g: $greycat.GreyCat = $greycat.$.default): Stack {
      return new Stack($g.abi.libs_by_name.get(stdlib.name)!.mapped[96], values);
    }
    static create<T>(values: core.Array | null, $g: $greycat.GreyCat = $greycat.$.default): Stack<T> {
      return new Stack($g.abi.libs_by_name.get(stdlib.name)!.mapped[96], values);
    }
  }
  ...
  export class MultiQuantizer<T = any> extends $greycat.GCObject {
    ...
    dimensions!: core.Array;

    static createFrom<T>({dimensions}: {dimensions: core.Array}, $g: $greycat.GreyCat = $greycat.$.default): MultiQuantizer {
      return new MultiQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[97], dimensions);
    }
    static create<T>(dimensions: core.Array, $g: $greycat.GreyCat = $greycat.$.default): MultiQuantizer<T> {
      return new MultiQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[97], dimensions);
    }
  }
  ...
  export class Gaussian extends $greycat.GCObject {
    ...
    static createFrom({sum, sumsq, count, min, max}: {sum: core.float | null, sumsq: core.float | null, count: core.int | null, min: core.float | null, max: core.float | null}, $g: $greycat.GreyCat = $greycat.$.default): Gaussian {
      return new Gaussian($g.abi.libs_by_name.get(stdlib.name)!.mapped[98], sum, sumsq, count, min, max);
    }
  ...
  export class LinearQuantizer<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({min, max, bins, open}: {min: core.float, max: core.float, bins: core.int, open: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): LinearQuantizer {
      return new LinearQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[99], min, max, bins, open);
    }
  ...
  export class Histogram<T = any> extends $greycat.GCObject {
    ...
    quantizer!: util.Quantizer;
    bins!: core.Array<core.int | null> | null;
    nb_rejected!: core.int | null;

    static createFrom<T>({quantizer, bins, nb_rejected}: {quantizer: util.Quantizer, bins: core.Array<core.int | null> | null, nb_rejected: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): Histogram {
      return new Histogram($g.abi.libs_by_name.get(stdlib.name)!.mapped[101], quantizer, bins, nb_rejected);
    }
    static create<T>(quantizer: util.Quantizer, bins: core.Array<core.int | null> | null, nb_rejected: core.int | null, $g: $greycat.GreyCat = $greycat.$.default): Histogram<T> {
      return new Histogram($g.abi.libs_by_name.get(stdlib.name)!.mapped[101], quantizer, bins, nb_rejected);
    }
  }
  ...
  export class Crypto extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Crypto {
      return new Crypto($g.abi.libs_by_name.get(stdlib.name)!.mapped[103]);
    }
  ...
  export class Random extends $greycat.GCObject {
    ...
    static createFrom({seed, v}: {seed: core.int | null, v: core.float | null}, $g: $greycat.GreyCat = $greycat.$.default): Random {
      return new Random($g.abi.libs_by_name.get(stdlib.name)!.mapped[104], seed, v);
    }
  ...
  export class LogQuantizer<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({min, max, bins, open}: {min: core.float, max: core.float, bins: core.int, open: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): LogQuantizer {
      return new LogQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[105], min, max, bins, open);
    }
  ...
  export class Queue<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({values, capacity}: {values: core.Array | null, capacity: core.int | null}, $g: $greycat.GreyCat = $greycat.$.default): Queue {
      return new Queue($g.abi.libs_by_name.get(stdlib.name)!.mapped[106], values, capacity);
    }
    static create<T>(values: core.Array | null, capacity: core.int | null, $g: $greycat.GreyCat = $greycat.$.default): Queue<T> {
      return new Queue($g.abi.libs_by_name.get(stdlib.name)!.mapped[106], values, capacity);
    }
  }
  ...
  export class CustomQuantizer<T = any> extends $greycat.GCObject {
    ...
    min!: core.float;
    max!: core.float;
    step_starts!: core.Array;
    open!: boolean | null;

    static createFrom<T>({min, max, step_starts, open}: {min: core.float, max: core.float, step_starts: core.Array, open: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): CustomQuantizer {
      return new CustomQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[107], min, max, step_starts, open);
    }
    static create<T>(min: core.float, max: core.float, step_starts: core.Array, open: boolean | null, $g: $greycat.GreyCat = $greycat.$.default): CustomQuantizer<T> {
      return new CustomQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[107], min, max, step_starts, open);
    }
  }
  ...
  export class ProgressTracker extends $greycat.GCObject {
    ...
    static createFrom({start, total, counter, duration, progress, speed, remaining}: {start: core.time, total: core.int | null, counter: core.int | null, duration: core.duration | null, progress: core.float | null, speed: core.float | null, remaining: core.duration | null}, $g: $greycat.GreyCat = $greycat.$.default): ProgressTracker {
      return new ProgressTracker($g.abi.libs_by_name.get(stdlib.name)!.mapped[108], start, total, counter, duration, progress, speed, remaining);
    }
...
export const stdlib: $greycat.Library = {
  name: 'std',
  mapped: new globalThis.Array(109),
...
declare global {
  namespace greycat {
    interface GreyCat {
      call(method: 'core::nodeGeo::sample', args: [core.Array<core.nodeGeo>, core.geo | null, core.geo | null, core.int, core.SamplingMode], signal?: AbortSignal): Promise<core.Table>;
      spawn(method: 'core::nodeGeo::sample', args: [core.Array<core.nodeGeo>, core.geo | null, core.geo | null, core.int, core.SamplingMode], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeGeo::sample', args: [core.Array<core.nodeGeo>, core.geo | null, core.geo | null, core.int, core.SamplingMode], pollEvery?: number, signal?: AbortSignal): Promise<core.Table>;
      call(method: 'core::nodeGeo::info', args: [core.Array<core.nodeGeo>], signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.geo>>>;
      spawn(method: 'core::nodeGeo::info', args: [core.Array<core.nodeGeo>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeGeo::info', args: [core.Array<core.nodeGeo>], pollEvery?: number, signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.geo>>>;
      call(method: 'core::nodeTime::sample', args: [core.Array<core.nodeTime>, core.time | null, core.time | null, core.int, core.SamplingMode, core.duration | null, core.TimeZone | null], signal?: AbortSignal): Promise<core.Table>;
      spawn(method: 'core::nodeTime::sample', args: [core.Array<core.nodeTime>, core.time | null, core.time | null, core.int, core.SamplingMode, core.duration | null, core.TimeZone | null], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeTime::sample', args: [core.Array<core.nodeTime>, core.time | null, core.time | null, core.int, core.SamplingMode, core.duration | null, core.TimeZone | null], pollEvery?: number, signal?: AbortSignal): Promise<core.Table>;
      call(method: 'core::nodeTime::info', args: [core.Array<core.nodeTime>], signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.time>>>;
      spawn(method: 'core::nodeTime::info', args: [core.Array<core.nodeTime>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeTime::info', args: [core.Array<core.nodeTime>], pollEvery?: number, signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.time>>>;
      call(method: 'core::Table::applyMappings', args: [core.Table, core.Array<core.TableColumnMapping>], signal?: AbortSignal): Promise<core.Table>;
      spawn(method: 'core::Table::applyMappings', args: [core.Table, core.Array<core.TableColumnMapping>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::Table::applyMappings', args: [core.Table, core.Array<core.TableColumnMapping>], pollEvery?: number, signal?: AbortSignal): Promise<core.Table>;
      ...
      call(method: 'core::nodeIndex::sample', args: [core.Array<core.nodeIndex>, any | null, core.int, core.SamplingMode], signal?: AbortSignal): Promise<core.Table>;
      spawn(method: 'core::nodeIndex::sample', args: [core.Array<core.nodeIndex>, any | null, core.int, core.SamplingMode], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeIndex::sample', args: [core.Array<core.nodeIndex>, any | null, core.int, core.SamplingMode], pollEvery?: number, signal?: AbortSignal): Promise<core.Table>;
      call(method: 'core::nodeIndex::info', args: [core.Array<core.nodeIndex>], signal?: AbortSignal): Promise<core.Array<core.NodeInfo>>;
      spawn(method: 'core::nodeIndex::info', args: [core.Array<core.nodeIndex>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeIndex::info', args: [core.Array<core.nodeIndex>], pollEvery?: number, signal?: AbortSignal): Promise<core.Array<core.NodeInfo>>;
      call(method: 'core::node::resolve_all', args: [core.Array<core.node | null>], signal?: AbortSignal): Promise<core.Array>;
      spawn(method: 'core::node::resolve_all', args: [core.Array<core.node | null>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::node::resolve_all', args: [core.Array<core.node | null>], pollEvery?: number, signal?: AbortSignal): Promise<core.Array>;
      call(method: 'core::nodeList::sample', args: [core.Array<core.nodeList>, core.int | null, core.int | null, core.int, core.SamplingMode, core.int | null], signal?: AbortSignal): Promise<core.Table>;
      spawn(method: 'core::nodeList::sample', args: [core.Array<core.nodeList>, core.int | null, core.int | null, core.int, core.SamplingMode, core.int | null], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeList::sample', args: [core.Array<core.nodeList>, core.int | null, core.int | null, core.int, core.SamplingMode, core.int | null], pollEvery?: number, signal?: AbortSignal): Promise<core.Table>;
      call(method: 'core::nodeList::info', args: [core.Array<core.nodeList>], signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.int>>>;
      spawn(method: 'core::nodeList::info', args: [core.Array<core.nodeList>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'core::nodeList::info', args: [core.Array<core.nodeList>], pollEvery?: number, signal?: AbortSignal): Promise<core.Array<core.NodeInfo<core.int>>>;
      ...
      call(method: 'runtime::User::permissions', args?: undefined, signal?: AbortSignal): Promise<core.Array<string>>;
      spawn(method: 'runtime::User::permissions', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::User::permissions', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<string>>;
      ...
      call(method: 'runtime::PeriodicTask::all', args?: undefined, signal?: AbortSignal): Promise<core.Array<runtime.PeriodicTask>>;
      spawn(method: 'runtime::PeriodicTask::all', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::PeriodicTask::all', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<runtime.PeriodicTask>>;
      call(method: 'runtime::PeriodicTask::set', args: [core.Array<runtime.PeriodicTask>], signal?: AbortSignal): Promise<unknown>;
      spawn(method: 'runtime::PeriodicTask::set', args: [core.Array<runtime.PeriodicTask>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::PeriodicTask::set', args: [core.Array<runtime.PeriodicTask>], pollEvery?: number, signal?: AbortSignal): Promise<unknown>;
      ...
      call(method: 'runtime::Task::running', args?: undefined, signal?: AbortSignal): Promise<core.Array<runtime.TaskInfo>>;
      spawn(method: 'runtime::Task::running', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::Task::running', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<runtime.TaskInfo>>;
      call(method: 'runtime::Task::history', args: [core.int, core.int], signal?: AbortSignal): Promise<core.Array<runtime.Task>>;
      spawn(method: 'runtime::Task::history', args: [core.int, core.int], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::Task::history', args: [core.int, core.int], pollEvery?: number, signal?: AbortSignal): Promise<core.Array<runtime.Task>>;
      ...
      call(method: 'runtime::Debug::add', args: [core.Array<runtime.DebugBreakpoint>], signal?: AbortSignal): Promise<unknown>;
      spawn(method: 'runtime::Debug::add', args: [core.Array<runtime.DebugBreakpoint>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::Debug::add', args: [core.Array<runtime.DebugBreakpoint>], pollEvery?: number, signal?: AbortSignal): Promise<unknown>;
      call(method: 'runtime::Debug::remove', args: [core.Array<runtime.DebugBreakpoint>], signal?: AbortSignal): Promise<unknown>;
      spawn(method: 'runtime::Debug::remove', args: [core.Array<runtime.DebugBreakpoint>], signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::Debug::remove', args: [core.Array<runtime.DebugBreakpoint>], pollEvery?: number, signal?: AbortSignal): Promise<unknown>;
      call(method: 'runtime::Debug::workers', args?: undefined, signal?: AbortSignal): Promise<core.Array<core.int>>;
      spawn(method: 'runtime::Debug::workers', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::Debug::workers', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<core.int>>;
      ...
      call(method: 'runtime::SecurityEntity::all', args?: undefined, signal?: AbortSignal): Promise<core.Array<runtime.SecurityEntity>>;
      spawn(method: 'runtime::SecurityEntity::all', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::SecurityEntity::all', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<runtime.SecurityEntity>>;
      ...
      call(method: 'runtime::UserRole::all', args?: undefined, signal?: AbortSignal): Promise<core.Array<runtime.UserRole>>;
      spawn(method: 'runtime::UserRole::all', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::UserRole::all', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<runtime.UserRole>>;
      ...
      call(method: 'runtime::SecurityPolicy::permissions', args?: undefined, signal?: AbortSignal): Promise<core.Array<string>>;
      spawn(method: 'runtime::SecurityPolicy::permissions', args?: undefined, signal?: AbortSignal): Promise<$greycat.std.runtime.Task>;
      spawnAwait(method: 'runtime::SecurityPolicy::permissions', args?: undefined, pollEvery?: number, signal?: AbortSignal): Promise<core.Array<string>>;
