...
export namespace core {
  ...
  export class ErrorFrame extends $greycat.GCObject {
    ...
    static createFrom({module = null, function_, line, column}: {module?: string | null, function_: string, line: number | bigint, column: number | bigint}, $g: $greycat.GreyCat = $greycat.$.default): ErrorFrame {
      return new ErrorFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[35], module, function_, line, column);
    }
...
export namespace runtime {
  ...
  export class Runtime extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Runtime {
      return new Runtime($g.abi.libs_by_name.get(stdlib.name)!.mapped[61]);
    }
  ...
  export class Job<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({function_, arguments_ = null}: {function_: core.function_, arguments_?: globalThis.Array<any | null> | null}, $g: $greycat.GreyCat = $greycat.$.default): Job {
      return new Job($g.abi.libs_by_name.get(stdlib.name)!.mapped[62], function_, arguments_);
    }
  ...
  export class DebugVariable extends $greycat.GCObject {
    ...
    static createFrom({name = null, value = null}: {name?: string | null, value?: any | null}, $g: $greycat.GreyCat = $greycat.$.default): DebugVariable {
      return new DebugVariable($g.abi.libs_by_name.get(stdlib.name)!.mapped[63], name, value);
    }
  ...
  export class Log extends $greycat.GCObject {
    ...
    static createFrom({level, time, user_id = null, id = null, id2 = null, src = null, tag = null, data = null}: {level: runtime.LogLevel, time: core.time, user_id?: number | bigint | null, id?: number | bigint | null, id2?: number | bigint | null, src?: string | null, tag?: string | null, data?: any | null}, $g: $greycat.GreyCat = $greycat.$.default): Log {
      return new Log($g.abi.libs_by_name.get(stdlib.name)!.mapped[75], level, time, user_id, id, id2, src, tag, data);
    }
...
export namespace io {
  ...
  export class CsvAnalysisConfig extends $greycat.GCObject {
    ...
    static createFrom({header_lines = null, separator = null, string_delimiter = null, decimal_separator = null, thousands_separator = null, row_limit = null, enumerable_limit = null, date_check_limit = null, date_formats = null}: {header_lines?: number | bigint | null, separator?: string | null, string_delimiter?: string | null, decimal_separator?: string | null, thousands_separator?: string | null, row_limit?: number | bigint | null, enumerable_limit?: number | bigint | null, date_check_limit?: number | bigint | null, date_formats?: globalThis.Array<string> | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvAnalysisConfig {
      return new CsvAnalysisConfig($g.abi.libs_by_name.get(stdlib.name)!.mapped[85], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats);
    }
...
export namespace util {
  ...
  export class Gaussian extends $greycat.GCObject {
    ...
    static createFrom({sum = null, sumsq = null, count = null, min = null, max = null}: {sum?: number | null, sumsq?: number | null, count?: number | bigint | null, min?: number | null, max?: number | null}, $g: $greycat.GreyCat = $greycat.$.default): Gaussian {
      return new Gaussian($g.abi.libs_by_name.get(stdlib.name)!.mapped[118], sum, sumsq, count, min, max);
    }
  ...
  export class GaussianProfileSlot extends $greycat.GCObject {
    ...
    static createFrom({sum, sumsq, count}: {sum: number | bigint, sumsq: number | bigint, count: number | bigint}, $g: $greycat.GreyCat = $greycat.$.default): GaussianProfileSlot {
      return new GaussianProfileSlot($g.abi.libs_by_name.get(stdlib.name)!.mapped[125], sum, sumsq, count);
    }
...
export const stdlib: $greycat.Library = {
  name: 'std',
  mapped: new globalThis.Array(133),
  ...
  init(abi) {
    ...
    this.mapped[30] = abi.type_by_fqn.get(core.DurationUnit._type)!;
    this.mapped[30]?.resolveGeneratedOffsetWithValues('microseconds', 1,'milliseconds', 1000,'seconds', 1000000,'minutes', 60000000,'hours', 3600000000,'days', 86400000000);
    ...
    this.mapped[36] = abi.type_by_fqn.get(core.CalendarUnit._type)!;
    this.mapped[36]?.resolveGeneratedOffsetWithValues('year', 0,'month', 1,'day', 2,'hour', 3,'minute', 4,'second', 5,'microsecond', 6);
    this.mapped[37] = abi.type_by_fqn.get(core.t2._type)!;
    this.mapped[38] = abi.type_by_fqn.get(core.FloatPrecision._type)!;
    this.mapped[38]?.resolveGeneratedOffsetWithValues('p1', 1.0,'p10', 0.1,'p100', 0.01,'p1000', 0.001,'p10000', 0.0001,'p100000', 0.00001,'p1000000', 0.000001,'p10000000', 0.0000001,'p100000000', 0.00000001,'p1000000000', 0.000000001,'p10000000000', 0.9999999994E-10);
    this.mapped[39] = abi.type_by_fqn.get(core.duration._type)!;
    this.mapped[40] = abi.type_by_fqn.get(core.t4f._type)!;
    this.mapped[41] = abi.type_by_fqn.get(core.t2f._type)!;
    ...
    this.mapped[43] = abi.type_by_fqn.get(core.time._type)!;
    if (this.mapped[43]) {
      this.mapped[43].static_values = {'min': abi.createTime(-9223372036854775808n),'max': abi.createTime(9223372036854775807n),};
    }
    this.mapped[44] = abi.type_by_fqn.get(core.float._type)!;
    if (this.mapped[44]) {
      this.mapped[44].static_values = {'min': -1.7976931349E308,'max': 1.7976931349E308,};
    }
    this.mapped[45] = abi.type_by_fqn.get(core.SortOrder._type)!;
