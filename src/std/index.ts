...
export namespace core {
  ...
  export class DurationUnit extends $greycat.GCEnum {
    ...
    static microseconds($g: $greycat.GreyCat = $greycat.$.default): DurationUnit {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[2];
  ...
  export class TensorType extends $greycat.GCEnum {
    ...
    static i32($g: $greycat.GreyCat = $greycat.$.default): TensorType {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[3];
  ...
  export class nodeTimeSingleton extends $greycat.GCObject {
    ...
    static createFrom({t, v}: {t: core.time, v: any}, $g: $greycat.GreyCat = $greycat.$.default): nodeTimeSingleton {
      return new nodeTimeSingleton($g.abi.libs_by_name.get(stdlib.name)!.mapped[5], t, v);
    }
  ...
  export class GeoPoly extends $greycat.GCObject {
    ...
    static createFrom({points}: {points: globalThis.Array<core.geo>}, $g: $greycat.GreyCat = $greycat.$.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[9], points);
    }
  ...
  export class Error extends $greycat.GCObject {
    ...
    static createFrom({message, stack}: {message: string | null, stack: globalThis.Array<core.ErrorFrame>}, $g: $greycat.GreyCat = $greycat.$.default): Error {
      return new Error($g.abi.libs_by_name.get(stdlib.name)!.mapped[11], message, stack);
    }
  ...
  export class Tuple<T = any, U = any> extends $greycat.GCObject {
    ...
    static createFrom<T, U>({x, y}: {x: any | null, y: any | null}, $g: $greycat.GreyCat = $greycat.$.default): Tuple {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[13], x, y);
    }
  ...
  export class MathConstants extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): MathConstants {
      return new MathConstants($g.abi.libs_by_name.get(stdlib.name)!.mapped[19]);
    }
...
export namespace runtime {
  ...
  export class DebugInfo extends $greycat.GCObject {
    ...
    static createFrom({scopes, root}: {scopes: globalThis.Array<runtime.DebugFrame>, root: any}, $g: $greycat.GreyCat = $greycat.$.default): DebugInfo {
      return new DebugInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[27], scopes, root);
    }
  ...
  export class Debug extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Debug {
      return new Debug($g.abi.libs_by_name.get(stdlib.name)!.mapped[31]);
    }
  ...
  export class DebugVariable extends $greycat.GCObject {
    ...
    static createFrom({name, value}: {name: string | null, value: any | null}, $g: $greycat.GreyCat = $greycat.$.default): DebugVariable {
      return new DebugVariable($g.abi.libs_by_name.get(stdlib.name)!.mapped[34], name, value);
    }
  ...
  export class OpenIDConnect extends $greycat.GCObject {
    ...
    static createFrom({url, clientId}: {url: string, clientId: string}, $g: $greycat.GreyCat = $greycat.$.default): OpenIDConnect {
      return new OpenIDConnect($g.abi.libs_by_name.get(stdlib.name)!.mapped[36], url, clientId);
    }
  ...
  export class TaskRequest extends $greycat.GCObject {
    ...
    static createFrom({function_, arguments_, mode}: {function_: core.function_, arguments_: globalThis.Array<any | null> | null, mode: runtime.TaskMode | null}, $g: $greycat.GreyCat = $greycat.$.default): TaskRequest {
      return new TaskRequest($g.abi.libs_by_name.get(stdlib.name)!.mapped[40], function_, arguments_, mode);
    }
  ...
  export class SecurityPolicy extends $greycat.GCObject {
    ...
    static createFrom({entities, credentials, roles, fields, keys, keys_last_refresh}: {entities: globalThis.Array<runtime.SecurityEntity> | null, credentials: globalThis.Map<string, runtime.UserCredential> | null, roles: globalThis.Map<string, runtime.UserRole> | null, fields: runtime.SecurityFields | null, keys: globalThis.Map<string, string> | null, keys_last_refresh: core.time | null}, $g: $greycat.GreyCat = $greycat.$.default): SecurityPolicy {
      return new SecurityPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[44], entities, credentials, roles, fields, keys, keys_last_refresh);
    }
...
export namespace io {
  ...
  export class GcbWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append}: {path: string, append: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): GcbWriter {
      return new GcbWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[58], path, append);
    }
  ...
  export class TextEncoder extends $greycat.GCEnum {
    ...
    static plain($g: $greycat.GreyCat = $greycat.$.default): TextEncoder {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[60];
      return t.static_values['plain'];
    }
  ...
  export class CsvWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append, format}: {path: string, append: boolean | null, format: io.CsvFormat}, $g: $greycat.GreyCat = $greycat.$.default): CsvWriter {
      return new CsvWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[62], path, append, format);
    }
  ...
  export class Http extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Http {
      return new Http($g.abi.libs_by_name.get(stdlib.name)!.mapped[65]);
    }
  ...
  export class CsvAnalysis extends $greycat.GCObject {
    ...
    static createFrom({config, statistics}: {config: io.CsvAnalysisConfig | null, statistics: io.CsvStatistics | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvAnalysis {
      return new CsvAnalysis($g.abi.libs_by_name.get(stdlib.name)!.mapped[66], config, statistics);
    }
  ...
  export class TextWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append}: {path: string, append: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): TextWriter {
      return new TextWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], path, append);
    }
  ...
  export class FileWalker extends $greycat.GCObject {
    ...
    static createFrom({path}: {path: string}, $g: $greycat.GreyCat = $greycat.$.default): FileWalker {
      return new FileWalker($g.abi.libs_by_name.get(stdlib.name)!.mapped[77], path);
    }
...
export namespace util {
  ...
  export class Plot extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Plot {
      return new Plot($g.abi.libs_by_name.get(stdlib.name)!.mapped[93]);
    }
  ...
  export class MultiQuantizer<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({dimensions}: {dimensions: globalThis.Array<any | null>}, $g: $greycat.GreyCat = $greycat.$.default): MultiQuantizer {
      return new MultiQuantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[95], dimensions);
    }
  ...
  export class Assert extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Assert {
      return new Assert($g.abi.libs_by_name.get(stdlib.name)!.mapped[96]);
    }
  ...
  export class Stack<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({values}: {values: globalThis.Array<any | null> | null}, $g: $greycat.GreyCat = $greycat.$.default): Stack {
      return new Stack($g.abi.libs_by_name.get(stdlib.name)!.mapped[100], values);
    }
...
export const stdlib: $greycat.Library = {
  name: 'std',
  mapped: new globalThis.Array(110),
  ...
  init(abi) {
    ...
    this.mapped[2] = abi.type_by_fqn.get(core.t2f._type)!;
    this.mapped[3] = abi.type_by_fqn.get(core.int._type)!;
    if (this.mapped[3]) {
      this.mapped[3].static_values = {'min': -9223372036854775808n,'max': 9223372036854775807n,};
    }
    this.mapped[4] = abi.type_by_fqn.get(core.function_._type)!;
    this.mapped[5] = abi.type_by_fqn.get(core.nodeTime._type)!;
    this.mapped[6] = abi.type_by_fqn.get(core.DurationUnit._type)!;
    this.mapped[6]?.resolveGeneratedOffsetWithValues('microseconds', 1,'milliseconds', 1000,'seconds', 1000000,'minutes', 60000000,'hours', 3600000000,'days', 86400000000);
    this.mapped[7] = abi.type_by_fqn.get(core.TensorType._type)!;
    this.mapped[7]?.resolveGeneratedOffsetWithValues('i32', 4,'i64', 8,'f32', 4,'f64', 8,'c64', 8,'c128', 16);
    this.mapped[8] = abi.type_by_fqn.get(core.CalendarUnit._type)!;
    this.mapped[8]?.resolveGeneratedOffsetWithValues('year', 0,'month', 1,'day', 2,'hour', 3,'minute', 4,'second', 5,'microsecond', 6);
    this.mapped[9] = abi.type_by_fqn.get(core.nodeTimeSingleton._type)!;
    this.mapped[10] = abi.type_by_fqn.get(core.Buffer._type)!;
    this.mapped[11] = abi.type_by_fqn.get(core.t4._type)!;
    this.mapped[12] = abi.type_by_fqn.get(core.SortOrder._type)!;
    this.mapped[12]?.resolveGeneratedOffsetWithValues('asc', null,'desc', null);
    this.mapped[13] = abi.type_by_fqn.get(core.GeoCircle._type)!;
    this.mapped[14] = abi.type_by_fqn.get(core.Array._type)!;
    this.mapped[15] = abi.type_by_fqn.get(core.Map._type)!;
    this.mapped[16] = abi.type_by_fqn.get(core.GeoPoly._type)!;
    this.mapped[17] = abi.type_by_fqn.get(core.Error._type)!;
    this.mapped[18] = abi.type_by_fqn.get(core.Tensor._type)!;
    this.mapped[19] = abi.type_by_fqn.get(core.t3f._type)!;
    ...
    this.mapped[22] = abi.type_by_fqn.get(core.Table._type)!;
    this.mapped[23] = abi.type_by_fqn.get(core.String._type)!;
    this.mapped[24] = abi.type_by_fqn.get(core.field._type)!;
    this.mapped[25] = abi.type_by_fqn.get(core.t3._type)!;
    ...
    this.mapped[29] = abi.type_by_fqn.get(core.ErrorCode._type)!;
    this.mapped[29]?.resolveGeneratedOffsetWithValues('none', 0,'interrupted', 1,'await', 2,'timeout', 6,'forbidden', 7,'runtime_error', 8);
    this.mapped[30] = abi.type_by_fqn.get(core.t2._type)!;
    this.mapped[31] = abi.type_by_fqn.get(core.str._type)!;
    this.mapped[32] = abi.type_by_fqn.get(core.Date._type)!;
    this.mapped[33] = abi.type_by_fqn.get(core.duration._type)!;
    this.mapped[34] = abi.type_by_fqn.get(core.MathConstants._type)!;
    if (this.mapped[34]) {
      this.mapped[34].static_values = {'e': 2.7182818285,'log_2e': 1.4426950409,'log_10e': 0.4342944819,'ln2': 0.6931471806,'ln10': 2.302585093,'pi': 3.1415926536,'pi_2': 1.5707963268,'pi_4': 0.7853981634,'m1_pi': 0.3183098862,'m2_pi': 0.6366197724,'m2_sqrt_pi': 1.1283791671,'sqrt2': 1.4142135624,'sqrt1_2': 0.7071067812,};
    }
