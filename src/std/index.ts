...
export namespace core {
  export class GeoPoly extends $sdk.GCObject {
    ...
    static createFrom({points}: {points: globalThis.Array<$sdk.std.core.geo>}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[0], points);
    }
  ...
  export class NodeInfo<T extends $sdk.Value = any> extends $sdk.GCObject {
    ...
    static createFrom({size, from, to}: {size: bigint | number, from: any | null, to: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): NodeInfo {
      return new NodeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[3], size, from, to);
    }
  ...
  export class GeoBox extends $sdk.GCObject {
    ...
    static createFrom({sw, ne}: {sw: $sdk.std.core.geo, ne: $sdk.std.core.geo}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoBox {
      return new GeoBox($g.abi.libs_by_name.get(stdlib.name)!.mapped[10], sw, ne);
    }
  ...
  export class ErrorFrame extends $sdk.GCObject {
    ...
    static createFrom({module, function_, line, column}: {module: string | null, function_: string, line: bigint | number, column: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ErrorFrame {
      return new ErrorFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[18], module, function_, line, column);
    }
  ...
  export class Error extends $sdk.GCObject {
    ...
    static createFrom({message, stack}: {message: string | null, stack: globalThis.Array<core.ErrorFrame>}, $g: $sdk.GreyCat = globalThis.greycat.default): Error {
      return new Error($g.abi.libs_by_name.get(stdlib.name)!.mapped[19], message, stack);
    }
  ...
  export class TableColumnMeta extends $sdk.GCObject {
    ...
    static createFrom({type, size, index, header, min, max, avg, std}: {type: string | null, size: bigint | number, index: boolean, header: string | null, min: any | null, max: any | null, avg: any | null, std: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TableColumnMeta {
      return new TableColumnMeta($g.abi.libs_by_name.get(stdlib.name)!.mapped[21], type, size, index, header, min, max, avg, std);
    }
  ...
  export class TimeZone extends $sdk.GCEnum {
    ...
    static Africa_Accra($g: $sdk.GreyCat = globalThis.greycat.default): TimeZone {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[30];
  ...
  export class GeoCircle extends $sdk.GCObject {
    ...
    static createFrom({center, radius}: {center: $sdk.std.core.geo, radius: number}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoCircle {
      return new GeoCircle($g.abi.libs_by_name.get(stdlib.name)!.mapped[31], center, radius);
    }
  ...
  export class TypeField extends $sdk.GCObject {
    ...
    static createFrom({name, type, is_nullable, offset}: {name: string, type: core.type, is_nullable: boolean, offset: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): TypeField {
      return new TypeField($g.abi.libs_by_name.get(stdlib.name)!.mapped[33], name, type, is_nullable, offset);
    }
  ...
  export class Tuple<T extends $sdk.Value = any, U extends $sdk.Value = any> extends $sdk.GCObject {
    ...
    static createFrom({x, y}: {x: any, y: any}, $g: $sdk.GreyCat = globalThis.greycat.default): Tuple {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[36], x, y);
    }
  ...
  export class TableColumnMapping extends $sdk.GCObject {
    ...
    static createFrom({column, extractors}: {column: bigint | number, extractors: globalThis.Array<any>}, $g: $sdk.GreyCat = globalThis.greycat.default): TableColumnMapping {
      return new TableColumnMapping($g.abi.libs_by_name.get(stdlib.name)!.mapped[47], column, extractors);
    }
...
export namespace runtime {
  ...
  export class RuntimeInfo extends $sdk.GCObject {
    ...
    static createFrom({version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats}: {version: string, program_version: string | null, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: bigint | number, bg_threads: bigint | number, fg_threads: bigint | number, mem_total: bigint | number, mem_worker: bigint | number, nb_ctx: bigint | number, store_stats: runtime.StoreStat | null}, $g: $sdk.GreyCat = globalThis.greycat.default): RuntimeInfo {
      return new RuntimeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[49], version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
    }
  ...
  export class UserCredential extends $sdk.GCObject {
    ...
    static createFrom({offset, pass}: {offset: bigint | number, pass: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): UserCredential {
      return new UserCredential($g.abi.libs_by_name.get(stdlib.name)!.mapped[50], offset, pass);
    }
  ...
  export class SecurityFields extends $sdk.GCObject {
    ...
    static createFrom({email, name, first_name, last_name, roles, groups}: {email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: globalThis.Map<string, string> | null, groups: globalThis.Map<string, string> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): SecurityFields {
      return new SecurityFields($g.abi.libs_by_name.get(stdlib.name)!.mapped[51], email, name, first_name, last_name, roles, groups);
    }
  ...
  export class Runtime extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Runtime {
      return new Runtime($g.abi.libs_by_name.get(stdlib.name)!.mapped[52]);
    }
  ...
  export class UserGroupPolicy extends $sdk.GCObject {
    ...
    static createFrom({group_id, type}: {group_id: bigint | number, type: runtime.UserGroupPolicyType}, $g: $sdk.GreyCat = globalThis.greycat.default): UserGroupPolicy {
      return new UserGroupPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[54], group_id, type);
    }
  ...
  export class DebugBreakpoint extends $sdk.GCObject {
    ...
    static createFrom({module, line, column}: {module: string, line: bigint | number, column: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): DebugBreakpoint {
      return new DebugBreakpoint($g.abi.libs_by_name.get(stdlib.name)!.mapped[57], module, line, column);
    }
  ...
  export class License extends $sdk.GCObject {
    ...
    static createFrom({name, start, end, company, max_memory, extra_1, extra_2, type}: {name: string | null, start: $sdk.std.core.time, end: $sdk.std.core.time, company: string | null, max_memory: bigint | number, extra_1: bigint | number | null, extra_2: bigint | number | null, type: runtime.LicenseType | null}, $g: $sdk.GreyCat = globalThis.greycat.default): License {
      return new License($g.abi.libs_by_name.get(stdlib.name)!.mapped[60], name, start, end, company, max_memory, extra_1, extra_2, type);
    }
  ...
  export class UserGroup extends $sdk.GCObject {
    ...
    static createFrom({id, name, activated}: {id: bigint | number, name: string, activated: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): UserGroup {
      return new UserGroup($g.abi.libs_by_name.get(stdlib.name)!.mapped[61], id, name, activated);
    }
  ...
  export class User extends $sdk.GCObject {
    ...
    static createFrom({id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external}: {id: bigint | number, name: string, activated: boolean, full_name: string | null, email: string | null, role: string | null, permissions_flags: bigint | number | null, groups: globalThis.Array<runtime.UserGroupPolicy> | null, groups_flags: bigint | number | null, external: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): User {
      return new User($g.abi.libs_by_name.get(stdlib.name)!.mapped[63], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
    }
  ...
  export class PeriodicTask extends $sdk.GCObject {
    ...
    static createFrom({function_, user_id, arguments_, start, every}: {function_: core.function_ | null, user_id: bigint | number, arguments_: globalThis.Array<any> | null, start: $sdk.std.core.time, every: $sdk.std.core.duration}, $g: $sdk.GreyCat = globalThis.greycat.default): PeriodicTask {
      return new PeriodicTask($g.abi.libs_by_name.get(stdlib.name)!.mapped[64], function_, user_id, arguments_, start, every);
    }
  ...
  export class Task extends $sdk.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, start, duration, status}: {user_id: bigint | number, task_id: bigint | number, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, start: $sdk.std.core.time | null, duration: $sdk.std.core.duration | null, status: runtime.TaskStatus}, $g: $sdk.GreyCat = globalThis.greycat.default): Task {
      return new Task($g.abi.libs_by_name.get(stdlib.name)!.mapped[66], user_id, task_id, mod, type, fun, creation, start, duration, status);
    }
  ...
  export class TaskRequest extends $sdk.GCObject {
    ...
    static createFrom({function_, arguments_, mode}: {function_: core.function_, arguments_: globalThis.Array<any> | null, mode: runtime.TaskMode | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TaskRequest {
      return new TaskRequest($g.abi.libs_by_name.get(stdlib.name)!.mapped[67], function_, arguments_, mode);
    }
  ...
  export class Debug extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Debug {
      return new Debug($g.abi.libs_by_name.get(stdlib.name)!.mapped[68]);
    }
  ...
  export class TaskResult extends $sdk.GCObject {
    ...
    static createFrom({values, errors}: {values: globalThis.Array<any>, errors: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): TaskResult {
      return new TaskResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], values, errors);
    }
  ...
  export class StoreStat extends $sdk.GCObject {
    ...
    static createFrom({capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio}: {capacity_bytes: bigint | number, allocated_bytes: bigint | number, allocated_ratio: number, remained_bytes: bigint | number, remained_ratio: number, used_bytes: bigint | number, used_ratio: number, available_bytes: bigint | number, available_ratio: number}, $g: $sdk.GreyCat = globalThis.greycat.default): StoreStat {
      return new StoreStat($g.abi.libs_by_name.get(stdlib.name)!.mapped[70], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
    }
  ...
  export class TaskInfo extends $sdk.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, start, duration, status, progress, remaining, sub_waiting, sub_tasks_all}: {user_id: bigint | number, task_id: bigint | number, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, start: $sdk.std.core.time | null, duration: $sdk.std.core.duration | null, status: runtime.TaskStatus, progress: number | null, remaining: $sdk.std.core.duration | null, sub_waiting: bigint | number | null, sub_tasks_all: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TaskInfo {
      return new TaskInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[71], user_id, task_id, mod, type, fun, creation, start, duration, status, progress, remaining, sub_waiting, sub_tasks_all);
    }
  ...
  export class DebugFrame extends $sdk.GCObject {
    ...
    static createFrom({module, line, column, scope}: {module: string, line: bigint | number, column: bigint | number, scope: globalThis.Map<string, any>}, $g: $sdk.GreyCat = globalThis.greycat.default): DebugFrame {
      return new DebugFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[74], module, line, column, scope);
    }
  ...
  export class UserRole extends $sdk.GCObject {
    ...
    static createFrom({name, permissions}: {name: string, permissions: globalThis.Array<string>}, $g: $sdk.GreyCat = globalThis.greycat.default): UserRole {
      return new UserRole($g.abi.libs_by_name.get(stdlib.name)!.mapped[75], name, permissions);
    }
...
export namespace io {
  export class JsonReader extends $sdk.GCObject {
    ...
    static createFrom({path, pos, ignore_types}: {path: string, pos: bigint | number | null, ignore_types: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): JsonReader {
      return new JsonReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[76], path, pos, ignore_types);
    }
  ...
  export class CsvColumnStatistics extends $sdk.GCObject {
    ...
    static createFrom({name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile}: {name: string | null, example: any | null, null_count: bigint | number, bool_count: bigint | number, int_count: bigint | number, float_count: bigint | number, string_count: bigint | number, date_count: bigint | number, date_format_count: globalThis.Map<string, bigint | number>, enumerable_count: globalThis.Map<any, bigint | number>, profile: util.Gaussian}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnStatistics {
      return new CsvColumnStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[77], name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile);
    }
  ...
  export class Email extends $sdk.GCObject {
    ...
    static createFrom({from, subject, body, body_is_html, to, cc, bcc}: {from: string, subject: string, body: string, body_is_html: boolean, to: globalThis.Array<string>, cc: globalThis.Array<string> | null, bcc: globalThis.Array<string> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Email {
      return new Email($g.abi.libs_by_name.get(stdlib.name)!.mapped[78], from, subject, body, body_is_html, to, cc, bcc);
    }
  ...
  export class File extends $sdk.GCObject {
    ...
    static createFrom({path, size, last_modification}: {path: string, size: bigint | number | null, last_modification: $sdk.std.core.time | null}, $g: $sdk.GreyCat = globalThis.greycat.default): File {
      return new File($g.abi.libs_by_name.get(stdlib.name)!.mapped[79], path, size, last_modification);
    }
  ...
  export class CsvReader extends $sdk.GCObject {
    ...
    static createFrom({path, format, pos}: {path: string, format: io.CsvFormat, pos: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvReader {
      return new CsvReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[81], path, format, pos);
    }
  ...
  export class CsvColumnIgnored extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnIgnored {
      return new CsvColumnIgnored($g.abi.libs_by_name.get(stdlib.name)!.mapped[82], name, mandatory, offset);
    }
  ...
  export class CsvColumnFloat extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnFloat {
      return new CsvColumnFloat($g.abi.libs_by_name.get(stdlib.name)!.mapped[83], name, mandatory, offset);
    }
  ...
  export class FileWalker extends $sdk.GCObject {
    ...
    static createFrom({path}: {path: string}, $g: $sdk.GreyCat = globalThis.greycat.default): FileWalker {
      return new FileWalker($g.abi.libs_by_name.get(stdlib.name)!.mapped[85], path);
    }
  ...
  export class CsvFormat extends $sdk.GCObject {
    ...
    static createFrom({header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns}: {header_lines: bigint | number | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, columns_size: bigint | number | null, columns: globalThis.Array<io.CsvColumn> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[87], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
  ...
  export class CsvColumnTime extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, unit: core.DurationUnit | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnTime {
      return new CsvColumnTime($g.abi.libs_by_name.get(stdlib.name)!.mapped[88], name, mandatory, offset, unit);
    }
  ...
  export class CsvAnalysis extends $sdk.GCObject {
    ...
    static createFrom({config, statistics}: {config: io.CsvAnalysisConfig | null, statistics: io.CsvStatistics | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvAnalysis {
      return new CsvAnalysis($g.abi.libs_by_name.get(stdlib.name)!.mapped[89], config, statistics);
    }
  ...
  export class CsvColumnString extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, trim, try_number, try_json, values, encoder}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: globalThis.Array<string> | null, encoder: io.TextEncoder | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnString {
      return new CsvColumnString($g.abi.libs_by_name.get(stdlib.name)!.mapped[90], name, mandatory, offset, trim, try_number, try_json, values, encoder);
    }
  ...
  export class TextWriter extends $sdk.GCObject {
    ...
    static createFrom({path, append}: {path: string, append: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TextWriter {
      return new TextWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[91], path, append);
    }
  ...
  export class TextReader extends $sdk.GCObject {
    ...
    static createFrom({path, pos}: {path: string, pos: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TextReader {
      return new TextReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[92], path, pos);
    }
  ...
  export class CsvColumnBoolean extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnBoolean {
      return new CsvColumnBoolean($g.abi.libs_by_name.get(stdlib.name)!.mapped[94], name, mandatory, offset);
    }
  ...
  export class GcbReader extends $sdk.GCObject {
    ...
    static createFrom({path, pos}: {path: string, pos: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): GcbReader {
      return new GcbReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[95], path, pos);
    }
  ...
  export class SmtpMode extends $sdk.GCEnum {
    ...
    static plain($g: $sdk.GreyCat = globalThis.greycat.default): SmtpMode {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[96];
      return t.static_values['plain'];
    }
  ...
  export class CsvColumnDuration extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, unit: core.DurationUnit | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnDuration {
      return new CsvColumnDuration($g.abi.libs_by_name.get(stdlib.name)!.mapped[97], name, mandatory, offset, unit);
    }
  ...
  export class Url extends $sdk.GCObject {
    ...
    static createFrom({protocol, host, port, path, params, hash}: {protocol: string | null, host: string | null, port: bigint | number | null, path: string | null, params: globalThis.Map<string, string> | null, hash: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Url {
      return new Url($g.abi.libs_by_name.get(stdlib.name)!.mapped[98], protocol, host, port, path, params, hash);
    }
  ...
  export class JsonWriter extends $sdk.GCObject {
    ...
    static createFrom({path, append}: {path: string, append: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): JsonWriter {
      return new JsonWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[99], path, append);
    }
  ...
  export class HttpHeader extends $sdk.GCObject {
    ...
    static createFrom({name, value}: {name: string, value: string}, $g: $sdk.GreyCat = globalThis.greycat.default): HttpHeader {
      return new HttpHeader($g.abi.libs_by_name.get(stdlib.name)!.mapped[100], name, value);
    }
  ...
  export class Smtp extends $sdk.GCObject {
    ...
    static createFrom({host, port, mode, authenticate, user, pass}: {host: string, port: bigint | number, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Smtp {
      return new Smtp($g.abi.libs_by_name.get(stdlib.name)!.mapped[101], host, port, mode, authenticate, user, pass);
    }
  ...
  export class CsvWriter extends $sdk.GCObject {
    ...
    static createFrom({path, format, append}: {path: string, format: io.CsvFormat, append: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvWriter {
      return new CsvWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[102], path, format, append);
    }
  ...
  export class GcbWriter extends $sdk.GCObject {
    ...
    static createFrom({path, append}: {path: string, append: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): GcbWriter {
      return new GcbWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[103], path, append);
    }
  ...
  export class CsvStatistics extends $sdk.GCObject {
    ...
    static createFrom({header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count}: {header_lines: bigint | number | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, columns: globalThis.Array<io.CsvColumnStatistics>, line_count: bigint | number, fail_count: bigint | number, file_count: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvStatistics {
      return new CsvStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[104], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns, line_count, fail_count, file_count);
    }
  ...
  export class TextEncoder extends $sdk.GCEnum {
    ...
    static plain($g: $sdk.GreyCat = globalThis.greycat.default): TextEncoder {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[105];
      return t.static_values['plain'];
    }
  ...
  export class CsvAnalysisConfig extends $sdk.GCObject {
    ...
    static createFrom({header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats}: {header_lines: bigint | number | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, row_limit: bigint | number | null, enumerable_limit: bigint | number | null, date_check_limit: bigint | number | null, date_formats: globalThis.Array<string> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvAnalysisConfig {
      return new CsvAnalysisConfig($g.abi.libs_by_name.get(stdlib.name)!.mapped[106], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats);
    }
  ...
  export class CsvColumnInteger extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnInteger {
      return new CsvColumnInteger($g.abi.libs_by_name.get(stdlib.name)!.mapped[107], name, mandatory, offset);
    }
  ...
  export class Http extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Http {
      return new Http($g.abi.libs_by_name.get(stdlib.name)!.mapped[108]);
    }
...
export namespace util {
  ...
  export class ProgressTracker extends $sdk.GCObject {
    ...
    static createFrom({start, total, counter, duration, progress, speed, remaining}: {start: $sdk.std.core.time, total: bigint | number | null, counter: bigint | number | null, duration: $sdk.std.core.duration | null, progress: number | null, speed: number | null, remaining: $sdk.std.core.duration | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ProgressTracker {
      return new ProgressTracker($g.abi.libs_by_name.get(stdlib.name)!.mapped[111], start, total, counter, duration, progress, speed, remaining);
    }
  ...
  export class QuantizerDenseDim extends $sdk.GCObject {
    ...
    static createFrom({min, max, step}: {min: bigint | number, max: bigint | number, step: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): QuantizerDenseDim {
      return new QuantizerDenseDim($g.abi.libs_by_name.get(stdlib.name)!.mapped[112], min, max, step);
    }
  ...
  export class Quantizer extends $sdk.GCObject {
    ...
    static createFrom({dimensions}: {dimensions: globalThis.Array<util.QuantizerDim>}, $g: $sdk.GreyCat = globalThis.greycat.default): Quantizer {
      return new Quantizer($g.abi.libs_by_name.get(stdlib.name)!.mapped[113], dimensions);
    }
  ...
  export class BoxPlotInt extends $sdk.GCObject {
    ...
    static createFrom({min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size}: {min: bigint | number, max: bigint | number, whiskerLow: bigint | number, whiskerHigh: bigint | number, percentile1: bigint | number, percentile5: bigint | number, percentile25: bigint | number, percentile50: bigint | number, percentile75: bigint | number, percentile95: bigint | number, percentile99: bigint | number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): BoxPlotInt {
      return new BoxPlotInt($g.abi.libs_by_name.get(stdlib.name)!.mapped[118], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
    }
  ...
  export class BoxPlotFloat extends $sdk.GCObject {
    ...
    static createFrom({min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size}: {min: number, max: number, whiskerLow: number, whiskerHigh: number, percentile1: number, percentile5: number, percentile25: number, percentile50: number, percentile75: number, percentile95: number, percentile99: number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): BoxPlotFloat {
      return new BoxPlotFloat($g.abi.libs_by_name.get(stdlib.name)!.mapped[119], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
    }
  ...
  export class Random extends $sdk.GCObject {
    ...
    static createFrom({seed, v}: {seed: bigint | number, v: number}, $g: $sdk.GreyCat = globalThis.greycat.default): Random {
      return new Random($g.abi.libs_by_name.get(stdlib.name)!.mapped[122], seed, v);
    }
  ...
  export class Assert extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Assert {
      return new Assert($g.abi.libs_by_name.get(stdlib.name)!.mapped[125]);
    }
  ...
  export class Gaussian extends $sdk.GCObject {
    ...
    static createFrom({sum, sum_sq, count, min, max}: {sum: number | null, sum_sq: number | null, count: bigint | number | null, min: number | null, max: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Gaussian {
      return new Gaussian($g.abi.libs_by_name.get(stdlib.name)!.mapped[126], sum, sum_sq, count, min, max);
    }
  ...
  export class QuantizerSparseDim extends $sdk.GCObject {
    ...
    static createFrom({values}: {values: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): QuantizerSparseDim {
      return new QuantizerSparseDim($g.abi.libs_by_name.get(stdlib.name)!.mapped[127], values);
    }
...
export const stdlib: $sdk.Library = {
  ...
  init(abi) {
    this.mapped[0] = abi.type_by_fqn.get(core.GeoPoly._type)!;
    this.mapped[1] = abi.type_by_fqn.get(core.node._type)!;
    this.mapped[2] = abi.type_by_fqn.get(core.duration._type)!;
    this.mapped[3] = abi.type_by_fqn.get(core.NodeInfo._type)!;
    this.mapped[4] = abi.type_by_fqn.get(core.tf4d._type)!;
    this.mapped[5] = abi.type_by_fqn.get(core.SamplingMode._type)!;
    this.mapped[5]?.resolveGeneratedOffsetWithValues('fixed', 0,'fixed_reg', 1,'adaptative', 2,'dense', 3);
    this.mapped[6] = abi.type_by_fqn.get(core.geo._type)!;
    if (this.mapped[6]) {
      this.mapped[6].static_values = {'min': abi.createGeo(-85.0511287602,-179.9999999581),'max': abi.createGeo(85.0511287602,179.9999999581),};
    }
    this.mapped[7] = abi.type_by_fqn.get(core.String._type)!;
    this.mapped[8] = abi.type_by_fqn.get(core.ti10d._type)!;
    this.mapped[9] = abi.type_by_fqn.get(core.nodeList._type)!;
    this.mapped[10] = abi.type_by_fqn.get(core.GeoBox._type)!;
    this.mapped[11] = abi.type_by_fqn.get(core.type._type)!;
    this.mapped[12] = abi.type_by_fqn.get(core.function_._type)!;
    this.mapped[13] = abi.type_by_fqn.get(core.ti2d._type)!;
    this.mapped[14] = abi.type_by_fqn.get(core.ti4d._type)!;
    this.mapped[15] = abi.type_by_fqn.get(core.float._type)!;
    if (this.mapped[15]) {
      this.mapped[15].static_values = {'min': -1.7976931349E308,'max': 1.7976931349E308,};
    }
    this.mapped[16] = abi.type_by_fqn.get(core.nodeGeo._type)!;
    this.mapped[17] = abi.type_by_fqn.get(core.nodeTime._type)!;
    this.mapped[18] = abi.type_by_fqn.get(core.ErrorFrame._type)!;
    this.mapped[19] = abi.type_by_fqn.get(core.Error._type)!;
    ...
    this.mapped[41] = abi.type_by_fqn.get(core.Buffer._type)!;
    this.mapped[42] = abi.type_by_fqn.get(core.Map._type)!;
    this.mapped[43] = abi.type_by_fqn.get(core.Array._type)!;
    this.mapped[44] = abi.type_by_fqn.get(core.tf3d._type)!;
    ...
    this.mapped[46] = abi.type_by_fqn.get(core.ErrorCode._type)!;
    this.mapped[46]?.resolveGeneratedOffsetWithValues('none', 0,'interrupted', 1,'await', 2,'too_deep_iterator', 3,'wrong_operand', 4,'wrong_params', 5,'wrong_param_type', 6,'wrong_numeric', 7,'wrong_state', 8,'wrong_null', 9,'unresolved_ref', 10,'wrong_type', 13,'wrong_dimension', 14,'unsupported_operation', 15,'unsupported_type', 16,'dimensions_mismatch', 17,'timeout', 18,'forbidden', 19,'runtime_error', 20);
    this.mapped[47] = abi.type_by_fqn.get(core.TableColumnMapping._type)!;
    this.mapped[48] = abi.type_by_fqn.get(runtime.System._type)!;
    this.mapped[49] = abi.type_by_fqn.get(runtime.RuntimeInfo._type)!;
    this.mapped[50] = abi.type_by_fqn.get(runtime.UserCredential._type)!;
    this.mapped[51] = abi.type_by_fqn.get(runtime.SecurityFields._type)!;
    this.mapped[52] = abi.type_by_fqn.get(runtime.Runtime._type)!;
    this.mapped[53] = abi.type_by_fqn.get(runtime.TaskStatus._type)!;
    this.mapped[53]?.resolveGeneratedOffsetWithValues('empty', 0,'waiting', 1,'running', 2,'await', 3,'cancelled', 4,'error', 5,'ended', 6,'ended_with_errors', 7);
    this.mapped[54] = abi.type_by_fqn.get(runtime.UserGroupPolicy._type)!;
    this.mapped[55] = abi.type_by_fqn.get(runtime.DebugInfo._type)!;
    this.mapped[56] = abi.type_by_fqn.get(runtime.TaskMode._type)!;
    this.mapped[56]?.resolveGeneratedOffsetWithValues('commit', null,'volatile', null,'exclusive', null);
    this.mapped[57] = abi.type_by_fqn.get(runtime.DebugBreakpoint._type)!;
    ...
    this.mapped[60] = abi.type_by_fqn.get(runtime.License._type)!;
    this.mapped[61] = abi.type_by_fqn.get(runtime.UserGroup._type)!;
    this.mapped[62] = abi.type_by_fqn.get(runtime.LicenseType._type)!;
    this.mapped[62]?.resolveGeneratedOffsetWithValues('community', 0,'enterprise', 1,'testing', 2);
    this.mapped[63] = abi.type_by_fqn.get(runtime.User._type)!;
    this.mapped[64] = abi.type_by_fqn.get(runtime.PeriodicTask._type)!;
    this.mapped[65] = abi.type_by_fqn.get(runtime.SecurityEntity._type)!;
    this.mapped[66] = abi.type_by_fqn.get(runtime.Task._type)!;
    this.mapped[67] = abi.type_by_fqn.get(runtime.TaskRequest._type)!;
    this.mapped[68] = abi.type_by_fqn.get(runtime.Debug._type)!;
    this.mapped[69] = abi.type_by_fqn.get(runtime.TaskResult._type)!;
    this.mapped[70] = abi.type_by_fqn.get(runtime.StoreStat._type)!;
    this.mapped[71] = abi.type_by_fqn.get(runtime.TaskInfo._type)!;
    this.mapped[72] = abi.type_by_fqn.get(runtime.TaskBase._type)!;
    this.mapped[73] = abi.type_by_fqn.get(runtime.UserGroupPolicyType._type)!;
    this.mapped[73]?.resolveGeneratedOffsetWithValues('read', 0,'write', 1,'execute', 2);
    this.mapped[74] = abi.type_by_fqn.get(runtime.DebugFrame._type)!;
    this.mapped[75] = abi.type_by_fqn.get(runtime.UserRole._type)!;
    this.mapped[76] = abi.type_by_fqn.get(io.JsonReader._type)!;
    this.mapped[77] = abi.type_by_fqn.get(io.CsvColumnStatistics._type)!;
    this.mapped[78] = abi.type_by_fqn.get(io.Email._type)!;
    this.mapped[79] = abi.type_by_fqn.get(io.File._type)!;
    this.mapped[80] = abi.type_by_fqn.get(io.CsvColumnDate._type)!;
    this.mapped[81] = abi.type_by_fqn.get(io.CsvReader._type)!;
    this.mapped[82] = abi.type_by_fqn.get(io.CsvColumnIgnored._type)!;
    this.mapped[83] = abi.type_by_fqn.get(io.CsvColumnFloat._type)!;
    this.mapped[84] = abi.type_by_fqn.get(io.CsvColumn._type)!;
    this.mapped[85] = abi.type_by_fqn.get(io.FileWalker._type)!;
    this.mapped[86] = abi.type_by_fqn.get(io.SmtpAuth._type)!;
    this.mapped[86]?.resolveGeneratedOffsetWithValues('none', 0,'plain', 1,'login', 2);
    this.mapped[87] = abi.type_by_fqn.get(io.CsvFormat._type)!;
    this.mapped[88] = abi.type_by_fqn.get(io.CsvColumnTime._type)!;
    this.mapped[89] = abi.type_by_fqn.get(io.CsvAnalysis._type)!;
    this.mapped[90] = abi.type_by_fqn.get(io.CsvColumnString._type)!;
    this.mapped[91] = abi.type_by_fqn.get(io.TextWriter._type)!;
    this.mapped[92] = abi.type_by_fqn.get(io.TextReader._type)!;
    this.mapped[93] = abi.type_by_fqn.get(io.CsvValidateResult._type)!;
    this.mapped[94] = abi.type_by_fqn.get(io.CsvColumnBoolean._type)!;
    this.mapped[95] = abi.type_by_fqn.get(io.GcbReader._type)!;
    this.mapped[96] = abi.type_by_fqn.get(io.SmtpMode._type)!;
    this.mapped[96]?.resolveGeneratedOffsetWithValues('plain', 0,'ssl_tls', 1,'starttls', 2);
    this.mapped[97] = abi.type_by_fqn.get(io.CsvColumnDuration._type)!;
    this.mapped[98] = abi.type_by_fqn.get(io.Url._type)!;
    this.mapped[99] = abi.type_by_fqn.get(io.JsonWriter._type)!;
    this.mapped[100] = abi.type_by_fqn.get(io.HttpHeader._type)!;
    this.mapped[101] = abi.type_by_fqn.get(io.Smtp._type)!;
    this.mapped[102] = abi.type_by_fqn.get(io.CsvWriter._type)!;
    this.mapped[103] = abi.type_by_fqn.get(io.GcbWriter._type)!;
    this.mapped[104] = abi.type_by_fqn.get(io.CsvStatistics._type)!;
    this.mapped[105] = abi.type_by_fqn.get(io.TextEncoder._type)!;
    this.mapped[105]?.resolveGeneratedOffsetWithValues('plain', null,'base64', null,'base64url', null,'hexadecimal', null);
    this.mapped[106] = abi.type_by_fqn.get(io.CsvAnalysisConfig._type)!;
    if (this.mapped[106]) {
      this.mapped[106].static_values = {'enumerable_limit_default': 100,'date_check_limit_default': 100,};
    }
    this.mapped[107] = abi.type_by_fqn.get(io.CsvColumnInteger._type)!;
    this.mapped[108] = abi.type_by_fqn.get(io.Http._type)!;
    this.mapped[109] = abi.type_by_fqn.get(util.HistogramFloat._type)!;
    if (this.mapped[109]) {
      this.mapped[109].static_values = {'table_off_from': 0,'table_off_to': 1,'table_off_count': 2,'table_off_percentage': 3,};
    }
    this.mapped[110] = abi.type_by_fqn.get(util.Iban._type)!;
    this.mapped[111] = abi.type_by_fqn.get(util.ProgressTracker._type)!;
    this.mapped[112] = abi.type_by_fqn.get(util.QuantizerDenseDim._type)!;
    this.mapped[113] = abi.type_by_fqn.get(util.Quantizer._type)!;
    this.mapped[114] = abi.type_by_fqn.get(util.SlidingWindow._type)!;
    this.mapped[115] = abi.type_by_fqn.get(util.Plot._type)!;
    this.mapped[116] = abi.type_by_fqn.get(util.HistogramInt._type)!;
    if (this.mapped[116]) {
      this.mapped[116].static_values = {'table_off_from': 0,'table_off_to': 1,'table_off_count': 2,'table_off_percentage': 3,};
    }
    this.mapped[117] = abi.type_by_fqn.get(util.QuantizerDim._type)!;
    this.mapped[118] = abi.type_by_fqn.get(util.BoxPlotInt._type)!;
    this.mapped[119] = abi.type_by_fqn.get(util.BoxPlotFloat._type)!;
    this.mapped[120] = abi.type_by_fqn.get(util.Queue._type)!;
    this.mapped[121] = abi.type_by_fqn.get(util.Crypto._type)!;
    this.mapped[122] = abi.type_by_fqn.get(util.Random._type)!;
    this.mapped[123] = abi.type_by_fqn.get(util.GaussianProfile._type)!;
    if (this.mapped[123]) {
      this.mapped[123].static_values = {'table_off_size': 0,'table_off_min': 1,'table_off_max': 2,'table_off_avg': 3,'table_off_std': 4,'table_off_sum': 5,'table_off_columns': 6,};
    }
    this.mapped[124] = abi.type_by_fqn.get(util.TimeWindow._type)!;
    this.mapped[125] = abi.type_by_fqn.get(util.Assert._type)!;
    this.mapped[126] = abi.type_by_fqn.get(util.Gaussian._type)!;
    this.mapped[127] = abi.type_by_fqn.get(util.QuantizerSparseDim._type)!;
  },
};
