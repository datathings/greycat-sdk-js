...
export namespace compute {
  export class ComputeActivationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({slope, shift}: {slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationHardSigmoid {
      return new ComputeActivationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[0], slope, shift);
    }
  ...
  export class ComputeOperationAdd extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAdd {
      return new ComputeOperationAdd($g.abi.libs_by_name.get(algebralib.name)!.mapped[1], input, input2, output);
    }
  ...
  export class ComputeOperationClip extends $sdk.GCObject {
    ...
    static createFrom({input, output, min, max}: {input: string, output: string, min: number | null, max: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationClip {
      return new ComputeOperationClip($g.abi.libs_by_name.get(algebralib.name)!.mapped[3], input, output, min, max);
    }
  ...
  export class ComputeOperationArgMax extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMax {
      return new ComputeOperationArgMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[4], input, output, output2);
    }
  ...
  export class ComputeOperationSub extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSub {
      return new ComputeOperationSub($g.abi.libs_by_name.get(algebralib.name)!.mapped[5], input, input2, output);
    }
  ...
  export class ComputeLayerCustom extends $sdk.GCObject {
    ...
    static createFrom({name, ops, vars}: {name: string, ops: globalThis.Array<compute.ComputeOperation>, vars: globalThis.Array<compute.ComputeVariable>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCustom {
      return new ComputeLayerCustom($g.abi.libs_by_name.get(algebralib.name)!.mapped[7], name, ops, vars);
    }
  ...
  export class ComputeOptimizerSgd extends $sdk.GCObject {
    ...
    static createFrom({learning_rate}: {learning_rate: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerSgd {
      return new ComputeOptimizerSgd($g.abi.libs_by_name.get(algebralib.name)!.mapped[8], learning_rate);
    }
  ...
  export class ComputeOperationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output, slope, shift}: {input: string, output: string, slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationHardSigmoid {
      return new ComputeOperationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[9], input, output, slope, shift);
    }
  ...
  export class ComputeOperationTan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTan {
      return new ComputeOperationTan($g.abi.libs_by_name.get(algebralib.name)!.mapped[10], input, output);
    }
  ...
  export class ComputeOptimizerFtrl extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, lambda1, lambda2, beta}: {learning_rate: number | null, lambda1: number | null, lambda2: number | null, beta: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerFtrl {
      return new ComputeOptimizerFtrl($g.abi.libs_by_name.get(algebralib.name)!.mapped[11], learning_rate, lambda1, lambda2, beta);
    }
  ...
  export class ComputeInitializerNone extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNone {
      return new ComputeInitializerNone($g.abi.libs_by_name.get(algebralib.name)!.mapped[13]);
    }
  ...
  export class ComputeOperationSoftSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftSign {
      return new ComputeOperationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[14], input, output);
    }
  ...
  export class ComputeOperationAtan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtan {
      return new ComputeOperationAtan($g.abi.libs_by_name.get(algebralib.name)!.mapped[17], input, output);
    }
  ...
  export class ComputeOperationSinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSinh {
      return new ComputeOperationSinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[18], input, output);
    }
  ...
  export class ComputeInitializerReluUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerReluUniform {
      return new ComputeInitializerReluUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[19]);
    }
  ...
  export class ComputeInitializerLSTM extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLSTM {
      return new ComputeInitializerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[20]);
    }
  ...
  export class ComputeOperationMatMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output, transposeA, transposeB, alpha, beta}: {input: string, input2: string, output: string, transposeA: boolean, transposeB: boolean, alpha: number, beta: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMatMul {
      return new ComputeOperationMatMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[21], input, input2, output, transposeA, transposeB, alpha, beta);
    }
  ...
  export class ComputeLayerPCAScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerPCAScaler {
      return new ComputeLayerPCAScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[22], name, type, inverse_transform);
    }
  ...
  export class ComputeOperationAsin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsin {
      return new ComputeOperationAsin($g.abi.libs_by_name.get(algebralib.name)!.mapped[24], input, output);
    }
  ...
  export class ComputeOperationSqrt extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSqrt {
      return new ComputeOperationSqrt($g.abi.libs_by_name.get(algebralib.name)!.mapped[25], input, output);
    }
  ...
  export class ComputeInitializerGlorotUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerGlorotUniform {
      return new ComputeInitializerGlorotUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[26]);
    }
  ...
  export class ComputeOperationAbs extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAbs {
      return new ComputeOperationAbs($g.abi.libs_by_name.get(algebralib.name)!.mapped[28], input, output);
    }
  ...
  export class ComputeLayerSeq extends $sdk.GCObject {
    ...
    static createFrom({name, calls, optimizer}: {name: string, calls: globalThis.Array<compute.ComputeLayerCall>, optimizer: compute.ComputeOptimizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerSeq {
      return new ComputeLayerSeq($g.abi.libs_by_name.get(algebralib.name)!.mapped[29], name, calls, optimizer);
    }
  ...
  export class ComputeVarOptimize extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, l1, l2, init}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, l1: number, l2: number, init: compute.ComputeInitializer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarOptimize {
      return new ComputeVarOptimize($g.abi.libs_by_name.get(algebralib.name)!.mapped[30], name, type, shape, l1, l2, init);
    }
  ...
  export class ComputeLayerActivation extends $sdk.GCObject {
    ...
    static createFrom({name, activation}: {name: string, activation: compute.ComputeActivation}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerActivation {
      return new ComputeLayerActivation($g.abi.libs_by_name.get(algebralib.name)!.mapped[31], name, activation);
    }
  ...
  export class ComputeOperationNeg extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationNeg {
      return new ComputeOperationNeg($g.abi.libs_by_name.get(algebralib.name)!.mapped[33], input, output);
    }
  ...
  export class ComputeLayerLossRegression extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeRegressionLoss}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossRegression {
      return new ComputeLayerLossRegression($g.abi.libs_by_name.get(algebralib.name)!.mapped[36], name, reduction, loss_type);
    }
  ...
  export class ComputeLayerStandardScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerStandardScaler {
      return new ComputeLayerStandardScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[40], name, type, inverse_transform);
    }
  ...
  export class ComputeActivationTanh extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationTanh {
      return new ComputeActivationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[41]);
    }
  ...
  export class ComputeInitializerLeCunUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLeCunUniform {
      return new ComputeInitializerLeCunUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[44]);
    }
  ...
  export class ComputeOperationSoftplus extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftplus {
      return new ComputeOperationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[45], input, output);
    }
  ...
  export class ComputeOperationEuclidean extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationEuclidean {
      return new ComputeOperationEuclidean($g.abi.libs_by_name.get(algebralib.name)!.mapped[46], input, input2, output);
    }
  ...
  export class ComputeOptimizerNesterov extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNesterov {
      return new ComputeOptimizerNesterov($g.abi.libs_by_name.get(algebralib.name)!.mapped[48], learning_rate, decay_rate);
    }
  ...
  export class ComputeOperationExp extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationExp {
      return new ComputeOperationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[49], input, output);
    }
  ...
  export class ComputeLayerLinear extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLinear {
      return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[50], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
    }
  ...
  export class ComputeActivationCelu extends $sdk.GCObject {
    ...
    static createFrom({alpha}: {alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationCelu {
      return new ComputeActivationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[51], alpha);
    }
  ...
  export class ComputeOperationCelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCelu {
      return new ComputeOperationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[52], input, output, alpha);
    }
  ...
  export class ComputeOperationSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSigmoid {
      return new ComputeOperationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[54], input, output);
    }
  ...
  export class ComputeInitializerPytorch extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerPytorch {
      return new ComputeInitializerPytorch($g.abi.libs_by_name.get(algebralib.name)!.mapped[57]);
    }
  ...
  export class ComputeOperationLogSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLogSoftmax {
      return new ComputeOperationLogSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[62], input, output, axis);
    }
  ...
  export class ComputeOperationArgMin extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMin {
      return new ComputeOperationArgMin($g.abi.libs_by_name.get(algebralib.name)!.mapped[65], input, output, output2);
    }
  ...
  export class ComputeInitializerNormal extends $sdk.GCObject {
    ...
    static createFrom({avg, std}: {avg: number, std: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormal {
      return new ComputeInitializerNormal($g.abi.libs_by_name.get(algebralib.name)!.mapped[68], avg, std);
    }
  ...
  export class ComputeInitializerXavier extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavier {
      return new ComputeInitializerXavier($g.abi.libs_by_name.get(algebralib.name)!.mapped[70]);
    }
  ...
  export class ComputeActivationRelu extends $sdk.GCObject {
    ...
    static createFrom({max_value, threshold}: {max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationRelu {
      return new ComputeActivationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[72], max_value, threshold);
    }
  ...
  export class ComputeOperationAcos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcos {
      return new ComputeOperationAcos($g.abi.libs_by_name.get(algebralib.name)!.mapped[73], input, output);
    }
  ...
  export class ComputeActivationSoftSign extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftSign {
      return new ComputeActivationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[75]);
    }
  ...
  export class ComputeOptimizerAdaMax extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaMax {
      return new ComputeOptimizerAdaMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[76], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeActivationSelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSelu {
      return new ComputeActivationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[80]);
    }
  ...
  export class ComputeActivationElu extends $sdk.GCObject {
    ...
    static createFrom({alpha}: {alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationElu {
      return new ComputeActivationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[81], alpha);
    }
  ...
  export class ComputeModel extends $sdk.GCObject {
    ...
    static createFrom({layers}: {layers: globalThis.Array<compute.ComputeLayer>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeModel {
      return new ComputeModel($g.abi.libs_by_name.get(algebralib.name)!.mapped[82], layers);
    }
  ...
  export class ComputeOperationCos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCos {
      return new ComputeOperationCos($g.abi.libs_by_name.get(algebralib.name)!.mapped[83], input, output);
    }
  ...
  export class ComputeActivationSigmoid extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSigmoid {
      return new ComputeActivationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[84]);
    }
  ...
  export class ComputeInitializerNormalOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalOut {
      return new ComputeInitializerNormalOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[87]);
    }
  ...
  export class ComputeInitializerUniformAvg extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformAvg {
      return new ComputeInitializerUniformAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[88]);
    }
  ...
  export class ComputeLayerClassification extends $sdk.GCObject {
    ...
    static createFrom({name, calculate_probabilities, from_logits}: {name: string, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerClassification {
      return new ComputeLayerClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[89], name, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOperationRaiseToPower extends $sdk.GCObject {
    ...
    static createFrom({input, output, power}: {input: string, output: string, power: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationRaiseToPower {
      return new ComputeOperationRaiseToPower($g.abi.libs_by_name.get(algebralib.name)!.mapped[91], input, output, power);
    }
  ...
  export class ComputeInitializerUniform extends $sdk.GCObject {
    ...
    static createFrom({min, max}: {min: number, max: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniform {
      return new ComputeInitializerUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[92], min, max);
    }
  ...
  export class ComputeActivationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({alpha, max_value, threshold}: {alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationLeakyRelu {
      return new ComputeActivationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[93], alpha, max_value, threshold);
    }
  ...
  export class ComputeOperationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha, max_value, threshold}: {input: string, output: string, alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeakyRelu {
      return new ComputeOperationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[94], input, output, alpha, max_value, threshold);
    }
  ...
  export class ComputeInitializerNormalIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalIn {
      return new ComputeInitializerNormalIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[97]);
    }
  ...
  export class ComputeActivationExp extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationExp {
      return new ComputeActivationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[98]);
    }
  ...
  export class ComputeOperationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftmax {
      return new ComputeOperationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[100], input, output);
    }
  ...
  export class ComputeLayerDense extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[101], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
    static create(name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[101], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
  ...
  export class ComputeInitializerXavierUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavierUniform {
      return new ComputeInitializerXavierUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[102]);
    }
  ...
  export class ComputeBinding extends $sdk.GCObject {
    ...
    static createFrom({src_layer_name, src_var_name, target_var_name}: {src_layer_name: string, src_var_name: string, target_var_name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeBinding {
      return new ComputeBinding($g.abi.libs_by_name.get(algebralib.name)!.mapped[103], src_layer_name, src_var_name, target_var_name);
    }
  ...
  export class ComputeVarConst extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarConst {
      return new ComputeVarConst($g.abi.libs_by_name.get(algebralib.name)!.mapped[104], name, type, shape);
    }
  ...
  export class ComputeOptimizerAdaGrad extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, initial_accumulator, smooth_epsilon}: {learning_rate: number | null, initial_accumulator: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaGrad {
      return new ComputeOptimizerAdaGrad($g.abi.libs_by_name.get(algebralib.name)!.mapped[105], learning_rate, initial_accumulator, smooth_epsilon);
    }
  ...
  export class ComputeOptimizerNadam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNadam {
      return new ComputeOptimizerNadam($g.abi.libs_by_name.get(algebralib.name)!.mapped[106], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeInitializerUniformIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformIn {
      return new ComputeInitializerUniformIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[107]);
    }
  ...
  export class ComputeOperationSum extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSum {
      return new ComputeOperationSum($g.abi.libs_by_name.get(algebralib.name)!.mapped[108], input, output, axis);
    }
  ...
  export class ComputeOperationSin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSin {
      return new ComputeOperationSin($g.abi.libs_by_name.get(algebralib.name)!.mapped[111], input, output);
    }
  ...
  export class ComputeCounter extends $sdk.GCObject {
    ...
    static createFrom({epoch, optimizationSteps, batchNotOptimized}: {epoch: bigint | number, optimizationSteps: bigint | number, batchNotOptimized: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeCounter {
      return new ComputeCounter($g.abi.libs_by_name.get(algebralib.name)!.mapped[112], epoch, optimizationSteps, batchNotOptimized);
    }
  ...
  export class ComputeLayerMinMaxScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerMinMaxScaler {
      return new ComputeLayerMinMaxScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[114], name, type, inverse_transform);
    }
  ...
  export class ComputeLayerLossClassification extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeClassificationLoss, has_class_weights: boolean, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossClassification {
      return new ComputeLayerLossClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[115], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOperationAsinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsinh {
      return new ComputeOperationAsinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[116], input, output);
    }
  ...
  export class ComputeLayerFilter extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, maskValues}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, maskValues: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerFilter {
      return new ComputeLayerFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[118], name, type, inputs, outputs, maskValues);
    }
  ...
  export class ComputeLayerLSTM extends $sdk.GCObject {
    ...
    static createFrom({name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences}: {name: string, bias_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_regularizer: compute.ComputeRegularizer | null, type: $sdk.std.core.TensorType, use_bias: boolean | null, return_sequences: boolean | null, bidirectional: boolean | null, auto_init_states: boolean | null, inputs: bigint | number, outputs: bigint | number, layers: bigint | number, sequences: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLSTM {
      return new ComputeLayerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[120], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
    }
  ...
  export class ComputeOperationAcosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcosh {
      return new ComputeOperationAcosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[121], input, output);
    }
  ...
  export class ComputeOperationDiv extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationDiv {
      return new ComputeOperationDiv($g.abi.libs_by_name.get(algebralib.name)!.mapped[122], input, input2, output);
    }
  ...
  export class ComputeOperationCosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCosh {
      return new ComputeOperationCosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[123], input, output);
    }
  ...
  export class ComputeInitializerRelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerRelu {
      return new ComputeInitializerRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[124]);
    }
  ...
  export class ComputeLayerCall extends $sdk.GCObject {
    ...
    static createFrom({layer_name, bindings}: {layer_name: string, bindings: globalThis.Array<compute.ComputeBinding>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCall {
      return new ComputeLayerCall($g.abi.libs_by_name.get(algebralib.name)!.mapped[126], layer_name, bindings);
    }
  ...
  export class ComputeOperationAvg extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAvg {
      return new ComputeOperationAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[127], input, input2, output);
    }
...
export namespace nn {
  export class ClassificationNetwork extends $sdk.GCObject {
    ...
    static createFrom({inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits}: {inputs: bigint | number, inputs_gradients: boolean, outputs: bigint | number, fixed_batch_size: bigint | number, inputs_sequences: bigint | number, outputs_sequences: bigint | number, tensor_type: $sdk.std.core.TensorType, seed: bigint | number, randomizeSeed: boolean, layers: globalThis.Array<compute.ComputeLayer> | null, preProcessType: nn.PreProcessType | null, preProcessObject: any | null, postProcessType: nn.PostProcessType | null, postProcessObject: any | null, optimizer: compute.ComputeOptimizer, lossLayer: compute.ComputeLayerLoss | null, _lastLayer: string | null, _lastOutput: string | null, calculate_probabilities: boolean, has_class_weights: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ClassificationNetwork {
      return new ClassificationNetwork($g.abi.libs_by_name.get(algebralib.name)!.mapped[129], inputs, inputs_gradients, outputs, fixed_batch_size, inputs_sequences, outputs_sequences, tensor_type, seed, randomizeSeed, layers, preProcessType, preProcessObject, postProcessType, postProcessObject, optimizer, lossLayer, _lastLayer, _lastOutput, calculate_probabilities, has_class_weights, from_logits);
    }
  ...
  export class BindingsResult extends $sdk.GCObject {
    ...
    static createFrom({previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer}: {previousLayerName: string, previousLayerOutput: string, expectedLayerName: string, expectedLayerOutput: string, postLayer: compute.ComputeLayer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): BindingsResult {
      return new BindingsResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[139], previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer);
    }
...
export namespace ml {
  export class TimeSeriesDecomposition extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): TimeSeriesDecomposition {
      return new TimeSeriesDecomposition($g.abi.libs_by_name.get(algebralib.name)!.mapped[142]);
    }
  ...
  export class Solver extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Solver {
      return new Solver($g.abi.libs_by_name.get(algebralib.name)!.mapped[144]);
    }
...
export const algebralib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[0] = abi.type_by_fqn.get(compute.ComputeActivationHardSigmoid._type)!;
    this.mapped[0].resolveGeneratedOffsets('slope','shift');
    this.mapped[0].static_values = [0.2,0.5];
    this.mapped[1] = abi.type_by_fqn.get(compute.ComputeOperationAdd._type)!;
    this.mapped[1].resolveGeneratedOffsets('input','input2','output');
    ...
    this.mapped[3] = abi.type_by_fqn.get(compute.ComputeOperationClip._type)!;
    this.mapped[3].resolveGeneratedOffsets('input','output','min','max');
    this.mapped[4] = abi.type_by_fqn.get(compute.ComputeOperationArgMax._type)!;
    this.mapped[4].resolveGeneratedOffsets('input','output','output2');
    this.mapped[5] = abi.type_by_fqn.get(compute.ComputeOperationSub._type)!;
    this.mapped[5].resolveGeneratedOffsets('input','input2','output');
    this.mapped[6] = abi.type_by_fqn.get(compute.ComputeState._type)!;
    this.mapped[7] = abi.type_by_fqn.get(compute.ComputeLayerCustom._type)!;
    this.mapped[7].resolveGeneratedOffsets('name','ops','vars');
    this.mapped[8] = abi.type_by_fqn.get(compute.ComputeOptimizerSgd._type)!;
    this.mapped[8].resolveGeneratedOffsets('learning_rate');
    this.mapped[8].static_values = [0.01];
    this.mapped[9] = abi.type_by_fqn.get(compute.ComputeOperationHardSigmoid._type)!;
    this.mapped[9].resolveGeneratedOffsets('input','output','slope','shift');
    this.mapped[9].static_values = [0.2,0.5];
    this.mapped[10] = abi.type_by_fqn.get(compute.ComputeOperationTan._type)!;
    this.mapped[10].resolveGeneratedOffsets('input','output');
    this.mapped[11] = abi.type_by_fqn.get(compute.ComputeOptimizerFtrl._type)!;
    this.mapped[11].resolveGeneratedOffsets('learning_rate','lambda1','lambda2','beta');
    this.mapped[11].static_values = [0.001,0.0,0.0,0.0];
    this.mapped[12] = abi.type_by_fqn.get(compute.ComputeVariable._type)!;
    this.mapped[12].resolveGeneratedOffsets('name');
    this.mapped[13] = abi.type_by_fqn.get(compute.ComputeInitializerNone._type)!;
    this.mapped[14] = abi.type_by_fqn.get(compute.ComputeOperationSoftSign._type)!;
    this.mapped[14].resolveGeneratedOffsets('input','output');
    this.mapped[15] = abi.type_by_fqn.get(compute.ComputeRegressionLoss._type)!;
    this.mapped[15].resolveGeneratedOffsetWithValues('square', "Square",'abs', "Abs");
    this.mapped[16] = abi.type_by_fqn.get(compute.ComputeOperation2In1Out._type)!;
    this.mapped[16].resolveGeneratedOffsets('input','input2','output');
    this.mapped[17] = abi.type_by_fqn.get(compute.ComputeOperationAtan._type)!;
    this.mapped[17].resolveGeneratedOffsets('input','output');
    this.mapped[18] = abi.type_by_fqn.get(compute.ComputeOperationSinh._type)!;
    this.mapped[18].resolveGeneratedOffsets('input','output');
    this.mapped[19] = abi.type_by_fqn.get(compute.ComputeInitializerReluUniform._type)!;
    this.mapped[20] = abi.type_by_fqn.get(compute.ComputeInitializerLSTM._type)!;
    this.mapped[21] = abi.type_by_fqn.get(compute.ComputeOperationMatMul._type)!;
    this.mapped[21].resolveGeneratedOffsets('input','input2','output','transposeA','transposeB','alpha','beta');
    this.mapped[21].static_values = [false,1.0,0.0];
    this.mapped[22] = abi.type_by_fqn.get(compute.ComputeLayerPCAScaler._type)!;
    this.mapped[22].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[22].static_values = ["input","output","avg","std","space"];
    ...
    this.mapped[24] = abi.type_by_fqn.get(compute.ComputeOperationAsin._type)!;
    this.mapped[24].resolveGeneratedOffsets('input','output');
    this.mapped[25] = abi.type_by_fqn.get(compute.ComputeOperationSqrt._type)!;
    this.mapped[25].resolveGeneratedOffsets('input','output');
    this.mapped[26] = abi.type_by_fqn.get(compute.ComputeInitializerGlorotUniform._type)!;
    this.mapped[27] = abi.type_by_fqn.get(compute.ComputeRegularizer._type)!;
    this.mapped[27].resolveGeneratedOffsets('l1','l2');
    this.mapped[28] = abi.type_by_fqn.get(compute.ComputeOperationAbs._type)!;
    this.mapped[28].resolveGeneratedOffsets('input','output');
    this.mapped[29] = abi.type_by_fqn.get(compute.ComputeLayerSeq._type)!;
    this.mapped[29].resolveGeneratedOffsets('name','calls','optimizer');
    this.mapped[30] = abi.type_by_fqn.get(compute.ComputeVarOptimize._type)!;
    this.mapped[30].resolveGeneratedOffsets('name','type','shape','l1','l2','init');
    this.mapped[31] = abi.type_by_fqn.get(compute.ComputeLayerActivation._type)!;
    this.mapped[31].resolveGeneratedOffsets('name','activation');
    this.mapped[31].static_values = ["input","output"];
    ...
    this.mapped[33] = abi.type_by_fqn.get(compute.ComputeOperationNeg._type)!;
    this.mapped[33].resolveGeneratedOffsets('input','output');
    this.mapped[34] = abi.type_by_fqn.get(compute.ComputeVarProxy._type)!;
    this.mapped[34].resolveGeneratedOffsets('name');
    this.mapped[35] = abi.type_by_fqn.get(compute.ComputeOperation1In1Out._type)!;
    this.mapped[35].resolveGeneratedOffsets('input','output');
    this.mapped[36] = abi.type_by_fqn.get(compute.ComputeLayerLossRegression._type)!;
    this.mapped[36].resolveGeneratedOffsets('name','reduction','loss_type');
    this.mapped[37] = abi.type_by_fqn.get(compute.ComputeVarInOut._type)!;
    this.mapped[37].resolveGeneratedOffsets('name','type','shape','with_grad');
    this.mapped[38] = abi.type_by_fqn.get(compute.ComputeEngine._type)!;
    ...
    this.mapped[40] = abi.type_by_fqn.get(compute.ComputeLayerStandardScaler._type)!;
    this.mapped[40].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[40].static_values = ["input","output","avg","std"];
    this.mapped[41] = abi.type_by_fqn.get(compute.ComputeActivationTanh._type)!;
    ...
    this.mapped[44] = abi.type_by_fqn.get(compute.ComputeInitializerLeCunUniform._type)!;
    this.mapped[45] = abi.type_by_fqn.get(compute.ComputeOperationSoftplus._type)!;
    this.mapped[45].resolveGeneratedOffsets('input','output');
    this.mapped[46] = abi.type_by_fqn.get(compute.ComputeOperationEuclidean._type)!;
    this.mapped[46].resolveGeneratedOffsets('input','input2','output');
    this.mapped[47] = abi.type_by_fqn.get(compute.ComputeInitializerConstant._type)!;
    this.mapped[47].resolveGeneratedOffsets('value');
    this.mapped[48] = abi.type_by_fqn.get(compute.ComputeOptimizerNesterov._type)!;
    this.mapped[48].resolveGeneratedOffsets('learning_rate','decay_rate');
    this.mapped[48].static_values = [0.001,0.9];
    this.mapped[49] = abi.type_by_fqn.get(compute.ComputeOperationExp._type)!;
    this.mapped[49].resolveGeneratedOffsets('input','output');
    this.mapped[50] = abi.type_by_fqn.get(compute.ComputeLayerLinear._type)!;
    this.mapped[50].resolveGeneratedOffsets('name','type','inputs','outputs','use_bias','weight_initializer','weight_regularizer','bias_initializer','bias_regularizer');
    this.mapped[50].static_values = ["input","output","weight","bias","mult"];
    this.mapped[51] = abi.type_by_fqn.get(compute.ComputeActivationCelu._type)!;
    this.mapped[51].resolveGeneratedOffsets('alpha');
    this.mapped[51].static_values = [1.0];
    this.mapped[52] = abi.type_by_fqn.get(compute.ComputeOperationCelu._type)!;
    this.mapped[52].resolveGeneratedOffsets('input','output','alpha');
    this.mapped[52].static_values = [1.0];
    this.mapped[53] = abi.type_by_fqn.get(compute.ComputeInitializerNormalAvg._type)!;
    this.mapped[54] = abi.type_by_fqn.get(compute.ComputeOperationSigmoid._type)!;
    ...
    this.mapped[57] = abi.type_by_fqn.get(compute.ComputeInitializerPytorch._type)!;
    ...
    this.mapped[61].resolveGeneratedOffsets('learning_rate','decay_rate','smooth_epsilon');
    this.mapped[61].static_values = [0.001,0.9,0.0000001];
    this.mapped[62] = abi.type_by_fqn.get(compute.ComputeOperationLogSoftmax._type)!;
    this.mapped[62].resolveGeneratedOffsets('input','output','axis');
    ...
    this.mapped[64] = abi.type_by_fqn.get(compute.ComputeReduction._type)!;
    this.mapped[64].resolveGeneratedOffsetWithValues('auto', "auto",'none', "none",'sum', "sum",'mean', "mean",'disabled', "disabled");
    this.mapped[65] = abi.type_by_fqn.get(compute.ComputeOperationArgMin._type)!;
    this.mapped[65].resolveGeneratedOffsets('input','output','output2');
    ...
    this.mapped[68] = abi.type_by_fqn.get(compute.ComputeInitializerNormal._type)!;
    this.mapped[68].resolveGeneratedOffsets('avg','std');
    this.mapped[69] = abi.type_by_fqn.get(compute.ComputeActivation._type)!;
    this.mapped[70] = abi.type_by_fqn.get(compute.ComputeInitializerXavier._type)!;
    this.mapped[71] = abi.type_by_fqn.get(compute.ComputeOperation._type)!;
    this.mapped[72] = abi.type_by_fqn.get(compute.ComputeActivationRelu._type)!;
    this.mapped[72].resolveGeneratedOffsets('max_value','threshold');
    this.mapped[72].static_values = [0.0];
    this.mapped[73] = abi.type_by_fqn.get(compute.ComputeOperationAcos._type)!;
    ...
    this.mapped[75] = abi.type_by_fqn.get(compute.ComputeActivationSoftSign._type)!;
    this.mapped[76] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaMax._type)!;
    this.mapped[76].resolveGeneratedOffsets('learning_rate','beta1','beta2','smooth_epsilon');
    this.mapped[76].static_values = [0.001,0.9,0.999,0.0000001];
    this.mapped[77] = abi.type_by_fqn.get(compute.ComputeOptimizerMomentum._type)!;
    this.mapped[77].resolveGeneratedOffsets('learning_rate','decay_rate');
    this.mapped[77].static_values = [0.001,0.9];
    ...
    this.mapped[79] = abi.type_by_fqn.get(compute.ComputeLayer._type)!;
    this.mapped[79].resolveGeneratedOffsets('name');
    this.mapped[80] = abi.type_by_fqn.get(compute.ComputeActivationSelu._type)!;
    this.mapped[81] = abi.type_by_fqn.get(compute.ComputeActivationElu._type)!;
    this.mapped[81].resolveGeneratedOffsets('alpha');
    this.mapped[81].static_values = [1.0];
    this.mapped[82] = abi.type_by_fqn.get(compute.ComputeModel._type)!;
    this.mapped[82].resolveGeneratedOffsets('layers');
    this.mapped[83] = abi.type_by_fqn.get(compute.ComputeOperationCos._type)!;
    this.mapped[83].resolveGeneratedOffsets('input','output');
    this.mapped[84] = abi.type_by_fqn.get(compute.ComputeActivationSigmoid._type)!;
    ...
    this.mapped[87] = abi.type_by_fqn.get(compute.ComputeInitializerNormalOut._type)!;
    this.mapped[88] = abi.type_by_fqn.get(compute.ComputeInitializerUniformAvg._type)!;
    this.mapped[89] = abi.type_by_fqn.get(compute.ComputeLayerClassification._type)!;
    this.mapped[89].resolveGeneratedOffsets('name','calculate_probabilities','from_logits');
    this.mapped[89].static_values = ["input","predicted_classes","probabilities"];
    ...
    this.mapped[91] = abi.type_by_fqn.get(compute.ComputeOperationRaiseToPower._type)!;
    this.mapped[91].resolveGeneratedOffsets('input','output','power');
    this.mapped[92] = abi.type_by_fqn.get(compute.ComputeInitializerUniform._type)!;
    this.mapped[92].resolveGeneratedOffsets('min','max');
    this.mapped[93] = abi.type_by_fqn.get(compute.ComputeActivationLeakyRelu._type)!;
    this.mapped[93].resolveGeneratedOffsets('alpha','max_value','threshold');
    this.mapped[93].static_values = [0.3,0.0];
    this.mapped[94] = abi.type_by_fqn.get(compute.ComputeOperationLeakyRelu._type)!;
    this.mapped[94].resolveGeneratedOffsets('input','output','alpha','max_value','threshold');
    this.mapped[94].static_values = [0.3,1.7976931349E308,0.0];
    ...
    this.mapped[96].resolveGeneratedOffsets('input','value');
    this.mapped[97] = abi.type_by_fqn.get(compute.ComputeInitializerNormalIn._type)!;
    this.mapped[98] = abi.type_by_fqn.get(compute.ComputeActivationExp._type)!;
    this.mapped[99] = abi.type_by_fqn.get(compute.ComputeClassificationLoss._type)!;
    this.mapped[99].resolveGeneratedOffsetWithValues('categorical_cross_entropy', "Categorical Cross Entropy",'sparse_categorical_cross_entropy', "Sparse Categorical Cross Entropy");
    this.mapped[100] = abi.type_by_fqn.get(compute.ComputeOperationSoftmax._type)!;
    this.mapped[100].resolveGeneratedOffsets('input','output');
    this.mapped[101] = abi.type_by_fqn.get(compute.ComputeLayerDense._type)!;
    this.mapped[101].resolveGeneratedOffsets('name','type','inputs','outputs','use_bias','weight_initializer','weight_regularizer','bias_initializer','bias_regularizer','activation');
    this.mapped[101].static_values = ["input","output","weight","bias","mult","pre_activation"];
    this.mapped[102] = abi.type_by_fqn.get(compute.ComputeInitializerXavierUniform._type)!;
    this.mapped[103] = abi.type_by_fqn.get(compute.ComputeBinding._type)!;
    this.mapped[103].resolveGeneratedOffsets('src_layer_name','src_var_name','target_var_name');
    this.mapped[104] = abi.type_by_fqn.get(compute.ComputeVarConst._type)!;
    this.mapped[104].resolveGeneratedOffsets('name','type','shape');
    this.mapped[105] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaGrad._type)!;
    this.mapped[105].resolveGeneratedOffsets('learning_rate','initial_accumulator','smooth_epsilon');
    this.mapped[105].static_values = [0.001,0.1,0.0000001];
    this.mapped[106] = abi.type_by_fqn.get(compute.ComputeOptimizerNadam._type)!;
    ...
    this.mapped[107] = abi.type_by_fqn.get(compute.ComputeInitializerUniformIn._type)!;
    this.mapped[108] = abi.type_by_fqn.get(compute.ComputeOperationSum._type)!;
    this.mapped[108].resolveGeneratedOffsets('input','output','axis');
    ...
    this.mapped[110].resolveGeneratedOffsets('input','output','max_value','threshold');
    this.mapped[110].static_values = [0.0];
    this.mapped[111] = abi.type_by_fqn.get(compute.ComputeOperationSin._type)!;
    this.mapped[111].resolveGeneratedOffsets('input','output');
    this.mapped[112] = abi.type_by_fqn.get(compute.ComputeCounter._type)!;
    this.mapped[112].resolveGeneratedOffsets('epoch','optimizationSteps','batchNotOptimized');
    ...
    this.mapped[114] = abi.type_by_fqn.get(compute.ComputeLayerMinMaxScaler._type)!;
    this.mapped[114].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[114].static_values = ["input","output","min","max"];
    this.mapped[115] = abi.type_by_fqn.get(compute.ComputeLayerLossClassification._type)!;
    this.mapped[115].resolveGeneratedOffsets('name','reduction','loss_type','has_class_weights','calculate_probabilities','from_logits');
    this.mapped[115].static_values = ["class_weights","predicted_classes","probabilities","sum_reduce"];
    this.mapped[116] = abi.type_by_fqn.get(compute.ComputeOperationAsinh._type)!;
    ...
    this.mapped[117].resolveGeneratedOffsets('input','output','alpha');
    this.mapped[118] = abi.type_by_fqn.get(compute.ComputeLayerFilter._type)!;
    this.mapped[118].resolveGeneratedOffsets('name','type','inputs','outputs','maskValues');
    this.mapped[118].static_values = ["input","output","mask"];
    this.mapped[119] = abi.type_by_fqn.get(compute.ComputeLayerLoss._type)!;
    this.mapped[119].resolveGeneratedOffsets('name','reduction');
    this.mapped[119].static_values = ["computed","expected","loss"];
    this.mapped[120] = abi.type_by_fqn.get(compute.ComputeLayerLSTM._type)!;
    this.mapped[120].resolveGeneratedOffsets('name','bias_initializer','weight_regularizer','bias_regularizer','type','use_bias','return_sequences','bidirectional','auto_init_states','inputs','outputs','layers','sequences');
    this.mapped[120].static_values = ["input","output","hx","cx","hy","cy","weight","bias","internal_i","internal_f","internal_cp","internal_o","internal_h","internal_c","internal_mult","internal_output"];
    this.mapped[121] = abi.type_by_fqn.get(compute.ComputeOperationAcosh._type)!;
    this.mapped[121].resolveGeneratedOffsets('input','output');
    this.mapped[122] = abi.type_by_fqn.get(compute.ComputeOperationDiv._type)!;
    this.mapped[122].resolveGeneratedOffsets('input','input2','output');
    this.mapped[123] = abi.type_by_fqn.get(compute.ComputeOperationCosh._type)!;
    this.mapped[123].resolveGeneratedOffsets('input','output');
    this.mapped[124] = abi.type_by_fqn.get(compute.ComputeInitializerRelu._type)!;
    this.mapped[125] = abi.type_by_fqn.get(compute.ComputeActivationSoftplus._type)!;
    this.mapped[126] = abi.type_by_fqn.get(compute.ComputeLayerCall._type)!;
    this.mapped[126].resolveGeneratedOffsets('layer_name','bindings');
    this.mapped[127] = abi.type_by_fqn.get(compute.ComputeOperationAvg._type)!;
    ...
    this.mapped[129] = abi.type_by_fqn.get(nn.ClassificationNetwork._type)!;
    this.mapped[129].resolveGeneratedOffsets('inputs','inputs_gradients','outputs','fixed_batch_size','inputs_sequences','outputs_sequences','tensor_type','seed','randomizeSeed','layers','preProcessType','preProcessObject','postProcessType','postProcessObject','optimizer','lossLayer','_lastLayer','_lastOutput','calculate_probabilities','has_class_weights','from_logits');
    this.mapped[130] = abi.type_by_fqn.get(nn.RegressionNetwork._type)!;
    this.mapped[130].resolveGeneratedOffsets('inputs','inputs_gradients','outputs','fixed_batch_size','inputs_sequences','outputs_sequences','tensor_type','seed','randomizeSeed','layers','preProcessType','preProcessObject','postProcessType','postProcessObject','optimizer','lossLayer','_lastLayer','_lastOutput');
    ...
    this.mapped[132] = abi.type_by_fqn.get(nn.ComputeActivations._type)!;
    this.mapped[132].resolveGeneratedOffsetWithValues('relu', "Relu",'leaky_relu', "Leaky Relu",'sigmoid', "Sigmoid",'hard_sigmoid', "Hard Sigmoid",'exp', "Exp",'soft_max', "Soft Max",'soft_plus', "Soft Plus",'soft_sign', "Soft Sign",'tanh', "Tanh",'selu', "Selu",'elu', "Elu",'celu', "Celu");
    ...
    this.mapped[135].resolveGeneratedOffsets('inputs','inputs_gradients','outputs','fixed_batch_size','inputs_sequences','outputs_sequences','tensor_type','seed','randomizeSeed','layers','preProcessType','preProcessObject','postProcessType','postProcessObject','optimizer','lossLayer','_lastLayer','_lastOutput','encoder_layer_idx','encoder_layer_name','encoder_layer_var');
    this.mapped[136] = abi.type_by_fqn.get(nn.NeuralNetwork._type)!;
    this.mapped[136].resolveGeneratedOffsets('inputs','inputs_gradients','outputs','fixed_batch_size','inputs_sequences','outputs_sequences','tensor_type','seed','randomizeSeed','layers','preProcessType','preProcessObject','postProcessType','postProcessObject','optimizer','lossLayer','_lastLayer','_lastOutput');
    this.mapped[136].static_values = ["Inputs or outputs can't be negative","Last layer has different number of outputs than declared","Incompatible loss function","Some NN layers are not currently supported","Tensor Type not currently supported","NN should contain at least 1 layer","layer placeholders","layer classification","layer preprocess","layer postprocess learn","layer main","layer loss learn","layer loss display","layer postprocess display","seq predict","seq learn","seq loss display","seq encode","seq decode","var input","var enc input","var targets","var Classifier classes","var Classifier probabilities","var Classifier class weights","var input avg","var input min","var input max","var input std","var input space","var output avg","var output min","var output max","var output std"];
    ...
    this.mapped[139] = abi.type_by_fqn.get(nn.BindingsResult._type)!;
    this.mapped[139].resolveGeneratedOffsets('previousLayerName','previousLayerOutput','expectedLayerName','expectedLayerOutput','postLayer');
    ...
    this.mapped[142] = abi.type_by_fqn.get(ml.TimeSeriesDecomposition._type)!;
    ...
    this.mapped[144] = abi.type_by_fqn.get(ml.Solver._type)!;
