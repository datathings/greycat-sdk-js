...
export namespace pattern_detectors {
  export class RandomPatternDetector extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): RandomPatternDetector {
      return new RandomPatternDetector($g.abi.libs_by_name.get(patternslib.name)!.mapped[0]);
    }
  ...
  export class SaxPatternDetectionEngine extends $sdk.GCObject {
    ...
    static createFrom({timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length}: {timeseries: $sdk.std.core.nodeTime, state: pattern_detectors.PatternDetectionEngineState | null, nullStrategy: pattern_detectors.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: pattern_detectors.SamplingPolicy | null, alphabet_size: bigint | number, alphabet_boundaries: globalThis.Array<number>, lookup_table: $sdk.std.core.nodeIndex, max_distance: number, pattern_fingerprints: globalThis.Array<string>, fingerprint_length: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): SaxPatternDetectionEngine {
      return new SaxPatternDetectionEngine($g.abi.libs_by_name.get(patternslib.name)!.mapped[2], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length);
    }
  ...
  export class EuclideanPatternDetectionEngine extends $sdk.GCObject {
    ...
    static createFrom({timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation}: {timeseries: $sdk.std.core.nodeTime, state: pattern_detectors.PatternDetectionEngineState | null, nullStrategy: pattern_detectors.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: pattern_detectors.SamplingPolicy | null, std: number | null, matchingNormalisation: pattern_detectors.MatchingNormalisation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): EuclideanPatternDetectionEngine {
      return new EuclideanPatternDetectionEngine($g.abi.libs_by_name.get(patternslib.name)!.mapped[6], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation);
    }
    static create(timeseries: $sdk.std.core.nodeTime, state: pattern_detectors.PatternDetectionEngineState | null, nullStrategy: pattern_detectors.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: pattern_detectors.SamplingPolicy | null, std: number | null, matchingNormalisation: pattern_detectors.MatchingNormalisation | null, $g: $sdk.GreyCat = globalThis.greycat.default): EuclideanPatternDetectionEngine {
      return new EuclideanPatternDetectionEngine($g.abi.libs_by_name.get(patternslib.name)!.mapped[6], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, std, matchingNormalisation);
    }
  ...
  export class PatternDetectionSensitivity extends $sdk.GCObject {
    ...
    static createFrom({threshold, overlap}: {threshold: number, overlap: number}, $g: $sdk.GreyCat = globalThis.greycat.default): PatternDetectionSensitivity {
      return new PatternDetectionSensitivity($g.abi.libs_by_name.get(patternslib.name)!.mapped[9], threshold, overlap);
    }
  ...
  export class ScoreDetails extends $sdk.GCObject {
    ...
    static createFrom({best_pattern, timespan}: {best_pattern: bigint | number, timespan: $sdk.std.core.duration}, $g: $sdk.GreyCat = globalThis.greycat.default): ScoreDetails {
      return new ScoreDetails($g.abi.libs_by_name.get(patternslib.name)!.mapped[13], best_pattern, timespan);
    }
...
export const patternslib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[0] = abi.type_by_fqn.get(pattern_detectors.RandomPatternDetector._type)!;
    this.mapped[1] = abi.type_by_fqn.get(pattern_detectors.MatchingNormalisation._type)!;
    this.mapped[1].resolveGeneratedOffsetWithValues('as_is', "As-is",'shift', "Vertical shift",'scaling', "Vertical scaling",'shift_and_scaling', "Vertical shift and scaling");
    this.mapped[2] = abi.type_by_fqn.get(pattern_detectors.SaxPatternDetectionEngine._type)!;
    this.mapped[2].resolveGeneratedOffsets('timeseries','state','nullStrategy','nullReplaceConstant','samplingPolicy','alphabet_size','alphabet_boundaries','lookup_table','max_distance','pattern_fingerprints','fingerprint_length');
    this.mapped[2].static_values = ["ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz"];
    this.mapped[3] = abi.type_by_fqn.get(pattern_detectors.SamplingPolicy._type)!;
    this.mapped[3].resolveGeneratedOffsetWithValues('as_is', "As-is",'average_frequency', "Average frequency",'highest_frequency', "Highest frequency");
    this.mapped[4] = abi.type_by_fqn.get(pattern_detectors.ScoreDetailsSingleton._type)!;
    this.mapped[4].resolveGeneratedOffsets('best_pattern','timespan','timestamp');
    this.mapped[5] = abi.type_by_fqn.get(pattern_detectors.RandomPatternDetectionEngine._type)!;
    this.mapped[5].resolveGeneratedOffsets('timeseries','state','nullStrategy','nullReplaceConstant','samplingPolicy','rng');
    this.mapped[6] = abi.type_by_fqn.get(pattern_detectors.EuclideanPatternDetectionEngine._type)!;
    this.mapped[6].resolveGeneratedOffsets('timeseries','state','nullStrategy','nullReplaceConstant','samplingPolicy','std','matchingNormalisation');
    this.mapped[7] = abi.type_by_fqn.get(pattern_detectors.PatternDetectionEngine._type)!;
    this.mapped[7].resolveGeneratedOffsets('timeseries','state','nullStrategy','nullReplaceConstant','samplingPolicy');
    ...
    this.mapped[9] = abi.type_by_fqn.get(pattern_detectors.PatternDetectionSensitivity._type)!;
    this.mapped[9].resolveGeneratedOffsets('threshold','overlap');
    this.mapped[10] = abi.type_by_fqn.get(pattern_detectors.PatternNullStrategy._type)!;
    this.mapped[10].resolveGeneratedOffsetWithValues('replace', "Replace",'interpolate', "Interpolate",'previous', "Previous",'next', "Next",'none', "None");
    this.mapped[11] = abi.type_by_fqn.get(pattern_detectors.PatternDetectors._type)!;
    this.mapped[11].resolveGeneratedOffsetWithValues('none', "None",'euclidean', "Euclidean",'random', "Random",'sax', "SAX");
    this.mapped[12] = abi.type_by_fqn.get(pattern_detectors.EuclideanPatternDetector._type)!;
    this.mapped[13] = abi.type_by_fqn.get(pattern_detectors.ScoreDetails._type)!;
    this.mapped[13].resolveGeneratedOffsets('best_pattern','timespan');
    ...
    this.mapped[15].resolveGeneratedOffsets('score','best_pattern','timespan');
