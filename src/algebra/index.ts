...
export namespace compute {
  ...
  export class ComputeInitializerNormalOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalOut {
      return new ComputeInitializerNormalOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[2]);
    }
  ...
  export class ComputeInitializerUniformIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformIn {
      return new ComputeInitializerUniformIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[3]);
    }
  ...
  export class ComputeOperationSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSign {
      return new ComputeOperationSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[4], input, output);
    }
  ...
  export class ComputeOperationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output, slope, shift}: {input: string, output: string, slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationHardSigmoid {
      return new ComputeOperationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[6], input, output, slope, shift);
    }
  ...
  export class ComputeInitializerSigmoidUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerSigmoidUniform {
      return new ComputeInitializerSigmoidUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[7]);
    }
  ...
  export class ComputeInitializerLeCunUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLeCunUniform {
      return new ComputeInitializerLeCunUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[9]);
    }
  ...
  export class ComputeInitializerGlorotUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerGlorotUniform {
      return new ComputeInitializerGlorotUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[10]);
    }
  ...
  export class ComputeOptimizerAdam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdam {
      return new ComputeOptimizerAdam($g.abi.libs_by_name.get(algebralib.name)!.mapped[12], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeLayerMinMaxScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerMinMaxScaler {
      return new ComputeLayerMinMaxScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[13], name, type, inverse_transform);
    }
  ...
  export class ComputeLayerFilter extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, maskValues}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, maskValues: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerFilter {
      return new ComputeLayerFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[14], name, type, inputs, outputs, maskValues);
    }
  ...
  export class ComputeOperationArgMax extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMax {
      return new ComputeOperationArgMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[15], input, output, output2);
    }
  ...
  export class ComputeLayerCall extends $sdk.GCObject {
    ...
    static createFrom({layer_name, bindings}: {layer_name: string, bindings: globalThis.Array<compute.ComputeBinding>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCall {
      return new ComputeLayerCall($g.abi.libs_by_name.get(algebralib.name)!.mapped[16], layer_name, bindings);
    }
  ...
  export class ComputeVarConst extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarConst {
      return new ComputeVarConst($g.abi.libs_by_name.get(algebralib.name)!.mapped[17], name, type, shape);
    }
  ...
  export class ComputeOperationClip extends $sdk.GCObject {
    ...
    static createFrom({input, output, min, max}: {input: string, output: string, min: number | null, max: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationClip {
      return new ComputeOperationClip($g.abi.libs_by_name.get(algebralib.name)!.mapped[18], input, output, min, max);
    }
  ...
  export class ComputeOperationScale extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationScale {
      return new ComputeOperationScale($g.abi.libs_by_name.get(algebralib.name)!.mapped[19], input, output, alpha);
    }
  ...
  export class ComputeOperationTan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTan {
      return new ComputeOperationTan($g.abi.libs_by_name.get(algebralib.name)!.mapped[20], input, output);
    }
  ...
  export class ComputeOperationElu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationElu {
      return new ComputeOperationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[21], input, output, alpha);
    }
  ...
  export class ComputeOptimizerNesterov extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNesterov {
      return new ComputeOptimizerNesterov($g.abi.libs_by_name.get(algebralib.name)!.mapped[22], learning_rate, decay_rate);
    }
  ...
  export class ComputeActivationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({slope, shift}: {slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationHardSigmoid {
      return new ComputeActivationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[23], slope, shift);
    }
  ...
  export class ComputeOperationSin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSin {
      return new ComputeOperationSin($g.abi.libs_by_name.get(algebralib.name)!.mapped[24], input, output);
    }
  ...
  export class ComputeLayerLSTM extends $sdk.GCObject {
    ...
    static createFrom({name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences}: {name: string, bias_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_regularizer: compute.ComputeRegularizer | null, type: $sdk.std.core.TensorType, use_bias: boolean | null, return_sequences: boolean | null, bidirectional: boolean | null, auto_init_states: boolean | null, inputs: bigint | number, outputs: bigint | number, layers: bigint | number, sequences: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLSTM {
      return new ComputeLayerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[25], name, bias_initializer, weight_regularizer, bias_regularizer, type, use_bias, return_sequences, bidirectional, auto_init_states, inputs, outputs, layers, sequences);
    }
  ...
  export class ComputeOperationAsinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsinh {
      return new ComputeOperationAsinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[28], input, output);
    }
  ...
  export class ComputeOperationMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMul {
      return new ComputeOperationMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[30], input, input2, output);
    }
  ...
  export class ComputeOperationAddBias extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAddBias {
      return new ComputeOperationAddBias($g.abi.libs_by_name.get(algebralib.name)!.mapped[32], input, input2, output);
    }
  ...
  export class ComputeOperationExp extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationExp {
      return new ComputeOperationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[33], input, output);
    }
  ...
  export class ComputeOperationSqrt extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSqrt {
      return new ComputeOperationSqrt($g.abi.libs_by_name.get(algebralib.name)!.mapped[34], input, output);
    }
  ...
  export class ComputeInitializerPytorch extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerPytorch {
      return new ComputeInitializerPytorch($g.abi.libs_by_name.get(algebralib.name)!.mapped[36]);
    }
  ...
  export class ComputeOperationSoftplus extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftplus {
      return new ComputeOperationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[37], input, output);
    }
  ...
  export class ComputeLayerSeq extends $sdk.GCObject {
    ...
    static createFrom({name, calls, optimizer}: {name: string, calls: globalThis.Array<compute.ComputeLayerCall>, optimizer: compute.ComputeOptimizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerSeq {
      return new ComputeLayerSeq($g.abi.libs_by_name.get(algebralib.name)!.mapped[38], name, calls, optimizer);
    }
  ...
  export class ComputeModel extends $sdk.GCObject {
    ...
    static createFrom({layers}: {layers: globalThis.Array<compute.ComputeLayer>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeModel {
      return new ComputeModel($g.abi.libs_by_name.get(algebralib.name)!.mapped[39], layers);
    }
  ...
  export class ComputeLayerLossClassification extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeClassificationLoss, has_class_weights: boolean, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossClassification {
      return new ComputeLayerLossClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[40], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOptimizerAdaDelta extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate, smooth_epsilon}: {learning_rate: number | null, decay_rate: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaDelta {
      return new ComputeOptimizerAdaDelta($g.abi.libs_by_name.get(algebralib.name)!.mapped[42], learning_rate, decay_rate, smooth_epsilon);
    }
  ...
  export class ComputeActivationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({alpha, max_value, threshold}: {alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationLeakyRelu {
      return new ComputeActivationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[44], alpha, max_value, threshold);
    }
  ...
  export class ComputeOperationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha, max_value, threshold}: {input: string, output: string, alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeakyRelu {
      return new ComputeOperationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[45], input, output, alpha, max_value, threshold);
    }
  ...
  export class ComputeOperationAtanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtanh {
      return new ComputeOperationAtanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[46], input, output);
    }
  ...
  export class ComputeInitializerXavierUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavierUniform {
      return new ComputeInitializerXavierUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[47]);
    }
  ...
  export class ComputeOptimizerNadam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNadam {
      return new ComputeOptimizerNadam($g.abi.libs_by_name.get(algebralib.name)!.mapped[48], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeLayerCustom extends $sdk.GCObject {
    ...
    static createFrom({name, ops, vars}: {name: string, ops: globalThis.Array<compute.ComputeOperation>, vars: globalThis.Array<compute.ComputeVariable>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCustom {
      return new ComputeLayerCustom($g.abi.libs_by_name.get(algebralib.name)!.mapped[51], name, ops, vars);
    }
  ...
  export class ComputeActivationTanh extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationTanh {
      return new ComputeActivationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[55]);
    }
  ...
  export class ComputeLayerActivation extends $sdk.GCObject {
    ...
    static createFrom({name, activation}: {name: string, activation: compute.ComputeActivation}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerActivation {
      return new ComputeLayerActivation($g.abi.libs_by_name.get(algebralib.name)!.mapped[56], name, activation);
    }
  ...
  export class ComputeOperationLeCunTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeCunTanh {
      return new ComputeOperationLeCunTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[58], input, output);
    }
  ...
  export class ComputeInitializerReluUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerReluUniform {
      return new ComputeInitializerReluUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[59]);
    }
  ...
  export class ComputeOperationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftmax {
      return new ComputeOperationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[60], input, output);
    }
  ...
  export class ComputeOperationSub extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSub {
      return new ComputeOperationSub($g.abi.libs_by_name.get(algebralib.name)!.mapped[61], input, input2, output);
    }
  ...
  export class ComputeInitializerNone extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNone {
      return new ComputeInitializerNone($g.abi.libs_by_name.get(algebralib.name)!.mapped[63]);
    }
  ...
  export class ComputeOperationCos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCos {
      return new ComputeOperationCos($g.abi.libs_by_name.get(algebralib.name)!.mapped[65], input, output);
    }
  ...
  export class ComputeInitializerUniform extends $sdk.GCObject {
    ...
    static createFrom({min, max}: {min: number, max: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniform {
      return new ComputeInitializerUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[66], min, max);
    }
  ...
  export class ComputeOperationAcosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcosh {
      return new ComputeOperationAcosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[67], input, output);
    }
  ...
  export class ComputeOperationAsin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsin {
      return new ComputeOperationAsin($g.abi.libs_by_name.get(algebralib.name)!.mapped[68], input, output);
    }
  ...
  export class ComputeVarInOut extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, with_grad}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, with_grad: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarInOut {
      return new ComputeVarInOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[69], name, type, shape, with_grad);
    }
  ...
  export class ComputeOperationLog extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLog {
      return new ComputeOperationLog($g.abi.libs_by_name.get(algebralib.name)!.mapped[70], input, output);
    }
  ...
  export class ComputeOperationAdd extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAdd {
      return new ComputeOperationAdd($g.abi.libs_by_name.get(algebralib.name)!.mapped[71], input, input2, output);
    }
  ...
  export class ComputeOperationLogSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLogSoftmax {
      return new ComputeOperationLogSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[72], input, output, axis);
    }
  ...
  export class ComputeActivationRelu extends $sdk.GCObject {
    ...
    static createFrom({max_value, threshold}: {max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationRelu {
      return new ComputeActivationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[73], max_value, threshold);
    }
  ...
  export class ComputeLayerLossRegression extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeRegressionLoss}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossRegression {
      return new ComputeLayerLossRegression($g.abi.libs_by_name.get(algebralib.name)!.mapped[74], name, reduction, loss_type);
    }
  ...
  export class ComputeOptimizerAdaMax extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaMax {
      return new ComputeOptimizerAdaMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[75], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeOptimizerAdaGrad extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, initial_accumulator, smooth_epsilon}: {learning_rate: number | null, initial_accumulator: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaGrad {
      return new ComputeOptimizerAdaGrad($g.abi.libs_by_name.get(algebralib.name)!.mapped[77], learning_rate, initial_accumulator, smooth_epsilon);
    }
  ...
  export class ComputeOperationFilter extends $sdk.GCObject {
    ...
    static createFrom({input, output, mask, nbOutputs}: {input: string, output: string, mask: string, nbOutputs: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationFilter {
      return new ComputeOperationFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[78], input, output, mask, nbOutputs);
    }
  ...
  export class ComputeOperationCelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCelu {
      return new ComputeOperationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[79], input, output, alpha);
    }
  ...
  export class ComputeActivationCelu extends $sdk.GCObject {
    ...
    static createFrom({alpha}: {alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationCelu {
      return new ComputeActivationCelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[80], alpha);
    }
  ...
  export class ComputeOperationSum extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSum {
      return new ComputeOperationSum($g.abi.libs_by_name.get(algebralib.name)!.mapped[81], input, output, axis);
    }
  ...
  export class ComputeOperationAbs extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAbs {
      return new ComputeOperationAbs($g.abi.libs_by_name.get(algebralib.name)!.mapped[83], input, output);
    }
  ...
  export class ComputeActivationExp extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationExp {
      return new ComputeActivationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[84]);
    }
  ...
  export class ComputeActivationSoftSign extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftSign {
      return new ComputeActivationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[85]);
    }
  ...
  export class ComputeActivationElu extends $sdk.GCObject {
    ...
    static createFrom({alpha}: {alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationElu {
      return new ComputeActivationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[90], alpha);
    }
  ...
  export class ComputeOperationSoftSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftSign {
      return new ComputeOperationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[91], input, output);
    }
  ...
  export class ComputeOperationMatMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output, transposeA, transposeB, alpha, beta}: {input: string, input2: string, output: string, transposeA: boolean, transposeB: boolean, alpha: number, beta: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMatMul {
      return new ComputeOperationMatMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[92], input, input2, output, transposeA, transposeB, alpha, beta);
    }
  ...
  export class ComputeVarOptimize extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, l1, l2, init}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, l1: number, l2: number, init: compute.ComputeInitializer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarOptimize {
      return new ComputeVarOptimize($g.abi.libs_by_name.get(algebralib.name)!.mapped[94], name, type, shape, l1, l2, init);
    }
  ...
  export class ComputeActivationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({classes}: {classes: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftmax {
      return new ComputeActivationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[95], classes);
    }
  ...
  export class ComputeOperationFill extends $sdk.GCObject {
    ...
    static createFrom({input, value}: {input: string, value: any}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationFill {
      return new ComputeOperationFill($g.abi.libs_by_name.get(algebralib.name)!.mapped[96], input, value);
    }
  ...
  export class ComputeOperationEuclidean extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationEuclidean {
      return new ComputeOperationEuclidean($g.abi.libs_by_name.get(algebralib.name)!.mapped[97], input, input2, output);
    }
  ...
  export class ComputeRegularizer extends $sdk.GCObject {
    ...
    static createFrom({l1, l2}: {l1: number, l2: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeRegularizer {
      return new ComputeRegularizer($g.abi.libs_by_name.get(algebralib.name)!.mapped[100], l1, l2);
    }
  ...
  export class ComputeActivationSigmoid extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSigmoid {
      return new ComputeActivationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[101]);
    }
  ...
  export class ComputeLayerPCAScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerPCAScaler {
      return new ComputeLayerPCAScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[102], name, type, inverse_transform);
    }
  ...
  export class ComputeActivationSelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSelu {
      return new ComputeActivationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[105]);
    }
  ...
  export class ComputeOperationRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, max_value, threshold}: {input: string, output: string, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationRelu {
      return new ComputeOperationRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[106], input, output, max_value, threshold);
    }
  ...
  export class ComputeInitializerXavier extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerXavier {
      return new ComputeInitializerXavier($g.abi.libs_by_name.get(algebralib.name)!.mapped[107]);
    }
  ...
  export class ComputeLayerDense extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[111], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
    static create(name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[111], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
  ...
  export class ComputeOperationSumIf extends $sdk.GCObject {
    ...
    static createFrom({input, ifCondition, output, counts, classes}: {input: string, ifCondition: string, output: string, counts: string, classes: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSumIf {
      return new ComputeOperationSumIf($g.abi.libs_by_name.get(algebralib.name)!.mapped[112], input, ifCondition, output, counts, classes);
    }
  ...
  export class ComputeOperationNeg extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationNeg {
      return new ComputeOperationNeg($g.abi.libs_by_name.get(algebralib.name)!.mapped[113], input, output);
    }
  ...
  export class ComputeOptimizerRmsProp extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate, smooth_epsilon}: {learning_rate: number | null, decay_rate: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerRmsProp {
      return new ComputeOptimizerRmsProp($g.abi.libs_by_name.get(algebralib.name)!.mapped[114], learning_rate, decay_rate, smooth_epsilon);
    }
  ...
  export class ComputeInitializerUniformOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformOut {
      return new ComputeInitializerUniformOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[115]);
    }
  ...
  export class ComputeBinding extends $sdk.GCObject {
    ...
    static createFrom({src_layer_name, src_var_name, target_var_name}: {src_layer_name: string, src_var_name: string, target_var_name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeBinding {
      return new ComputeBinding($g.abi.libs_by_name.get(algebralib.name)!.mapped[117], src_layer_name, src_var_name, target_var_name);
    }
  ...
  export class ComputeOperationAtan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtan {
      return new ComputeOperationAtan($g.abi.libs_by_name.get(algebralib.name)!.mapped[120], input, output);
    }
  ...
  export class ComputeLayerConfusion extends $sdk.GCObject {
    ...
    static createFrom({name, nbClass}: {name: string, nbClass: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerConfusion {
      return new ComputeLayerConfusion($g.abi.libs_by_name.get(algebralib.name)!.mapped[121], name, nbClass);
    }
  ...
  export class ComputeOperationSinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSinh {
      return new ComputeOperationSinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[123], input, output);
    }
  ...
  export class ComputeOperationPow extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationPow {
      return new ComputeOperationPow($g.abi.libs_by_name.get(algebralib.name)!.mapped[124], input, input2, output);
    }
  ...
  export class ComputeInitializerIdentity extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerIdentity {
      return new ComputeInitializerIdentity($g.abi.libs_by_name.get(algebralib.name)!.mapped[125]);
    }
  ...
  export class ComputeInitializerConstant extends $sdk.GCObject {
    ...
    static createFrom({value}: {value: any}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerConstant {
      return new ComputeInitializerConstant($g.abi.libs_by_name.get(algebralib.name)!.mapped[126], value);
    }
  ...
  export class ComputeVar extends $sdk.GCObject {
    ...
    static createFrom({name}: {name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVar {
      return new ComputeVar($g.abi.libs_by_name.get(algebralib.name)!.mapped[127], name);
    }
...
export namespace nn {
  ...
  export class ClassificationMetrics extends $sdk.GCObject {
    ...
    static createFrom({precision, recall, f1Score}: {precision: globalThis.Array<number>, recall: globalThis.Array<number>, f1Score: globalThis.Array<number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ClassificationMetrics {
      return new ClassificationMetrics($g.abi.libs_by_name.get(algebralib.name)!.mapped[135], precision, recall, f1Score);
    }
  ...
  export class BindingsResult extends $sdk.GCObject {
    ...
    static createFrom({previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer}: {previousLayerName: string, previousLayerOutput: string, expectedLayerName: string, expectedLayerOutput: string, postLayer: compute.ComputeLayer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): BindingsResult {
      return new BindingsResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[136], previousLayerName, previousLayerOutput, expectedLayerName, expectedLayerOutput, postLayer);
    }
...
export namespace patterns {
  ...
  export class SaxPatternDetectionEngine extends $sdk.GCObject {
    ...
    static createFrom({timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length}: {timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, alphabet_size: bigint | number, alphabet_boundaries: globalThis.Array<number>, lookup_table: $sdk.std.core.nodeIndex, max_distance: number, pattern_fingerprints: globalThis.Array<string>, fingerprint_length: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): SaxPatternDetectionEngine {
      return new SaxPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[145], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, alphabet_size, alphabet_boundaries, lookup_table, max_distance, pattern_fingerprints, fingerprint_length);
    }
  ...
  export class RandomPatternDetector extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): RandomPatternDetector {
      return new RandomPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[147]);
    }
  ...
  export class EuclideanPatternDetectionEngine extends $sdk.GCObject {
    ...
    static createFrom({timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation}: {timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, pattern_tensors: globalThis.Array<$sdk.std.core.Tensor> | null, window_tensors: globalThis.Array<$sdk.std.core.Tensor> | null, std: number | null, matchingNormalisation: patterns.MatchingNormalisation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): EuclideanPatternDetectionEngine {
      return new EuclideanPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[148], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation);
    }
    static create(timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, pattern_tensors: globalThis.Array<$sdk.std.core.Tensor> | null, window_tensors: globalThis.Array<$sdk.std.core.Tensor> | null, std: number | null, matchingNormalisation: patterns.MatchingNormalisation | null, $g: $sdk.GreyCat = globalThis.greycat.default): EuclideanPatternDetectionEngine {
      return new EuclideanPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[148], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, pattern_tensors, window_tensors, std, matchingNormalisation);
    }
  ...
  export class SaxPatternDetector extends $sdk.GCObject {
    ...
    static createFrom({alphabet_size, fingerprint_length}: {alphabet_size: bigint | number, fingerprint_length: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): SaxPatternDetector {
      return new SaxPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[149], alphabet_size, fingerprint_length);
    }
  ...
  export class ScoreDetailsSingleton extends $sdk.GCObject {
    ...
    static createFrom({best_pattern, timespan, timestamp}: {best_pattern: bigint | number, timespan: $sdk.std.core.duration, timestamp: $sdk.std.core.time}, $g: $sdk.GreyCat = globalThis.greycat.default): ScoreDetailsSingleton {
      return new ScoreDetailsSingleton($g.abi.libs_by_name.get(algebralib.name)!.mapped[150], best_pattern, timespan, timestamp);
    }
  ...
  export class OverlappingDetection extends $sdk.GCObject {
    ...
    static createFrom({score, best_pattern, timespan, overlap}: {score: number, best_pattern: bigint | number, timespan: $sdk.std.core.duration, overlap: $sdk.std.core.duration}, $g: $sdk.GreyCat = globalThis.greycat.default): OverlappingDetection {
      return new OverlappingDetection($g.abi.libs_by_name.get(algebralib.name)!.mapped[151], score, best_pattern, timespan, overlap);
    }
  ...
  export class RandomPatternDetectionEngine extends $sdk.GCObject {
    ...
    static createFrom({timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng}: {timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, rng: $sdk.std.util.Random}, $g: $sdk.GreyCat = globalThis.greycat.default): RandomPatternDetectionEngine {
      return new RandomPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[155], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng);
    }
    static create(timeseries: $sdk.std.core.nodeTime, state: patterns.PatternDetectionEngineState | null, nullStrategy: patterns.PatternNullStrategy | null, nullReplaceConstant: number | null, samplingPolicy: patterns.SamplingPolicy | null, rng: $sdk.std.util.Random, $g: $sdk.GreyCat = globalThis.greycat.default): RandomPatternDetectionEngine {
      return new RandomPatternDetectionEngine($g.abi.libs_by_name.get(algebralib.name)!.mapped[155], timeseries, state, nullStrategy, nullReplaceConstant, samplingPolicy, rng);
    }
  ...
  export class FFTPatternDetector extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): FFTPatternDetector {
      return new FFTPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[159]);
    }
  ...
  export class PatternDetectionSensitivity extends $sdk.GCObject {
    ...
    static createFrom({threshold, overlap}: {threshold: number, overlap: number}, $g: $sdk.GreyCat = globalThis.greycat.default): PatternDetectionSensitivity {
      return new PatternDetectionSensitivity($g.abi.libs_by_name.get(algebralib.name)!.mapped[160], threshold, overlap);
    }
  ...
  export class EuclideanPatternDetector extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): EuclideanPatternDetector {
      return new EuclideanPatternDetector($g.abi.libs_by_name.get(algebralib.name)!.mapped[162]);
    }
...
export namespace ml {
  export class Solver extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Solver {
      return new Solver($g.abi.libs_by_name.get(algebralib.name)!.mapped[166]);
    }
  ...
  export class HeatMapProfile extends $sdk.GCObject {
    ...
    static createFrom({counts, x_labels, y_labels, counts_max, counts_sum}: {counts: $sdk.std.core.Table<bigint | number>, x_labels: globalThis.Array<string>, y_labels: globalThis.Array<string>, counts_max: bigint | number, counts_sum: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): HeatMapProfile {
      return new HeatMapProfile($g.abi.libs_by_name.get(algebralib.name)!.mapped[170], counts, x_labels, y_labels, counts_max, counts_sum);
    }
  ...
  export class TimeSeriesDecomposition extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): TimeSeriesDecomposition {
      return new TimeSeriesDecomposition($g.abi.libs_by_name.get(algebralib.name)!.mapped[171]);
    }
...
export namespace transforms {
  export class FFTModel extends $sdk.GCObject {
    ...
    static createFrom({nt, sampling_step, time_complex, frequency_complex, frequency_table, start_time, best_size}: {nt: $sdk.std.core.nodeTime, sampling_step: $sdk.std.core.duration, time_complex: $sdk.std.core.Tensor, frequency_complex: $sdk.std.core.Tensor, frequency_table: $sdk.std.core.Table, start_time: $sdk.std.core.time, best_size: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): FFTModel {
      return new FFTModel($g.abi.libs_by_name.get(algebralib.name)!.mapped[172], nt, sampling_step, time_complex, frequency_complex, frequency_table, start_time, best_size);
    }
...
export namespace powerflow {
  export class PowerLineResult extends $sdk.GCObject {
    ...
    static createFrom({p_from_mw, q_from_mvar, p_to_mw, q_to_mvar, pl_mw, ql_mvar, i_from_ka, i_to_ka, i_ka, vm_from_pu, vm_to_pu, va_from_radians, va_to_radians, loading_percent}: {p_from_mw: number, q_from_mvar: number, p_to_mw: number, q_to_mvar: number, pl_mw: number, ql_mvar: number, i_from_ka: number, i_to_ka: number, i_ka: number, vm_from_pu: number, vm_to_pu: number, va_from_radians: number, va_to_radians: number, loading_percent: number}, $g: $sdk.GreyCat = globalThis.greycat.default): PowerLineResult {
      return new PowerLineResult($g.abi.libs_by_name.get(algebralib.name)!.mapped[173], p_from_mw, q_from_mvar, p_to_mw, q_to_mvar, pl_mw, ql_mvar, i_from_ka, i_to_ka, i_ka, vm_from_pu, vm_to_pu, va_from_radians, va_to_radians, loading_percent);
    }
...
export const algebralib: $sdk.Library = {
  ...
  init(abi) {
    ...
    if (this.mapped[1]) {
      this.mapped[1].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.9,};
    }
    this.mapped[2] = abi.type_by_fqn.get(compute.ComputeInitializerNormalOut._type);
    this.mapped[3] = abi.type_by_fqn.get(compute.ComputeInitializerUniformIn._type);
    this.mapped[4] = abi.type_by_fqn.get(compute.ComputeOperationSign._type);
    this.mapped[5] = abi.type_by_fqn.get(compute.ComputeInitializerNormal._type);
    this.mapped[6] = abi.type_by_fqn.get(compute.ComputeOperationHardSigmoid._type);
    if (this.mapped[6]) {
      this.mapped[6].static_values = {['slope_def']: 0.2,['shift_def']: 0.5,};
    }
    this.mapped[7] = abi.type_by_fqn.get(compute.ComputeInitializerSigmoidUniform._type);
    this.mapped[8] = abi.type_by_fqn.get(compute.ComputeClassificationLoss._type);
    this.mapped[8]?.resolveGeneratedOffsetWithValues('categorical_cross_entropy', "Categorical Cross Entropy",'sparse_categorical_cross_entropy', "Sparse Categorical Cross Entropy");
    this.mapped[9] = abi.type_by_fqn.get(compute.ComputeInitializerLeCunUniform._type);
    this.mapped[10] = abi.type_by_fqn.get(compute.ComputeInitializerGlorotUniform._type);
    this.mapped[11] = abi.type_by_fqn.get(compute.ComputeActivationSoftplus._type);
    this.mapped[12] = abi.type_by_fqn.get(compute.ComputeOptimizerAdam._type);
    if (this.mapped[12]) {
      this.mapped[12].static_values = {['learning_rate_def']: 0.001,['beta1_def']: 0.9,['beta2_def']: 0.999,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[13] = abi.type_by_fqn.get(compute.ComputeLayerMinMaxScaler._type);
    if (this.mapped[13]) {
      this.mapped[13].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_min_name']: "min",['var_max_name']: "max",};
    }
    this.mapped[14] = abi.type_by_fqn.get(compute.ComputeLayerFilter._type);
    if (this.mapped[14]) {
      this.mapped[14].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_mask_name']: "mask",};
    }
    this.mapped[15] = abi.type_by_fqn.get(compute.ComputeOperationArgMax._type);
    this.mapped[16] = abi.type_by_fqn.get(compute.ComputeLayerCall._type);
    this.mapped[17] = abi.type_by_fqn.get(compute.ComputeVarConst._type);
    this.mapped[18] = abi.type_by_fqn.get(compute.ComputeOperationClip._type);
    this.mapped[19] = abi.type_by_fqn.get(compute.ComputeOperationScale._type);
    this.mapped[20] = abi.type_by_fqn.get(compute.ComputeOperationTan._type);
    this.mapped[21] = abi.type_by_fqn.get(compute.ComputeOperationElu._type);
    if (this.mapped[21]) {
      this.mapped[21].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[22] = abi.type_by_fqn.get(compute.ComputeOptimizerNesterov._type);
    if (this.mapped[22]) {
      this.mapped[22].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.9,};
    }
    this.mapped[23] = abi.type_by_fqn.get(compute.ComputeActivationHardSigmoid._type);
    if (this.mapped[23]) {
      this.mapped[23].static_values = {['slope_def']: 0.2,['shift_def']: 0.5,};
    }
    this.mapped[24] = abi.type_by_fqn.get(compute.ComputeOperationSin._type);
    this.mapped[25] = abi.type_by_fqn.get(compute.ComputeLayerLSTM._type);
    if (this.mapped[25]) {
      this.mapped[25].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_hx_name']: "hx",['var_cx_name']: "cx",['var_hy_name']: "hy",['var_cy_name']: "cy",['var_weight_name']: "weight",['var_bias_name']: "bias",['var_internal_i_name']: "internal_i",['var_internal_f_name']: "internal_f",['var_internal_cp_name']: "internal_cp",['var_internal_o_name']: "internal_o",['var_internal_h_name']: "internal_h",['var_internal_c_name']: "internal_c",['var_internal_mult_name']: "internal_mult",['var_internal_output_name']: "internal_output",};
    }
    this.mapped[26] = abi.type_by_fqn.get(compute.ComputeInitializerNormalAvg._type);
    this.mapped[27] = abi.type_by_fqn.get(compute.ComputeOperation2In1Out._type);
    this.mapped[28] = abi.type_by_fqn.get(compute.ComputeOperationAsinh._type);
    this.mapped[29] = abi.type_by_fqn.get(compute.ComputeInitializerNormalIn._type);
    this.mapped[30] = abi.type_by_fqn.get(compute.ComputeOperationMul._type);
    this.mapped[31] = abi.type_by_fqn.get(compute.ComputeOperation._type);
    this.mapped[32] = abi.type_by_fqn.get(compute.ComputeOperationAddBias._type);
    this.mapped[33] = abi.type_by_fqn.get(compute.ComputeOperationExp._type);
    this.mapped[34] = abi.type_by_fqn.get(compute.ComputeOperationSqrt._type);
    this.mapped[35] = abi.type_by_fqn.get(compute.ComputeEngine._type);
    this.mapped[36] = abi.type_by_fqn.get(compute.ComputeInitializerPytorch._type);
    this.mapped[37] = abi.type_by_fqn.get(compute.ComputeOperationSoftplus._type);
    this.mapped[38] = abi.type_by_fqn.get(compute.ComputeLayerSeq._type);
    this.mapped[39] = abi.type_by_fqn.get(compute.ComputeModel._type);
    this.mapped[40] = abi.type_by_fqn.get(compute.ComputeLayerLossClassification._type);
    if (this.mapped[40]) {
      this.mapped[40].static_values = {['var_class_weights_name']: "class_weights",['var_predicted_classes_name']: "predicted_classes",['var_probabilities_name']: "probabilities",['var_sum_reduce_name']: "sum_reduce",};
    }
    this.mapped[41] = abi.type_by_fqn.get(compute.ComputeOperationAcos._type);
    this.mapped[42] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaDelta._type);
    if (this.mapped[42]) {
      this.mapped[42].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.95,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[43] = abi.type_by_fqn.get(compute.ComputeInitializerUniformAvg._type);
    this.mapped[44] = abi.type_by_fqn.get(compute.ComputeActivationLeakyRelu._type);
    if (this.mapped[44]) {
      this.mapped[44].static_values = {['alpha_def']: 0.3,['threshold_def']: 0.0,};
    }
    this.mapped[45] = abi.type_by_fqn.get(compute.ComputeOperationLeakyRelu._type);
    if (this.mapped[45]) {
      this.mapped[45].static_values = {['alpha_def']: 0.3,['max_value_def']: 1.7976931349E308,['threshold_def']: 0.0,};
    }
    this.mapped[46] = abi.type_by_fqn.get(compute.ComputeOperationAtanh._type);
    this.mapped[47] = abi.type_by_fqn.get(compute.ComputeInitializerXavierUniform._type);
    this.mapped[48] = abi.type_by_fqn.get(compute.ComputeOptimizerNadam._type);
    if (this.mapped[48]) {
    ...
    if (this.mapped[49]) {
      this.mapped[49].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_weight_name']: "weight",['var_bias_name']: "bias",['var_mult_name']: "mult",};
    }
    ...
    this.mapped[51] = abi.type_by_fqn.get(compute.ComputeLayerCustom._type);
    ...
    if (this.mapped[53]) {
      this.mapped[53].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_avg_name']: "avg",['var_std_name']: "std",};
    }
    this.mapped[54] = abi.type_by_fqn.get(compute.ComputeCounter._type);
    this.mapped[55] = abi.type_by_fqn.get(compute.ComputeActivationTanh._type);
    this.mapped[56] = abi.type_by_fqn.get(compute.ComputeLayerActivation._type);
    if (this.mapped[56]) {
      this.mapped[56].static_values = {['var_input_name']: "input",['var_output_name']: "output",};
    }
    this.mapped[57] = abi.type_by_fqn.get(compute.ComputeRegressionLoss._type);
    this.mapped[57]?.resolveGeneratedOffsetWithValues('square', "Square",'abs', "Abs");
    this.mapped[58] = abi.type_by_fqn.get(compute.ComputeOperationLeCunTanh._type);
    this.mapped[59] = abi.type_by_fqn.get(compute.ComputeInitializerReluUniform._type);
    this.mapped[60] = abi.type_by_fqn.get(compute.ComputeOperationSoftmax._type);
    this.mapped[61] = abi.type_by_fqn.get(compute.ComputeOperationSub._type);
    this.mapped[62] = abi.type_by_fqn.get(compute.ComputeActivation._type);
    this.mapped[63] = abi.type_by_fqn.get(compute.ComputeInitializerNone._type);
    this.mapped[64] = abi.type_by_fqn.get(compute.ComputeState._type);
    this.mapped[65] = abi.type_by_fqn.get(compute.ComputeOperationCos._type);
    this.mapped[66] = abi.type_by_fqn.get(compute.ComputeInitializerUniform._type);
    this.mapped[67] = abi.type_by_fqn.get(compute.ComputeOperationAcosh._type);
    this.mapped[68] = abi.type_by_fqn.get(compute.ComputeOperationAsin._type);
    this.mapped[69] = abi.type_by_fqn.get(compute.ComputeVarInOut._type);
    this.mapped[70] = abi.type_by_fqn.get(compute.ComputeOperationLog._type);
    this.mapped[71] = abi.type_by_fqn.get(compute.ComputeOperationAdd._type);
    this.mapped[72] = abi.type_by_fqn.get(compute.ComputeOperationLogSoftmax._type);
    this.mapped[73] = abi.type_by_fqn.get(compute.ComputeActivationRelu._type);
    if (this.mapped[73]) {
      this.mapped[73].static_values = {['threshold_def']: 0.0,};
    }
    this.mapped[74] = abi.type_by_fqn.get(compute.ComputeLayerLossRegression._type);
    this.mapped[75] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaMax._type);
    if (this.mapped[75]) {
      this.mapped[75].static_values = {['learning_rate_def']: 0.001,['beta1_def']: 0.9,['beta2_def']: 0.999,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[76] = abi.type_by_fqn.get(compute.ComputeInitializer._type);
    this.mapped[77] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaGrad._type);
    if (this.mapped[77]) {
      this.mapped[77].static_values = {['learning_rate_def']: 0.001,['initial_accumulator_def']: 0.1,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[78] = abi.type_by_fqn.get(compute.ComputeOperationFilter._type);
    this.mapped[79] = abi.type_by_fqn.get(compute.ComputeOperationCelu._type);
    if (this.mapped[79]) {
      this.mapped[79].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[80] = abi.type_by_fqn.get(compute.ComputeActivationCelu._type);
    if (this.mapped[80]) {
      this.mapped[80].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[81] = abi.type_by_fqn.get(compute.ComputeOperationSum._type);
    this.mapped[82] = abi.type_by_fqn.get(compute.ComputeOperationArg._type);
    this.mapped[83] = abi.type_by_fqn.get(compute.ComputeOperationAbs._type);
    this.mapped[84] = abi.type_by_fqn.get(compute.ComputeActivationExp._type);
    this.mapped[85] = abi.type_by_fqn.get(compute.ComputeActivationSoftSign._type);
    ...
    this.mapped[88] = abi.type_by_fqn.get(compute.ComputeOptimizer._type);
    this.mapped[89] = abi.type_by_fqn.get(compute.ComputeOperationArgMin._type);
    this.mapped[90] = abi.type_by_fqn.get(compute.ComputeActivationElu._type);
    if (this.mapped[90]) {
      this.mapped[90].static_values = {['alpha_def']: 1.0,};
    }
    this.mapped[91] = abi.type_by_fqn.get(compute.ComputeOperationSoftSign._type);
    this.mapped[92] = abi.type_by_fqn.get(compute.ComputeOperationMatMul._type);
    if (this.mapped[92]) {
      this.mapped[92].static_values = {['transpose_def']: false,['alpha_def']: 1.0,['beta_def']: 0.0,};
    }
    this.mapped[93] = abi.type_by_fqn.get(compute.ComputeOperationDiv._type);
    this.mapped[94] = abi.type_by_fqn.get(compute.ComputeVarOptimize._type);
    this.mapped[95] = abi.type_by_fqn.get(compute.ComputeActivationSoftmax._type);
    this.mapped[96] = abi.type_by_fqn.get(compute.ComputeOperationFill._type);
    this.mapped[97] = abi.type_by_fqn.get(compute.ComputeOperationEuclidean._type);
    this.mapped[98] = abi.type_by_fqn.get(compute.ComputeVariable._type);
    this.mapped[99] = abi.type_by_fqn.get(compute.ComputeLayer._type);
    this.mapped[100] = abi.type_by_fqn.get(compute.ComputeRegularizer._type);
    this.mapped[101] = abi.type_by_fqn.get(compute.ComputeActivationSigmoid._type);
    this.mapped[102] = abi.type_by_fqn.get(compute.ComputeLayerPCAScaler._type);
    if (this.mapped[102]) {
      this.mapped[102].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_avg_name']: "avg",['var_std_name']: "std",['var_space_name']: "space",};
    }
    this.mapped[103] = abi.type_by_fqn.get(compute.ComputeOperationSigmoid._type);
    this.mapped[104] = abi.type_by_fqn.get(compute.ComputeReduction._type);
    this.mapped[104]?.resolveGeneratedOffsetWithValues('auto', "auto",'none', "none",'sum', "sum",'mean', "mean",'disabled', "disabled");
    this.mapped[105] = abi.type_by_fqn.get(compute.ComputeActivationSelu._type);
    this.mapped[106] = abi.type_by_fqn.get(compute.ComputeOperationRelu._type);
    if (this.mapped[106]) {
      this.mapped[106].static_values = {['threshold_def']: 0.0,};
    }
    this.mapped[107] = abi.type_by_fqn.get(compute.ComputeInitializerXavier._type);
    ...
    this.mapped[111] = abi.type_by_fqn.get(compute.ComputeLayerDense._type);
    if (this.mapped[111]) {
      this.mapped[111].static_values = {['var_input_name']: "input",['var_output_name']: "output",['var_weight_name']: "weight",['var_bias_name']: "bias",['var_mult_name']: "mult",['var_pre_activation_name']: "pre_activation",};
    }
    this.mapped[112] = abi.type_by_fqn.get(compute.ComputeOperationSumIf._type);
    this.mapped[113] = abi.type_by_fqn.get(compute.ComputeOperationNeg._type);
    this.mapped[114] = abi.type_by_fqn.get(compute.ComputeOptimizerRmsProp._type);
    if (this.mapped[114]) {
      this.mapped[114].static_values = {['learning_rate_def']: 0.001,['decay_rate_def']: 0.9,['smooth_epsilon_def']: 0.0000001,};
    }
    this.mapped[115] = abi.type_by_fqn.get(compute.ComputeInitializerUniformOut._type);
    this.mapped[116] = abi.type_by_fqn.get(compute.ComputeLayerClassification._type);
    if (this.mapped[116]) {
      this.mapped[116].static_values = {['var_input_name']: "input",['var_predicted_classes_name']: "predicted_classes",['var_probabilities_name']: "probabilities",};
    }
    this.mapped[117] = abi.type_by_fqn.get(compute.ComputeBinding._type);
    this.mapped[118] = abi.type_by_fqn.get(compute.ComputeOperation1In1Out._type);
    ...
    this.mapped[120] = abi.type_by_fqn.get(compute.ComputeOperationAtan._type);
    this.mapped[121] = abi.type_by_fqn.get(compute.ComputeLayerConfusion._type);
    if (this.mapped[121]) {
      this.mapped[121].static_values = {['var_computed_name']: "computed",['var_expected_name']: "expected",['var_confusion_name']: "confusion",};
    }
    this.mapped[122] = abi.type_by_fqn.get(compute.ComputeOperationCosh._type);
    this.mapped[123] = abi.type_by_fqn.get(compute.ComputeOperationSinh._type);
    this.mapped[124] = abi.type_by_fqn.get(compute.ComputeOperationPow._type);
    this.mapped[125] = abi.type_by_fqn.get(compute.ComputeInitializerIdentity._type);
    this.mapped[126] = abi.type_by_fqn.get(compute.ComputeInitializerConstant._type);
    this.mapped[127] = abi.type_by_fqn.get(compute.ComputeVar._type);
    ...
    this.mapped[135] = abi.type_by_fqn.get(nn.ClassificationMetrics._type);
    this.mapped[136] = abi.type_by_fqn.get(nn.BindingsResult._type);
    ...
    this.mapped[140] = abi.type_by_fqn.get(nn.ComputeLayerTypes._type);
    this.mapped[140]?.resolveGeneratedOffsetWithValues('linear', "Linear",'dense', "Dense",'activation', "Activation",'lstm', "LSTM",'loss', "Loss",'filter', "Filter");
    this.mapped[141] = abi.type_by_fqn.get(nn.PostProcessType._type);
    this.mapped[141]?.resolveGeneratedOffsetWithValues('none', "None",'min_max_scaling', "Min/Max Scaling",'standard_scaling', "Standard Scaling");
    ...
    this.mapped[145] = abi.type_by_fqn.get(patterns.SaxPatternDetectionEngine._type);
    if (this.mapped[145]) {
      this.mapped[145].static_values = {['alphabet']: "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz",};
    }
    this.mapped[146] = abi.type_by_fqn.get(patterns.PatternDetectors._type);
    this.mapped[146]?.resolveGeneratedOffsetWithValues('none', "None",'euclidean', "Euclidean",'fft', "FFT",'dtw', "DTW",'random', "Random",'sax', "SAX");
    this.mapped[147] = abi.type_by_fqn.get(patterns.RandomPatternDetector._type);
    this.mapped[148] = abi.type_by_fqn.get(patterns.EuclideanPatternDetectionEngine._type);
    this.mapped[149] = abi.type_by_fqn.get(patterns.SaxPatternDetector._type);
    this.mapped[150] = abi.type_by_fqn.get(patterns.ScoreDetailsSingleton._type);
    this.mapped[151] = abi.type_by_fqn.get(patterns.OverlappingDetection._type);
    this.mapped[152] = abi.type_by_fqn.get(patterns.PatternDetectionEngine._type);
    this.mapped[153] = abi.type_by_fqn.get(patterns.MatchingNormalisation._type);
    this.mapped[153]?.resolveGeneratedOffsetWithValues('as_is', "As-is",'shift', "Vertical shift",'scaling', "Vertical scaling",'shift_and_scaling', "Vertical shift and scaling");
    this.mapped[154] = abi.type_by_fqn.get(patterns.PatternDetector._type);
    this.mapped[155] = abi.type_by_fqn.get(patterns.RandomPatternDetectionEngine._type);
    this.mapped[156] = abi.type_by_fqn.get(patterns.SamplingPolicy._type);
    this.mapped[156]?.resolveGeneratedOffsetWithValues('as_is', "As-is",'average_frequency', "Average frequency",'highest_frequency', "Highest frequency");
    ...
    this.mapped[159] = abi.type_by_fqn.get(patterns.FFTPatternDetector._type);
    this.mapped[160] = abi.type_by_fqn.get(patterns.PatternDetectionSensitivity._type);
    this.mapped[161] = abi.type_by_fqn.get(patterns.DistanceMetrics._type);
    this.mapped[162] = abi.type_by_fqn.get(patterns.EuclideanPatternDetector._type);
    ...
    this.mapped[166] = abi.type_by_fqn.get(ml.Solver._type);
    this.mapped[167] = abi.type_by_fqn.get(ml.Polynomial._type);
    this.mapped[168] = abi.type_by_fqn.get(ml.GaussianND._type);
    this.mapped[169] = abi.type_by_fqn.get(ml.PCA._type);
    if (this.mapped[169]) {
      this.mapped[169].static_values = {['threshold_def']: 0.95,};
    }
    this.mapped[170] = abi.type_by_fqn.get(ml.HeatMapProfile._type);
    this.mapped[171] = abi.type_by_fqn.get(ml.TimeSeriesDecomposition._type);
    this.mapped[172] = abi.type_by_fqn.get(transforms.FFTModel._type);
    this.mapped[173] = abi.type_by_fqn.get(powerflow.PowerLineResult._type);
