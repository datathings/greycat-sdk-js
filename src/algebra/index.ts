...
export namespace compute {
  ...
  export class ComputeActivationExp extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationExp {
      return new ComputeActivationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[1]);
    }
  ...
  export class ComputeOptimizerSgd extends $sdk.GCObject {
    ...
    static createFrom({learning_rate}: {learning_rate: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerSgd {
      return new ComputeOptimizerSgd($g.abi.libs_by_name.get(algebralib.name)!.mapped[2], learning_rate);
    }
  ...
  export class ComputeLayerLossClassification extends $sdk.GCObject {
    ...
    static createFrom({name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits}: {name: string, reduction: compute.ComputeReduction | null, loss_type: compute.ComputeClassificationLoss, has_class_weights: boolean, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLossClassification {
      return new ComputeLayerLossClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[3], name, reduction, loss_type, has_class_weights, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeOperationRaiseToPower extends $sdk.GCObject {
    ...
    static createFrom({input, output, power}: {input: string, output: string, power: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationRaiseToPower {
      return new ComputeOperationRaiseToPower($g.abi.libs_by_name.get(algebralib.name)!.mapped[5], input, output, power);
    }
  ...
  export class ComputeVarInOut extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, with_grad}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, with_grad: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarInOut {
      return new ComputeVarInOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[6], name, type, shape, with_grad);
    }
  ...
  export class ComputeOperationFill extends $sdk.GCObject {
    ...
    static createFrom({input, value}: {input: string, value: any}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationFill {
      return new ComputeOperationFill($g.abi.libs_by_name.get(algebralib.name)!.mapped[7], input, value);
    }
  ...
  export class ComputeVarConst extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarConst {
      return new ComputeVarConst($g.abi.libs_by_name.get(algebralib.name)!.mapped[8], name, type, shape);
    }
  ...
  export class ComputeLayerClassification extends $sdk.GCObject {
    ...
    static createFrom({name, calculate_probabilities, from_logits}: {name: string, calculate_probabilities: boolean, from_logits: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerClassification {
      return new ComputeLayerClassification($g.abi.libs_by_name.get(algebralib.name)!.mapped[10], name, calculate_probabilities, from_logits);
    }
  ...
  export class ComputeLayerCall extends $sdk.GCObject {
    ...
    static createFrom({layer_name, bindings}: {layer_name: string, bindings: globalThis.Array<compute.ComputeBinding>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCall {
      return new ComputeLayerCall($g.abi.libs_by_name.get(algebralib.name)!.mapped[12], layer_name, bindings);
    }
  ...
  export class ComputeInitializerLeCunUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLeCunUniform {
      return new ComputeInitializerLeCunUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[13]);
    }
  ...
  export class ComputeOptimizerNesterov extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNesterov {
      return new ComputeOptimizerNesterov($g.abi.libs_by_name.get(algebralib.name)!.mapped[14], learning_rate, decay_rate);
    }
  ...
  export class ComputeOperationClip extends $sdk.GCObject {
    ...
    static createFrom({input, output, min, max}: {input: string, output: string, min: number | null, max: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationClip {
      return new ComputeOperationClip($g.abi.libs_by_name.get(algebralib.name)!.mapped[15], input, output, min, max);
    }
  ...
  export class ComputeOperationLog extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLog {
      return new ComputeOperationLog($g.abi.libs_by_name.get(algebralib.name)!.mapped[18], input, output);
    }
  ...
  export class ComputeOperationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha, max_value, threshold}: {input: string, output: string, alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeakyRelu {
      return new ComputeOperationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[19], input, output, alpha, max_value, threshold);
    }
  ...
  export class ComputeInitializerUniformIn extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformIn {
      return new ComputeInitializerUniformIn($g.abi.libs_by_name.get(algebralib.name)!.mapped[20]);
    }
  ...
  export class ComputeLayerMinMaxScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerMinMaxScaler {
      return new ComputeLayerMinMaxScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[21], name, type, inverse_transform);
    }
  ...
  export class ComputeOperationArgMin extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMin {
      return new ComputeOperationArgMin($g.abi.libs_by_name.get(algebralib.name)!.mapped[24], input, output, output2);
    }
  ...
  export class ComputeOperationCosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCosh {
      return new ComputeOperationCosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[25], input, output);
    }
  ...
  export class ComputeOperationAtan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtan {
      return new ComputeOperationAtan($g.abi.libs_by_name.get(algebralib.name)!.mapped[27], input, output);
    }
  ...
  export class ComputeModel extends $sdk.GCObject {
    ...
    static createFrom({layers}: {layers: globalThis.Array<compute.ComputeLayer>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeModel {
      return new ComputeModel($g.abi.libs_by_name.get(algebralib.name)!.mapped[29], layers);
    }
  ...
  export class ComputeOperationSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftmax {
      return new ComputeOperationSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[30], input, output);
    }
  ...
  export class ComputeVar extends $sdk.GCObject {
    ...
    static createFrom({name}: {name: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVar {
      return new ComputeVar($g.abi.libs_by_name.get(algebralib.name)!.mapped[31], name);
    }
  ...
  export class ComputeOperationTan extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTan {
      return new ComputeOperationTan($g.abi.libs_by_name.get(algebralib.name)!.mapped[32], input, output);
    }
  ...
  export class ComputeLayerDense extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, activation: compute.ComputeActivation | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerDense {
      return new ComputeLayerDense($g.abi.libs_by_name.get(algebralib.name)!.mapped[33], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer, activation);
    }
  ...
  export class ComputeOperationAcosh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcosh {
      return new ComputeOperationAcosh($g.abi.libs_by_name.get(algebralib.name)!.mapped[35], input, output);
    }
  ...
  export class ComputeOperationAvg extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAvg {
      return new ComputeOperationAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[39], input, input2, output);
    }
  ...
  export class ComputeVarOptimize extends $sdk.GCObject {
    ...
    static createFrom({name, type, shape, l1, l2, init}: {name: string, type: $sdk.std.core.TensorType, shape: globalThis.Array<bigint | number>, l1: number, l2: number, init: compute.ComputeInitializer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeVarOptimize {
      return new ComputeVarOptimize($g.abi.libs_by_name.get(algebralib.name)!.mapped[41], name, type, shape, l1, l2, init);
    }
  ...
  export class ComputeInitializerIdentity extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerIdentity {
      return new ComputeInitializerIdentity($g.abi.libs_by_name.get(algebralib.name)!.mapped[43]);
    }
  ...
  export class ComputeOperationTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationTanh {
      return new ComputeOperationTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[44], input, output);
    }
  ...
  export class ComputeOptimizerNadam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerNadam {
      return new ComputeOptimizerNadam($g.abi.libs_by_name.get(algebralib.name)!.mapped[45], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeLayerLinear extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLinear {
      return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[47], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
    }
    static create(name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, use_bias: boolean, weight_initializer: compute.ComputeInitializer | null, weight_regularizer: compute.ComputeRegularizer | null, bias_initializer: compute.ComputeInitializer | null, bias_regularizer: compute.ComputeRegularizer | null, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerLinear {
      return new ComputeLayerLinear($g.abi.libs_by_name.get(algebralib.name)!.mapped[47], name, type, inputs, outputs, use_bias, weight_initializer, weight_regularizer, bias_initializer, bias_regularizer);
    }
  ...
  export class ComputeActivationSigmoid extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSigmoid {
      return new ComputeActivationSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[48]);
    }
  ...
  export class ComputeActivationSoftSign extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftSign {
      return new ComputeActivationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[49]);
    }
  ...
  export class ComputeOperationSinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSinh {
      return new ComputeOperationSinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[52], input, output);
    }
  ...
  export class ComputeLayerFilter extends $sdk.GCObject {
    ...
    static createFrom({name, type, inputs, outputs, maskValues}: {name: string, type: $sdk.std.core.TensorType, inputs: bigint | number, outputs: bigint | number, maskValues: globalThis.Array<bigint | number>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerFilter {
      return new ComputeLayerFilter($g.abi.libs_by_name.get(algebralib.name)!.mapped[53], name, type, inputs, outputs, maskValues);
    }
  ...
  export class ComputeOperationScale extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationScale {
      return new ComputeOperationScale($g.abi.libs_by_name.get(algebralib.name)!.mapped[55], input, output, alpha);
    }
  ...
  export class ComputeLayerActivation extends $sdk.GCObject {
    ...
    static createFrom({name, activation}: {name: string, activation: compute.ComputeActivation}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerActivation {
      return new ComputeLayerActivation($g.abi.libs_by_name.get(algebralib.name)!.mapped[57], name, activation);
    }
  ...
  export class ComputeOperationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({input, output, slope, shift}: {input: string, output: string, slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationHardSigmoid {
      return new ComputeOperationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[58], input, output, slope, shift);
    }
  ...
  export class ComputeLayerPCAScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerPCAScaler {
      return new ComputeLayerPCAScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[59], name, type, inverse_transform);
    }
  ...
  export class ComputeOperationLogSoftmax extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLogSoftmax {
      return new ComputeOperationLogSoftmax($g.abi.libs_by_name.get(algebralib.name)!.mapped[60], input, output, axis);
    }
  ...
  export class ComputeOperationLeCunTanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationLeCunTanh {
      return new ComputeOperationLeCunTanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[61], input, output);
    }
  ...
  export class ComputeActivationSelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSelu {
      return new ComputeActivationSelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[62]);
    }
  ...
  export class ComputeInitializerNormal extends $sdk.GCObject {
    ...
    static createFrom({avg, std}: {avg: number, std: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormal {
      return new ComputeInitializerNormal($g.abi.libs_by_name.get(algebralib.name)!.mapped[64], avg, std);
    }
  ...
  export class ComputeInitializerUniform extends $sdk.GCObject {
    ...
    static createFrom({min, max}: {min: number, max: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniform {
      return new ComputeInitializerUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[65], min, max);
    }
  ...
  export class ComputeOperationEuclidean extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationEuclidean {
      return new ComputeOperationEuclidean($g.abi.libs_by_name.get(algebralib.name)!.mapped[67], input, input2, output);
    }
  ...
  export class ComputeOperationSum extends $sdk.GCObject {
    ...
    static createFrom({input, output, axis}: {input: string, output: string, axis: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSum {
      return new ComputeOperationSum($g.abi.libs_by_name.get(algebralib.name)!.mapped[69], input, output, axis);
    }
  ...
  export class ComputeInitializerUniformOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformOut {
      return new ComputeInitializerUniformOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[70]);
    }
  ...
  export class ComputeInitializerRelu extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerRelu {
      return new ComputeInitializerRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[72]);
    }
  ...
  export class ComputeActivationLeakyRelu extends $sdk.GCObject {
    ...
    static createFrom({alpha, max_value, threshold}: {alpha: number | null, max_value: number | null, threshold: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationLeakyRelu {
      return new ComputeActivationLeakyRelu($g.abi.libs_by_name.get(algebralib.name)!.mapped[74], alpha, max_value, threshold);
    }
  ...
  export class ComputeOperationAtanh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAtanh {
      return new ComputeOperationAtanh($g.abi.libs_by_name.get(algebralib.name)!.mapped[75], input, output);
    }
  ...
  export class ComputeOperationAsinh extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsinh {
      return new ComputeOperationAsinh($g.abi.libs_by_name.get(algebralib.name)!.mapped[79], input, output);
    }
  ...
  export class ComputeActivationHardSigmoid extends $sdk.GCObject {
    ...
    static createFrom({slope, shift}: {slope: number | null, shift: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationHardSigmoid {
      return new ComputeActivationHardSigmoid($g.abi.libs_by_name.get(algebralib.name)!.mapped[80], slope, shift);
    }
  ...
  export class ComputeRegularizer extends $sdk.GCObject {
    ...
    static createFrom({l1, l2}: {l1: number, l2: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeRegularizer {
      return new ComputeRegularizer($g.abi.libs_by_name.get(algebralib.name)!.mapped[83], l1, l2);
    }
  ...
  export class ComputeOptimizerMomentum extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate}: {learning_rate: number | null, decay_rate: number}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerMomentum {
      return new ComputeOptimizerMomentum($g.abi.libs_by_name.get(algebralib.name)!.mapped[84], learning_rate, decay_rate);
    }
  ...
  export class ComputeOptimizerRmsProp extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, decay_rate, smooth_epsilon}: {learning_rate: number | null, decay_rate: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerRmsProp {
      return new ComputeOptimizerRmsProp($g.abi.libs_by_name.get(algebralib.name)!.mapped[86], learning_rate, decay_rate, smooth_epsilon);
    }
  ...
  export class ComputeInitializerPytorch extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerPytorch {
      return new ComputeInitializerPytorch($g.abi.libs_by_name.get(algebralib.name)!.mapped[88]);
    }
  ...
  export class ComputeOperationAsin extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAsin {
      return new ComputeOperationAsin($g.abi.libs_by_name.get(algebralib.name)!.mapped[90], input, output);
    }
  ...
  export class ComputeOperationPow extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationPow {
      return new ComputeOperationPow($g.abi.libs_by_name.get(algebralib.name)!.mapped[91], input, input2, output);
    }
  ...
  export class ComputeInitializerNone extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNone {
      return new ComputeInitializerNone($g.abi.libs_by_name.get(algebralib.name)!.mapped[92]);
    }
  ...
  export class ComputeInitializerReluUniform extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerReluUniform {
      return new ComputeInitializerReluUniform($g.abi.libs_by_name.get(algebralib.name)!.mapped[93]);
    }
  ...
  export class ComputeActivationSoftplus extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeActivationSoftplus {
      return new ComputeActivationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[94]);
    }
  ...
  export class ComputeOperationSoftSign extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftSign {
      return new ComputeOperationSoftSign($g.abi.libs_by_name.get(algebralib.name)!.mapped[96], input, output);
    }
  ...
  export class ComputeLayerStandardScaler extends $sdk.GCObject {
    ...
    static createFrom({name, type, inverse_transform}: {name: string, type: $sdk.std.core.TensorType, inverse_transform: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerStandardScaler {
      return new ComputeLayerStandardScaler($g.abi.libs_by_name.get(algebralib.name)!.mapped[97], name, type, inverse_transform);
    }
  ...
  export class ComputeInitializerUniformAvg extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerUniformAvg {
      return new ComputeInitializerUniformAvg($g.abi.libs_by_name.get(algebralib.name)!.mapped[99]);
    }
  ...
  export class ComputeOperationElu extends $sdk.GCObject {
    ...
    static createFrom({input, output, alpha}: {input: string, output: string, alpha: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationElu {
      return new ComputeOperationElu($g.abi.libs_by_name.get(algebralib.name)!.mapped[100], input, output, alpha);
    }
  ...
  export class ComputeInitializerNormalOut extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerNormalOut {
      return new ComputeInitializerNormalOut($g.abi.libs_by_name.get(algebralib.name)!.mapped[102]);
    }
  ...
  export class ComputeOptimizerFtrl extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, lambda1, lambda2, beta}: {learning_rate: number | null, lambda1: number | null, lambda2: number | null, beta: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerFtrl {
      return new ComputeOptimizerFtrl($g.abi.libs_by_name.get(algebralib.name)!.mapped[104], learning_rate, lambda1, lambda2, beta);
    }
  ...
  export class ComputeLayerSeq extends $sdk.GCObject {
    ...
    static createFrom({name, calls, optimizer}: {name: string, calls: globalThis.Array<compute.ComputeLayerCall>, optimizer: compute.ComputeOptimizer | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerSeq {
      return new ComputeLayerSeq($g.abi.libs_by_name.get(algebralib.name)!.mapped[105], name, calls, optimizer);
    }
  ...
  export class ComputeInitializerLSTM extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): ComputeInitializerLSTM {
      return new ComputeInitializerLSTM($g.abi.libs_by_name.get(algebralib.name)!.mapped[106]);
    }
  ...
  export class ComputeLayerCustom extends $sdk.GCObject {
    ...
    static createFrom({name, ops, vars}: {name: string, ops: globalThis.Array<compute.ComputeOperation>, vars: globalThis.Array<compute.ComputeVariable>}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeLayerCustom {
      return new ComputeLayerCustom($g.abi.libs_by_name.get(algebralib.name)!.mapped[107], name, ops, vars);
    }
  ...
  export class ComputeOperationSoftplus extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSoftplus {
      return new ComputeOperationSoftplus($g.abi.libs_by_name.get(algebralib.name)!.mapped[110], input, output);
    }
  ...
  export class ComputeOperationSqrt extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSqrt {
      return new ComputeOperationSqrt($g.abi.libs_by_name.get(algebralib.name)!.mapped[111], input, output);
    }
  ...
  export class ComputeOperationExp extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationExp {
      return new ComputeOperationExp($g.abi.libs_by_name.get(algebralib.name)!.mapped[113], input, output);
    }
  ...
  export class ComputeOperationDiv extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationDiv {
      return new ComputeOperationDiv($g.abi.libs_by_name.get(algebralib.name)!.mapped[114], input, input2, output);
    }
  ...
  export class ComputeOperationMul extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationMul {
      return new ComputeOperationMul($g.abi.libs_by_name.get(algebralib.name)!.mapped[115], input, input2, output);
    }
  ...
  export class ComputeOptimizerAdaGrad extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, initial_accumulator, smooth_epsilon}: {learning_rate: number | null, initial_accumulator: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdaGrad {
      return new ComputeOptimizerAdaGrad($g.abi.libs_by_name.get(algebralib.name)!.mapped[116], learning_rate, initial_accumulator, smooth_epsilon);
    }
  ...
  export class ComputeOperationArgMax extends $sdk.GCObject {
    ...
    static createFrom({input, output, output2}: {input: string, output: string, output2: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationArgMax {
      return new ComputeOperationArgMax($g.abi.libs_by_name.get(algebralib.name)!.mapped[117], input, output, output2);
    }
  ...
  export class ComputeOperationCos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationCos {
      return new ComputeOperationCos($g.abi.libs_by_name.get(algebralib.name)!.mapped[118], input, output);
    }
  ...
  export class ComputeOptimizerAdam extends $sdk.GCObject {
    ...
    static createFrom({learning_rate, beta1, beta2, smooth_epsilon}: {learning_rate: number | null, beta1: number | null, beta2: number | null, smooth_epsilon: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOptimizerAdam {
      return new ComputeOptimizerAdam($g.abi.libs_by_name.get(algebralib.name)!.mapped[120], learning_rate, beta1, beta2, smooth_epsilon);
    }
  ...
  export class ComputeOperationSub extends $sdk.GCObject {
    ...
    static createFrom({input, input2, output}: {input: string, input2: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationSub {
      return new ComputeOperationSub($g.abi.libs_by_name.get(algebralib.name)!.mapped[121], input, input2, output);
    }
  ...
  export class ComputeOperationAcos extends $sdk.GCObject {
    ...
    static createFrom({input, output}: {input: string, output: string}, $g: $sdk.GreyCat = globalThis.greycat.default): ComputeOperationAcos {
      return new ComputeOperationAcos($g.abi.libs_by_name.get(algebralib.name)!.mapped[124], input, output);
    }
...
export const algebralib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[0] = abi.type_by_fqn.get(compute.ComputeOptimizer._type)!;
    this.mapped[0].resolveGeneratedOffsets('learning_rate');
    this.mapped[1] = abi.type_by_fqn.get(compute.ComputeActivationExp._type)!;
    this.mapped[2] = abi.type_by_fqn.get(compute.ComputeOptimizerSgd._type)!;
    this.mapped[2].resolveGeneratedOffsets('learning_rate');
    this.mapped[2].static_values = [0.01];
    this.mapped[3] = abi.type_by_fqn.get(compute.ComputeLayerLossClassification._type)!;
    this.mapped[3].resolveGeneratedOffsets('name','reduction','loss_type','has_class_weights','calculate_probabilities','from_logits');
    this.mapped[3].static_values = ["class_weights","predicted_classes","probabilities","sum_reduce"];
    ...
    this.mapped[5] = abi.type_by_fqn.get(compute.ComputeOperationRaiseToPower._type)!;
    this.mapped[5].resolveGeneratedOffsets('input','output','power');
    this.mapped[6] = abi.type_by_fqn.get(compute.ComputeVarInOut._type)!;
    this.mapped[6].resolveGeneratedOffsets('name','type','shape','with_grad');
    this.mapped[7] = abi.type_by_fqn.get(compute.ComputeOperationFill._type)!;
    this.mapped[7].resolveGeneratedOffsets('input','value');
    this.mapped[8] = abi.type_by_fqn.get(compute.ComputeVarConst._type)!;
    this.mapped[8].resolveGeneratedOffsets('name','type','shape');
    this.mapped[9] = abi.type_by_fqn.get(compute.ComputeLayer._type)!;
    this.mapped[9].resolveGeneratedOffsets('name');
    this.mapped[10] = abi.type_by_fqn.get(compute.ComputeLayerClassification._type)!;
    this.mapped[10].resolveGeneratedOffsets('name','calculate_probabilities','from_logits');
    this.mapped[10].static_values = ["input","predicted_classes","probabilities"];
    ...
    this.mapped[12] = abi.type_by_fqn.get(compute.ComputeLayerCall._type)!;
    this.mapped[12].resolveGeneratedOffsets('layer_name','bindings');
    this.mapped[13] = abi.type_by_fqn.get(compute.ComputeInitializerLeCunUniform._type)!;
    this.mapped[14] = abi.type_by_fqn.get(compute.ComputeOptimizerNesterov._type)!;
    this.mapped[14].resolveGeneratedOffsets('learning_rate','decay_rate');
    this.mapped[14].static_values = [0.001,0.9];
    this.mapped[15] = abi.type_by_fqn.get(compute.ComputeOperationClip._type)!;
    this.mapped[15].resolveGeneratedOffsets('input','output','min','max');
    this.mapped[16] = abi.type_by_fqn.get(compute.ComputeInitializerConstant._type)!;
    this.mapped[16].resolveGeneratedOffsets('value');
    this.mapped[17] = abi.type_by_fqn.get(compute.ComputeOperationAbs._type)!;
    this.mapped[17].resolveGeneratedOffsets('input','output');
    this.mapped[18] = abi.type_by_fqn.get(compute.ComputeOperationLog._type)!;
    this.mapped[18].resolveGeneratedOffsets('input','output');
    this.mapped[19] = abi.type_by_fqn.get(compute.ComputeOperationLeakyRelu._type)!;
    this.mapped[19].resolveGeneratedOffsets('input','output','alpha','max_value','threshold');
    this.mapped[19].static_values = [0.3,1.7976931349E308,0.0];
    this.mapped[20] = abi.type_by_fqn.get(compute.ComputeInitializerUniformIn._type)!;
    this.mapped[21] = abi.type_by_fqn.get(compute.ComputeLayerMinMaxScaler._type)!;
    this.mapped[21].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[21].static_values = ["input","output","min","max"];
    ...
    this.mapped[23].resolveGeneratedOffsets('input','output','output2');
    this.mapped[24] = abi.type_by_fqn.get(compute.ComputeOperationArgMin._type)!;
    this.mapped[24].resolveGeneratedOffsets('input','output','output2');
    this.mapped[25] = abi.type_by_fqn.get(compute.ComputeOperationCosh._type)!;
    this.mapped[25].resolveGeneratedOffsets('input','output');
    this.mapped[26] = abi.type_by_fqn.get(compute.ComputeOperation1In1Out._type)!;
    this.mapped[26].resolveGeneratedOffsets('input','output');
    this.mapped[27] = abi.type_by_fqn.get(compute.ComputeOperationAtan._type)!;
    this.mapped[27].resolveGeneratedOffsets('input','output');
    this.mapped[28] = abi.type_by_fqn.get(compute.ComputeRegressionLoss._type)!;
    this.mapped[28].resolveGeneratedOffsetWithValues('square', "Square",'abs', "Abs");
    this.mapped[29] = abi.type_by_fqn.get(compute.ComputeModel._type)!;
    this.mapped[29].resolveGeneratedOffsets('layers');
    this.mapped[30] = abi.type_by_fqn.get(compute.ComputeOperationSoftmax._type)!;
    this.mapped[30].resolveGeneratedOffsets('input','output');
    this.mapped[31] = abi.type_by_fqn.get(compute.ComputeVar._type)!;
    this.mapped[31].resolveGeneratedOffsets('name');
    this.mapped[32] = abi.type_by_fqn.get(compute.ComputeOperationTan._type)!;
    this.mapped[32].resolveGeneratedOffsets('input','output');
    this.mapped[33] = abi.type_by_fqn.get(compute.ComputeLayerDense._type)!;
    this.mapped[33].resolveGeneratedOffsets('name','type','inputs','outputs','use_bias','weight_initializer','weight_regularizer','bias_initializer','bias_regularizer','activation');
    this.mapped[33].static_values = ["input","output","weight","bias","mult","pre_activation"];
    this.mapped[34] = abi.type_by_fqn.get(compute.ComputeEngine._type)!;
    this.mapped[35] = abi.type_by_fqn.get(compute.ComputeOperationAcosh._type)!;
    this.mapped[35].resolveGeneratedOffsets('input','output');
    this.mapped[36] = abi.type_by_fqn.get(compute.ComputeState._type)!;
    ...
    this.mapped[38].resolveGeneratedOffsets('input','output','mask','nbOutputs');
    this.mapped[39] = abi.type_by_fqn.get(compute.ComputeOperationAvg._type)!;
    this.mapped[39].resolveGeneratedOffsets('input','input2','output');
    this.mapped[40] = abi.type_by_fqn.get(compute.ComputeInitializer._type)!;
    this.mapped[41] = abi.type_by_fqn.get(compute.ComputeVarOptimize._type)!;
    this.mapped[41].resolveGeneratedOffsets('name','type','shape','l1','l2','init');
    this.mapped[42] = abi.type_by_fqn.get(compute.ComputeOperationNeg._type)!;
    this.mapped[42].resolveGeneratedOffsets('input','output');
    this.mapped[43] = abi.type_by_fqn.get(compute.ComputeInitializerIdentity._type)!;
    this.mapped[44] = abi.type_by_fqn.get(compute.ComputeOperationTanh._type)!;
    this.mapped[44].resolveGeneratedOffsets('input','output');
    this.mapped[45] = abi.type_by_fqn.get(compute.ComputeOptimizerNadam._type)!;
    ...
    this.mapped[46].resolveGeneratedOffsets('input','output','alpha');
    this.mapped[46].static_values = [1.0];
    this.mapped[47] = abi.type_by_fqn.get(compute.ComputeLayerLinear._type)!;
    this.mapped[47].resolveGeneratedOffsets('name','type','inputs','outputs','use_bias','weight_initializer','weight_regularizer','bias_initializer','bias_regularizer');
    this.mapped[47].static_values = ["input","output","weight","bias","mult"];
    this.mapped[48] = abi.type_by_fqn.get(compute.ComputeActivationSigmoid._type)!;
    this.mapped[49] = abi.type_by_fqn.get(compute.ComputeActivationSoftSign._type)!;
    ...
    this.mapped[51].resolveGeneratedOffsets('name','bias_initializer','weight_regularizer','bias_regularizer','type','use_bias','return_sequences','bidirectional','auto_init_states','inputs','outputs','layers','sequences');
    this.mapped[51].static_values = ["input","output","hx","cx","hy","cy","weight","bias","internal_i","internal_f","internal_cp","internal_o","internal_h","internal_c","internal_mult","internal_output"];
    this.mapped[52] = abi.type_by_fqn.get(compute.ComputeOperationSinh._type)!;
    this.mapped[52].resolveGeneratedOffsets('input','output');
    this.mapped[53] = abi.type_by_fqn.get(compute.ComputeLayerFilter._type)!;
    this.mapped[53].resolveGeneratedOffsets('name','type','inputs','outputs','maskValues');
    this.mapped[53].static_values = ["input","output","mask"];
    this.mapped[54] = abi.type_by_fqn.get(compute.ComputeInitializerGlorotUniform._type)!;
    this.mapped[55] = abi.type_by_fqn.get(compute.ComputeOperationScale._type)!;
    ...
    this.mapped[57] = abi.type_by_fqn.get(compute.ComputeLayerActivation._type)!;
    this.mapped[57].resolveGeneratedOffsets('name','activation');
    this.mapped[57].static_values = ["input","output"];
    this.mapped[58] = abi.type_by_fqn.get(compute.ComputeOperationHardSigmoid._type)!;
    this.mapped[58].resolveGeneratedOffsets('input','output','slope','shift');
    this.mapped[58].static_values = [0.2,0.5];
    this.mapped[59] = abi.type_by_fqn.get(compute.ComputeLayerPCAScaler._type)!;
    this.mapped[59].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[59].static_values = ["input","output","avg","std","space"];
    this.mapped[60] = abi.type_by_fqn.get(compute.ComputeOperationLogSoftmax._type)!;
    this.mapped[60].resolveGeneratedOffsets('input','output','axis');
    this.mapped[61] = abi.type_by_fqn.get(compute.ComputeOperationLeCunTanh._type)!;
    this.mapped[61].resolveGeneratedOffsets('input','output');
    this.mapped[62] = abi.type_by_fqn.get(compute.ComputeActivationSelu._type)!;
    this.mapped[63] = abi.type_by_fqn.get(compute.ComputeVariable._type)!;
    this.mapped[63].resolveGeneratedOffsets('name');
    this.mapped[64] = abi.type_by_fqn.get(compute.ComputeInitializerNormal._type)!;
    this.mapped[64].resolveGeneratedOffsets('avg','std');
    this.mapped[65] = abi.type_by_fqn.get(compute.ComputeInitializerUniform._type)!;
    this.mapped[65].resolveGeneratedOffsets('min','max');
    ...
    this.mapped[67] = abi.type_by_fqn.get(compute.ComputeOperationEuclidean._type)!;
    ...
    this.mapped[69] = abi.type_by_fqn.get(compute.ComputeOperationSum._type)!;
    this.mapped[69].resolveGeneratedOffsets('input','output','axis');
    this.mapped[70] = abi.type_by_fqn.get(compute.ComputeInitializerUniformOut._type)!;
    this.mapped[71] = abi.type_by_fqn.get(compute.ComputeLayerLossRegression._type)!;
    this.mapped[71].resolveGeneratedOffsets('name','reduction','loss_type');
    this.mapped[72] = abi.type_by_fqn.get(compute.ComputeInitializerRelu._type)!;
    this.mapped[73] = abi.type_by_fqn.get(compute.ComputeInitializerNormalIn._type)!;
    this.mapped[74] = abi.type_by_fqn.get(compute.ComputeActivationLeakyRelu._type)!;
    this.mapped[74].resolveGeneratedOffsets('alpha','max_value','threshold');
    this.mapped[74].static_values = [0.3,0.0];
    this.mapped[75] = abi.type_by_fqn.get(compute.ComputeOperationAtanh._type)!;
    ...
    this.mapped[76].resolveGeneratedOffsets('input','ifCondition','output','counts','classes');
    this.mapped[77] = abi.type_by_fqn.get(compute.ComputeOperation._type)!;
    this.mapped[78] = abi.type_by_fqn.get(compute.ComputeClassificationLoss._type)!;
    this.mapped[78].resolveGeneratedOffsetWithValues('categorical_cross_entropy', "Categorical Cross Entropy",'sparse_categorical_cross_entropy', "Sparse Categorical Cross Entropy");
    this.mapped[79] = abi.type_by_fqn.get(compute.ComputeOperationAsinh._type)!;
    this.mapped[79].resolveGeneratedOffsets('input','output');
    this.mapped[80] = abi.type_by_fqn.get(compute.ComputeActivationHardSigmoid._type)!;
    this.mapped[80].resolveGeneratedOffsets('slope','shift');
    this.mapped[80].static_values = [0.2,0.5];
    ...
    this.mapped[82].resolveGeneratedOffsets('learning_rate','decay_rate','smooth_epsilon');
    this.mapped[82].static_values = [0.001,0.95,0.0000001];
    this.mapped[83] = abi.type_by_fqn.get(compute.ComputeRegularizer._type)!;
    this.mapped[83].resolveGeneratedOffsets('l1','l2');
    this.mapped[84] = abi.type_by_fqn.get(compute.ComputeOptimizerMomentum._type)!;
    this.mapped[84].resolveGeneratedOffsets('learning_rate','decay_rate');
    this.mapped[84].static_values = [0.001,0.9];
    this.mapped[85] = abi.type_by_fqn.get(compute.ComputeActivationRelu._type)!;
    this.mapped[85].resolveGeneratedOffsets('max_value','threshold');
    this.mapped[85].static_values = [0.0];
    this.mapped[86] = abi.type_by_fqn.get(compute.ComputeOptimizerRmsProp._type)!;
    this.mapped[86].resolveGeneratedOffsets('learning_rate','decay_rate','smooth_epsilon');
    this.mapped[86].static_values = [0.001,0.9,0.0000001];
    this.mapped[87] = abi.type_by_fqn.get(compute.ComputeOperationSign._type)!;
    this.mapped[87].resolveGeneratedOffsets('input','output');
    this.mapped[88] = abi.type_by_fqn.get(compute.ComputeInitializerPytorch._type)!;
    this.mapped[89] = abi.type_by_fqn.get(compute.ComputeOperation2In1Out._type)!;
    this.mapped[89].resolveGeneratedOffsets('input','input2','output');
    this.mapped[90] = abi.type_by_fqn.get(compute.ComputeOperationAsin._type)!;
    this.mapped[90].resolveGeneratedOffsets('input','output');
    this.mapped[91] = abi.type_by_fqn.get(compute.ComputeOperationPow._type)!;
    this.mapped[91].resolveGeneratedOffsets('input','input2','output');
    this.mapped[92] = abi.type_by_fqn.get(compute.ComputeInitializerNone._type)!;
    this.mapped[93] = abi.type_by_fqn.get(compute.ComputeInitializerReluUniform._type)!;
    this.mapped[94] = abi.type_by_fqn.get(compute.ComputeActivationSoftplus._type)!;
    this.mapped[95] = abi.type_by_fqn.get(compute.ComputeActivation._type)!;
    this.mapped[96] = abi.type_by_fqn.get(compute.ComputeOperationSoftSign._type)!;
    this.mapped[96].resolveGeneratedOffsets('input','output');
    this.mapped[97] = abi.type_by_fqn.get(compute.ComputeLayerStandardScaler._type)!;
    this.mapped[97].resolveGeneratedOffsets('name','type','inverse_transform');
    this.mapped[97].static_values = ["input","output","avg","std"];
    this.mapped[98] = abi.type_by_fqn.get(compute.ComputeLayerLoss._type)!;
    this.mapped[98].resolveGeneratedOffsets('name','reduction');
    this.mapped[98].static_values = ["computed","expected","loss"];
    this.mapped[99] = abi.type_by_fqn.get(compute.ComputeInitializerUniformAvg._type)!;
    this.mapped[100] = abi.type_by_fqn.get(compute.ComputeOperationElu._type)!;
    this.mapped[100].resolveGeneratedOffsets('input','output','alpha');
    this.mapped[100].static_values = [1.0];
    ...
    this.mapped[102] = abi.type_by_fqn.get(compute.ComputeInitializerNormalOut._type)!;
    this.mapped[103] = abi.type_by_fqn.get(compute.ComputeActivationTanh._type)!;
    this.mapped[104] = abi.type_by_fqn.get(compute.ComputeOptimizerFtrl._type)!;
    this.mapped[104].resolveGeneratedOffsets('learning_rate','lambda1','lambda2','beta');
    this.mapped[104].static_values = [0.001,0.0,0.0,0.0];
    this.mapped[105] = abi.type_by_fqn.get(compute.ComputeLayerSeq._type)!;
    this.mapped[105].resolveGeneratedOffsets('name','calls','optimizer');
    this.mapped[106] = abi.type_by_fqn.get(compute.ComputeInitializerLSTM._type)!;
    this.mapped[107] = abi.type_by_fqn.get(compute.ComputeLayerCustom._type)!;
    this.mapped[107].resolveGeneratedOffsets('name','ops','vars');
    ...
    this.mapped[110] = abi.type_by_fqn.get(compute.ComputeOperationSoftplus._type)!;
    this.mapped[110].resolveGeneratedOffsets('input','output');
    this.mapped[111] = abi.type_by_fqn.get(compute.ComputeOperationSqrt._type)!;
    ...
    this.mapped[113] = abi.type_by_fqn.get(compute.ComputeOperationExp._type)!;
    this.mapped[113].resolveGeneratedOffsets('input','output');
    this.mapped[114] = abi.type_by_fqn.get(compute.ComputeOperationDiv._type)!;
    this.mapped[114].resolveGeneratedOffsets('input','input2','output');
    this.mapped[115] = abi.type_by_fqn.get(compute.ComputeOperationMul._type)!;
    this.mapped[115].resolveGeneratedOffsets('input','input2','output');
    this.mapped[116] = abi.type_by_fqn.get(compute.ComputeOptimizerAdaGrad._type)!;
    this.mapped[116].resolveGeneratedOffsets('learning_rate','initial_accumulator','smooth_epsilon');
    this.mapped[116].static_values = [0.001,0.1,0.0000001];
    this.mapped[117] = abi.type_by_fqn.get(compute.ComputeOperationArgMax._type)!;
    this.mapped[117].resolveGeneratedOffsets('input','output','output2');
    this.mapped[118] = abi.type_by_fqn.get(compute.ComputeOperationCos._type)!;
    ...
    this.mapped[119].resolveGeneratedOffsets('input','input2','output','transposeA','transposeB','alpha','beta');
    this.mapped[119].static_values = [false,1.0,0.0];
    this.mapped[120] = abi.type_by_fqn.get(compute.ComputeOptimizerAdam._type)!;
    ...
    this.mapped[121] = abi.type_by_fqn.get(compute.ComputeOperationSub._type)!;
    ...
    this.mapped[124] = abi.type_by_fqn.get(compute.ComputeOperationAcos._type)!;
    ...
    this.mapped[127].resolveGeneratedOffsets('src_layer_name','src_var_name','target_var_name');
    ...
    this.mapped[129] = abi.type_by_fqn.get(nn.ComputeLayerTypes._type)!;
    this.mapped[129].resolveGeneratedOffsetWithValues('linear', "Linear",'dense', "Dense",'activation', "Activation",'lstm', "LSTM",'loss', "Loss",'filter', "Filter");
    this.mapped[130] = abi.type_by_fqn.get(nn.PostProcessType._type)!;
    this.mapped[130].resolveGeneratedOffsetWithValues('none', "None",'min_max_scaling', "Min/Max Scaling",'standard_scaling', "Standard Scaling");
    ...
    this.mapped[135].resolveGeneratedOffsets('inputs','inputs_gradients','outputs','fixed_batch_size','inputs_sequences','outputs_sequences','tensor_type','seed','randomizeSeed','layers','preProcessType','preProcessObject','postProcessType','postProcessObject','optimizer','lossLayer','_lastLayer','_lastOutput');
    ...
    this.mapped[138].resolveGeneratedOffsets('inputs','inputs_gradients','outputs','fixed_batch_size','inputs_sequences','outputs_sequences','tensor_type','seed','randomizeSeed','layers','preProcessType','preProcessObject','postProcessType','postProcessObject','optimizer','lossLayer','_lastLayer','_lastOutput','calculate_probabilities','has_class_weights','from_logits');
    ...
    this.mapped[140].static_values = ["Inputs or outputs can't be negative","Last layer has different number of outputs than declared","Incompatible loss function","Some NN layers are not currently supported","Tensor Type not currently supported","NN should contain at least 1 layer","layer placeholders","layer classification","layer preprocess","layer postprocess learn","layer main","layer loss learn","layer loss display","layer postprocess display","seq predict","seq learn","seq loss display","seq encode","seq decode","var input","var enc input","var targets","var Classifier classes","var Classifier probabilities","var Classifier class weights","var input avg","var input min","var input max","var input std","var input space","var output avg","var output min","var output max","var output std"];
