...
export namespace core {
  ...
  export class Error extends $greycat.GCObject {
    ...
    static createFrom({message = null, stack}: {message?: string | null, stack: globalThis.Array<core.ErrorFrame>}, $g: $greycat.GreyCat = $greycat.$.default): Error {
      return new Error($g.abi.libs_by_name.get(stdlib.name)!.mapped[4], message, stack);
    }
  ...
  export class nodeList_info_args extends $greycat.GCObject {
    nodes!: globalThis.Array<core.nodeList>;
    static create(nodes: globalThis.Array<core.nodeList>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeList_info_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[6], nodes);
    }
  }

  export class nodeList_sample_args extends $greycat.GCObject {
    ...
    static create(refs: globalThis.Array<core.nodeList>, from: number | bigint | null, to: number | bigint | null, maxRows: number | bigint, mode: core.SamplingMode, maxDephasing: number | bigint | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeList_sample_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[7], refs, from, to, maxRows, mode, maxDephasing);
    }
  }
  ...
  export class nodeGeo_info_args extends $greycat.GCObject {
    nodes!: globalThis.Array<core.nodeGeo>;
    static create(nodes: globalThis.Array<core.nodeGeo>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeGeo_info_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[9], nodes);
    }
  }

  export class nodeGeo_sample_args extends $greycat.GCObject {
    refs!: globalThis.Array<core.nodeGeo>;
    from!: core.geo | null;
    to!: core.geo | null;
    maxRows!: number | bigint;
    mode!: core.SamplingMode;
    static create(refs: globalThis.Array<core.nodeGeo>, from: core.geo | null, to: core.geo | null, maxRows: number | bigint, mode: core.SamplingMode, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeGeo_sample_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[10], refs, from, to, maxRows, mode);
    }
  }
  ...
  export class Table_applyMappings_args extends $greycat.GCObject {
    table!: core.Table;
    mappings!: globalThis.Array<core.TableColumnMapping>;
    static create(table: core.Table, mappings: globalThis.Array<core.TableColumnMapping>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Table_applyMappings_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[17], table, mappings);
    }
  }
  ...
  export class Date_fromTime_args extends $greycat.GCObject {
    time!: core.time;
    tz!: core.TimeZone | null;
    static create(time: core.time, tz: core.TimeZone | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Date_fromTime_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[19], time, tz);
    }
  }
  ...
  export class node_resolve_all_args extends $greycat.GCObject {
    n!: globalThis.Array<core.node | null>;
    static create(n: globalThis.Array<core.node | null>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new node_resolve_all_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[23], n);
    }
  }
  ...
  export class GeoCircle extends $greycat.GCObject {
    ...
    static createFrom({center, radius}: {center: core.geo, radius: number}, $g: $greycat.GreyCat = $greycat.$.default): GeoCircle {
      return new GeoCircle($g.abi.libs_by_name.get(stdlib.name)!.mapped[24], center, radius);
    }
  ...
  export class GeoPoly extends $greycat.GCObject {
    ...
    static createFrom({points}: {points: globalThis.Array<core.geo>}, $g: $greycat.GreyCat = $greycat.$.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[26], points);
    }
  ...
  export class MathConstants extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): MathConstants {
      return new MathConstants($g.abi.libs_by_name.get(stdlib.name)!.mapped[27]);
    }
  ...
  export class nodeTimeSingleton extends $greycat.GCObject {
    ...
    static createFrom({t, v}: {t: core.time, v: any}, $g: $greycat.GreyCat = $greycat.$.default): nodeTimeSingleton {
      return new nodeTimeSingleton($g.abi.libs_by_name.get(stdlib.name)!.mapped[29], t, v);
    }
  ...
  export class NodeInfo<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({size, from = null, to = null}: {size: number | bigint, from?: any | null, to?: any | null}, $g: $greycat.GreyCat = $greycat.$.default): NodeInfo {
      return new NodeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[31], size, from, to);
    }
  ...
  export class nodeTime_info_args extends $greycat.GCObject {
    nodes!: globalThis.Array<core.nodeTime>;
    static create(nodes: globalThis.Array<core.nodeTime>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeTime_info_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[35], nodes);
    }
  }

  export class nodeTime_sample_args extends $greycat.GCObject {
    ...
    tz!: core.TimeZone | null;
    static create(refs: globalThis.Array<core.nodeTime>, from: core.time | null, to: core.time | null, maxRows: number | bigint, mode: core.SamplingMode, maxDephasing: core.duration | null, tz: core.TimeZone | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeTime_sample_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[36], refs, from, to, maxRows, mode, maxDephasing, tz);
    }
  }
  ...
  export class Tuple<T = any, U = any> extends $greycat.GCObject {
    ...
    static createFrom<T, U>({x = null, y = null}: {x?: any | null, y?: any | null}, $g: $greycat.GreyCat = $greycat.$.default): Tuple {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[44], x, y);
    }
    static create<T, U>(x: any | null = null, y: any | null = null, $g: $greycat.GreyCat = $greycat.$.default): Tuple<T, U> {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[44], x, y);
    }
  }
  ...
  export class SortOrder extends $greycat.GCEnum {
    ...
    static asc($g: $greycat.GreyCat = $greycat.$.default): SortOrder {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[55];
  ...
  export class nodeIndex_info_args extends $greycat.GCObject {
    nodes!: globalThis.Array<core.nodeIndex>;
    static create(nodes: globalThis.Array<core.nodeIndex>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeIndex_info_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[57], nodes);
    }
  }

  export class nodeIndex_sample_args extends $greycat.GCObject {
    refs!: globalThis.Array<core.nodeIndex>;
    from!: any | null;
    maxRows!: number | bigint;
    mode!: core.SamplingMode;
    static create(refs: globalThis.Array<core.nodeIndex>, from: any | null, maxRows: number | bigint, mode: core.SamplingMode, $g: $greycat.GreyCat = $greycat.$.default) {
      return new nodeIndex_sample_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[58], refs, from, maxRows, mode);
    }
  }
...
export namespace runtime {
  export class User extends $greycat.GCObject {
    ...
    static createFrom({id, name, activated, full_name = null, email = null, role = null, permissions_flags = null, groups = null, groups_flags = null, external}: {id: number | bigint, name: string, activated: boolean, full_name?: string | null, email?: string | null, role?: string | null, permissions_flags?: number | bigint | null, groups?: globalThis.Array<runtime.UserGroupPolicy> | null, groups_flags?: number | bigint | null, external: boolean}, $g: $greycat.GreyCat = $greycat.$.default): User {
      return new User($g.abi.libs_by_name.get(stdlib.name)!.mapped[60], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
    }
  ...
  export class User_getToken_args extends $greycat.GCObject {
    id!: number | bigint;
    static create(id: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new User_getToken_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[61], id);
    }
  }

  export class User_setPassword_args extends $greycat.GCObject {
    name!: string;
    pass!: string;
    static create(name: string, pass: string, $g: $greycat.GreyCat = $greycat.$.default) {
      return new User_setPassword_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[62], name, pass);
    }
  }

  export class User_renew_args extends $greycat.GCObject {
    use_cookie!: boolean;
    static create(use_cookie: boolean, $g: $greycat.GreyCat = $greycat.$.default) {
      return new User_renew_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[66], use_cookie);
    }
  }

  export class User_tokenLogin_args extends $greycat.GCObject {
    token!: string;
    use_cookie!: boolean;
    static create(token: string, use_cookie: boolean, $g: $greycat.GreyCat = $greycat.$.default) {
      return new User_tokenLogin_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[68], token, use_cookie);
    }
  }

  export class User_login_args extends $greycat.GCObject {
    credentials!: string;
    use_cookie!: boolean;
    static create(credentials: string, use_cookie: boolean, $g: $greycat.GreyCat = $greycat.$.default) {
      return new User_login_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], credentials, use_cookie);
    }
  }
  ...
  export class System extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): System {
      return new System($g.abi.libs_by_name.get(stdlib.name)!.mapped[71]);
    }
  ...
  export class OpenIDConnect extends $greycat.GCObject {
    ...
    static createFrom({url, clientId}: {url: string, clientId: string}, $g: $greycat.GreyCat = $greycat.$.default): OpenIDConnect {
      return new OpenIDConnect($g.abi.libs_by_name.get(stdlib.name)!.mapped[73], url, clientId);
    }
  ...
  export class License extends $greycat.GCObject {
    ...
    static createFrom({name = null, start, end, company = null, max_memory, extra_1 = null, extra_2 = null, type = null}: {name?: string | null, start: core.time, end: core.time, company?: string | null, max_memory: number | bigint, extra_1?: number | bigint | null, extra_2?: number | bigint | null, type?: runtime.LicenseType | null}, $g: $greycat.GreyCat = $greycat.$.default): License {
      return new License($g.abi.libs_by_name.get(stdlib.name)!.mapped[75], name, start, end, company, max_memory, extra_1, extra_2, type);
    }
  ...
  export class Task extends $greycat.GCObject {
    ...
    static createFrom({user_id, task_id, mod = null, type = null, fun = null, creation, start = null, duration = null, status, progress = null}: {user_id: number | bigint, task_id: number | bigint, mod?: string | null, type?: string | null, fun?: string | null, creation: core.time, start?: core.time | null, duration?: core.duration | null, status: runtime.TaskStatus, progress?: number | null}, $g: $greycat.GreyCat = $greycat.$.default): Task {
      return new Task($g.abi.libs_by_name.get(stdlib.name)!.mapped[76], user_id, task_id, mod, type, fun, creation, start, duration, status, progress);
    }
  ...
  export class Task_is_running_args extends $greycat.GCObject {
    task_id!: number | bigint;
    static create(task_id: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Task_is_running_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[77], task_id);
    }
  }

  export class Task_cancel_args extends $greycat.GCObject {
    task_id!: number | bigint;
    static create(task_id: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Task_cancel_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[78], task_id);
    }
  }

  export class Task_history_args extends $greycat.GCObject {
    offset!: number | bigint;
    max!: number | bigint;
    static create(offset: number | bigint, max: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Task_history_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[79], offset, max);
    }
  }
  ...
  export class UserGroupPolicy extends $greycat.GCObject {
    ...
    static createFrom({group_id, type}: {group_id: number | bigint, type: runtime.UserGroupPolicyType}, $g: $greycat.GreyCat = $greycat.$.default): UserGroupPolicy {
      return new UserGroupPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[81], group_id, type);
    }
  ...
  export class PeriodicTask extends $greycat.GCObject {
    ...
    static createFrom({function_ = null, user_id, arguments_ = null, start, every}: {function_?: core.function_ | null, user_id: number | bigint, arguments_?: globalThis.Array<any | null> | null, start: core.time, every: core.duration}, $g: $greycat.GreyCat = $greycat.$.default): PeriodicTask {
      return new PeriodicTask($g.abi.libs_by_name.get(stdlib.name)!.mapped[82], function_, user_id, arguments_, start, every);
    }
  ...
  export class PeriodicTask_set_args extends $greycat.GCObject {
    tasks!: globalThis.Array<runtime.PeriodicTask>;
    static create(tasks: globalThis.Array<runtime.PeriodicTask>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new PeriodicTask_set_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[83], tasks);
    }
  }
  ...
  export class Debug_info_args extends $greycat.GCObject {
    worker!: number | bigint;
    static create(worker: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Debug_info_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[86], worker);
    }
  }

  export class Debug_resume_args extends $greycat.GCObject {
    worker!: number | bigint;
    static create(worker: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Debug_resume_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[87], worker);
    }
  }

  export class Debug_pause_args extends $greycat.GCObject {
    worker!: number | bigint;
    static create(worker: number | bigint, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Debug_pause_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[88], worker);
    }
  }

  export class Debug_remove_args extends $greycat.GCObject {
    bps!: globalThis.Array<runtime.DebugBreakpoint>;
    static create(bps: globalThis.Array<runtime.DebugBreakpoint>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Debug_remove_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[90], bps);
    }
  }

  export class Debug_add_args extends $greycat.GCObject {
    bps!: globalThis.Array<runtime.DebugBreakpoint>;
    static create(bps: globalThis.Array<runtime.DebugBreakpoint>, $g: $greycat.GreyCat = $greycat.$.default) {
      return new Debug_add_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[91], bps);
    }
  }
  ...
  export class SecurityPolicy extends $greycat.GCObject {
    ...
    static createFrom({entities = null, credentials = null, roles = null, fields = null, keys = null, keys_last_refresh = null}: {entities?: globalThis.Array<runtime.SecurityEntity> | null, credentials?: globalThis.Map<string, runtime.UserCredential> | null, roles?: globalThis.Map<string, runtime.UserRole> | null, fields?: runtime.SecurityFields | null, keys?: globalThis.Map<string, string> | null, keys_last_refresh?: core.time | null}, $g: $greycat.GreyCat = $greycat.$.default): SecurityPolicy {
      return new SecurityPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[92], entities, credentials, roles, fields, keys, keys_last_refresh);
    }
  ...
  export class UserCredential extends $greycat.GCObject {
    ...
    static createFrom({offset, pass = null}: {offset: number | bigint, pass?: string | null}, $g: $greycat.GreyCat = $greycat.$.default): UserCredential {
      return new UserCredential($g.abi.libs_by_name.get(stdlib.name)!.mapped[95], offset, pass);
    }
  ...
  export class Runtime extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Runtime {
      return new Runtime($g.abi.libs_by_name.get(stdlib.name)!.mapped[96]);
    }
  ...
  export class Job<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({function_, arguments_ = null}: {function_: core.function_, arguments_?: globalThis.Array<any | null> | null}, $g: $greycat.GreyCat = $greycat.$.default): Job {
      return new Job($g.abi.libs_by_name.get(stdlib.name)!.mapped[100], function_, arguments_);
    }
  ...
  export class DebugVariable extends $greycat.GCObject {
    ...
    static createFrom({name = null, value = null}: {name?: string | null, value?: any | null}, $g: $greycat.GreyCat = $greycat.$.default): DebugVariable {
      return new DebugVariable($g.abi.libs_by_name.get(stdlib.name)!.mapped[101], name, value);
    }
  ...
  export class DebugInfo extends $greycat.GCObject {
    ...
    static createFrom({scopes, root}: {scopes: globalThis.Array<runtime.DebugFrame>, root: any}, $g: $greycat.GreyCat = $greycat.$.default): DebugInfo {
      return new DebugInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[102], scopes, root);
    }
  ...
  export class RuntimeInfo extends $greycat.GCObject {
    ...
    static createFrom({version, program_version = null, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats = null}: {version: string, program_version?: string | null, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: number | bigint, bg_threads: number | bigint, fg_threads: number | bigint, mem_total: number | bigint, mem_worker: number | bigint, nb_ctx: number | bigint, store_stats?: runtime.StoreStat | null}, $g: $greycat.GreyCat = $greycat.$.default): RuntimeInfo {
      return new RuntimeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[103], version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
    }
  ...
  export class DebugBreakpoint extends $greycat.GCObject {
    ...
    static createFrom({module, line, column}: {module: string, line: number | bigint, column: number | bigint}, $g: $greycat.GreyCat = $greycat.$.default): DebugBreakpoint {
      return new DebugBreakpoint($g.abi.libs_by_name.get(stdlib.name)!.mapped[104], module, line, column);
    }
  ...
  export class StoreStat extends $greycat.GCObject {
    ...
    static createFrom({capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio}: {capacity_bytes: number | bigint, allocated_bytes: number | bigint, allocated_ratio: number, remained_bytes: number | bigint, remained_ratio: number, used_bytes: number | bigint, used_ratio: number, available_bytes: number | bigint, available_ratio: number}, $g: $greycat.GreyCat = $greycat.$.default): StoreStat {
      return new StoreStat($g.abi.libs_by_name.get(stdlib.name)!.mapped[105], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
    }
  ...
  export class SecurityFields extends $greycat.GCObject {
    ...
    static createFrom({email = null, name = null, first_name = null, last_name = null, roles = null, groups = null}: {email?: string | null, name?: string | null, first_name?: string | null, last_name?: string | null, roles?: globalThis.Map<string, string> | null, groups?: globalThis.Map<string, string> | null}, $g: $greycat.GreyCat = $greycat.$.default): SecurityFields {
      return new SecurityFields($g.abi.libs_by_name.get(stdlib.name)!.mapped[106], email, name, first_name, last_name, roles, groups);
    }
  ...
  export class SecurityFields_set_args extends $greycat.GCObject {
    f!: runtime.SecurityFields;
    static create(f: runtime.SecurityFields, $g: $greycat.GreyCat = $greycat.$.default) {
      return new SecurityFields_set_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[108], f);
    }
  }
  ...
  export class CallPerf extends $greycat.GCObject {
    ...
    static createFrom({duration, bytes_write_disk, bytes_write_disk_raw, bytes_read_disk, bytes_read_disk_raw, bytes_read_cache}: {duration: core.duration, bytes_write_disk: number | bigint, bytes_write_disk_raw: number | bigint, bytes_read_disk: number | bigint, bytes_read_disk_raw: number | bigint, bytes_read_cache: number | bigint}, $g: $greycat.GreyCat = $greycat.$.default): CallPerf {
      return new CallPerf($g.abi.libs_by_name.get(stdlib.name)!.mapped[109], duration, bytes_write_disk, bytes_write_disk_raw, bytes_read_disk, bytes_read_disk_raw, bytes_read_cache);
    }
  ...
  export class UserRole extends $greycat.GCObject {
    ...
    static createFrom({name, permissions}: {name: string, permissions: globalThis.Array<string>}, $g: $greycat.GreyCat = $greycat.$.default): UserRole {
      return new UserRole($g.abi.libs_by_name.get(stdlib.name)!.mapped[111], name, permissions);
    }
  ...
  export class UserRole_set_args extends $greycat.GCObject {
    value!: runtime.UserRole;
    static create(value: runtime.UserRole, $g: $greycat.GreyCat = $greycat.$.default) {
      return new UserRole_set_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[112], value);
    }
  }

  export class UserRole_remove_args extends $greycat.GCObject {
    name!: string;
    static create(name: string, $g: $greycat.GreyCat = $greycat.$.default) {
      return new UserRole_remove_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[113], name);
    }
  }
  ...
  export class UserGroup extends $greycat.GCObject {
    ...
    static createFrom({id, name, activated}: {id: number | bigint, name: string, activated: boolean}, $g: $greycat.GreyCat = $greycat.$.default): UserGroup {
      return new UserGroup($g.abi.libs_by_name.get(stdlib.name)!.mapped[115], id, name, activated);
    }
  ...
  export class DebugFrame extends $greycat.GCObject {
    ...
    static createFrom({module = null, function_ = null, line, column, scope}: {module?: string | null, function_?: core.function_ | null, line: number | bigint, column: number | bigint, scope: globalThis.Array<runtime.DebugVariable>}, $g: $greycat.GreyCat = $greycat.$.default): DebugFrame {
      return new DebugFrame($g.abi.libs_by_name.get(stdlib.name)!.mapped[116], module, function_, line, column, scope);
    }
  ...
  export class SecurityEntity_set_args extends $greycat.GCObject {
    entity!: runtime.SecurityEntity;
    static create(entity: runtime.SecurityEntity, $g: $greycat.GreyCat = $greycat.$.default) {
      return new SecurityEntity_set_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[118], entity);
    }
  }
  ...
  export class Log extends $greycat.GCObject {
    ...
    static createFrom({level, time, user_id = null, id = null, id2 = null, src = null, tag = null, data = null}: {level: runtime.LogLevel, time: core.time, user_id?: number | bigint | null, id?: number | bigint | null, id2?: number | bigint | null, src?: string | null, tag?: string | null, data?: any | null}, $g: $greycat.GreyCat = $greycat.$.default): Log {
      return new Log($g.abi.libs_by_name.get(stdlib.name)!.mapped[120], level, time, user_id, id, id2, src, tag, data);
    }
...
export namespace io {
  export class JsonReader<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, pos = null}: {path: string, pos?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): JsonReader {
      return new JsonReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[121], path, pos);
    }
  ...
  export class CsvColumnIgnored extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnIgnored {
      return new CsvColumnIgnored($g.abi.libs_by_name.get(stdlib.name)!.mapped[122], name, mandatory, offset);
    }
  ...
  export class Json<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>($g: $greycat.GreyCat = $greycat.$.default): Json {
      return new Json($g.abi.libs_by_name.get(stdlib.name)!.mapped[123]);
    }
  ...
  export class CsvColumnFloat extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnFloat {
      return new CsvColumnFloat($g.abi.libs_by_name.get(stdlib.name)!.mapped[124], name, mandatory, offset);
    }
  ...
  export class CsvColumnInteger extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnInteger {
      return new CsvColumnInteger($g.abi.libs_by_name.get(stdlib.name)!.mapped[125], name, mandatory, offset);
    }
  ...
  export class CsvColumnBoolean extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnBoolean {
      return new CsvColumnBoolean($g.abi.libs_by_name.get(stdlib.name)!.mapped[126], name, mandatory, offset);
    }
  ...
  export class Http extends $greycat.GCObject {
    ...
    static createFrom($g: $greycat.GreyCat = $greycat.$.default): Http {
      return new Http($g.abi.libs_by_name.get(stdlib.name)!.mapped[128]);
    }
  ...
  export class CsvAnalysisConfig extends $greycat.GCObject {
    ...
    static enumerable_limit_default($g: $greycat.GreyCat = $greycat.$.default): bigint {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[130];
    ...
    static createFrom({header_lines = null, separator = null, string_delimiter = null, decimal_separator = null, thousands_separator = null, row_limit = null, enumerable_limit = null, date_check_limit = null, date_formats = null}: {header_lines?: number | bigint | null, separator?: string | null, string_delimiter?: string | null, decimal_separator?: string | null, thousands_separator?: string | null, row_limit?: number | bigint | null, enumerable_limit?: number | bigint | null, date_check_limit?: number | bigint | null, date_formats?: globalThis.Array<string> | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvAnalysisConfig {
      return new CsvAnalysisConfig($g.abi.libs_by_name.get(stdlib.name)!.mapped[130], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, row_limit, enumerable_limit, date_check_limit, date_formats);
    }
  ...
  export class File extends $greycat.GCObject {
    ...
    static createFrom({path, size = null, last_modification = null}: {path: string, size?: number | bigint | null, last_modification?: core.time | null}, $g: $greycat.GreyCat = $greycat.$.default): File {
      return new File($g.abi.libs_by_name.get(stdlib.name)!.mapped[132], path, size, last_modification);
    }
  ...
  export class TextReader extends $greycat.GCObject {
    ...
    static createFrom({path, pos = null}: {path: string, pos?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): TextReader {
      return new TextReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[133], path, pos);
    }
  ...
  export class TextEncoder extends $greycat.GCEnum {
    ...
    static plain($g: $greycat.GreyCat = $greycat.$.default): TextEncoder {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[134];
  ...
  export class SmtpMode extends $greycat.GCEnum {
    ...
    static plain($g: $greycat.GreyCat = $greycat.$.default): SmtpMode {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[135];
      return t.static_values['plain'];
    }
  ...
  export class CsvWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append = null, format = null}: {path: string, append?: boolean | null, format?: io.CsvFormat | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvWriter {
      return new CsvWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[136], path, append, format);
    }
  ...
  export class Email extends $greycat.GCObject {
    ...
    static createFrom({from, subject, body, body_is_html, to, cc = null, bcc = null}: {from: string, subject: string, body: string, body_is_html: boolean, to: globalThis.Array<string>, cc?: globalThis.Array<string> | null, bcc?: globalThis.Array<string> | null}, $g: $greycat.GreyCat = $greycat.$.default): Email {
      return new Email($g.abi.libs_by_name.get(stdlib.name)!.mapped[137], from, subject, body, body_is_html, to, cc, bcc);
    }
  ...
  export class Url extends $greycat.GCObject {
    ...
    static createFrom({protocol = null, host = null, port = null, path = null, params = null, hash = null}: {protocol?: string | null, host?: string | null, port?: number | bigint | null, path?: string | null, params?: globalThis.Map<string, string> | null, hash?: string | null}, $g: $greycat.GreyCat = $greycat.$.default): Url {
      return new Url($g.abi.libs_by_name.get(stdlib.name)!.mapped[138], protocol, host, port, path, params, hash);
    }
  ...
  export class JsonWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append = null}: {path: string, append?: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): JsonWriter {
      return new JsonWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[140], path, append);
    }
  ...
  export class CsvColumnString extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null, trim = null, try_number = null, try_json = null, values = null, encoder = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null, trim?: boolean | null, try_number?: boolean | null, try_json?: boolean | null, values?: globalThis.Array<string> | null, encoder?: io.TextEncoder | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnString {
      return new CsvColumnString($g.abi.libs_by_name.get(stdlib.name)!.mapped[141], name, mandatory, offset, trim, try_number, try_json, values, encoder);
    }
  ...
  export class TextWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append = null}: {path: string, append?: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): TextWriter {
      return new TextWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[142], path, append);
    }
  ...
  export class CsvSharding extends $greycat.GCObject {
    ...
    static createFrom({id, column, modulo}: {id: number | bigint, column: number | bigint, modulo: number | bigint}, $g: $greycat.GreyCat = $greycat.$.default): CsvSharding {
      return new CsvSharding($g.abi.libs_by_name.get(stdlib.name)!.mapped[143], id, column, modulo);
    }
  ...
  export class FileWalker extends $greycat.GCObject {
    ...
    static createFrom({path}: {path: string}, $g: $greycat.GreyCat = $greycat.$.default): FileWalker {
      return new FileWalker($g.abi.libs_by_name.get(stdlib.name)!.mapped[144], path);
    }
  ...
  export class GcbWriter<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, append = null}: {path: string, append?: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): GcbWriter {
      return new GcbWriter($g.abi.libs_by_name.get(stdlib.name)!.mapped[145], path, append);
    }
  ...
  export class CsvValidateResult extends $greycat.GCObject {
    ...
    static createFrom({line_count, fail_count, invalid_count}: {line_count: number | bigint, fail_count: number | bigint, invalid_count: globalThis.Array<number | bigint>}, $g: $greycat.GreyCat = $greycat.$.default): CsvValidateResult {
      return new CsvValidateResult($g.abi.libs_by_name.get(stdlib.name)!.mapped[146], line_count, fail_count, invalid_count);
    }
  ...
  export class CsvColumnTime extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null, unit = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null, unit?: core.DurationUnit | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnTime {
      return new CsvColumnTime($g.abi.libs_by_name.get(stdlib.name)!.mapped[147], name, mandatory, offset, unit);
    }
  ...
  export class CsvColumnStatistics extends $greycat.GCObject {
    ...
    static createFrom({name = null, example = null, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile}: {name?: string | null, example?: any | null, null_count: number | bigint, bool_count: number | bigint, int_count: number | bigint, float_count: number | bigint, string_count: number | bigint, date_count: number | bigint, date_format_count: globalThis.Map<string, number | bigint>, enumerable_count: globalThis.Map<any, number | bigint>, profile: util.Gaussian}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnStatistics {
      return new CsvColumnStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[148], name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, enumerable_count, profile);
    }
  ...
  export class CsvReader<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, pos = null, format = null, sharding = null}: {path: string, pos?: number | bigint | null, format?: io.CsvFormat | null, sharding?: io.CsvSharding | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvReader {
      return new CsvReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[149], path, pos, format, sharding);
    }
  ...
  export class CsvColumnDate extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null, format = null, tz = null, as_time = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null, format?: string | null, tz?: core.TimeZone | null, as_time?: boolean | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnDate {
      return new CsvColumnDate($g.abi.libs_by_name.get(stdlib.name)!.mapped[150], name, mandatory, offset, format, tz, as_time);
    }
  ...
  export class CsvAnalysis extends $greycat.GCObject {
    ...
    static createFrom({config = null, statistics = null}: {config?: io.CsvAnalysisConfig | null, statistics?: io.CsvStatistics | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvAnalysis {
      return new CsvAnalysis($g.abi.libs_by_name.get(stdlib.name)!.mapped[151], config, statistics);
    }
  ...
  export class CsvAnalysis_analyze_args extends $greycat.GCObject {
    file_path!: string;
    config!: io.CsvAnalysisConfig | null;
    static create(file_path: string, config: io.CsvAnalysisConfig | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new CsvAnalysis_analyze_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[152], file_path, config);
    }
  }
  ...
  export class Smtp extends $greycat.GCObject {
    ...
    static createFrom({host, port, mode = null, authenticate = null, user = null, pass = null}: {host: string, port: number | bigint, mode?: io.SmtpMode | null, authenticate?: io.SmtpAuth | null, user?: string | null, pass?: string | null}, $g: $greycat.GreyCat = $greycat.$.default): Smtp {
      return new Smtp($g.abi.libs_by_name.get(stdlib.name)!.mapped[153], host, port, mode, authenticate, user, pass);
    }
  ...
  export class CsvColumnDuration extends $greycat.GCObject {
    ...
    static createFrom({name = null, mandatory = null, offset = null, unit = null}: {name?: string | null, mandatory?: boolean | null, offset?: number | bigint | null, unit?: core.DurationUnit | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvColumnDuration {
      return new CsvColumnDuration($g.abi.libs_by_name.get(stdlib.name)!.mapped[154], name, mandatory, offset, unit);
    }
  ...
  export class GcbReader<T = any> extends $greycat.GCObject {
    ...
    static createFrom<T>({path, pos = null}: {path: string, pos?: number | bigint | null}, $g: $greycat.GreyCat = $greycat.$.default): GcbReader {
      return new GcbReader($g.abi.libs_by_name.get(stdlib.name)!.mapped[155], path, pos);
    }
  ...
  export class HttpHeader extends $greycat.GCObject {
    ...
    static createFrom({name, value}: {name: string, value: string}, $g: $greycat.GreyCat = $greycat.$.default): HttpHeader {
      return new HttpHeader($g.abi.libs_by_name.get(stdlib.name)!.mapped[156], name, value);
    }
  ...
  export class CsvFormat extends $greycat.GCObject {
    ...
    static createFrom({header_lines = null, separator = null, string_delimiter = null, decimal_separator = null, thousands_separator = null, columns_size = null, columns = null}: {header_lines?: number | bigint | null, separator?: string | null, string_delimiter?: string | null, decimal_separator?: string | null, thousands_separator?: string | null, columns_size?: number | bigint | null, columns?: globalThis.Array<io.CsvColumn> | null}, $g: $greycat.GreyCat = $greycat.$.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[157], header_lines, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
  ...
  export class CsvFormat_infer_args extends $greycat.GCObject {
    analysis!: io.CsvStatistics;
    static create(analysis: io.CsvStatistics, $g: $greycat.GreyCat = $greycat.$.default) {
      return new CsvFormat_infer_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[158], analysis);
    }
  }

  export class CsvFormat_sample_args extends $greycat.GCObject {
    path!: string;
    format!: io.CsvFormat | null;
    offset!: number | bigint | null;
    max!: number | bigint | null;
    static create(path: string, format: io.CsvFormat | null, offset: number | bigint | null, max: number | bigint | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new CsvFormat_sample_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[159], path, format, offset, max);
    }
  }

  export class CsvFormat_validate_args extends $greycat.GCObject {
    path!: string;
    format!: io.CsvFormat;
    max_rows!: number | bigint | null;
    max_invalid!: number | bigint | null;
    invalid_path!: string | null;
    static create(path: string, format: io.CsvFormat, max_rows: number | bigint | null, max_invalid: number | bigint | null, invalid_path: string | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new CsvFormat_validate_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[160], path, format, max_rows, max_invalid, invalid_path);
    }
  }

  export class CsvFormat_generate_args extends $greycat.GCObject {
    format!: io.CsvFormat;
    ident_col!: number | bigint | null;
    time_col!: number | bigint | null;
    static create(format: io.CsvFormat, ident_col: number | bigint | null, time_col: number | bigint | null, $g: $greycat.GreyCat = $greycat.$.default) {
      return new CsvFormat_generate_args($g.abi.libs_by_name.get(stdlib.name)!.mapped[161], format, ident_col, time_col);
    }
  }
  ...
  export class SmtpAuth extends $greycat.GCEnum {
    ...
    static none($g: $greycat.GreyCat = $greycat.$.default): SmtpAuth {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[162];
      return t.static_values['none'];
    }
...
export const stdlib: $greycat.Library = {
  ...
  init(abi) {
    ...
    this.mapped[1] = abi.type_by_fqn.get(core.t4._type)!;
    this.mapped[2] = abi.type_by_fqn.get(core.int._type)!;
    if (this.mapped[2]) {
      this.mapped[2].static_values = {'min': -9223372036854775808n,'max': 9223372036854775807n,};
    }
    this.mapped[3] = abi.type_by_fqn.get(core.function_._type)!;
    this.mapped[4] = abi.type_by_fqn.get(core.Error._type)!;
    this.mapped[5] = abi.type_by_fqn.get(core.nodeList._type)!;
    this.mapped[6] = abi.type_by_fqn.get('core::nodeList_info_args')!;
    this.mapped[7] = abi.type_by_fqn.get('core::nodeList_sample_args')!;
    this.mapped[8] = abi.type_by_fqn.get(core.nodeGeo._type)!;
    this.mapped[9] = abi.type_by_fqn.get('core::nodeGeo_info_args')!;
    this.mapped[10] = abi.type_by_fqn.get('core::nodeGeo_sample_args')!;
    ...
    this.mapped[19] = abi.type_by_fqn.get('core::Date_fromTime_args')!;
    ...
    this.mapped[23] = abi.type_by_fqn.get('core::node_resolve_all_args')!;
    this.mapped[24] = abi.type_by_fqn.get(core.GeoCircle._type)!;
    this.mapped[25] = abi.type_by_fqn.get(core.SamplingMode._type)!;
    this.mapped[25]?.resolveGeneratedOffsetWithValues('fixed', 0,'fixed_reg', 1,'adaptative', 2,'dense', 3);
    this.mapped[26] = abi.type_by_fqn.get(core.GeoPoly._type)!;
    this.mapped[27] = abi.type_by_fqn.get(core.MathConstants._type)!;
    if (this.mapped[27]) {
      this.mapped[27].static_values = {'e': 2.7182818285,'log_2e': 1.4426950409,'log_10e': 0.4342944819,'ln2': 0.6931471806,'ln10': 2.302585093,'pi': 3.1415926536,'pi_2': 1.5707963268,'pi_4': 0.7853981634,'m1_pi': 0.3183098862,'m2_pi': 0.6366197724,'m2_sqrt_pi': 1.1283791671,'sqrt2': 1.4142135624,'sqrt1_2': 0.7071067812,};
    }
    this.mapped[28] = abi.type_by_fqn.get(core.type._type)!;
    this.mapped[29] = abi.type_by_fqn.get(core.nodeTimeSingleton._type)!;
    this.mapped[30] = abi.type_by_fqn.get(core.null_._type)!;
    this.mapped[31] = abi.type_by_fqn.get(core.NodeInfo._type)!;
    this.mapped[32] = abi.type_by_fqn.get(core.char._type)!;
    this.mapped[33] = abi.type_by_fqn.get(core.TableColumnMapping._type)!;
    this.mapped[34] = abi.type_by_fqn.get(core.nodeTime._type)!;
    this.mapped[35] = abi.type_by_fqn.get('core::nodeTime_info_args')!;
    ...
    this.mapped[95] = abi.type_by_fqn.get(runtime.UserCredential._type)!;
    this.mapped[96] = abi.type_by_fqn.get(runtime.Runtime._type)!;
    this.mapped[97] = abi.type_by_fqn.get('runtime::Runtime_root_args')!;
    this.mapped[98] = abi.type_by_fqn.get('runtime::Runtime_abi_args')!;
    this.mapped[99] = abi.type_by_fqn.get('runtime::Runtime_info_args')!;
    this.mapped[100] = abi.type_by_fqn.get(runtime.Job._type)!;
    this.mapped[101] = abi.type_by_fqn.get(runtime.DebugVariable._type)!;
    this.mapped[102] = abi.type_by_fqn.get(runtime.DebugInfo._type)!;
    this.mapped[103] = abi.type_by_fqn.get(runtime.RuntimeInfo._type)!;
    this.mapped[104] = abi.type_by_fqn.get(runtime.DebugBreakpoint._type)!;
    this.mapped[105] = abi.type_by_fqn.get(runtime.StoreStat._type)!;
    this.mapped[106] = abi.type_by_fqn.get(runtime.SecurityFields._type)!;
    this.mapped[107] = abi.type_by_fqn.get('runtime::SecurityFields_get_args')!;
    this.mapped[108] = abi.type_by_fqn.get('runtime::SecurityFields_set_args')!;
    this.mapped[109] = abi.type_by_fqn.get(runtime.CallPerf._type)!;
    this.mapped[110] = abi.type_by_fqn.get(runtime.TaskStatus._type)!;
    this.mapped[110]?.resolveGeneratedOffsetWithValues('empty', 0,'waiting', 1,'running', 2,'await', 3,'cancelled', 4,'error', 5,'ended', 6,'ended_with_errors', 7);
    this.mapped[111] = abi.type_by_fqn.get(runtime.UserRole._type)!;
    this.mapped[112] = abi.type_by_fqn.get('runtime::UserRole_set_args')!;
    this.mapped[113] = abi.type_by_fqn.get('runtime::UserRole_remove_args')!;
    this.mapped[114] = abi.type_by_fqn.get('runtime::UserRole_all_args')!;
    this.mapped[115] = abi.type_by_fqn.get(runtime.UserGroup._type)!;
    this.mapped[116] = abi.type_by_fqn.get(runtime.DebugFrame._type)!;
    this.mapped[117] = abi.type_by_fqn.get(runtime.SecurityEntity._type)!;
    this.mapped[118] = abi.type_by_fqn.get('runtime::SecurityEntity_set_args')!;
    this.mapped[119] = abi.type_by_fqn.get('runtime::SecurityEntity_all_args')!;
    this.mapped[120] = abi.type_by_fqn.get(runtime.Log._type)!;
    this.mapped[121] = abi.type_by_fqn.get(io.JsonReader._type)!;
    this.mapped[122] = abi.type_by_fqn.get(io.CsvColumnIgnored._type)!;
    this.mapped[123] = abi.type_by_fqn.get(io.Json._type)!;
    this.mapped[124] = abi.type_by_fqn.get(io.CsvColumnFloat._type)!;
    this.mapped[125] = abi.type_by_fqn.get(io.CsvColumnInteger._type)!;
    this.mapped[126] = abi.type_by_fqn.get(io.CsvColumnBoolean._type)!;
    this.mapped[127] = abi.type_by_fqn.get(io.CsvStatistics._type)!;
    this.mapped[128] = abi.type_by_fqn.get(io.Http._type)!;
    this.mapped[129] = abi.type_by_fqn.get(io.CsvColumn._type)!;
    this.mapped[130] = abi.type_by_fqn.get(io.CsvAnalysisConfig._type)!;
    if (this.mapped[130]) {
      this.mapped[130].static_values = {'enumerable_limit_default': 100,'date_check_limit_default': 100,};
    }
    this.mapped[131] = abi.type_by_fqn.get(io.Reader._type)!;
    this.mapped[132] = abi.type_by_fqn.get(io.File._type)!;
    this.mapped[133] = abi.type_by_fqn.get(io.TextReader._type)!;
    this.mapped[134] = abi.type_by_fqn.get(io.TextEncoder._type)!;
    this.mapped[134]?.resolveGeneratedOffsetWithValues('plain', null,'base64', null,'base64url', null,'hexadecimal', null);
    this.mapped[135] = abi.type_by_fqn.get(io.SmtpMode._type)!;
    this.mapped[135]?.resolveGeneratedOffsetWithValues('plain', 0,'ssl_tls', 1,'starttls', 2);
    this.mapped[136] = abi.type_by_fqn.get(io.CsvWriter._type)!;
    this.mapped[137] = abi.type_by_fqn.get(io.Email._type)!;
    this.mapped[138] = abi.type_by_fqn.get(io.Url._type)!;
    this.mapped[139] = abi.type_by_fqn.get(io.Writer._type)!;
    this.mapped[140] = abi.type_by_fqn.get(io.JsonWriter._type)!;
    this.mapped[141] = abi.type_by_fqn.get(io.CsvColumnString._type)!;
    this.mapped[142] = abi.type_by_fqn.get(io.TextWriter._type)!;
    this.mapped[143] = abi.type_by_fqn.get(io.CsvSharding._type)!;
    this.mapped[144] = abi.type_by_fqn.get(io.FileWalker._type)!;
    this.mapped[145] = abi.type_by_fqn.get(io.GcbWriter._type)!;
    this.mapped[146] = abi.type_by_fqn.get(io.CsvValidateResult._type)!;
    this.mapped[147] = abi.type_by_fqn.get(io.CsvColumnTime._type)!;
    this.mapped[148] = abi.type_by_fqn.get(io.CsvColumnStatistics._type)!;
    this.mapped[149] = abi.type_by_fqn.get(io.CsvReader._type)!;
    this.mapped[150] = abi.type_by_fqn.get(io.CsvColumnDate._type)!;
    this.mapped[151] = abi.type_by_fqn.get(io.CsvAnalysis._type)!;
    this.mapped[152] = abi.type_by_fqn.get('io::CsvAnalysis_analyze_args')!;
    this.mapped[153] = abi.type_by_fqn.get(io.Smtp._type)!;
    this.mapped[154] = abi.type_by_fqn.get(io.CsvColumnDuration._type)!;
    this.mapped[155] = abi.type_by_fqn.get(io.GcbReader._type)!;
    this.mapped[156] = abi.type_by_fqn.get(io.HttpHeader._type)!;
    this.mapped[157] = abi.type_by_fqn.get(io.CsvFormat._type)!;
    this.mapped[158] = abi.type_by_fqn.get('io::CsvFormat_infer_args')!;
    this.mapped[159] = abi.type_by_fqn.get('io::CsvFormat_sample_args')!;
    this.mapped[160] = abi.type_by_fqn.get('io::CsvFormat_validate_args')!;
    this.mapped[161] = abi.type_by_fqn.get('io::CsvFormat_generate_args')!;
    this.mapped[162] = abi.type_by_fqn.get(io.SmtpAuth._type)!;
    this.mapped[162]?.resolveGeneratedOffsetWithValues('none', 0,'plain', 1,'login', 2);
