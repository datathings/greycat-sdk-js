...
export namespace core {
  ...
  export class GeoCircle extends $sdk.GCObject {
    ...
    static createFrom({center, radius}: {center: $sdk.std.core.geo, radius: number}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoCircle {
      return new GeoCircle($g.abi.libs_by_name.get(stdlib.name)!.mapped[15], center, radius);
    }
  ...
  export class NodeInfo<T extends $sdk.Value = any> extends $sdk.GCObject {
    ...
    static createFrom({size, from, to}: {size: bigint | number, from: any | null, to: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): NodeInfo {
      return new NodeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[17], size, from, to);
    }
  ...
  export class TimeZone extends $sdk.GCEnum {
    ...
    static Africa_Accra($g: $sdk.GreyCat = globalThis.greycat.default): TimeZone {
      const t = $g.abi.libs_by_name.get(stdlib.name)!.mapped[19];
  ...
  export class nodeTimeSingleton extends $sdk.GCObject {
    ...
    static createFrom({t, v}: {t: $sdk.std.core.time, v: any}, $g: $sdk.GreyCat = globalThis.greycat.default): nodeTimeSingleton {
      return new nodeTimeSingleton($g.abi.libs_by_name.get(stdlib.name)!.mapped[24], t, v);
    }
  ...
  export class Tuple<T extends $sdk.Value = any, U extends $sdk.Value = any> extends $sdk.GCObject {
    ...
    static createFrom({x, y}: {x: any, y: any}, $g: $sdk.GreyCat = globalThis.greycat.default): Tuple {
      return new Tuple($g.abi.libs_by_name.get(stdlib.name)!.mapped[29], x, y);
    }
  ...
  export class TableColumnMeta extends $sdk.GCObject {
    ...
    static createFrom({type, size, index, header, min, max, avg, std}: {type: string | null, size: bigint | number, index: boolean, header: string | null, min: any | null, max: any | null, avg: any | null, std: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TableColumnMeta {
      return new TableColumnMeta($g.abi.libs_by_name.get(stdlib.name)!.mapped[34], type, size, index, header, min, max, avg, std);
    }
  ...
  export class GeoPoly extends $sdk.GCObject {
    ...
    static createFrom({points}: {points: globalThis.Array<$sdk.std.core.geo>}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[35], points);
    }
  ...
  export class GeoBox extends $sdk.GCObject {
    ...
    static createFrom({sw, ne}: {sw: $sdk.std.core.geo, ne: $sdk.std.core.geo}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoBox {
      return new GeoBox($g.abi.libs_by_name.get(stdlib.name)!.mapped[37], sw, ne);
    }
...
export namespace runtime {
  export class SecurityFields extends $sdk.GCObject {
    ...
    static createFrom({email, name, first_name, last_name, roles, groups}: {email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: globalThis.Map<string, string> | null, groups: globalThis.Map<string, string> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): SecurityFields {
      return new SecurityFields($g.abi.libs_by_name.get(stdlib.name)!.mapped[39], email, name, first_name, last_name, roles, groups);
    }
  ...
  export class OpenIDConnect extends $sdk.GCObject {
    ...
    static createFrom({url, clientId}: {url: string, clientId: string}, $g: $sdk.GreyCat = globalThis.greycat.default): OpenIDConnect {
      return new OpenIDConnect($g.abi.libs_by_name.get(stdlib.name)!.mapped[40], url, clientId);
    }
  ...
  export class SecurityPolicy extends $sdk.GCObject {
    ...
    static createFrom({entities, credentials, roles, fields}: {entities: globalThis.Array<runtime.SecurityEntity>, credentials: globalThis.Map<string, runtime.UserCredential>, roles: globalThis.Map<string, runtime.UserRole>, fields: runtime.SecurityFields | null}, $g: $sdk.GreyCat = globalThis.greycat.default): SecurityPolicy {
      return new SecurityPolicy($g.abi.libs_by_name.get(stdlib.name)!.mapped[42], entities, credentials, roles, fields);
    }
  ...
  export class UserGroup extends $sdk.GCObject {
    ...
    static createFrom({id, name, activated}: {id: bigint | number, name: string, activated: boolean}, $g: $sdk.GreyCat = globalThis.greycat.default): UserGroup {
      return new UserGroup($g.abi.libs_by_name.get(stdlib.name)!.mapped[45], id, name, activated);
    }
  ...
  export class Runtime extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Runtime {
      return new Runtime($g.abi.libs_by_name.get(stdlib.name)!.mapped[46]);
    }
  ...
  export class RuntimeInfo extends $sdk.GCObject {
    ...
    static createFrom({version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats}: {version: string, program_version: string | null, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: bigint | number, bg_threads: bigint | number, fg_threads: bigint | number, mem_total: bigint | number, mem_worker: bigint | number, nb_ctx: bigint | number, store_stats: runtime.StoreStat | null}, $g: $sdk.GreyCat = globalThis.greycat.default): RuntimeInfo {
      return new RuntimeInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[48], version, program_version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
    }
  ...
  export class License extends $sdk.GCObject {
    ...
    static createFrom({name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4}: {name: string | null, start: $sdk.std.core.time, end: $sdk.std.core.time, company: string | null, max_workers: bigint | number, max_memory: bigint | number, extra_1: bigint | number | null, extra_2: bigint | number | null, extra_3: bigint | number | null, extra_4: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): License {
      return new License($g.abi.libs_by_name.get(stdlib.name)!.mapped[49], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4);
    }
  ...
  export class TaskInfo extends $sdk.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all}: {user_id: bigint | number, task_id: bigint | number, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, status: runtime.TaskStatus, start: $sdk.std.core.time | null, progress: number | null, remaining: $sdk.std.core.duration | null, duration: $sdk.std.core.duration | null, sub_waiting: bigint | number | null, sub_tasks_all: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TaskInfo {
      return new TaskInfo($g.abi.libs_by_name.get(stdlib.name)!.mapped[50], user_id, task_id, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all);
    }
  ...
  export class PeriodicTask extends $sdk.GCObject {
    ...
    static createFrom({function_, user_id, arguments_, start, every}: {function_: core.function_, user_id: bigint | number, arguments_: globalThis.Array<any> | null, start: $sdk.std.core.time, every: $sdk.std.core.duration}, $g: $sdk.GreyCat = globalThis.greycat.default): PeriodicTask {
      return new PeriodicTask($g.abi.libs_by_name.get(stdlib.name)!.mapped[52], function_, user_id, arguments_, start, every);
    }
  ...
  export class System extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): System {
      return new System($g.abi.libs_by_name.get(stdlib.name)!.mapped[54]);
    }
  ...
  export class Task extends $sdk.GCObject {
    ...
    static createFrom({user_id, task_id, mod, type, fun, creation, status}: {user_id: bigint | number, task_id: bigint | number, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, status: runtime.TaskStatus}, $g: $sdk.GreyCat = globalThis.greycat.default): Task {
      return new Task($g.abi.libs_by_name.get(stdlib.name)!.mapped[57], user_id, task_id, mod, type, fun, creation, status);
    }
...
export namespace io {
  export class CsvColumnStatistics extends $sdk.GCObject {
    ...
    static createFrom({name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, word_list, profile}: {name: string, example: any | null, null_count: bigint | number, bool_count: bigint | number, int_count: bigint | number, float_count: bigint | number, string_count: bigint | number, date_count: bigint | number, date_format_count: globalThis.Map<string, bigint | number>, word_list: globalThis.Map<string, bigint | number>, profile: util.Gaussian}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnStatistics {
      return new CsvColumnStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[58], name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, word_list, profile);
    }
  ...
  export class Url extends $sdk.GCObject {
    ...
    static createFrom({protocol, host, port, path, params, hash}: {protocol: string | null, host: string | null, port: bigint | number | null, path: string | null, params: globalThis.Map<string, string> | null, hash: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Url {
      return new Url($g.abi.libs_by_name.get(stdlib.name)!.mapped[59], protocol, host, port, path, params, hash);
    }
  ...
  export class File extends $sdk.GCObject {
    ...
    static createFrom({path, size, last_modification}: {path: string, size: bigint | number | null, last_modification: $sdk.std.core.time | null}, $g: $sdk.GreyCat = globalThis.greycat.default): File {
      return new File($g.abi.libs_by_name.get(stdlib.name)!.mapped[60], path, size, last_modification);
    }
  ...
  export class CsvColumnIgnored extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnIgnored {
      return new CsvColumnIgnored($g.abi.libs_by_name.get(stdlib.name)!.mapped[61], name, mandatory, offset);
    }
  ...
  export class CsvColumnString extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, trim, try_number, try_json, values, encoder}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: globalThis.Array<string> | null, encoder: io.TextEncoder | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnString {
      return new CsvColumnString($g.abi.libs_by_name.get(stdlib.name)!.mapped[63], name, mandatory, offset, trim, try_number, try_json, values, encoder);
    }
  ...
  export class CsvColumnInteger extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnInteger {
      return new CsvColumnInteger($g.abi.libs_by_name.get(stdlib.name)!.mapped[66], name, mandatory, offset);
    }
  ...
  export class CsvStatistics extends $sdk.GCObject {
    ...
    static createFrom({columns, line_count, fail_count, file_count}: {columns: globalThis.Array<io.CsvColumnStatistics>, line_count: bigint | number, fail_count: bigint | number, file_count: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvStatistics {
      return new CsvStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[68], columns, line_count, fail_count, file_count);
    }
  ...
  export class CsvColumnDate extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, format, tz, as_time}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, format: string | null, tz: core.TimeZone | null, as_time: boolean | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnDate {
      return new CsvColumnDate($g.abi.libs_by_name.get(stdlib.name)!.mapped[69], name, mandatory, offset, format, tz, as_time);
    }
  ...
  export class Http extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Http {
      return new Http($g.abi.libs_by_name.get(stdlib.name)!.mapped[70]);
    }
  ...
  export class CsvAnalysis extends $sdk.GCObject {
    ...
    static createFrom({format, row_limit, enum_limit, date_check_limit, date_formats, statistics}: {format: io.CsvFormat | null, row_limit: bigint | number | null, enum_limit: bigint | number | null, date_check_limit: bigint | number | null, date_formats: globalThis.Array<string> | null, statistics: io.CsvStatistics | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvAnalysis {
      return new CsvAnalysis($g.abi.libs_by_name.get(stdlib.name)!.mapped[71], format, row_limit, enum_limit, date_check_limit, date_formats, statistics);
    }
  ...
  export class CsvFormat extends $sdk.GCObject {
    ...
    static createFrom({header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns}: {header_lines: bigint | number | null, infer: boolean | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, columns_size: bigint | number | null, columns: globalThis.Array<io.CsvColumn> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[75], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
  ...
  export class CsvColumnTime extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, unit: core.DurationUnit | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnTime {
      return new CsvColumnTime($g.abi.libs_by_name.get(stdlib.name)!.mapped[76], name, mandatory, offset, unit);
    }
  ...
  export class Smtp extends $sdk.GCObject {
    ...
    static createFrom({host, port, mode, authenticate, user, pass}: {host: string, port: bigint | number, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Smtp {
      return new Smtp($g.abi.libs_by_name.get(stdlib.name)!.mapped[77], host, port, mode, authenticate, user, pass);
    }
  ...
  export class CsvColumnDuration extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, unit}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, unit: core.DurationUnit | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnDuration {
      return new CsvColumnDuration($g.abi.libs_by_name.get(stdlib.name)!.mapped[78], name, mandatory, offset, unit);
    }
...
export namespace math {
  export class MathConstants extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): MathConstants {
      return new MathConstants($g.abi.libs_by_name.get(stdlib.name)!.mapped[80]);
    }
...
export namespace util {
  ...
  export class Assert extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Assert {
      return new Assert($g.abi.libs_by_name.get(stdlib.name)!.mapped[82]);
    }
  ...
  export class Gaussian extends $sdk.GCObject {
    ...
    static createFrom({sum, sum_sq, count, min, max}: {sum: number | null, sum_sq: number | null, count: bigint | number | null, min: number | null, max: number | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Gaussian {
      return new Gaussian($g.abi.libs_by_name.get(stdlib.name)!.mapped[84], sum, sum_sq, count, min, max);
    }
  ...
  export class Random extends $sdk.GCObject {
    ...
    static createFrom({seed, v}: {seed: bigint | number, v: number}, $g: $sdk.GreyCat = globalThis.greycat.default): Random {
      return new Random($g.abi.libs_by_name.get(stdlib.name)!.mapped[88], seed, v);
    }
  ...
  export class BoxPlotInt extends $sdk.GCObject {
    ...
    static createFrom({min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size}: {min: bigint | number, max: bigint | number, whiskerLow: bigint | number, whiskerHigh: bigint | number, percentile1: bigint | number, percentile5: bigint | number, percentile25: bigint | number, percentile50: bigint | number, percentile75: bigint | number, percentile95: bigint | number, percentile99: bigint | number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): BoxPlotInt {
      return new BoxPlotInt($g.abi.libs_by_name.get(stdlib.name)!.mapped[89], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
    }
  ...
  export class Crypto extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Crypto {
      return new Crypto($g.abi.libs_by_name.get(stdlib.name)!.mapped[90]);
    }
  ...
  export class BoxPlotFloat extends $sdk.GCObject {
    ...
    static createFrom({min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size}: {min: number, max: number, whiskerLow: number, whiskerHigh: number, percentile1: number, percentile5: number, percentile25: number, percentile50: number, percentile75: number, percentile95: number, percentile99: number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): BoxPlotFloat {
      return new BoxPlotFloat($g.abi.libs_by_name.get(stdlib.name)!.mapped[95], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
    }
...
export const stdlib: $sdk.Library = {
  name: 'std',
  mapped: new globalThis.Array(97),
  ...
  init(abi) {
    ...
    this.mapped[27] = abi.type_by_fqn.get(core.DurationUnit._type);
    this.mapped[27]?.resolveGeneratedOffsetWithValues('microseconds', 1,'milliseconds', 1000,'seconds', 1000000,'minutes', 60000000,'hours', 3600000000,'days', 86400000000,'weeks', 604800000000,'months', 2628000000000,'years', 31536000000000);
    this.mapped[28] = abi.type_by_fqn.get(core.tf2d._type);
    this.mapped[29] = abi.type_by_fqn.get(core.Tuple._type);
    this.mapped[30] = abi.type_by_fqn.get(core.TensorType._type);
    this.mapped[30]?.resolveGeneratedOffsetWithValues('i32', 4,'i64', 8,'f32', 4,'f64', 8,'c64', 8,'c128', 16);
    this.mapped[31] = abi.type_by_fqn.get(core.nodeIndexBucket._type);
    this.mapped[32] = abi.type_by_fqn.get(core.Map._type);
    this.mapped[33] = abi.type_by_fqn.get(core.nodeTime._type);
    this.mapped[34] = abi.type_by_fqn.get(core.TableColumnMeta._type);
    this.mapped[35] = abi.type_by_fqn.get(core.GeoPoly._type);
    this.mapped[36] = abi.type_by_fqn.get(core.ti6d._type);
    this.mapped[37] = abi.type_by_fqn.get(core.GeoBox._type);
    this.mapped[38] = abi.type_by_fqn.get(core.geo._type);
    if (this.mapped[38]) {
      this.mapped[38].static_values = {['min']: abi.createGeo(-85.0511287602,-179.9999999581),['max']: abi.createGeo(85.0511287602,179.9999999581),};
    }
    this.mapped[39] = abi.type_by_fqn.get(runtime.SecurityFields._type);
    this.mapped[40] = abi.type_by_fqn.get(runtime.OpenIDConnect._type);
    this.mapped[41] = abi.type_by_fqn.get(runtime.StoreStat._type);
    this.mapped[42] = abi.type_by_fqn.get(runtime.SecurityPolicy._type);
    this.mapped[43] = abi.type_by_fqn.get(runtime.UserGroupPolicy._type);
    this.mapped[44] = abi.type_by_fqn.get(runtime.User._type);
    this.mapped[45] = abi.type_by_fqn.get(runtime.UserGroup._type);
    this.mapped[46] = abi.type_by_fqn.get(runtime.Runtime._type);
    ...
    this.mapped[49] = abi.type_by_fqn.get(runtime.License._type);
    ...
    this.mapped[52] = abi.type_by_fqn.get(runtime.PeriodicTask._type);
    this.mapped[53] = abi.type_by_fqn.get(runtime.SecurityEntity._type);
    this.mapped[54] = abi.type_by_fqn.get(runtime.System._type);
    this.mapped[55] = abi.type_by_fqn.get(runtime.UserGroupPolicyType._type);
    this.mapped[55]?.resolveGeneratedOffsetWithValues('read', 0,'write', 1,'execute', 2);
    this.mapped[56] = abi.type_by_fqn.get(runtime.UserRole._type);
    this.mapped[57] = abi.type_by_fqn.get(runtime.Task._type);
    this.mapped[58] = abi.type_by_fqn.get(io.CsvColumnStatistics._type);
    this.mapped[59] = abi.type_by_fqn.get(io.Url._type);
    this.mapped[60] = abi.type_by_fqn.get(io.File._type);
    this.mapped[61] = abi.type_by_fqn.get(io.CsvColumnIgnored._type);
    this.mapped[62] = abi.type_by_fqn.get(io.SmtpMode._type);
    this.mapped[62]?.resolveGeneratedOffsetWithValues('plain', 0,'ssl_tls', 1,'starttls', 2);
    this.mapped[63] = abi.type_by_fqn.get(io.CsvColumnString._type);
    this.mapped[64] = abi.type_by_fqn.get(io.CsvColumnBoolean._type);
    this.mapped[65] = abi.type_by_fqn.get(io.CsvColumn._type);
    this.mapped[66] = abi.type_by_fqn.get(io.CsvColumnInteger._type);
    this.mapped[67] = abi.type_by_fqn.get(io.Email._type);
    this.mapped[68] = abi.type_by_fqn.get(io.CsvStatistics._type);
    this.mapped[69] = abi.type_by_fqn.get(io.CsvColumnDate._type);
    this.mapped[70] = abi.type_by_fqn.get(io.Http._type);
    this.mapped[71] = abi.type_by_fqn.get(io.CsvAnalysis._type);
    if (this.mapped[71]) {
      this.mapped[71].static_values = {['row_limit_default']: 1000,['enum_limit_default']: 100,['date_check_limit_default']: 100,};
    }
    ...
    this.mapped[74] = abi.type_by_fqn.get(io.TextEncoder._type);
    this.mapped[74]?.resolveGeneratedOffsetWithValues('plain', null,'base64', null,'base64url', null,'hexadecimal', null);
    this.mapped[75] = abi.type_by_fqn.get(io.CsvFormat._type);
    this.mapped[76] = abi.type_by_fqn.get(io.CsvColumnTime._type);
    this.mapped[77] = abi.type_by_fqn.get(io.Smtp._type);
    ...
    if (this.mapped[80]) {
      this.mapped[80].static_values = {['e']: 2.7182818285,['log_2e']: 1.4426950409,['log_10e']: 0.4342944819,['ln2']: 0.6931471806,['ln10']: 2.302585093,['pi']: 3.1415926536,['pi_2']: 1.5707963268,['pi_4']: 0.7853981634,['m1_pi']: 0.3183098862,['m2_pi']: 0.6366197724,['m2_sqrt_pi']: 1.1283791671,['sqrt2']: 1.4142135624,['sqrt1_2']: 0.7071067812,};
    }
    this.mapped[81] = abi.type_by_fqn.get(util.Buffer._type);
    this.mapped[82] = abi.type_by_fqn.get(util.Assert._type);
    this.mapped[83] = abi.type_by_fqn.get(util.Quantizer._type);
    this.mapped[84] = abi.type_by_fqn.get(util.Gaussian._type);
    this.mapped[85] = abi.type_by_fqn.get(util.Queue._type);
    this.mapped[86] = abi.type_by_fqn.get(util.ProgressTracker._type);
    this.mapped[87] = abi.type_by_fqn.get(util.TimeWindow._type);
    this.mapped[88] = abi.type_by_fqn.get(util.Random._type);
    this.mapped[89] = abi.type_by_fqn.get(util.BoxPlotInt._type);
    ...
    this.mapped[94] = abi.type_by_fqn.get(util.HistogramInt._type);
    if (this.mapped[94]) {
      this.mapped[94].static_values = {['table_off_from']: 0,['table_off_to']: 1,['table_off_count']: 2,['table_off_percentage']: 3,};
    }
    this.mapped[95] = abi.type_by_fqn.get(util.BoxPlotFloat._type);
