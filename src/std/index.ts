...
export namespace core {
  ...
  export class nodeTimeSingleton extends $sdk.GCObject {
    ...
    static createFrom({t, v}: {t: $sdk.std.core.time, v: any}, $g: $sdk.GreyCat = globalThis.greycat.default): nodeTimeSingleton {
      return new nodeTimeSingleton($g.abi.libs_by_name.get(stdlib.name)!.mapped[23], t, v);
    }
  ...
  export class GeoCircle extends $sdk.GCObject {
    ...
    static createFrom({center, radius}: {center: $sdk.std.core.geo, radius: number}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoCircle {
      return new GeoCircle($g.abi.libs_by_name.get(stdlib.name)!.mapped[29], center, radius);
    }
  ...
  export class TableColumnMeta extends $sdk.GCObject {
    ...
    static createFrom({type, size, index, header, min, max, avg, std}: {type: string | null, size: bigint | number, index: boolean, header: string | null, min: any | null, max: any | null, avg: any | null, std: any | null}, $g: $sdk.GreyCat = globalThis.greycat.default): TableColumnMeta {
      return new TableColumnMeta($g.abi.libs_by_name.get(stdlib.name)!.mapped[35], type, size, index, header, min, max, avg, std);
    }
  ...
  export class GeoPoly extends $sdk.GCObject {
    ...
    static createFrom({points}: {points: globalThis.Array<$sdk.std.core.geo>}, $g: $sdk.GreyCat = globalThis.greycat.default): GeoPoly {
      return new GeoPoly($g.abi.libs_by_name.get(stdlib.name)!.mapped[38], points);
    }
...
export namespace io {
  export class CsvStatistics extends $sdk.GCObject {
    ...
    static createFrom({columns, line_count, fail_count, file_count}: {columns: globalThis.Array<io.CsvColumnStatistics>, line_count: bigint | number, fail_count: bigint | number, file_count: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvStatistics {
      return new CsvStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[58], columns, line_count, fail_count, file_count);
    }
  ...
  export class CsvColumnStatistics extends $sdk.GCObject {
    ...
    static createFrom({name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, word_list, profile}: {name: string, example: any | null, null_count: bigint | number, bool_count: bigint | number, int_count: bigint | number, float_count: bigint | number, string_count: bigint | number, date_count: bigint | number, date_format_count: globalThis.Map<string, bigint | number>, word_list: globalThis.Map<string, bigint | number>, profile: util.Gaussian}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnStatistics {
      return new CsvColumnStatistics($g.abi.libs_by_name.get(stdlib.name)!.mapped[62], name, example, null_count, bool_count, int_count, float_count, string_count, date_count, date_format_count, word_list, profile);
    }
  ...
  export class CsvAnalysis extends $sdk.GCObject {
    ...
    static createFrom({format, row_limit, enum_limit, date_check_limit, date_formats, statistics}: {format: io.CsvFormat | null, row_limit: bigint | number | null, enum_limit: bigint | number | null, date_check_limit: bigint | number | null, date_formats: globalThis.Array<string> | null, statistics: io.CsvStatistics | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvAnalysis {
      return new CsvAnalysis($g.abi.libs_by_name.get(stdlib.name)!.mapped[66], format, row_limit, enum_limit, date_check_limit, date_formats, statistics);
    }
  ...
  export class Smtp extends $sdk.GCObject {
    ...
    static createFrom({host, port, mode, authenticate, user, pass}: {host: string, port: bigint | number, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null}, $g: $sdk.GreyCat = globalThis.greycat.default): Smtp {
      return new Smtp($g.abi.libs_by_name.get(stdlib.name)!.mapped[67], host, port, mode, authenticate, user, pass);
    }
  ...
  export class CsvColumnString extends $sdk.GCObject {
    ...
    static createFrom({name, mandatory, offset, trim, try_number, try_json, values, encoder}: {name: string | null, mandatory: boolean | null, offset: bigint | number | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: globalThis.Array<string> | null, encoder: io.TextEncoder | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvColumnString {
      return new CsvColumnString($g.abi.libs_by_name.get(stdlib.name)!.mapped[68], name, mandatory, offset, trim, try_number, try_json, values, encoder);
    }
  ...
  export class CsvFormat extends $sdk.GCObject {
    ...
    static createFrom({header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns}: {header_lines: bigint | number | null, infer: boolean | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, columns_size: bigint | number | null, columns: globalThis.Array<io.CsvColumn> | null}, $g: $sdk.GreyCat = globalThis.greycat.default): CsvFormat {
      return new CsvFormat($g.abi.libs_by_name.get(stdlib.name)!.mapped[72], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns_size, columns);
    }
...
export namespace util {
  ...
  export class Assert extends $sdk.GCObject {
    ...
    static createFrom($g: $sdk.GreyCat = globalThis.greycat.default): Assert {
      return new Assert($g.abi.libs_by_name.get(stdlib.name)!.mapped[86]);
    }
  ...
  export class BoxPlotInt extends $sdk.GCObject {
    ...
    static createFrom({min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size}: {min: bigint | number, max: bigint | number, whiskerLow: bigint | number, whiskerHigh: bigint | number, percentile1: bigint | number, percentile5: bigint | number, percentile25: bigint | number, percentile50: bigint | number, percentile75: bigint | number, percentile95: bigint | number, percentile99: bigint | number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number}, $g: $sdk.GreyCat = globalThis.greycat.default): BoxPlotInt {
      return new BoxPlotInt($g.abi.libs_by_name.get(stdlib.name)!.mapped[91], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
    }
...
export const stdlib: $sdk.Library = {
  ...
  init(abi) {
    this.mapped[0] = abi.type_by_fqn.get(core.tf4d._type);
    ...
    this.mapped[3] = abi.type_by_fqn.get(core.ErrorCode._type);
    this.mapped[3]?.resolveGeneratedOffsetWithValues('none', 0,'too_deep_workspace', 1,'too_deep_iterator', 2,'wrong_operand', 3,'wrong_params', 4,'wrong_param_type', 5,'wrong_numeric', 6,'wrong_state', 7,'wrong_null', 8,'unresolved_ref', 9,'assign_error', 10,'interrupted', 11,'throw', 12,'wrong_type', 13,'wrong_dimension', 14,'unsupported_operation', 15,'unsupported_type', 16,'dimensions_mismatch', 17,'timeout', 18,'forbidden', 19,'runtime_error', 20);
    this.mapped[4] = abi.type_by_fqn.get(core.DurationUnit._type);
    this.mapped[4]?.resolveGeneratedOffsetWithValues('microseconds', 1,'milliseconds', 1000,'seconds', 1000000,'minutes', 60000000,'hours', 3600000000,'days', 86400000000,'weeks', 604800000000,'months', 2628000000000,'years', 31536000000000);
    this.mapped[5] = abi.type_by_fqn.get(core.nodeIndexBucket._type);
    this.mapped[6] = abi.type_by_fqn.get(core.Array._type);
    this.mapped[7] = abi.type_by_fqn.get(core.Table._type);
    this.mapped[8] = abi.type_by_fqn.get(core.ti2d._type);
    this.mapped[9] = abi.type_by_fqn.get(core.Map._type);
    ...
    this.mapped[16] = abi.type_by_fqn.get(core.Tensor._type);
    ...
    this.mapped[20] = abi.type_by_fqn.get(core.TensorType._type);
    this.mapped[20]?.resolveGeneratedOffsetWithValues('i32', 4,'i64', 8,'f32', 4,'f64', 8,'c64', 8,'c128', 16);
    this.mapped[21] = abi.type_by_fqn.get(core.ti3d._type);
    this.mapped[22] = abi.type_by_fqn.get(core.function_._type);
    this.mapped[23] = abi.type_by_fqn.get(core.nodeTimeSingleton._type);
    ...
    this.mapped[27] = abi.type_by_fqn.get(core.Error._type);
    this.mapped[28] = abi.type_by_fqn.get(core.Tuple._type);
    this.mapped[29] = abi.type_by_fqn.get(core.GeoCircle._type);
    this.mapped[30] = abi.type_by_fqn.get(core.nodeIndex._type);
    this.mapped[31] = abi.type_by_fqn.get(core.tf3d._type);
    this.mapped[32] = abi.type_by_fqn.get(core.nodeGeo._type);
    this.mapped[33] = abi.type_by_fqn.get(core.nodeTime._type);
    this.mapped[34] = abi.type_by_fqn.get(core.geo._type);
    if (this.mapped[34]) {
      this.mapped[34].static_values = {['min']: abi.createGeo(-85.0511287602,-179.9999999581),['max']: abi.createGeo(85.0511287602,179.9999999581),};
    }
    this.mapped[35] = abi.type_by_fqn.get(core.TableColumnMeta._type);
    this.mapped[36] = abi.type_by_fqn.get(core.DatePart._type);
    this.mapped[36]?.resolveGeneratedOffsetWithValues('years', 0,'months', 1,'days', 2,'hours', 3,'minutes', 4,'seconds', 5,'microseconds', 6);
    this.mapped[37] = abi.type_by_fqn.get(core.ti5d._type);
    this.mapped[38] = abi.type_by_fqn.get(core.GeoPoly._type);
    ...
    this.mapped[62] = abi.type_by_fqn.get(io.CsvColumnStatistics._type);
    ...
    this.mapped[66] = abi.type_by_fqn.get(io.CsvAnalysis._type);
    if (this.mapped[66]) {
      this.mapped[66].static_values = {['row_limit_default']: 1000,['enum_limit_default']: 100,['date_check_limit_default']: 100,};
    }
    this.mapped[67] = abi.type_by_fqn.get(io.Smtp._type);
    this.mapped[68] = abi.type_by_fqn.get(io.CsvColumnString._type);
    this.mapped[69] = abi.type_by_fqn.get(io.CsvColumn._type);
    this.mapped[70] = abi.type_by_fqn.get(io.CsvColumnDate._type);
    this.mapped[71] = abi.type_by_fqn.get(io.CsvColumnDuration._type);
    this.mapped[72] = abi.type_by_fqn.get(io.CsvFormat._type);
    this.mapped[73] = abi.type_by_fqn.get(io.HttpHeader._type);
    this.mapped[74] = abi.type_by_fqn.get(io.SmtpMode._type);
    this.mapped[74]?.resolveGeneratedOffsetWithValues('plain', 0,'ssl_tls', 1,'starttls', 2);
    ...
    this.mapped[83] = abi.type_by_fqn.get(util.Iban._type);
    this.mapped[84] = abi.type_by_fqn.get(util.SlidingWindow._type);
    this.mapped[85] = abi.type_by_fqn.get(util.Random._type);
    this.mapped[86] = abi.type_by_fqn.get(util.Assert._type);
    this.mapped[87] = abi.type_by_fqn.get(util.HistogramInt._type);
    if (this.mapped[87]) {
      this.mapped[87].static_values = {['table_off_from']: 0,['table_off_to']: 1,['table_off_count']: 2,['table_off_percentage']: 3,};
    }
    ...
    if (this.mapped[90]) {
      this.mapped[90].static_values = {['table_off_from']: 0,['table_off_to']: 1,['table_off_count']: 2,['table_off_percentage']: 3,};
    }
    this.mapped[91] = abi.type_by_fqn.get(util.BoxPlotInt._type);
    this.mapped[92] = abi.type_by_fqn.get(util.Gaussian._type);
    this.mapped[93] = abi.type_by_fqn.get(util.TimeWindow._type);
