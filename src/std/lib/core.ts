...
export class GeoBox extends $sdk.GCObject {
 ...
 static create($g: $sdk.GreyCat, sw: $sdk.std.core.geo, ne: $sdk.std.core.geo): GeoBox {
    return new GeoBox($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[0], sw, ne);
  }
}
...
export class TimeZone extends $sdk.GCEnum {
 ...
 static create($g: $sdk.GreyCat): TimeZone {
    return new TimeZone($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[2]);
  }
}
...
export class TableColumnMeta extends $sdk.GCObject {
 ...
 static create($g: $sdk.GreyCat, type: string | null, size: bigint | number, index: boolean, min: any | null, max: any | null, avg: any | null, std: any | null): TableColumnMeta {
    return new TableColumnMeta($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[6], type, size, index, min, max, avg, std);
  }
}

export class ti2d extends $sdk.GCObject {
  static readonly _type = 'core::ti2d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): ti2d {
    return new ti2d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[7]);
  }
}

export class Error extends std_n.core.Error {}

export class tf2d extends $sdk.GCObject {
  static readonly _type = 'core::tf2d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): tf2d {
    return new tf2d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[9]);
  }
}
...
export class ErrorCode extends $sdk.GCEnum {
  ...
  public static none($g: $sdk.GreyCat): $std.core.ErrorCode {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[10];
 ...
 static create($g: $sdk.GreyCat): ErrorCode {
    return new ErrorCode($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[10]);
  }
}

export class ti4d extends $sdk.GCObject {
  static readonly _type = 'core::ti4d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): ti4d {
    return new ti4d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[11]);
  }
}
...
export class SamplingMode extends $sdk.GCEnum {
 ...
 static create($g: $sdk.GreyCat): SamplingMode {
    return new SamplingMode($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[12]);
  }
}
...
export class DurationUnit extends $sdk.GCEnum {
 ...
 static create($g: $sdk.GreyCat): DurationUnit {
    return new DurationUnit($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[13]);
  }
}
...
export class TensorType extends $sdk.GCEnum {
 ...
 static create($g: $sdk.GreyCat): TensorType {
    return new TensorType($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[14]);
  }
}
...
export class ti6d extends $sdk.GCObject {
  static readonly _type = 'core::ti6d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): ti6d {
    return new ti6d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[17]);
  }
}
...
export class ti3d extends $sdk.GCObject {
  static readonly _type = 'core::ti3d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): ti3d {
    return new ti3d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[22]);
  }
}

export class nodeTime extends std_n.core.nodeTime {}

export class ti10d extends $sdk.GCObject {
  static readonly _type = 'core::ti10d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): ti10d {
    return new ti10d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[24]);
  }
}
...
export class function_ extends $sdk.GCObject {
 ...
 static create($g: $sdk.GreyCat): function_ {
    return new function_($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[25]);
  }
}
...
export class NodeTimeInfo extends $sdk.GCObject {
 ...
 static create($g: $sdk.GreyCat, size: bigint | number, from: $sdk.std.core.time | null, to: $sdk.std.core.time | null): NodeTimeInfo {
    return new NodeTimeInfo($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[26], size, from, to);
  }
}
...
export class Tuple extends $sdk.GCObject {
 ...
 static create($g: $sdk.GreyCat, x: any, y: any): Tuple {
    return new Tuple($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[27], x, y);
  }
}

export class nodeIndex extends std_n.core.nodeIndex {}

export class tf3d extends $sdk.GCObject {
  static readonly _type = 'core::tf3d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): tf3d {
    return new tf3d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[29]);
  }
}
...
export class DatePart extends $sdk.GCEnum {
  ...
  public static years($g: $sdk.GreyCat): $std.core.DatePart {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[32];
 ...
 static create($g: $sdk.GreyCat): DatePart {
    return new DatePart($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[32]);
  }
}

export class nodeGeo extends std_n.core.nodeGeo {}

export class ti5d extends $sdk.GCObject {
  static readonly _type = 'core::ti5d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): ti5d {
    return new ti5d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[34]);
  }
}

export class tf4d extends $sdk.GCObject {
  static readonly _type = 'core::tf4d';

  constructor(type: $sdk.AbiType, ...attributes: any[]) {
    super(type, ...attributes);
  }

 static create($g: $sdk.GreyCat): tf4d {
    return new tf4d($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[35]);
  }
}
