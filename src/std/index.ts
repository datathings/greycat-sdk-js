...
export class NodeTimeInfo extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, size: bigint | number, from: $sdk.std.core.time | null, to: $sdk.std.core.time | null): NodeTimeInfo {
    return new NodeTimeInfo($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[1], size, from, to);
  }
}
...
export class TimeZone extends $sdk.GCEnum {
  ...
  public static Africa_Accra($g: $sdk.GreyCat): core.TimeZone {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[5];
...
export class TensorType extends $sdk.GCEnum {
  ...
  public static i32($g: $sdk.GreyCat): core.TensorType {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[6];
...
export class SamplingMode extends $sdk.GCEnum {
  ...
  public static fixed($g: $sdk.GreyCat): core.SamplingMode {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[7];
...
export class GeoBox extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, sw: $sdk.std.core.geo, ne: $sdk.std.core.geo): GeoBox {
    return new GeoBox($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[14], sw, ne);
  }
}
...
export class GeoPoly extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, points: Array<$sdk.std.core.geo>): GeoPoly {
    return new GeoPoly($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[15], points);
  }
}
...
export class TableColumnMeta extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, type: string | null, size: bigint | number, index: boolean, min: any | null, max: any | null, avg: any | null, std: any | null): TableColumnMeta {
    return new TableColumnMeta($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[17], type, size, index, min, max, avg, std);
  }
}
...
export class GeoCircle extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, center: $sdk.std.core.geo, radius: number): GeoCircle {
    return new GeoCircle($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[18], center, radius);
  }
}
...
export class ErrorCode extends $sdk.GCEnum {
  ...
  public static none($g: $sdk.GreyCat): core.ErrorCode {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[20];
...
export class Tuple extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, x: any, y: any): Tuple {
    return new Tuple($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[21], x, y);
  }
}
...
export class DurationUnit extends $sdk.GCEnum {
  ...
  public static microseconds($g: $sdk.GreyCat): core.DurationUnit {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[26];
...
export class Random extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, seed: bigint | number, v: number): Random {
    return new Random($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[39], seed, v);
  }
}
...
export class ProgressTracker extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, start: $sdk.std.core.time, total: bigint | number | null, counter: bigint | number | null, duration: $sdk.std.core.duration | null, progress: number | null, speed: number | null, remaining: $sdk.std.core.duration | null): ProgressTracker {
    return new ProgressTracker($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[42], start, total, counter, duration, progress, speed, remaining);
  }
}
...
export class BoxPlotFloat extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, min: number, max: number, whiskerLow: number, whiskerHigh: number, percentile1: number, percentile5: number, percentile25: number, percentile50: number, percentile75: number, percentile95: number, percentile99: number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number): BoxPlotFloat {
    return new BoxPlotFloat($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[43], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
  }
}
...
export class Crypto extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Crypto {
    return new Crypto($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[45]);
  }
}
...
export class Assert extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Assert {
    return new Assert($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[48]);
  }
}
...
export class BoxPlotInt extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, min: bigint | number, max: bigint | number, whiskerLow: bigint | number, whiskerHigh: bigint | number, percentile1: bigint | number, percentile5: bigint | number, percentile25: bigint | number, percentile50: bigint | number, percentile75: bigint | number, percentile95: bigint | number, percentile99: bigint | number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number): BoxPlotInt {
    return new BoxPlotInt($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[51], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
  }
}
...
export class Gaussian extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, sum: number | null, sum_sq: number | null, count: bigint | number | null, min: number | null, max: number | null): Gaussian {
    return new Gaussian($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[52], sum, sum_sq, count, min, max);
  }
}
...
export class MathConstants extends $sdk.GCObject {
  ...
  public static e($g: $sdk.GreyCat): number {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[54];
  ...
  static create($g: $sdk.GreyCat): MathConstants {
    return new MathConstants($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[54]);
  }
}
...
export class Task extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, user: bigint | number, parent: bigint | number | null, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, status: runtime.TaskStatus, start: $sdk.std.core.time | null, progress: number | null, remaining: $sdk.std.core.duration | null, duration: $sdk.std.core.duration | null, sub_waiting: bigint | number | null, sub_tasks_all: bigint | number | null): Task {
    return new Task($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[55], id, user, parent, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all);
  }
}
...
export class UserRole extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string, permissions: Array<string>): UserRole {
    return new UserRole($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[56], name, permissions);
  }
}
...
export class UserCredential extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, offset: bigint | number, pass: string | null): UserCredential {
    return new UserCredential($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[57], offset, pass);
  }
}
...
export class System extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): System {
    return new System($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[58]);
  }
}
...
export class UserGroup extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, name: string, activated: boolean): UserGroup {
    return new UserGroup($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[59], id, name, activated);
  }
}
...
export class User extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, name: string, activated: boolean, full_name: string | null, email: string | null, role: string | null, permissions_flags: bigint | number | null, groups: Array<runtime.UserGroupPolicy> | null, groups_flags: bigint | number | null, external: boolean): User {
    return new User($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[60], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
  }
}
...
export class License extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, start: $sdk.std.core.time, end: $sdk.std.core.time, company: string | null, max_workers: bigint | number, max_memory: bigint | number, extra_1: bigint | number | null, extra_2: bigint | number | null, extra_3: bigint | number | null, extra_4: bigint | number | null): License {
    return new License($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[61], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4);
  }
}
...
export class PeriodicTask extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string, user_id: bigint | number, args: string | null, start: $sdk.std.core.time, every: $sdk.std.core.duration): PeriodicTask {
    return new PeriodicTask($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[62], name, user_id, args, start, every);
  }
}
...
export class SecurityFields extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: Map<string, string> | null, groups: Map<string, string> | null): SecurityFields {
    return new SecurityFields($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[63], email, name, first_name, last_name, roles, groups);
  }
}
...
export class RuntimeInfo extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, version: string, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: bigint | number, bg_threads: bigint | number, fg_threads: bigint | number, mem_total: bigint | number, mem_worker: bigint | number, nb_ctx: bigint | number, store_stats: runtime.StoreStat | null): RuntimeInfo {
    return new RuntimeInfo($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[64], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
  }
}
...
export class OpenIDConnect extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, url: string, clientId: string): OpenIDConnect {
    return new OpenIDConnect($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[65], url, clientId);
  }
}
...
export class SecurityPolicy extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, entities: Array<runtime.SecurityEntity>, credentials: Map<string, runtime.UserCredential>, roles: Map<string, runtime.UserRole>, fields: runtime.SecurityFields | null): SecurityPolicy {
    return new SecurityPolicy($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[66], entities, credentials, roles, fields);
  }
}
...
export class SecurityEntity extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, name: string, activated: boolean): SecurityEntity {
    return new SecurityEntity($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[67], id, name, activated);
  }
}
...
export class UserGroupPolicy extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, group_id: bigint | number, type: runtime.UserGroupPolicyType): UserGroupPolicy {
    return new UserGroupPolicy($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[68], group_id, type);
  }
}
...
export class StoreStat extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, capacity_bytes: bigint | number, allocated_bytes: bigint | number, allocated_ratio: number, remained_bytes: bigint | number, remained_ratio: number, used_bytes: bigint | number, used_ratio: number, available_bytes: bigint | number, available_ratio: number): StoreStat {
    return new StoreStat($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[69], capacity_bytes, allocated_bytes, allocated_ratio, remained_bytes, remained_ratio, used_bytes, used_ratio, available_bytes, available_ratio);
  }
}
...
export class UserGroupPolicyType extends $sdk.GCEnum {
  ...
  public static read($g: $sdk.GreyCat): runtime.UserGroupPolicyType {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[71];
...
export class Runtime extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Runtime {
    return new Runtime($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[72]);
  }
}
...
export class Smtp extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, host: string, port: bigint | number, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null): Smtp {
    return new Smtp($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[73], host, port, mode, authenticate, user, pass);
  }
}
...
export class CsvColumn extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumn {
    return new CsvColumn($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[75], name, mandatory);
  }
}
...
export class CsvFormat extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, header_lines: bigint | number | null, infer: boolean | null, separator: string | null, string_delimiter: string | null, decimal_separator: string | null, thousands_separator: string | null, columns: Array<io.CsvColumn> | null): CsvFormat {
    return new CsvFormat($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[76], header_lines, infer, separator, string_delimiter, decimal_separator, thousands_separator, columns);
  }
}
...
export class File extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, path: string, size: bigint | number | null, last_modification: $sdk.std.core.time | null): File {
    return new File($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[77], path, size, last_modification);
  }
}
...
export class TextEncoder extends $sdk.GCEnum {
  ...
  public static plain($g: $sdk.GreyCat): io.TextEncoder {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[78];
...
export class CsvColumnString extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: Array<string> | null, encoder: io.TextEncoder | null): CsvColumnString {
    return new CsvColumnString($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[80], name, mandatory, trim, try_number, try_json, values, encoder);
  }
}
...
export class CsvColumnIgnored extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnIgnored {
    return new CsvColumnIgnored($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[81], name, mandatory);
  }
}
...
export class CsvColumnDate extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null, format: string | null, tz: core.TimeZone | null, as_time: boolean | null): CsvColumnDate {
    return new CsvColumnDate($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[82], name, mandatory, format, tz, as_time);
  }
}
...
export class HttpHeader extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string, value: string): HttpHeader {
    return new HttpHeader($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[83], name, value);
  }
}
...
export class Url extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, protocol: string | null, host: string | null, port: bigint | number | null, path: string | null, params: Map<string, string> | null, hash: string | null): Url {
    return new Url($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[84], protocol, host, port, path, params, hash);
  }
}
...
export class SmtpAuth extends $sdk.GCEnum {
  ...
  public static none($g: $sdk.GreyCat): io.SmtpAuth {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[86];
...
export class CsvColumnFloat extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnFloat {
    return new CsvColumnFloat($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[87], name, mandatory);
  }
}
...
export class CsvColumnInteger extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnInteger {
    return new CsvColumnInteger($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[88], name, mandatory);
  }
}
...
export class Http extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Http {
    return new Http($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[89]);
  }
}
...
export class Email extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, from: string, subject: string, body: string, body_is_html: boolean, to: Array<string>, cc: Array<string> | null, bcc: Array<string> | null): Email {
    return new Email($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[90], from, subject, body, body_is_html, to, cc, bcc);
  }
}
...
export const stdlib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[38] = abi.type_by_fqn.get(util.SlidingWindow._type)!;
    this.mapped[39] = abi.type_by_fqn.get(util.Random._type)!;
    this.mapped[39].resolveGeneratedOffsets('seed','v');
    this.mapped[40] = abi.type_by_fqn.get(util.TimeWindow._type)!;
    ...
    this.mapped[43] = abi.type_by_fqn.get(util.BoxPlotFloat._type)!;
    ...
    this.mapped[44] = abi.type_by_fqn.get(util.Buffer._type)!;
    this.mapped[45] = abi.type_by_fqn.get(util.Crypto._type)!;
    this.mapped[46] = abi.type_by_fqn.get(util.HistogramFloat._type)!;
    this.mapped[46].static_values = [0,1,2,3];
    this.mapped[47] = abi.type_by_fqn.get(util.Quantizer._type)!;
    this.mapped[48] = abi.type_by_fqn.get(util.Assert._type)!;
    this.mapped[49] = abi.type_by_fqn.get(util.GaussianProfile._type)!;
    this.mapped[49].static_values = [0,1,2,3,4,5,6];
    this.mapped[50] = abi.type_by_fqn.get(util.Iban._type)!;
    ...
    this.mapped[52] = abi.type_by_fqn.get(util.Gaussian._type)!;
    this.mapped[52].resolveGeneratedOffsets('sum','sum_sq','count','min','max');
    this.mapped[53] = abi.type_by_fqn.get(util.Queue._type)!;
    this.mapped[54] = abi.type_by_fqn.get(math.MathConstants._type)!;
    this.mapped[54].static_values = [2.7182818285,1.4426950409,0.4342944819,0.6931471806,2.302585093,3.1415926536,1.5707963268,0.7853981634,0.3183098862,0.6366197724,1.1283791671,1.4142135624,0.7071067812];
    this.mapped[55] = abi.type_by_fqn.get(runtime.Task._type)!;
    this.mapped[55].resolveGeneratedOffsets('id','user','parent','mod','type','fun','creation','status','start','progress','remaining','duration','sub_waiting','sub_tasks_all');
    this.mapped[56] = abi.type_by_fqn.get(runtime.UserRole._type)!;
    this.mapped[56].resolveGeneratedOffsets('name','permissions');
    this.mapped[57] = abi.type_by_fqn.get(runtime.UserCredential._type)!;
    this.mapped[57].resolveGeneratedOffsets('offset','pass');
    this.mapped[58] = abi.type_by_fqn.get(runtime.System._type)!;
    this.mapped[59] = abi.type_by_fqn.get(runtime.UserGroup._type)!;
    this.mapped[59].resolveGeneratedOffsets('id','name','activated');
    this.mapped[60] = abi.type_by_fqn.get(runtime.User._type)!;
    this.mapped[60].resolveGeneratedOffsets('id','name','activated','full_name','email','role','permissions_flags','groups','groups_flags','external');
    this.mapped[61] = abi.type_by_fqn.get(runtime.License._type)!;
    this.mapped[61].resolveGeneratedOffsets('name','start','end','company','max_workers','max_memory','extra_1','extra_2','extra_3','extra_4');
    this.mapped[62] = abi.type_by_fqn.get(runtime.PeriodicTask._type)!;
    this.mapped[62].resolveGeneratedOffsets('name','user_id','args','start','every');
    this.mapped[63] = abi.type_by_fqn.get(runtime.SecurityFields._type)!;
    this.mapped[63].resolveGeneratedOffsets('email','name','first_name','last_name','roles','groups');
    ...
    this.mapped[65] = abi.type_by_fqn.get(runtime.OpenIDConnect._type)!;
    this.mapped[65].resolveGeneratedOffsets('url','clientId');
    this.mapped[66] = abi.type_by_fqn.get(runtime.SecurityPolicy._type)!;
    this.mapped[66].resolveGeneratedOffsets('entities','credentials','roles','fields');
    this.mapped[67] = abi.type_by_fqn.get(runtime.SecurityEntity._type)!;
    this.mapped[67].resolveGeneratedOffsets('id','name','activated');
    this.mapped[68] = abi.type_by_fqn.get(runtime.UserGroupPolicy._type)!;
    this.mapped[68].resolveGeneratedOffsets('group_id','type');
    this.mapped[69] = abi.type_by_fqn.get(runtime.StoreStat._type)!;
    this.mapped[69].resolveGeneratedOffsets('capacity_bytes','allocated_bytes','allocated_ratio','remained_bytes','remained_ratio','used_bytes','used_ratio','available_bytes','available_ratio');
    ...
    this.mapped[71] = abi.type_by_fqn.get(runtime.UserGroupPolicyType._type)!;
    this.mapped[71].resolveGeneratedOffsetWithValues('read', 0,'write', 1,'execute', 2);
    this.mapped[72] = abi.type_by_fqn.get(runtime.Runtime._type)!;
    this.mapped[73] = abi.type_by_fqn.get(io.Smtp._type)!;
    this.mapped[73].resolveGeneratedOffsets('host','port','mode','authenticate','user','pass');
    ...
    this.mapped[76] = abi.type_by_fqn.get(io.CsvFormat._type)!;
    this.mapped[76].resolveGeneratedOffsets('header_lines','infer','separator','string_delimiter','decimal_separator','thousands_separator','columns');
    this.mapped[77] = abi.type_by_fqn.get(io.File._type)!;
    this.mapped[77].resolveGeneratedOffsets('path','size','last_modification');
    this.mapped[78] = abi.type_by_fqn.get(io.TextEncoder._type)!;
    this.mapped[78].resolveGeneratedOffsetWithValues('plain', null,'base64', null,'base64url', null,'hexadecimal', null);
    this.mapped[79] = abi.type_by_fqn.get(io.CsvColumnTime._type)!;
    this.mapped[79].resolveGeneratedOffsets('name','mandatory','unit');
    this.mapped[80] = abi.type_by_fqn.get(io.CsvColumnString._type)!;
    this.mapped[80].resolveGeneratedOffsets('name','mandatory','trim','try_number','try_json','values','encoder');
    this.mapped[81] = abi.type_by_fqn.get(io.CsvColumnIgnored._type)!;
    this.mapped[81].resolveGeneratedOffsets('name','mandatory');
    this.mapped[82] = abi.type_by_fqn.get(io.CsvColumnDate._type)!;
    this.mapped[82].resolveGeneratedOffsets('name','mandatory','format','tz','as_time');
    this.mapped[83] = abi.type_by_fqn.get(io.HttpHeader._type)!;
    this.mapped[83].resolveGeneratedOffsets('name','value');
    this.mapped[84] = abi.type_by_fqn.get(io.Url._type)!;
    ...
    this.mapped[87].resolveGeneratedOffsets('name','mandatory');
    this.mapped[88] = abi.type_by_fqn.get(io.CsvColumnInteger._type)!;
    ...
    this.mapped[90].resolveGeneratedOffsets('from','subject','body','body_is_html','to','cc','bcc');
  },
};
