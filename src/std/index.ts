...
export class TableColumnMeta extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, type: string | null, size: bigint | number, index: boolean, min: any | null, max: any | null, avg: any | null, std: any | null): TableColumnMeta {
    return new TableColumnMeta($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[0], type, size, index, min, max, avg, std);
  }
}
...
export class GeoCircle extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, center: $sdk.std.core.geo, radius: number): GeoCircle {
    return new GeoCircle($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[6], center, radius);
  }
}
...
export class NodeTimeInfo extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, size: bigint | number, from: $sdk.std.core.time | null, to: $sdk.std.core.time | null): NodeTimeInfo {
    return new NodeTimeInfo($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[11], size, from, to);
  }
}
...
export class ErrorCode extends $sdk.GCEnum {
  ...
  public static none($g: $sdk.GreyCat): core.ErrorCode {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[12];
...
export class TensorType extends $sdk.GCEnum {
  ...
  public static i32($g: $sdk.GreyCat): core.TensorType {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[18];
...
export class DurationUnit extends $sdk.GCEnum {
  ...
  public static microseconds($g: $sdk.GreyCat): core.DurationUnit {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[19];
...
export class GeoPoly extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, points: Array<$sdk.std.core.geo>): GeoPoly {
    return new GeoPoly($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[20], points);
  }
}
...
export class TimeZone extends $sdk.GCEnum {
  ...
  public static Africa_Accra($g: $sdk.GreyCat): core.TimeZone {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[29];
...
export class Tuple extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, x: any, y: any): Tuple {
    return new Tuple($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[31], x, y);
  }
}
...
export class DatePart extends $sdk.GCEnum {
  ...
  public static years($g: $sdk.GreyCat): core.DatePart {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[33];
...
export class GeoBox extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, sw: $sdk.std.core.geo, ne: $sdk.std.core.geo): GeoBox {
    return new GeoBox($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[34], sw, ne);
  }
}
...
export class UserRole extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string, permissions: Array<string>): UserRole {
    return new UserRole($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[38], name, permissions);
  }
}
...
export class License extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, start: $sdk.std.core.time, end: $sdk.std.core.time, company: string | null, max_workers: bigint | number, max_memory: bigint | number, extra_1: bigint | number | null, extra_2: bigint | number | null, extra_3: bigint | number | null, extra_4: bigint | number | null): License {
    return new License($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[40], name, start, end, company, max_workers, max_memory, extra_1, extra_2, extra_3, extra_4);
  }
}
...
export class Task extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, user: bigint | number, parent: bigint | number | null, mod: string | null, type: string | null, fun: string | null, creation: $sdk.std.core.time, status: runtime.TaskStatus, start: $sdk.std.core.time | null, progress: number | null, remaining: $sdk.std.core.duration | null, duration: $sdk.std.core.duration | null, sub_waiting: bigint | number | null, sub_tasks_all: bigint | number | null): Task {
    return new Task($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[41], id, user, parent, mod, type, fun, creation, status, start, progress, remaining, duration, sub_waiting, sub_tasks_all);
  }
}
...
export class SecurityFields extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, email: string | null, name: string | null, first_name: string | null, last_name: string | null, roles: Map<string, string> | null, groups: Map<string, string> | null): SecurityFields {
    return new SecurityFields($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[42], email, name, first_name, last_name, roles, groups);
  }
}
...
export class OpenIDConnect extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, url: string, clientId: string): OpenIDConnect {
    return new OpenIDConnect($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[43], url, clientId);
  }
}
...
export class UserGroupPolicyType extends $sdk.GCEnum {
  ...
  public static read($g: $sdk.GreyCat): runtime.UserGroupPolicyType {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[45];
...
export class TaskStatus extends $sdk.GCEnum {
  ...
  public static empty($g: $sdk.GreyCat): runtime.TaskStatus {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[46];
...
export class SecurityEntity extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, name: string, activated: boolean): SecurityEntity {
    return new SecurityEntity($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[47], id, name, activated);
  }
}
...
export class UserGroup extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, name: string, activated: boolean): UserGroup {
    return new UserGroup($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[48], id, name, activated);
  }
}
...
export class Runtime extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Runtime {
    return new Runtime($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[49]);
  }
}
...
export class User extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, id: bigint | number, name: string, activated: boolean, full_name: string | null, email: string | null, role: string | null, permissions_flags: bigint | number | null, groups: Array<runtime.UserGroupPolicy> | null, groups_flags: bigint | number | null, external: boolean): User {
    return new User($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[50], id, name, activated, full_name, email, role, permissions_flags, groups, groups_flags, external);
  }
}
...
export class RuntimeInfo extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, version: string, arch: string, timezone: core.TimeZone, license: runtime.License, io_threads: bigint | number, bg_threads: bigint | number, fg_threads: bigint | number, mem_total: bigint | number, mem_worker: bigint | number, nb_ctx: bigint | number, store_stats: runtime.StoreStat | null): RuntimeInfo {
    return new RuntimeInfo($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[52], version, arch, timezone, license, io_threads, bg_threads, fg_threads, mem_total, mem_worker, nb_ctx, store_stats);
  }
}
...
export class PeriodicTask extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string, user_id: bigint | number, args: string | null, start: $sdk.std.core.time, every: $sdk.std.core.duration): PeriodicTask {
    return new PeriodicTask($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[54], name, user_id, args, start, every);
  }
}
...
export class SecurityPolicy extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, entities: Array<runtime.SecurityEntity>, credentials: Map<string, runtime.UserCredential>, roles: Map<string, runtime.UserRole>, fields: runtime.SecurityFields | null): SecurityPolicy {
    return new SecurityPolicy($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[55], entities, credentials, roles, fields);
  }
}
...
export class Email extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, from: string, subject: string, body: string, body_is_html: boolean, to: Array<string>, cc: Array<string> | null, bcc: Array<string> | null): Email {
    return new Email($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[56], from, subject, body, body_is_html, to, cc, bcc);
  }
}
...
export class CsvColumnString extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null, trim: boolean | null, try_number: boolean | null, try_json: boolean | null, values: Array<string> | null, encoder: io.TextEncoder | null): CsvColumnString {
    return new CsvColumnString($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[57], name, mandatory, trim, try_number, try_json, values, encoder);
  }
}
...
export class CsvColumnTime extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null, unit: core.DurationUnit | null): CsvColumnTime {
    return new CsvColumnTime($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[58], name, mandatory, unit);
  }
}
...
export class CsvColumnDate extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null, format: string | null, tz: core.TimeZone | null, as_time: boolean | null): CsvColumnDate {
    return new CsvColumnDate($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[59], name, mandatory, format, tz, as_time);
  }
}
...
export class CsvColumnFloat extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnFloat {
    return new CsvColumnFloat($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[60], name, mandatory);
  }
}
...
export class HttpHeader extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string, value: string): HttpHeader {
    return new HttpHeader($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[62], name, value);
  }
}
...
export class File extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, path: string, size: bigint | number | null, last_modification: $sdk.std.core.time | null): File {
    return new File($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[63], path, size, last_modification);
  }
}
...
export class TextEncoder extends $sdk.GCEnum {
  ...
  public static plain($g: $sdk.GreyCat): io.TextEncoder {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[64];
...
export class CsvColumn extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumn {
    return new CsvColumn($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[65], name, mandatory);
  }
}
...
export class SmtpMode extends $sdk.GCEnum {
  ...
  public static plain($g: $sdk.GreyCat): io.SmtpMode {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[66];
...
export class Smtp extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, host: string, port: bigint | number, mode: io.SmtpMode | null, authenticate: io.SmtpAuth | null, user: string | null, pass: string | null): Smtp {
    return new Smtp($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[67], host, port, mode, authenticate, user, pass);
  }
}
...
export class CsvColumnBoolean extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnBoolean {
    return new CsvColumnBoolean($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[68], name, mandatory);
  }
}
...
export class CsvColumnInteger extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnInteger {
    return new CsvColumnInteger($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[69], name, mandatory);
  }
}
...
export class SmtpAuth extends $sdk.GCEnum {
  ...
  public static none($g: $sdk.GreyCat): io.SmtpAuth {
    const t = $g.abi.libs_by_name.get($std.stdlib.name)!.mapped[70];
...
export class CsvColumnIgnored extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, name: string | null, mandatory: boolean | null): CsvColumnIgnored {
    return new CsvColumnIgnored($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[71], name, mandatory);
  }
}
...
export class Url extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, protocol: string | null, host: string | null, port: bigint | number | null, path: string | null, params: Map<string, string> | null, hash: string | null): Url {
    return new Url($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[72], protocol, host, port, path, params, hash);
  }
}
...
export class Http extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Http {
    return new Http($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[73]);
  }
}
...
export class Crypto extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Crypto {
    return new Crypto($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[75]);
  }
}
...
export class BoxPlotFloat extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, min: number, max: number, whiskerLow: number, whiskerHigh: number, percentile1: number, percentile5: number, percentile25: number, percentile50: number, percentile75: number, percentile95: number, percentile99: number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number): BoxPlotFloat {
    return new BoxPlotFloat($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[78], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
  }
}
...
export class ProgressTracker extends $sdk.GCObject {
  ...
  public get previous_time(): $sdk.std.core.time | null {
    return this.$attrs[this.$type.generated_offsets[4]];
  }
  public set previous_time(v: $sdk.std.core.time | null) {
    this.$attrs[this.$type.generated_offsets[4]] = v;
  }
  public get previous_steps(): bigint | number | null {
    return this.$attrs[this.$type.generated_offsets[5]];
  }
  public set previous_steps(v: bigint | number | null) {
    this.$attrs[this.$type.generated_offsets[5]] = v;
  }
  public get lap_duration(): $sdk.std.core.duration | null {
    return this.$attrs[this.$type.generated_offsets[6]];
  }
  public set lap_duration(v: $sdk.std.core.duration | null) {
    this.$attrs[this.$type.generated_offsets[6]] = v;
  }
  public get total_speed(): number | null {
    return this.$attrs[this.$type.generated_offsets[7]];
  }
  public set total_speed(v: number | null) {
    this.$attrs[this.$type.generated_offsets[7]] = v;
  }
  public get step_speed(): number | null {
    return this.$attrs[this.$type.generated_offsets[8]];
  }
  public set step_speed(v: number | null) {
    this.$attrs[this.$type.generated_offsets[8]] = v;
  }
  public get progress(): number | null {
    return this.$attrs[this.$type.generated_offsets[9]];
  ...
  public get remaining_time(): $sdk.std.core.duration | null {
    return this.$attrs[this.$type.generated_offsets[10]];
  }
  public set remaining_time(v: $sdk.std.core.duration | null) {
    this.$attrs[this.$type.generated_offsets[10]] = v;
  }
  static create($g: $sdk.GreyCat, start: $sdk.std.core.time, total: bigint | number | null, counter: bigint | number | null, duration: $sdk.std.core.duration | null, previous_time: $sdk.std.core.time | null, previous_steps: bigint | number | null, lap_duration: $sdk.std.core.duration | null, total_speed: number | null, step_speed: number | null, progress: number | null, remaining_time: $sdk.std.core.duration | null): ProgressTracker {
    return new ProgressTracker($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[80], start, total, counter, duration, previous_time, previous_steps, lap_duration, total_speed, step_speed, progress, remaining_time);
  }
}
...
export class NdEncoding extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): NdEncoding {
    return new NdEncoding($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[84]);
  }
}
...
export class BoxPlotInt extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat, min: bigint | number, max: bigint | number, whiskerLow: bigint | number, whiskerHigh: bigint | number, percentile1: bigint | number, percentile5: bigint | number, percentile25: bigint | number, percentile50: bigint | number, percentile75: bigint | number, percentile95: bigint | number, percentile99: bigint | number, countOutliersLow: bigint | number, countOutliersHigh: bigint | number, percentageOutliersLow: number, percentageOutliersHigh: number, sum: number, avg: number, std: number, size: bigint | number): BoxPlotInt {
    return new BoxPlotInt($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[87], min, max, whiskerLow, whiskerHigh, percentile1, percentile5, percentile25, percentile50, percentile75, percentile95, percentile99, countOutliersLow, countOutliersHigh, percentageOutliersLow, percentageOutliersHigh, sum, avg, std, size);
  }
}
...
export class Assert extends $sdk.GCObject {
  ...
  static create($g: $sdk.GreyCat): Assert {
    return new Assert($g.abi.libs_by_name.get($std.stdlib.name)!.mapped[89]);
  }
}
...
export const stdlib: $sdk.Library = {
  ...
  init(abi) {
    ...
    this.mapped[1] = abi.type_by_fqn.get(core.ti10d._type)!;
    this.mapped[2] = abi.type_by_fqn.get(core.SamplingMode._type)!;
    this.mapped[2].resolveGeneratedOffsetWithValues('fixed', 0,'fixed_reg', 1,'adaptative', 2,'dense', 3);
    ...
    this.mapped[6] = abi.type_by_fqn.get(core.GeoCircle._type)!;
    this.mapped[6].resolveGeneratedOffsets('center','radius');
    this.mapped[7] = abi.type_by_fqn.get(core.ti5d._type)!;
    ...
    this.mapped[9] = abi.type_by_fqn.get(core.nodeTime._type)!;
    this.mapped[10] = abi.type_by_fqn.get(core.ti4d._type)!;
    this.mapped[11] = abi.type_by_fqn.get(core.NodeTimeInfo._type)!;
    this.mapped[11].resolveGeneratedOffsets('size','from','to');
    this.mapped[12] = abi.type_by_fqn.get(core.ErrorCode._type)!;
    ...
    this.mapped[36] = abi.type_by_fqn.get(core.ti2d._type)!;
    this.mapped[37] = abi.type_by_fqn.get(core.String._type)!;
    this.mapped[38] = abi.type_by_fqn.get(runtime.UserRole._type)!;
    this.mapped[38].resolveGeneratedOffsets('name','permissions');
    this.mapped[39] = abi.type_by_fqn.get(runtime.UserCredential._type)!;
    this.mapped[39].resolveGeneratedOffsets('offset','pass');
    this.mapped[40] = abi.type_by_fqn.get(runtime.License._type)!;
    this.mapped[40].resolveGeneratedOffsets('name','start','end','company','max_workers','max_memory','extra_1','extra_2','extra_3','extra_4');
    this.mapped[41] = abi.type_by_fqn.get(runtime.Task._type)!;
    this.mapped[41].resolveGeneratedOffsets('id','user','parent','mod','type','fun','creation','status','start','progress','remaining','duration','sub_waiting','sub_tasks_all');
    this.mapped[42] = abi.type_by_fqn.get(runtime.SecurityFields._type)!;
    this.mapped[42].resolveGeneratedOffsets('email','name','first_name','last_name','roles','groups');
    ...
    this.mapped[46] = abi.type_by_fqn.get(runtime.TaskStatus._type)!;
    this.mapped[46].resolveGeneratedOffsetWithValues('empty', 0,'waiting', 1,'running', 2,'cancelled', 3,'error', 4,'ended', 5);
    this.mapped[47] = abi.type_by_fqn.get(runtime.SecurityEntity._type)!;
    this.mapped[47].resolveGeneratedOffsets('id','name','activated');
    this.mapped[48] = abi.type_by_fqn.get(runtime.UserGroup._type)!;
    this.mapped[48].resolveGeneratedOffsets('id','name','activated');
    this.mapped[49] = abi.type_by_fqn.get(runtime.Runtime._type)!;
    this.mapped[50] = abi.type_by_fqn.get(runtime.User._type)!;
    this.mapped[50].resolveGeneratedOffsets('id','name','activated','full_name','email','role','permissions_flags','groups','groups_flags','external');
    this.mapped[51] = abi.type_by_fqn.get(runtime.UserGroupPolicy._type)!;
    this.mapped[51].resolveGeneratedOffsets('group_id','type');
    this.mapped[52] = abi.type_by_fqn.get(runtime.RuntimeInfo._type)!;
    this.mapped[52].resolveGeneratedOffsets('version','arch','timezone','license','io_threads','bg_threads','fg_threads','mem_total','mem_worker','nb_ctx','store_stats');
    ...
    this.mapped[54].resolveGeneratedOffsets('name','user_id','args','start','every');
    this.mapped[55] = abi.type_by_fqn.get(runtime.SecurityPolicy._type)!;
    this.mapped[55].resolveGeneratedOffsets('entities','credentials','roles','fields');
    this.mapped[56] = abi.type_by_fqn.get(io.Email._type)!;
    ...
    this.mapped[59] = abi.type_by_fqn.get(io.CsvColumnDate._type)!;
    this.mapped[59].resolveGeneratedOffsets('name','mandatory','format','tz','as_time');
    this.mapped[60] = abi.type_by_fqn.get(io.CsvColumnFloat._type)!;
    ...
    this.mapped[63].resolveGeneratedOffsets('path','size','last_modification');
    this.mapped[64] = abi.type_by_fqn.get(io.TextEncoder._type)!;
    this.mapped[64].resolveGeneratedOffsetWithValues('plain', null,'base64', null,'base64url', null,'hexadecimal', null);
    this.mapped[65] = abi.type_by_fqn.get(io.CsvColumn._type)!;
    ...
    this.mapped[67] = abi.type_by_fqn.get(io.Smtp._type)!;
    this.mapped[67].resolveGeneratedOffsets('host','port','mode','authenticate','user','pass');
    this.mapped[68] = abi.type_by_fqn.get(io.CsvColumnBoolean._type)!;
    ...
    this.mapped[70] = abi.type_by_fqn.get(io.SmtpAuth._type)!;
    this.mapped[70].resolveGeneratedOffsetWithValues('none', 0,'plain', 1,'login', 2);
    this.mapped[71] = abi.type_by_fqn.get(io.CsvColumnIgnored._type)!;
    this.mapped[71].resolveGeneratedOffsets('name','mandatory');
    this.mapped[72] = abi.type_by_fqn.get(io.Url._type)!;
    this.mapped[72].resolveGeneratedOffsets('protocol','host','port','path','params','hash');
    this.mapped[73] = abi.type_by_fqn.get(io.Http._type)!;
    ...
    this.mapped[75] = abi.type_by_fqn.get(util.Crypto._type)!;
    this.mapped[76] = abi.type_by_fqn.get(util.Quantizer._type)!;
    this.mapped[77] = abi.type_by_fqn.get(util.GaussianProfile._type)!;
    this.mapped[78] = abi.type_by_fqn.get(util.BoxPlotFloat._type)!;
    this.mapped[78].resolveGeneratedOffsets('min','max','whiskerLow','whiskerHigh','percentile1','percentile5','percentile25','percentile50','percentile75','percentile95','percentile99','countOutliersLow','countOutliersHigh','percentageOutliersLow','percentageOutliersHigh','sum','avg','std','size');
    this.mapped[79] = abi.type_by_fqn.get(util.HistogramInt._type)!;
    this.mapped[79].static_values = [0,1,2,3];
    this.mapped[80] = abi.type_by_fqn.get(util.ProgressTracker._type)!;
    this.mapped[80].resolveGeneratedOffsets('start','total','counter','duration','previous_time','previous_steps','lap_duration','total_speed','step_speed','progress','remaining_time');
    this.mapped[81] = abi.type_by_fqn.get(util.SlidingWindow._type)!;
    this.mapped[82] = abi.type_by_fqn.get(util.Random._type)!;
    this.mapped[82].resolveGeneratedOffsets('seed','v');
    this.mapped[83] = abi.type_by_fqn.get(util.Buffer._type)!;
    this.mapped[84] = abi.type_by_fqn.get(util.NdEncoding._type)!;
    this.mapped[85] = abi.type_by_fqn.get(util.TimeWindow._type)!;
    this.mapped[86] = abi.type_by_fqn.get(util.Gaussian._type)!;
    this.mapped[87] = abi.type_by_fqn.get(util.BoxPlotInt._type)!;
    this.mapped[87].resolveGeneratedOffsets('min','max','whiskerLow','whiskerHigh','percentile1','percentile5','percentile25','percentile50','percentile75','percentile95','percentile99','countOutliersLow','countOutliersHigh','percentageOutliersLow','percentageOutliersHigh','sum','avg','std','size');
    this.mapped[88] = abi.type_by_fqn.get(util.Queue._type)!;
    this.mapped[89] = abi.type_by_fqn.get(util.Assert._type)!;
    this.mapped[90] = abi.type_by_fqn.get(util.Iban._type)!;
    this.mapped[91] = abi.type_by_fqn.get(util.HistogramFloat._type)!;
    this.mapped[91].static_values = [0,1,2,3];
  },
};
